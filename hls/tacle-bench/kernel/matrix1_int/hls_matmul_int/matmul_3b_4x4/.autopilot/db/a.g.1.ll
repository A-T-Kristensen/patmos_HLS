; ModuleID = '/home/patmos/github/bachelor_project_HLS/hls/tacle-bench/kernel/matrix1_int/hls_matmul_int/matmul_3b_4x4/.autopilot/db/a.g.1.bc'
...
define void @matmul_hw([4 x i32]* %a, [4 x i32]* %b, [4 x i32]* %c) nounwind uwtable {
  ...
  call void @llvm.dbg.value(metadata !{[4 x i32]* %a}, i64 0, metadata !24), !dbg !25 ; [debug line = 4:25] [debug variable = a]
  call void @llvm.dbg.value(metadata !{[4 x i32]* %b}, i64 0, metadata !26), !dbg !27 ; [debug line = 4:138] [debug variable = b]
  call void @llvm.dbg.value(metadata !{[4 x i32]* %c}, i64 0, metadata !28), !dbg !29 ; [debug line = 4:252] [debug variable = c]
  call void (...)* @_ssdm_SpecArrayDimSize([4 x i32]* %a, i32 4) nounwind, !dbg !30 ; [debug line = 5:2]
  call void (...)* @_ssdm_SpecArrayDimSize([4 x i32]* %b, i32 4) nounwind, !dbg !32 ; [debug line = 5:30]
  call void (...)* @_ssdm_SpecArrayDimSize([4 x i32]* %c, i32 4) nounwind, !dbg !33 ; [debug line = 5:58]
  ...
  call void (...)* @_ssdm_op_SpecResource([4 x i32]* %a, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([12 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 -1, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !36 ; [debug line = 9:1]
  call void (...)* @_ssdm_op_SpecInterface([4 x i32]* %b, i8* getelementptr inbounds ([5 x i8]* @.str2, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !37 ; [debug line = 11:1]
  call void (...)* @_ssdm_op_SpecResource([4 x i32]* %b, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([12 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 -1, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !38 ; [debug line = 12:1]
  call void (...)* @_ssdm_op_SpecInterface([4 x i32]* %c, i8* getelementptr inbounds ([5 x i8]* @.str2, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !39 ; [debug line = 14:1]
  call void (...)* @_ssdm_op_SpecResource([4 x i32]* %c, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([12 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 -1, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !40 ; [debug line = 15:1]
  call void @llvm.dbg.declare(metadata !{[4 x i32]* %a_row}, metadata !41), !dbg !42 ; [debug line = 17:11] [debug variable = a_row]
  call void @llvm.dbg.declare(metadata !{[4 x [4 x i32]]* %b_copy}, metadata !43), !dbg !46 ; [debug line = 18:11] [debug variable = b_copy]
...
; <label>:3                                       ; preds = %.preheader5
  ...
  %a.addr = getelementptr inbounds [4 x i32]* %a, i64 %tmp.1, i64 %tmp.4, !dbg !61 ; [#uses=1 type=i32*] [debug line = 32:6]
  ...
  %a_row.addr = getelementptr inbounds [4 x i32]* %a_row, i64 0, i64 %tmp.4, !dbg !61 ; [#uses=1 type=i32*] [debug line = 32:6]
...
.preheader:                                       ; preds = %4, %.preheader.preheader
  ...
  %exitcond1 = icmp eq i32 %k1, 4, !dbg !70       ; [#uses=1 type=i1] [debug line = 37:29]
  br i1 %exitcond1, label %.loopexit.loopexit, label %4, !dbg !70 ; [debug line = 37:29]

; <label>:4                                       ; preds = %.preheader
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([10 x i8]* @.str6, i64 0, i64 0)) nounwind, !dbg !71 ; [debug line = 37:106]
  %rbegin8 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([10 x i8]* @.str6, i64 0, i64 0)) nounwind, !dbg !71 ; [#uses=1 type=i32] [debug line = 37:106]
  %tmp.7 = sext i32 %k1 to i64, !dbg !66          ; [#uses=2 type=i64] [debug line = 38:7]
  %b.addr = getelementptr inbounds [4 x i32]* %b, i64 %tmp.7, i64 %tmp.6, !dbg !66 ; [#uses=1 type=i32*] [debug line = 38:7]
  ...
  %b_copy.addr = getelementptr inbounds [4 x [4 x i32]]* %b_copy, i64 0, i64 %tmp.7, i64 %tmp.6, !dbg !66 ; [#uses=1 type=i32*] [debug line = 38:7]
  store i32 %b.load, i32* %b_copy.addr, align 4, !dbg !66 ; [debug line = 38:7]
  %rend9 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([10 x i8]* @.str6, i64 0, i64 0), i32 %rbegin8) nounwind, !dbg !72 ; [#uses=0 type=i32] [debug line = 39:5]
  %k.2 = add nsw i32 %k1, 1, !dbg !73             ; [#uses=1 type=i32] [debug line = 37:100]
  call void @llvm.dbg.value(metadata !{i32 %k.2}, i64 0, metadata !74), !dbg !73 ; [debug line = 37:100] [debug variable = k]
  br label %.preheader, !dbg !73                  ; [debug line = 37:100]
...
; <label>:5                                       ; preds = %6, %.loopexit
  ...
  %exitcond = icmp eq i32 %k2, 4, !dbg !78        ; [#uses=1 type=i1] [debug line = 42:27]
  br i1 %exitcond, label %7, label %6, !dbg !78   ; [debug line = 42:27]

; <label>:6                                       ; preds = %5
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([8 x i8]* @.str7, i64 0, i64 0)) nounwind, !dbg !79 ; [debug line = 42:104]
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([8 x i8]* @.str7, i64 0, i64 0)) nounwind, !dbg !79 ; [#uses=1 type=i32] [debug line = 42:104]
  %tmp.12 = sext i32 %k2 to i64, !dbg !75         ; [#uses=2 type=i64] [debug line = 43:4]
  %a_row.addr.1 = getelementptr inbounds [4 x i32]* %a_row, i64 0, i64 %tmp.12, !dbg !75 ; [#uses=1 type=i32*] [debug line = 43:4]
  ...
  %b_copy.addr.1 = getelementptr inbounds [4 x [4 x i32]]* %b_copy, i64 0, i64 %tmp.12, i64 %tmp.9, !dbg !75 ; [#uses=1 type=i32*] [debug line = 43:4]
  ...
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([8 x i8]* @.str7, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !81 ; [#uses=0 type=i32] [debug line = 44:5]
  %k.3 = add nsw i32 %k2, 1, !dbg !82             ; [#uses=1 type=i32] [debug line = 42:98]
  call void @llvm.dbg.value(metadata !{i32 %k.3}, i64 0, metadata !83), !dbg !82 ; [debug line = 42:98] [debug variable = k]
  br label %5, !dbg !82                           ; [debug line = 42:98]

; <label>:7                                       ; preds = %5
  %tmp.0.lcssa = phi i32 [ %tmp10, %5 ]           ; [#uses=1 type=i32]
  %c.addr = getelementptr inbounds [4 x i32]* %c, i64 %tmp.1, i64 %tmp.9, !dbg !53 ; [#uses=1 type=i32*] [debug line = 46:5]
  store i32 %tmp.0.lcssa, i32* %c.addr, align 4, !dbg !53 ; [debug line = 46:5]
  %rend13 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([4 x i8]* @.str4, i64 0, i64 0), i32 %rbegin1) nounwind, !dbg !84 ; [#uses=0 type=i32] [debug line = 47:3]
  %j.1 = add nsw i32 %j, 1, !dbg !85              ; [#uses=1 type=i32] [debug line = 23:63]
  call void @llvm.dbg.value(metadata !{i32 %j.1}, i64 0, metadata !86), !dbg !85 ; [debug line = 23:63] [debug variable = j]
  br label %.preheader7, !dbg !85                 ; [debug line = 23:63]

; <label>:8                                       ; preds = %.preheader7
  %i.1 = add nsw i32 %i, 1, !dbg !87              ; [#uses=1 type=i32] [debug line = 21:58]
  call void @llvm.dbg.value(metadata !{i32 %i.1}, i64 0, metadata !88), !dbg !87 ; [debug line = 21:58] [debug variable = i]
  br label %1, !dbg !87                           ; [debug line = 21:58]
...
!5 = metadata !{i32 786478, i32 0, metadata !6, metadata !"matmul_hw", metadata !"matmul_hw", metadata !"", metadata !6, i32 4, metadata !7, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void ([4 x i32]*, [4 x i32]*, [4 x i32]*)* @matmul_hw, null, null, metadata !15, i32 5} ; [ DW_TAG_subprogram ]
...
!17 = metadata !{void ([4 x i32]*, [4 x i32]*, [4 x i32]*)* @matmul_hw, metadata !18, metadata !19, metadata !20, metadata !21, metadata !22, metadata !23}
...
!67 = metadata !{i32 786443, metadata !68, i32 37, i32 105, metadata !6, i32 10} ; [ DW_TAG_lexical_block ]
...
!71 = metadata !{i32 37, i32 106, metadata !67, null}
!72 = metadata !{i32 39, i32 5, metadata !67, null}
!73 = metadata !{i32 37, i32 100, metadata !68, null}
...
!76 = metadata !{i32 786443, metadata !77, i32 42, i32 103, metadata !6, i32 12} ; [ DW_TAG_lexical_block ]
...
!79 = metadata !{i32 42, i32 104, metadata !76, null}
...
!82 = metadata !{i32 42, i32 98, metadata !77, null}
