...
define void @matmul_hw([16 x i32]* %a, [16 x i32]* %b, [16 x i32]* %c) nounwind uwtable {
  ...
  call void (...)* @_ssdm_op_SpecBitsMap([16 x i32]* %a) nounwind, !map !7
  call void (...)* @_ssdm_op_SpecBitsMap([16 x i32]* %b) nounwind, !map !13
  call void (...)* @_ssdm_op_SpecBitsMap([16 x i32]* %c) nounwind, !map !17
...
.preheader7.preheader:                            ; preds = %.preheader7
  ...
  %tmp_9 = zext i5 %tmp_1 to i64
  %tmp_9_cast = zext i5 %tmp_1 to i6
  %a_addr = getelementptr [16 x i32]* %a, i64 0, i64 %tmp_9
  %tmp_10 = or i5 %tmp_1, 1
  %tmp_11 = call i64 @_ssdm_op_BitConcatenate.i64.i59.i5(i59 0, i5 %tmp_10)
  %a_addr_1 = getelementptr [16 x i32]* %a, i64 0, i64 %tmp_11
  %tmp_12 = or i5 %tmp_1, 2
  %tmp_13 = call i64 @_ssdm_op_BitConcatenate.i64.i59.i5(i59 0, i5 %tmp_12)
  %a_addr_2 = getelementptr [16 x i32]* %a, i64 0, i64 %tmp_13
  %tmp_14 = or i5 %tmp_1, 3
  %tmp_15 = call i64 @_ssdm_op_BitConcatenate.i64.i59.i5(i59 0, i5 %tmp_14)
  %a_addr_3 = getelementptr [16 x i32]* %a, i64 0, i64 %tmp_15
  ...
  %b_addr = getelementptr [16 x i32]* %b, i64 0, i64 %tmp_6
  %tmp_16 = add i4 4, %tmp_6_cast
  %tmp_16_cast = zext i4 %tmp_16 to i64
  %b_addr_1 = getelementptr [16 x i32]* %b, i64 0, i64 %tmp_16_cast
  %tmp_17 = call i64 @_ssdm_op_BitConcatenate.i64.i61.i3(i61 1, i3 %j_mid2)
  %b_addr_2 = getelementptr [16 x i32]* %b, i64 0, i64 %tmp_17
  %tmp_18 = add i5 12, %tmp_6_cast5
  %tmp_18_cast = zext i5 %tmp_18 to i64
  %b_addr_3 = getelementptr [16 x i32]* %b, i64 0, i64 %tmp_18_cast
  %tmp_19 = add i6 %tmp_9_cast, %tmp_6_cast6
  %tmp_19_cast = zext i6 %tmp_19 to i64
  %c_addr = getelementptr [16 x i32]* %c, i64 0, i64 %tmp_19_cast
  %b_copy_0_3_19 = load i32* %b_addr, align 4
  ...
  %b_copy_1_3_19 = load i32* %b_addr_1, align 4
  ...
  %b_copy_2_3_19 = load i32* %b_addr_2, align 4
  ...
  %b_copy_3_3_19 = load i32* %b_addr_3, align 4
  ...
  %tmp_4 = call i32 @_ssdm_op_Mux.ap_auto.4i32.i2(i32 %b_copy_0_3_18, i32 %b_copy_0_3_17, i32 %b_copy_0_3_16, i32 %b_copy_0_3_3, i2 %tmp) nounwind
  %tmp_s = mul nsw i32 %tmp_4, %a_row_0_1
  %tmp_5 = call i32 @_ssdm_op_Mux.ap_auto.4i32.i2(i32 %b_copy_1_3_18, i32 %b_copy_1_3_17, i32 %b_copy_1_3_16, i32 %b_copy_1_3_3, i2 %tmp) nounwind
  %tmp_2_1 = mul nsw i32 %tmp_5, %a_row_1_1
  %tmp_7 = call i32 @_ssdm_op_Mux.ap_auto.4i32.i2(i32 %b_copy_2_3_18, i32 %b_copy_2_3_17, i32 %b_copy_2_3_16, i32 %b_copy_2_3_3, i2 %tmp) nounwind
  %tmp_2_2 = mul nsw i32 %tmp_7, %a_row_2_1
  %tmp_8 = call i32 @_ssdm_op_Mux.ap_auto.4i32.i2(i32 %b_copy_3_3_18, i32 %b_copy_3_3_17, i32 %b_copy_3_3_16, i32 %b_copy_3_3_3, i2 %tmp) nounwind
