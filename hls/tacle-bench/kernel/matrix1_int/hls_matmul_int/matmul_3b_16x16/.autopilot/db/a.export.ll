...
define void @matmul_hw([256 x i32]* %a, [256 x i32]* %b, [256 x i32]* %c) nounwind uwtable {
  ...
  call void (...)* @_ssdm_op_SpecBitsMap([256 x i32]* %a) nounwind, !map !7
  call void (...)* @_ssdm_op_SpecBitsMap([256 x i32]* %b) nounwind, !map !13
  call void (...)* @_ssdm_op_SpecBitsMap([256 x i32]* %c) nounwind, !map !17
...
.preheader.preheader:                             ; preds = %.preheader7.preheader
  ...
  %tmp_6_cast1 = zext i5 %j_mid2 to i9
  %tmp_6_cast2 = zext i5 %j_mid2 to i8
  %tmp_6_cast20_cast = zext i5 %j_mid2 to i7
  %tmp_6_cast = zext i5 %j_mid2 to i6
  %b_addr = getelementptr [256 x i32]* %b, i64 0, i64 %tmp_6
  %tmp_37 = add i6 %tmp_6_cast, 16
  %tmp_37_cast = zext i6 %tmp_37 to i64
  %b_addr_1 = getelementptr [256 x i32]* %b, i64 0, i64 %tmp_37_cast
  %tmp_38 = call i64 @_ssdm_op_BitConcatenate.i64.i59.i5(i59 1, i5 %j_mid2)
  %b_addr_2 = getelementptr [256 x i32]* %b, i64 0, i64 %tmp_38
  %tmp_39 = add i7 %tmp_6_cast20_cast, 48
  %tmp_39_cast = zext i7 %tmp_39 to i64
  %b_addr_3 = getelementptr [256 x i32]* %b, i64 0, i64 %tmp_39_cast
  %tmp_40 = call i64 @_ssdm_op_BitConcatenate.i64.i59.i5(i59 2, i5 %j_mid2)
  %b_addr_4 = getelementptr [256 x i32]* %b, i64 0, i64 %tmp_40
  %tmp_41 = add i7 %tmp_6_cast20_cast, -48
  %tmp_41_cast = zext i7 %tmp_41 to i64
  %b_addr_5 = getelementptr [256 x i32]* %b, i64 0, i64 %tmp_41_cast
  %tmp_42 = call i64 @_ssdm_op_BitConcatenate.i64.i59.i5(i59 3, i5 %j_mid2)
  %b_addr_6 = getelementptr [256 x i32]* %b, i64 0, i64 %tmp_42
  %tmp_43 = add i8 %tmp_6_cast2, 112
  %tmp_43_cast = zext i8 %tmp_43 to i64
  %b_addr_7 = getelementptr [256 x i32]* %b, i64 0, i64 %tmp_43_cast
  %tmp_44 = call i64 @_ssdm_op_BitConcatenate.i64.i59.i5(i59 4, i5 %j_mid2)
  %b_addr_8 = getelementptr [256 x i32]* %b, i64 0, i64 %tmp_44
  %tmp_45 = add i8 %tmp_6_cast2, -112
  %tmp_45_cast = zext i8 %tmp_45 to i64
  %b_addr_9 = getelementptr [256 x i32]* %b, i64 0, i64 %tmp_45_cast
  %tmp_46 = call i64 @_ssdm_op_BitConcatenate.i64.i59.i5(i59 5, i5 %j_mid2)
  %b_addr_10 = getelementptr [256 x i32]* %b, i64 0, i64 %tmp_46
  %tmp_47 = add i8 %tmp_6_cast2, -80
  %tmp_47_cast = zext i8 %tmp_47 to i64
  %b_addr_11 = getelementptr [256 x i32]* %b, i64 0, i64 %tmp_47_cast
  %tmp_48 = call i64 @_ssdm_op_BitConcatenate.i64.i59.i5(i59 6, i5 %j_mid2)
  %b_addr_12 = getelementptr [256 x i32]* %b, i64 0, i64 %tmp_48
  %tmp_49_cast1 = sext i7 %tmp_41 to i8
  %tmp_49_cast = zext i8 %tmp_49_cast1 to i64
  %b_addr_13 = getelementptr [256 x i32]* %b, i64 0, i64 %tmp_49_cast
  %tmp_49 = call i64 @_ssdm_op_BitConcatenate.i64.i59.i5(i59 7, i5 %j_mid2)
  %b_addr_14 = getelementptr [256 x i32]* %b, i64 0, i64 %tmp_49
  %tmp_50 = add i9 %tmp_6_cast1, 240
  %tmp_51_cast = zext i9 %tmp_50 to i64
  %b_addr_15 = getelementptr [256 x i32]* %b, i64 0, i64 %tmp_51_cast
...
.loopexit:                                        ; preds = %.preheader.preheader, %.preheader7.preheader
  ...
  %tmp_51 = add i10 %tmp_4_cast, %tmp_9_cast
  %tmp_52_cast = zext i10 %tmp_51 to i64
  %c_addr = getelementptr [256 x i32]* %c, i64 0, i64 %tmp_52_cast
