...
define void @matmul_hw([4 x i32]* %a, [4 x i32]* %b, [4 x i32]* %c) nounwind uwtable {
  ...
  %b_copy_0_1 = alloca i32
  %b_copy_0_1_5 = alloca i32
  %b_copy_1_1 = alloca i32
  %b_copy_1_1_5 = alloca i32
  call void (...)* @_ssdm_op_SpecBitsMap([4 x i32]* %a) nounwind, !map !7
  call void (...)* @_ssdm_op_SpecBitsMap([4 x i32]* %b) nounwind, !map !13
  call void (...)* @_ssdm_op_SpecBitsMap([4 x i32]* %c) nounwind, !map !17
...
.preheader7.preheader:                            ; preds = %.preheader7
  ...
  %b_copy_0_1_load = load i32* %b_copy_0_1
  %b_copy_0_1_5_load = load i32* %b_copy_0_1_5
  %b_copy_1_1_load = load i32* %b_copy_1_1
  %b_copy_1_1_5_load = load i32* %b_copy_1_1_5
  %i_1 = add i2 1, %i
  ...
  %a_addr = getelementptr [4 x i32]* %a, i64 0, i64 %tmp_4
  %tmp_5 = or i3 %tmp_1, 1
  %tmp_7 = call i64 @_ssdm_op_BitConcatenate.i64.i61.i3(i61 0, i3 %tmp_5)
  %a_addr_1 = getelementptr [4 x i32]* %a, i64 0, i64 %tmp_7
  ...
  %b_addr = getelementptr [4 x i32]* %b, i64 0, i64 %tmp_6
  %tmp_8 = add i3 2, %tmp_6_cast
  %tmp_8_cast = zext i3 %tmp_8 to i64
  %b_addr_1 = getelementptr [4 x i32]* %b, i64 0, i64 %tmp_8_cast
  %tmp_9 = add i4 %tmp_4_cast, %tmp_6_cast5
  %tmp_9_cast = zext i4 %tmp_9 to i64
  %c_addr = getelementptr [4 x i32]* %c, i64 0, i64 %tmp_9_cast
  %b_copy_0_0 = load i32* %b_addr, align 4
  %tmp = trunc i2 %j_mid2 to i1
  %b_copy_0_1_1 = select i1 %tmp, i32 %b_copy_0_0, i32 %b_copy_0_1_5_load
  %b_copy_0_1_2 = select i1 %tmp, i32 %b_copy_0_1_load, i32 %b_copy_0_0
  %b_copy_1_0 = load i32* %b_addr_1, align 4
  %b_copy_1_1_1 = select i1 %tmp, i32 %b_copy_1_0, i32 %b_copy_1_1_5_load
  %b_copy_1_1_2 = select i1 %tmp, i32 %b_copy_1_1_load, i32 %b_copy_1_0
  %b_copy_1_1_3 = select i1 %tmp_mid2, i32 %b_copy_1_1_1, i32 %b_copy_1_1_5_load
  %b_copy_1_1_4 = select i1 %tmp_mid2, i32 %b_copy_1_1_2, i32 %b_copy_1_1_load
  %b_copy_0_1_3 = select i1 %tmp_mid2, i32 %b_copy_0_1_1, i32 %b_copy_0_1_5_load
  %b_copy_0_1_4 = select i1 %tmp_mid2, i32 %b_copy_0_1_2, i32 %b_copy_0_1_load
  %b_copy_load_0_phi = select i1 %tmp, i32 %b_copy_0_1_3, i32 %b_copy_0_1_4
  %tmp_s = mul nsw i32 %b_copy_load_0_phi, %a_row_0_1
  %b_copy_load_1_phi = select i1 %tmp, i32 %b_copy_1_1_3, i32 %b_copy_1_1_4
  %tmp_2_1 = mul nsw i32 %b_copy_load_1_phi, %a_row_1_1
  %tmp_5_1 = add nsw i32 %tmp_2_1, %tmp_s
  store i32 %tmp_5_1, i32* %c_addr, align 4
