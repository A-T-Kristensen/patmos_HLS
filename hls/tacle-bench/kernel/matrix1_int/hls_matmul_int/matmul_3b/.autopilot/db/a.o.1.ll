; ModuleID = '/home/patmos/github/bachelor_project_HLS/hls/tacle-bench/kernel/matrix1_int/hls_matmul_int/matmul_3b/.autopilot/db/a.g.1.bc'
...
define void @matmul_hw([2 x i32]* %a, [2 x i32]* %b, [2 x i32]* %c) nounwind uwtable {
  ...
  call void @llvm.dbg.value(metadata !{[2 x i32]* %a}, i64 0, metadata !24), !dbg !25 ; [debug line = 4:25] [debug variable = a]
  call void @llvm.dbg.value(metadata !{[2 x i32]* %b}, i64 0, metadata !26), !dbg !27 ; [debug line = 4:138] [debug variable = b]
  call void @llvm.dbg.value(metadata !{[2 x i32]* %c}, i64 0, metadata !28), !dbg !29 ; [debug line = 4:252] [debug variable = c]
  call void (...)* @_ssdm_SpecArrayDimSize([2 x i32]* %a, i32 2) nounwind, !dbg !30 ; [debug line = 5:2]
  call void (...)* @_ssdm_SpecArrayDimSize([2 x i32]* %b, i32 2) nounwind, !dbg !32 ; [debug line = 5:30]
  call void (...)* @_ssdm_SpecArrayDimSize([2 x i32]* %c, i32 2) nounwind, !dbg !33 ; [debug line = 5:58]
  ...
  call void (...)* @_ssdm_op_SpecInterface([2 x i32]* %a, i8* getelementptr inbounds ([5 x i8]* @.str2, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !35 ; [debug line = 8:1]
  call void (...)* @_ssdm_op_SpecResource([2 x i32]* %a, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([12 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 -1, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !36 ; [debug line = 9:1]
  call void (...)* @_ssdm_SpecArrayReshape([2 x i32]* %a, i32 2, i8* getelementptr inbounds ([6 x i8]* @.str4, i64 0, i64 0), i32 1, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !37 ; [debug line = 10:1]
  call void (...)* @_ssdm_op_SpecInterface([2 x i32]* %b, i8* getelementptr inbounds ([5 x i8]* @.str2, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !38 ; [debug line = 12:1]
  call void (...)* @_ssdm_op_SpecResource([2 x i32]* %b, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([12 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 -1, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !39 ; [debug line = 13:1]
  call void (...)* @_ssdm_SpecArrayReshape([2 x i32]* %b, i32 1, i8* getelementptr inbounds ([6 x i8]* @.str4, i64 0, i64 0), i32 1, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !40 ; [debug line = 14:1]
  call void (...)* @_ssdm_op_SpecInterface([2 x i32]* %c, i8* getelementptr inbounds ([5 x i8]* @.str2, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !41 ; [debug line = 16:1]
  call void (...)* @_ssdm_op_SpecResource([2 x i32]* %c, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([12 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 -1, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !42 ; [debug line = 17:1]
...
; <label>:3                                       ; preds = %.preheader5
  ...
  %a.addr = getelementptr inbounds [2 x i32]* %a, i64 %tmp.1, i64 %tmp.4, !dbg !63 ; [#uses=1 type=i32*] [debug line = 34:6]
  %a.load = load i32* %a.addr, align 4, !dbg !63  ; [#uses=2 type=i32] [debug line = 34:6]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %a.load) nounwind
  %a_row.addr = getelementptr inbounds [2 x i32]* %a_row, i64 0, i64 %tmp.4, !dbg !63 ; [#uses=1 type=i32*] [debug line = 34:6]
  store i32 %a.load, i32* %a_row.addr, align 4, !dbg !63 ; [debug line = 34:6]
...
.preheader.preheader:                             ; preds = %.loopexit6
  %tmp.6 = sext i32 %j to i64, !dbg !68           ; [#uses=2 type=i64] [debug line = 40:7]
  br label %.preheader, !dbg !72                  ; [debug line = 39:29]

.preheader:                                       ; preds = %4, %.preheader.preheader
  %k1 = phi i32 [ %k.2, %4 ], [ 0, %.preheader.preheader ] ; [#uses=3 type=i32]
  %exitcond1 = icmp eq i32 %k1, 2, !dbg !72       ; [#uses=1 type=i1] [debug line = 39:29]
  br i1 %exitcond1, label %.loopexit.loopexit, label %4, !dbg !72 ; [debug line = 39:29]

; <label>:4                                       ; preds = %.preheader
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([10 x i8]* @.str7, i64 0, i64 0)) nounwind, !dbg !73 ; [debug line = 39:106]
  %rbegin8 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([10 x i8]* @.str7, i64 0, i64 0)) nounwind, !dbg !73 ; [#uses=1 type=i32] [debug line = 39:106]
  %tmp.7 = sext i32 %k1 to i64, !dbg !68          ; [#uses=2 type=i64] [debug line = 40:7]
  %b.addr = getelementptr inbounds [2 x i32]* %b, i64 %tmp.7, i64 %tmp.6, !dbg !68 ; [#uses=1 type=i32*] [debug line = 40:7]
  %b.load = load i32* %b.addr, align 4, !dbg !68  ; [#uses=2 type=i32] [debug line = 40:7]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %b.load) nounwind
  %b_copy.addr = getelementptr inbounds [2 x [2 x i32]]* %b_copy, i64 0, i64 %tmp.7, i64 %tmp.6, !dbg !68 ; [#uses=1 type=i32*] [debug line = 40:7]
  store i32 %b.load, i32* %b_copy.addr, align 4, !dbg !68 ; [debug line = 40:7]
  %rend9 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([10 x i8]* @.str7, i64 0, i64 0), i32 %rbegin8) nounwind, !dbg !74 ; [#uses=0 type=i32] [debug line = 41:5]
  %k.2 = add nsw i32 %k1, 1, !dbg !75             ; [#uses=1 type=i32] [debug line = 39:100]
  call void @llvm.dbg.value(metadata !{i32 %k.2}, i64 0, metadata !76), !dbg !75 ; [debug line = 39:100] [debug variable = k]
  br label %.preheader, !dbg !75                  ; [debug line = 39:100]

.loopexit.loopexit:                               ; preds = %.preheader
  br label %.loopexit

.loopexit:                                        ; preds = %.loopexit.loopexit, %.loopexit6
  %tmp.9 = sext i32 %j to i64, !dbg !77           ; [#uses=2 type=i64] [debug line = 45:4]
  br label %5, !dbg !80                           ; [debug line = 44:27]

; <label>:5                                       ; preds = %6, %.loopexit
  %tmp10 = phi i32 [ 0, %.loopexit ], [ %tmp.14, %6 ] ; [#uses=2 type=i32]
  %k2 = phi i32 [ 0, %.loopexit ], [ %k.3, %6 ]   ; [#uses=3 type=i32]
  %exitcond = icmp eq i32 %k2, 2, !dbg !80        ; [#uses=1 type=i1] [debug line = 44:27]
  br i1 %exitcond, label %7, label %6, !dbg !80   ; [debug line = 44:27]

; <label>:6                                       ; preds = %5
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([8 x i8]* @.str8, i64 0, i64 0)) nounwind, !dbg !81 ; [debug line = 44:104]
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([8 x i8]* @.str8, i64 0, i64 0)) nounwind, !dbg !81 ; [#uses=1 type=i32] [debug line = 44:104]
  %tmp.12 = sext i32 %k2 to i64, !dbg !77         ; [#uses=2 type=i64] [debug line = 45:4]
  %a_row.addr.1 = getelementptr inbounds [2 x i32]* %a_row, i64 0, i64 %tmp.12, !dbg !77 ; [#uses=1 type=i32*] [debug line = 45:4]
  %a_row.load = load i32* %a_row.addr.1, align 4, !dbg !77 ; [#uses=2 type=i32] [debug line = 45:4]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %a_row.load) nounwind
  %b_copy.addr.1 = getelementptr inbounds [2 x [2 x i32]]* %b_copy, i64 0, i64 %tmp.12, i64 %tmp.9, !dbg !77 ; [#uses=1 type=i32*] [debug line = 45:4]
  %b_copy.load = load i32* %b_copy.addr.1, align 4, !dbg !77 ; [#uses=2 type=i32] [debug line = 45:4]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %b_copy.load) nounwind
  %tmp.13 = mul nsw i32 %b_copy.load, %a_row.load, !dbg !77 ; [#uses=1 type=i32] [debug line = 45:4]
  %tmp.14 = add nsw i32 %tmp.13, %tmp10, !dbg !77 ; [#uses=1 type=i32] [debug line = 45:4]
  call void @llvm.dbg.value(metadata !{i32 %tmp.14}, i64 0, metadata !82), !dbg !77 ; [debug line = 45:4] [debug variable = tmp]
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([8 x i8]* @.str8, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !83 ; [#uses=0 type=i32] [debug line = 46:5]
  %k.3 = add nsw i32 %k2, 1, !dbg !84             ; [#uses=1 type=i32] [debug line = 44:98]
  call void @llvm.dbg.value(metadata !{i32 %k.3}, i64 0, metadata !85), !dbg !84 ; [debug line = 44:98] [debug variable = k]
  br label %5, !dbg !84                           ; [debug line = 44:98]

; <label>:7                                       ; preds = %5
  %tmp.0.lcssa = phi i32 [ %tmp10, %5 ]           ; [#uses=1 type=i32]
  %c.addr = getelementptr inbounds [2 x i32]* %c, i64 %tmp.1, i64 %tmp.9, !dbg !55 ; [#uses=1 type=i32*] [debug line = 48:5]
  store i32 %tmp.0.lcssa, i32* %c.addr, align 4, !dbg !55 ; [debug line = 48:5]
  %rend13 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([4 x i8]* @.str5, i64 0, i64 0), i32 %rbegin1) nounwind, !dbg !86 ; [#uses=0 type=i32] [debug line = 49:3]
  %j.1 = add nsw i32 %j, 1, !dbg !87              ; [#uses=1 type=i32] [debug line = 25:63]
  call void @llvm.dbg.value(metadata !{i32 %j.1}, i64 0, metadata !88), !dbg !87 ; [debug line = 25:63] [debug variable = j]
  br label %.preheader7, !dbg !87                 ; [debug line = 25:63]

; <label>:8                                       ; preds = %.preheader7
  %i.1 = add nsw i32 %i, 1, !dbg !89              ; [#uses=1 type=i32] [debug line = 23:58]
  call void @llvm.dbg.value(metadata !{i32 %i.1}, i64 0, metadata !90), !dbg !89 ; [debug line = 23:58] [debug variable = i]
  br label %1, !dbg !89                           ; [debug line = 23:58]

; <label>:9                                       ; preds = %1
  ret void, !dbg !91                              ; [debug line = 51:1]
}
...
!67 = metadata !{i32 786688, metadata !61, metadata !"k", metadata !6, i32 33, metadata !12, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!68 = metadata !{i32 40, i32 7, metadata !69, null}
!69 = metadata !{i32 786443, metadata !70, i32 39, i32 105, metadata !6, i32 10} ; [ DW_TAG_lexical_block ]
!70 = metadata !{i32 786443, metadata !71, i32 39, i32 16, metadata !6, i32 9} ; [ DW_TAG_lexical_block ]
!71 = metadata !{i32 786443, metadata !52, i32 38, i32 16, metadata !6, i32 8} ; [ DW_TAG_lexical_block ]
!72 = metadata !{i32 39, i32 29, metadata !70, null}
!73 = metadata !{i32 39, i32 106, metadata !69, null}
!74 = metadata !{i32 41, i32 5, metadata !69, null}
!75 = metadata !{i32 39, i32 100, metadata !70, null}
!76 = metadata !{i32 786688, metadata !70, metadata !"k", metadata !6, i32 39, metadata !12, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!77 = metadata !{i32 45, i32 4, metadata !78, null}
!78 = metadata !{i32 786443, metadata !79, i32 44, i32 103, metadata !6, i32 12} ; [ DW_TAG_lexical_block ]
!79 = metadata !{i32 786443, metadata !52, i32 44, i32 14, metadata !6, i32 11} ; [ DW_TAG_lexical_block ]
!80 = metadata !{i32 44, i32 27, metadata !79, null}
!81 = metadata !{i32 44, i32 104, metadata !78, null}
!82 = metadata !{i32 786688, metadata !31, metadata !"tmp", metadata !6, i32 21, metadata !11, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!83 = metadata !{i32 46, i32 5, metadata !78, null}
!84 = metadata !{i32 44, i32 98, metadata !79, null}
!85 = metadata !{i32 786688, metadata !79, metadata !"k", metadata !6, i32 44, metadata !12, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!86 = metadata !{i32 49, i32 3, metadata !52, null}
!87 = metadata !{i32 25, i32 63, metadata !53, null}
!88 = metadata !{i32 786688, metadata !53, metadata !"j", metadata !6, i32 25, metadata !12, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!89 = metadata !{i32 23, i32 58, metadata !50, null}
!90 = metadata !{i32 786688, metadata !50, metadata !"i", metadata !6, i32 23, metadata !12, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!91 = metadata !{i32 51, i32 1, metadata !31, null}
