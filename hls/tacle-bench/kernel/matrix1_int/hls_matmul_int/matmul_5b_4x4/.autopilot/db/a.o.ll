; ModuleID = '/home/patmos/github/bachelor_project_HLS/hls/tacle-bench/kernel/matrix1_int/hls_matmul_int/matmul_5b_4x4/.autopilot/db/a.o.bc'
...
define void @matmul_hw([4 x i32]* %a, [4 x i32]* %b, [4 x i32]* %c) nounwind uwtable {
  ...
  call void (...)* @_ssdm_SpecArrayPartition([4 x i32]* %7, i32 1, i8* getelementptr inbounds ([6 x i8]* @.str, i32 0, i32 0), i32 2, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !34 ; [debug line = 6:1]
  %8 = load [4 x i32]** %1, align 8, !dbg !34     ; [#uses=1 type=[4 x i32]*] [debug line = 6:1]
  call void (...)* @_ssdm_SpecArrayPartition([4 x i32]* %8, i32 2, i8* getelementptr inbounds ([6 x i8]* @.str, i32 0, i32 0), i32 2, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !34 ; [debug line = 6:1]
