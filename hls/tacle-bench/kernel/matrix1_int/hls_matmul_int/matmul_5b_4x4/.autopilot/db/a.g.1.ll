; ModuleID = '/home/patmos/github/bachelor_project_HLS/hls/tacle-bench/kernel/matrix1_int/hls_matmul_int/matmul_5b_4x4/.autopilot/db/a.g.1.bc'
...
define void @matmul_hw([4 x i32]* %a, [4 x i32]* %b, [4 x i32]* %c) nounwind uwtable {
  ...
  call void (...)* @_ssdm_SpecArrayPartition([4 x i32]* %b, i32 1, i8* getelementptr inbounds ([6 x i8]* @.str, i64 0, i64 0), i32 2, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !34 ; [debug line = 6:1]
  call void (...)* @_ssdm_SpecArrayPartition([4 x i32]* %a, i32 2, i8* getelementptr inbounds ([6 x i8]* @.str, i64 0, i64 0), i32 2, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !34 ; [debug line = 6:1]
