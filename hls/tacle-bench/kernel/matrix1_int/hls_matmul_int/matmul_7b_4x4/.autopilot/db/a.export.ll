...
define void @matmul_hw([8 x i32]* %a_0, [8 x i32]* %a_1, [4 x i32]* %a_2, [8 x i32]* %b_0, [8 x i32]* %b_1, [4 x i32]* %b_2, [16 x i32]* %c) {
  ...
  call void (...)* @_ssdm_op_SpecBitsMap([4 x i32]* %a_2), !map !7
  call void (...)* @_ssdm_op_SpecBitsMap([8 x i32]* %a_1), !map !14
  call void (...)* @_ssdm_op_SpecBitsMap([8 x i32]* %a_0), !map !20
  call void (...)* @_ssdm_op_SpecBitsMap([4 x i32]* %b_2), !map !26
  call void (...)* @_ssdm_op_SpecBitsMap([8 x i32]* %b_1), !map !31
  call void (...)* @_ssdm_op_SpecBitsMap([8 x i32]* %b_0), !map !36
  call void (...)* @_ssdm_op_SpecBitsMap([16 x i32]* %c), !map !41
...
.preheader7.preheader:                            ; preds = %.preheader7
  ...
  %tmp_9 = zext i4 %tmp_1 to i64
  %a_0_addr = getelementptr [8 x i32]* %a_0, i64 0, i64 %tmp_9
  %tmp_10 = or i4 %tmp_1, 1
  %tmp_11 = call i64 @_ssdm_op_BitConcatenate.i64.i60.i4(i60 0, i4 %tmp_10)
  %a_0_addr_1 = getelementptr [8 x i32]* %a_0, i64 0, i64 %tmp_11
  %a_1_addr = getelementptr [8 x i32]* %a_1, i64 0, i64 %tmp_9
  %a_1_addr_1 = getelementptr [8 x i32]* %a_1, i64 0, i64 %tmp_11
  %tmp_12 = call i5 @_ssdm_op_BitConcatenate.i5.i3.i2(i3 %tmp_1_mid2_v, i2 0)
  %tmp_13_cast = zext i5 %tmp_12 to i6
  ...
  %a_row_2 = load i32* %a_1_addr, align 4
  %a_row_3 = load i32* %a_1_addr_1, align 4
  ...
  %b_0_addr = getelementptr [8 x i32]* %b_0, i64 0, i64 %tmp_6
  %tmp_13 = add i4 4, %tmp_6_cast
  %tmp_14_cast = zext i4 %tmp_13 to i64
  %b_0_addr_1 = getelementptr [8 x i32]* %b_0, i64 0, i64 %tmp_14_cast
  %b_1_addr = getelementptr [8 x i32]* %b_1, i64 0, i64 %tmp_6
  %b_1_addr_1 = getelementptr [8 x i32]* %b_1, i64 0, i64 %tmp_14_cast
  %tmp_14 = add i6 %tmp_13_cast, %tmp_6_cast5
  %tmp_15_cast = zext i6 %tmp_14 to i64
  %c_addr = getelementptr [16 x i32]* %c, i64 0, i64 %tmp_15_cast
  %b_copy_0_3_19 = load i32* %b_0_addr, align 4
  ...
  %b_copy_1_3_19 = load i32* %b_0_addr_1, align 4
  ...
  %b_copy_2_3_19 = load i32* %b_1_addr, align 4
  ...
  %b_copy_3_3_19 = load i32* %b_1_addr_1, align 4
  ...
  %tmp_4 = call i32 @_ssdm_op_Mux.ap_auto.4i32.i2(i32 %b_copy_0_3_18, i32 %b_copy_0_3_17, i32 %b_copy_0_3_16, i32 %b_copy_0_3_3, i2 %tmp)
  %tmp_s = mul nsw i32 %tmp_4, %a_row_0_1
  %tmp_5 = call i32 @_ssdm_op_Mux.ap_auto.4i32.i2(i32 %b_copy_1_3_18, i32 %b_copy_1_3_17, i32 %b_copy_1_3_16, i32 %b_copy_1_3_3, i2 %tmp)
  %tmp_2_1 = mul nsw i32 %tmp_5, %a_row_1_1
  ...
  %tmp_2_2 = mul nsw i32 %tmp_7, %a_row_2_1
  ...
  %tmp_2_3 = mul nsw i32 %tmp_8, %a_row_3_1
  %tmp9 = add i32 %tmp_2_1, %tmp_s
  %tmp2 = add i32 %tmp_2_3, %tmp_2_2
  %tmp_5_3 = add nsw i32 %tmp9, %tmp2
  store i32 %tmp_5_3, i32* %c_addr, align 4
