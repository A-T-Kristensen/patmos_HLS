; ModuleID = '/home/patmos/github/bachelor_project_HLS/hls/tacle-bench/kernel/matrix1_int/hls_matmul_int/matmul_3b_32x32/.autopilot/db/a.g.bc'
...
define void @matmul_hw([32 x i32]* %a, [32 x i32]* %b, [32 x i32]* %c) nounwind uwtable {
  %1 = alloca [32 x i32]*, align 8                ; [#uses=5 type=[32 x i32]**]
  %2 = alloca [32 x i32]*, align 8                ; [#uses=5 type=[32 x i32]**]
  ...
  %7 = load [32 x i32]** %1, align 8, !dbg !35    ; [#uses=1 type=[32 x i32]*] [debug line = 8:1]
  call void (...)* @_ssdm_op_SpecInterface([32 x i32]* %7, i8* getelementptr inbounds ([5 x i8]* @.str2, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !35 ; [debug line = 8:1]
  %8 = load [32 x i32]** %1, align 8, !dbg !36    ; [#uses=1 type=[32 x i32]*] [debug line = 9:1]
  call void (...)* @_ssdm_op_SpecResource([32 x i32]* %8, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([12 x i8]* @.str3, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 -1, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !36 ; [debug line = 9:1]
  %9 = load [32 x i32]** %2, align 8, !dbg !37    ; [#uses=1 type=[32 x i32]*] [debug line = 11:1]
  call void (...)* @_ssdm_op_SpecInterface([32 x i32]* %9, i8* getelementptr inbounds ([5 x i8]* @.str2, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !37 ; [debug line = 11:1]
  %10 = load [32 x i32]** %2, align 8, !dbg !38   ; [#uses=1 type=[32 x i32]*] [debug line = 12:1]
  call void (...)* @_ssdm_op_SpecResource([32 x i32]* %10, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([12 x i8]* @.str3, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 -1, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !38 ; [debug line = 12:1]
  %11 = load [32 x i32]** %3, align 8, !dbg !39   ; [#uses=1 type=[32 x i32]*] [debug line = 14:1]
  call void (...)* @_ssdm_op_SpecInterface([32 x i32]* %11, i8* getelementptr inbounds ([5 x i8]* @.str2, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !39 ; [debug line = 14:1]
  %12 = load [32 x i32]** %3, align 8, !dbg !40   ; [#uses=1 type=[32 x i32]*] [debug line = 15:1]
...
; <label>:13                                      ; preds = %108, %0
  ...
  %15 = icmp slt i32 %14, 32, !dbg !52            ; [#uses=1 type=i1] [debug line = 21:15]
...
; <label>:18                                      ; preds = %104, %17
  ...
  %20 = icmp slt i32 %19, 32, !dbg !58            ; [#uses=1 type=i1] [debug line = 23:20]
...
; <label>:26                                      ; preds = %41, %25
  ...
  %28 = icmp slt i32 %27, 32, !dbg !69            ; [#uses=1 type=i1] [debug line = 31:28]
...
; <label>:29                                      ; preds = %26
  ...
  %34 = load [32 x i32]** %1, align 8, !dbg !70   ; [#uses=1 type=[32 x i32]*] [debug line = 32:6]
  %35 = getelementptr inbounds [32 x i32]* %34, i64 %33, !dbg !70 ; [#uses=1 type=[32 x i32]*] [debug line = 32:6]
  %36 = getelementptr inbounds [32 x i32]* %35, i32 0, i64 %31, !dbg !70 ; [#uses=1 type=i32*] [debug line = 32:6]
  ...
  %40 = getelementptr inbounds [32 x i32]* %a_row, i32 0, i64 %39, !dbg !70 ; [#uses=1 type=i32*] [debug line = 32:6]
...
; <label>:50                                      ; preds = %68, %49
  ...
  %52 = icmp slt i32 %51, 32, !dbg !81            ; [#uses=1 type=i1] [debug line = 37:29]
...
; <label>:53                                      ; preds = %50
  ...
  %58 = load [32 x i32]** %2, align 8, !dbg !84   ; [#uses=1 type=[32 x i32]*] [debug line = 38:7]
  %59 = getelementptr inbounds [32 x i32]* %58, i64 %57, !dbg !84 ; [#uses=1 type=[32 x i32]*] [debug line = 38:7]
  %60 = getelementptr inbounds [32 x i32]* %59, i32 0, i64 %55, !dbg !84 ; [#uses=1 type=i32*] [debug line = 38:7]
  ...
  %66 = getelementptr inbounds [32 x [32 x i32]]* %b_copy, i32 0, i64 %65, !dbg !84 ; [#uses=1 type=[32 x i32]*] [debug line = 38:7]
  %67 = getelementptr inbounds [32 x i32]* %66, i32 0, i64 %63, !dbg !84 ; [#uses=1 type=i32*] [debug line = 38:7]
...
; <label>:74                                      ; preds = %92, %73
  ...
  %76 = icmp slt i32 %75, 32, !dbg !91            ; [#uses=1 type=i1] [debug line = 42:27]
...
; <label>:77                                      ; preds = %74
  ...
  %80 = getelementptr inbounds [32 x i32]* %a_row, i32 0, i64 %79, !dbg !94 ; [#uses=1 type=i32*] [debug line = 43:4]
  ...
  %86 = getelementptr inbounds [32 x [32 x i32]]* %b_copy, i32 0, i64 %85, !dbg !94 ; [#uses=1 type=[32 x i32]*] [debug line = 43:4]
  %87 = getelementptr inbounds [32 x i32]* %86, i32 0, i64 %83, !dbg !94 ; [#uses=1 type=i32*] [debug line = 43:4]
...
; <label>:95                                      ; preds = %74
  ...
  %101 = load [32 x i32]** %3, align 8, !dbg !97  ; [#uses=1 type=[32 x i32]*] [debug line = 46:5]
  %102 = getelementptr inbounds [32 x i32]* %101, i64 %100, !dbg !97 ; [#uses=1 type=[32 x i32]*] [debug line = 46:5]
  %103 = getelementptr inbounds [32 x i32]* %102, i32 0, i64 %98, !dbg !97 ; [#uses=1 type=i32*] [debug line = 46:5]
