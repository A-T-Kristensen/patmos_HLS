; ModuleID = '/home/patmos/github/bachelor_project_HLS/hls/tacle-bench/kernel/matrix1_int/hls_matmul_int/matmul_3b_32x32/.autopilot/db/a.g.1.bc'
...
define void @matmul_hw([32 x i32]* %a, [32 x i32]* %b, [32 x i32]* %c) nounwind uwtable {
  ...
  call void @llvm.dbg.value(metadata !{[32 x i32]* %a}, i64 0, metadata !24), !dbg !25 ; [debug line = 4:25] [debug variable = a]
  call void @llvm.dbg.value(metadata !{[32 x i32]* %b}, i64 0, metadata !26), !dbg !27 ; [debug line = 4:140] [debug variable = b]
  call void @llvm.dbg.value(metadata !{[32 x i32]* %c}, i64 0, metadata !28), !dbg !29 ; [debug line = 4:0] [debug variable = c]
  call void (...)* @_ssdm_SpecArrayDimSize([32 x i32]* %a, i32 32) nounwind, !dbg !30 ; [debug line = 5:2]
  call void (...)* @_ssdm_SpecArrayDimSize([32 x i32]* %b, i32 32) nounwind, !dbg !32 ; [debug line = 5:31]
  call void (...)* @_ssdm_SpecArrayDimSize([32 x i32]* %c, i32 32) nounwind, !dbg !33 ; [debug line = 5:60]
  ...
  call void (...)* @_ssdm_op_SpecResource([32 x i32]* %a, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([12 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 -1, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !36 ; [debug line = 9:1]
  call void (...)* @_ssdm_op_SpecInterface([32 x i32]* %b, i8* getelementptr inbounds ([5 x i8]* @.str2, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !37 ; [debug line = 11:1]
  call void (...)* @_ssdm_op_SpecResource([32 x i32]* %b, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([12 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 -1, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !38 ; [debug line = 12:1]
  call void (...)* @_ssdm_op_SpecInterface([32 x i32]* %c, i8* getelementptr inbounds ([5 x i8]* @.str2, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !39 ; [debug line = 14:1]
  call void (...)* @_ssdm_op_SpecResource([32 x i32]* %c, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([12 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 -1, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !40 ; [debug line = 15:1]
...
; <label>:3                                       ; preds = %.preheader5
  ...
  %a.addr = getelementptr inbounds [32 x i32]* %a, i64 %tmp.1, i64 %tmp.4, !dbg !61 ; [#uses=1 type=i32*] [debug line = 32:6]
  ...
  %a_row.addr = getelementptr inbounds [32 x i32]* %a_row, i64 0, i64 %tmp.4, !dbg !61 ; [#uses=1 type=i32*] [debug line = 32:6]
...
.preheader:                                       ; preds = %4, %.preheader.preheader
  ...
  %exitcond1 = icmp eq i32 %k1, 32, !dbg !70      ; [#uses=1 type=i1] [debug line = 37:29]
  br i1 %exitcond1, label %.loopexit.loopexit, label %4, !dbg !70 ; [debug line = 37:29]

; <label>:4                                       ; preds = %.preheader
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([10 x i8]* @.str6, i64 0, i64 0)) nounwind, !dbg !71 ; [debug line = 37:107]
  %rbegin8 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([10 x i8]* @.str6, i64 0, i64 0)) nounwind, !dbg !71 ; [#uses=1 type=i32] [debug line = 37:107]
  %tmp.7 = sext i32 %k1 to i64, !dbg !66          ; [#uses=2 type=i64] [debug line = 38:7]
  %b.addr = getelementptr inbounds [32 x i32]* %b, i64 %tmp.7, i64 %tmp.6, !dbg !66 ; [#uses=1 type=i32*] [debug line = 38:7]
  ...
  %b_copy.addr = getelementptr inbounds [32 x [32 x i32]]* %b_copy, i64 0, i64 %tmp.7, i64 %tmp.6, !dbg !66 ; [#uses=1 type=i32*] [debug line = 38:7]
...
; <label>:5                                       ; preds = %6, %.loopexit
  ...
  %exitcond = icmp eq i32 %k2, 32, !dbg !78       ; [#uses=1 type=i1] [debug line = 42:27]
  br i1 %exitcond, label %7, label %6, !dbg !78   ; [debug line = 42:27]

; <label>:6                                       ; preds = %5
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([8 x i8]* @.str7, i64 0, i64 0)) nounwind, !dbg !79 ; [debug line = 42:105]
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([8 x i8]* @.str7, i64 0, i64 0)) nounwind, !dbg !79 ; [#uses=1 type=i32] [debug line = 42:105]
  %tmp.12 = sext i32 %k2 to i64, !dbg !75         ; [#uses=2 type=i64] [debug line = 43:4]
  %a_row.addr.1 = getelementptr inbounds [32 x i32]* %a_row, i64 0, i64 %tmp.12, !dbg !75 ; [#uses=1 type=i32*] [debug line = 43:4]
  ...
  %b_copy.addr.1 = getelementptr inbounds [32 x [32 x i32]]* %b_copy, i64 0, i64 %tmp.12, i64 %tmp.9, !dbg !75 ; [#uses=1 type=i32*] [debug line = 43:4]
...
; <label>:7                                       ; preds = %5
  ...
  %c.addr = getelementptr inbounds [32 x i32]* %c, i64 %tmp.1, i64 %tmp.9, !dbg !53 ; [#uses=1 type=i32*] [debug line = 46:5]
