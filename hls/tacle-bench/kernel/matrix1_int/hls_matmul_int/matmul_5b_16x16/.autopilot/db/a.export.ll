...
define void @matmul_hw([128 x i32]* %a_0, [128 x i32]* %a_1, [128 x i32]* %b_0, [128 x i32]* %b_1, [256 x i32]* %c) {
  ...
  call void (...)* @_ssdm_op_SpecBitsMap([128 x i32]* %a_1), !map !7
  call void (...)* @_ssdm_op_SpecBitsMap([128 x i32]* %a_0), !map !14
  call void (...)* @_ssdm_op_SpecBitsMap([128 x i32]* %b_1), !map !20
  call void (...)* @_ssdm_op_SpecBitsMap([128 x i32]* %b_0), !map !25
  call void (...)* @_ssdm_op_SpecBitsMap([256 x i32]* %c), !map !30
...
.preheader.preheader:                             ; preds = %.preheader7.preheader
  ...
  %tmp_6_cast1 = zext i5 %j_mid2 to i8
  %tmp_6_cast2 = zext i5 %j_mid2 to i7
  %tmp_6_cast = zext i5 %j_mid2 to i6
  %b_0_addr = getelementptr [128 x i32]* %b_0, i64 0, i64 %tmp_6
  %tmp_22 = add i6 %tmp_6_cast, 16
  %tmp_23_cast = zext i6 %tmp_22 to i64
  %b_0_addr_1 = getelementptr [128 x i32]* %b_0, i64 0, i64 %tmp_23_cast
  %tmp_23 = call i64 @_ssdm_op_BitConcatenate.i64.i59.i5(i59 1, i5 %j_mid2)
  %b_0_addr_2 = getelementptr [128 x i32]* %b_0, i64 0, i64 %tmp_23
  %tmp_24 = add i7 %tmp_6_cast2, 48
  %tmp_25_cast = zext i7 %tmp_24 to i64
  %b_0_addr_3 = getelementptr [128 x i32]* %b_0, i64 0, i64 %tmp_25_cast
  %tmp_25 = call i64 @_ssdm_op_BitConcatenate.i64.i59.i5(i59 2, i5 %j_mid2)
  %b_0_addr_4 = getelementptr [128 x i32]* %b_0, i64 0, i64 %tmp_25
  %tmp_26 = add i7 %tmp_6_cast2, -48
  %tmp_27_cast = zext i7 %tmp_26 to i64
  %b_0_addr_5 = getelementptr [128 x i32]* %b_0, i64 0, i64 %tmp_27_cast
  %tmp_27 = call i64 @_ssdm_op_BitConcatenate.i64.i59.i5(i59 3, i5 %j_mid2)
  %b_0_addr_6 = getelementptr [128 x i32]* %b_0, i64 0, i64 %tmp_27
  %tmp_28 = add i8 %tmp_6_cast1, 112
  %tmp_29_cast = zext i8 %tmp_28 to i64
  %b_0_addr_7 = getelementptr [128 x i32]* %b_0, i64 0, i64 %tmp_29_cast
  %b_1_addr = getelementptr [128 x i32]* %b_1, i64 0, i64 %tmp_6
  %b_1_addr_1 = getelementptr [128 x i32]* %b_1, i64 0, i64 %tmp_23_cast
  %b_1_addr_2 = getelementptr [128 x i32]* %b_1, i64 0, i64 %tmp_23
  %b_1_addr_3 = getelementptr [128 x i32]* %b_1, i64 0, i64 %tmp_25_cast
  %b_1_addr_4 = getelementptr [128 x i32]* %b_1, i64 0, i64 %tmp_25
  %b_1_addr_5 = getelementptr [128 x i32]* %b_1, i64 0, i64 %tmp_27_cast
  %b_1_addr_6 = getelementptr [128 x i32]* %b_1, i64 0, i64 %tmp_27
  %b_1_addr_7 = getelementptr [128 x i32]* %b_1, i64 0, i64 %tmp_29_cast
...
.loopexit:                                        ; preds = %.preheader.preheader, %.preheader7.preheader
  ...
  %tmp_29 = add i10 %tmp_22_cast, %tmp_9_cast
  %tmp_30_cast = zext i10 %tmp_29 to i64
  %c_addr = getelementptr [256 x i32]* %c, i64 0, i64 %tmp_30_cast
...
.preheader7.preheader:                            ; preds = %.preheader7
  ...
  %a_0_addr = getelementptr [128 x i32]* %a_0, i64 0, i64 %tmp_4
  %tmp_5 = or i8 %tmp_1, 1
  %tmp_7 = call i64 @_ssdm_op_BitConcatenate.i64.i56.i8(i56 0, i8 %tmp_5)
  %a_0_addr_1 = getelementptr [128 x i32]* %a_0, i64 0, i64 %tmp_7
  %tmp_8 = or i8 %tmp_1, 2
  %tmp_10 = call i64 @_ssdm_op_BitConcatenate.i64.i56.i8(i56 0, i8 %tmp_8)
  %a_0_addr_2 = getelementptr [128 x i32]* %a_0, i64 0, i64 %tmp_10
  %tmp_11 = or i8 %tmp_1, 3
  %tmp_12 = call i64 @_ssdm_op_BitConcatenate.i64.i56.i8(i56 0, i8 %tmp_11)
  %a_0_addr_3 = getelementptr [128 x i32]* %a_0, i64 0, i64 %tmp_12
  %tmp_13 = or i8 %tmp_1, 4
  %tmp_14 = call i64 @_ssdm_op_BitConcatenate.i64.i56.i8(i56 0, i8 %tmp_13)
  %a_0_addr_4 = getelementptr [128 x i32]* %a_0, i64 0, i64 %tmp_14
  %tmp_15 = or i8 %tmp_1, 5
  %tmp_16 = call i64 @_ssdm_op_BitConcatenate.i64.i56.i8(i56 0, i8 %tmp_15)
  %a_0_addr_5 = getelementptr [128 x i32]* %a_0, i64 0, i64 %tmp_16
  %tmp_17 = or i8 %tmp_1, 6
  %tmp_18 = call i64 @_ssdm_op_BitConcatenate.i64.i56.i8(i56 0, i8 %tmp_17)
  %a_0_addr_6 = getelementptr [128 x i32]* %a_0, i64 0, i64 %tmp_18
  %tmp_19 = or i8 %tmp_1, 7
  %tmp_20 = call i64 @_ssdm_op_BitConcatenate.i64.i56.i8(i56 0, i8 %tmp_19)
  %a_0_addr_7 = getelementptr [128 x i32]* %a_0, i64 0, i64 %tmp_20
  %a_1_addr = getelementptr [128 x i32]* %a_1, i64 0, i64 %tmp_4
  %a_1_addr_1 = getelementptr [128 x i32]* %a_1, i64 0, i64 %tmp_7
  %a_1_addr_2 = getelementptr [128 x i32]* %a_1, i64 0, i64 %tmp_10
  %a_1_addr_3 = getelementptr [128 x i32]* %a_1, i64 0, i64 %tmp_12
  %a_1_addr_4 = getelementptr [128 x i32]* %a_1, i64 0, i64 %tmp_14
  %a_1_addr_5 = getelementptr [128 x i32]* %a_1, i64 0, i64 %tmp_16
  %a_1_addr_6 = getelementptr [128 x i32]* %a_1, i64 0, i64 %tmp_18
  %a_1_addr_7 = getelementptr [128 x i32]* %a_1, i64 0, i64 %tmp_20
...
!13 = metadata !{i32 8, i32 15, i32 1}
