...
define void @matmul_hw([96 x i32]* %a_0, [96 x i32]* %a_1, [64 x i32]* %a_2, [96 x i32]* %b_0, [96 x i32]* %b_1, [64 x i32]* %b_2, [256 x i32]* %c) {
  ...
  call void (...)* @_ssdm_op_SpecBitsMap([64 x i32]* %a_2), !map !7
  call void (...)* @_ssdm_op_SpecBitsMap([96 x i32]* %a_1), !map !14
  call void (...)* @_ssdm_op_SpecBitsMap([96 x i32]* %a_0), !map !20
  call void (...)* @_ssdm_op_SpecBitsMap([64 x i32]* %b_2), !map !26
  call void (...)* @_ssdm_op_SpecBitsMap([96 x i32]* %b_1), !map !31
  call void (...)* @_ssdm_op_SpecBitsMap([96 x i32]* %b_0), !map !36
  call void (...)* @_ssdm_op_SpecBitsMap([256 x i32]* %c), !map !41
...
.preheader.preheader:                             ; preds = %.preheader7.preheader
  ...
  %b_0_addr = getelementptr [96 x i32]* %b_0, i64 0, i64 %tmp_6
  %tmp_22 = add i6 %tmp_6_cast, 16
  %tmp_23_cast = zext i6 %tmp_22 to i64
  %b_0_addr_1 = getelementptr [96 x i32]* %b_0, i64 0, i64 %tmp_23_cast
  %tmp_23 = call i64 @_ssdm_op_BitConcatenate.i64.i59.i5(i59 1, i5 %j_mid2)
  %b_0_addr_2 = getelementptr [96 x i32]* %b_0, i64 0, i64 %tmp_23
  %tmp_24 = add i7 %tmp_6_cast1, 48
  %tmp_25_cast = zext i7 %tmp_24 to i64
  %b_0_addr_3 = getelementptr [96 x i32]* %b_0, i64 0, i64 %tmp_25_cast
  %tmp_25 = call i64 @_ssdm_op_BitConcatenate.i64.i59.i5(i59 2, i5 %j_mid2)
  %b_0_addr_4 = getelementptr [96 x i32]* %b_0, i64 0, i64 %tmp_25
  %tmp_26 = add i7 %tmp_6_cast1, -48
  %tmp_27_cast = zext i7 %tmp_26 to i64
  %b_0_addr_5 = getelementptr [96 x i32]* %b_0, i64 0, i64 %tmp_27_cast
  %b_1_addr = getelementptr [96 x i32]* %b_1, i64 0, i64 %tmp_6
  %b_1_addr_1 = getelementptr [96 x i32]* %b_1, i64 0, i64 %tmp_23_cast
  %b_1_addr_2 = getelementptr [96 x i32]* %b_1, i64 0, i64 %tmp_23
  %b_1_addr_3 = getelementptr [96 x i32]* %b_1, i64 0, i64 %tmp_25_cast
  %b_1_addr_4 = getelementptr [96 x i32]* %b_1, i64 0, i64 %tmp_25
  %b_1_addr_5 = getelementptr [96 x i32]* %b_1, i64 0, i64 %tmp_27_cast
  %b_2_addr = getelementptr [64 x i32]* %b_2, i64 0, i64 %tmp_6
  %b_2_addr_1 = getelementptr [64 x i32]* %b_2, i64 0, i64 %tmp_23_cast
  %b_2_addr_2 = getelementptr [64 x i32]* %b_2, i64 0, i64 %tmp_23
  %b_2_addr_3 = getelementptr [64 x i32]* %b_2, i64 0, i64 %tmp_25_cast
...
.preheader7.preheader:                            ; preds = %.preheader7
  ...
  %tmp_5 = sub i8 %tmp_1, %p_shl1_cast
  %tmp_5_cast = sext i8 %tmp_5 to i64
  %a_0_addr = getelementptr [96 x i32]* %a_0, i64 0, i64 %tmp_5_cast
  %tmp_7 = or i8 %tmp_5, 1
  %tmp_7_cast = zext i8 %tmp_7 to i64
  %a_0_addr_1 = getelementptr [96 x i32]* %a_0, i64 0, i64 %tmp_7_cast
  %tmp_8 = add i8 %tmp_5, 2
  %tmp_8_cast = sext i8 %tmp_8 to i64
  %a_0_addr_2 = getelementptr [96 x i32]* %a_0, i64 0, i64 %tmp_8_cast
  %tmp_10 = add i8 %tmp_5, 3
  %tmp_10_cast = sext i8 %tmp_10 to i64
  %a_0_addr_3 = getelementptr [96 x i32]* %a_0, i64 0, i64 %tmp_10_cast
  %tmp_11 = add i8 %tmp_5, 4
  %tmp_11_cast = sext i8 %tmp_11 to i64
  %a_0_addr_4 = getelementptr [96 x i32]* %a_0, i64 0, i64 %tmp_11_cast
  %tmp_12 = add i8 %tmp_5, 5
  %tmp_12_cast = sext i8 %tmp_12 to i64
  %a_0_addr_5 = getelementptr [96 x i32]* %a_0, i64 0, i64 %tmp_12_cast
  %a_1_addr = getelementptr [96 x i32]* %a_1, i64 0, i64 %tmp_5_cast
  %a_1_addr_1 = getelementptr [96 x i32]* %a_1, i64 0, i64 %tmp_7_cast
  %a_1_addr_2 = getelementptr [96 x i32]* %a_1, i64 0, i64 %tmp_8_cast
  %a_1_addr_3 = getelementptr [96 x i32]* %a_1, i64 0, i64 %tmp_10_cast
  %a_1_addr_4 = getelementptr [96 x i32]* %a_1, i64 0, i64 %tmp_11_cast
  %a_1_addr_5 = getelementptr [96 x i32]* %a_1, i64 0, i64 %tmp_12_cast
  %tmp_13 = call i7 @_ssdm_op_BitConcatenate.i7.i5.i2(i5 %tmp_1_mid2_v, i2 0)
  %tmp_14 = zext i7 %tmp_13 to i64
  %a_2_addr = getelementptr [64 x i32]* %a_2, i64 0, i64 %tmp_14
  %tmp_15 = or i7 %tmp_13, 1
  %tmp_16 = call i64 @_ssdm_op_BitConcatenate.i64.i57.i7(i57 0, i7 %tmp_15)
  %a_2_addr_1 = getelementptr [64 x i32]* %a_2, i64 0, i64 %tmp_16
  %tmp_17 = or i7 %tmp_13, 2
  %tmp_18 = call i64 @_ssdm_op_BitConcatenate.i64.i57.i7(i57 0, i7 %tmp_17)
  %a_2_addr_2 = getelementptr [64 x i32]* %a_2, i64 0, i64 %tmp_18
  %tmp_19 = or i7 %tmp_13, 3
  %tmp_20 = call i64 @_ssdm_op_BitConcatenate.i64.i57.i7(i57 0, i7 %tmp_19)
  %a_2_addr_3 = getelementptr [64 x i32]* %a_2, i64 0, i64 %tmp_20
  %tmp_21 = call i9 @_ssdm_op_BitConcatenate.i9.i5.i4(i5 %tmp_1_mid2_v, i4 0)
  %tmp_22_cast = zext i9 %tmp_21 to i10
  ...
  %a_row_6 = load i32* %a_1_addr, align 4
  %a_row_7 = load i32* %a_1_addr_1, align 4
  %a_row_8 = load i32* %a_1_addr_2, align 4
  %a_row_9 = load i32* %a_1_addr_3, align 4
  %a_row_10 = load i32* %a_1_addr_4, align 4
  %a_row_11 = load i32* %a_1_addr_5, align 4
  %a_row_12 = load i32* %a_2_addr, align 4
  %a_row_13 = load i32* %a_2_addr_1, align 4
  %a_row_14 = load i32* %a_2_addr_2, align 4
  %a_row_15 = load i32* %a_2_addr_3, align 4
