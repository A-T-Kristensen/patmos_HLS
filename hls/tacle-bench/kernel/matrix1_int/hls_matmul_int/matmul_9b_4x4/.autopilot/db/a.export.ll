...
define void @matmul_hw([4 x i32]* %a_0, [4 x i32]* %a_1, [4 x i32]* %a_2, [4 x i32]* %a_3, [4 x i32]* %b_0, [4 x i32]* %b_1, [4 x i32]* %b_2, [4 x i32]* %b_3, [16 x i32]* %c) {
  ...
  call void (...)* @_ssdm_op_SpecBitsMap([4 x i32]* %a_3), !map !7
  call void (...)* @_ssdm_op_SpecBitsMap([4 x i32]* %a_2), !map !14
  call void (...)* @_ssdm_op_SpecBitsMap([4 x i32]* %a_1), !map !20
  call void (...)* @_ssdm_op_SpecBitsMap([4 x i32]* %a_0), !map !26
  call void (...)* @_ssdm_op_SpecBitsMap([4 x i32]* %b_3), !map !32
  call void (...)* @_ssdm_op_SpecBitsMap([4 x i32]* %b_2), !map !37
  call void (...)* @_ssdm_op_SpecBitsMap([4 x i32]* %b_1), !map !42
  call void (...)* @_ssdm_op_SpecBitsMap([4 x i32]* %b_0), !map !47
  call void (...)* @_ssdm_op_SpecBitsMap([16 x i32]* %c), !map !52
...
.preheader7.preheader:                            ; preds = %.preheader7
  ...
  %tmp_1_mid2 = zext i3 %tmp_1_mid2_v to i64
  %tmp_1 = call i5 @_ssdm_op_BitConcatenate.i5.i3.i2(i3 %tmp_1_mid2_v, i2 0)
  %tmp_9_cast = zext i5 %tmp_1 to i6
  ...
  %a_0_addr = getelementptr [4 x i32]* %a_0, i64 0, i64 %tmp_1_mid2
  %a_row_0 = load i32* %a_0_addr, align 4
  %a_1_addr = getelementptr [4 x i32]* %a_1, i64 0, i64 %tmp_1_mid2
  %a_row_1 = load i32* %a_1_addr, align 4
  %a_2_addr = getelementptr [4 x i32]* %a_2, i64 0, i64 %tmp_1_mid2
  %a_row_2 = load i32* %a_2_addr, align 4
  %a_3_addr = getelementptr [4 x i32]* %a_3, i64 0, i64 %tmp_1_mid2
  %a_row_3 = load i32* %a_3_addr, align 4
  ...
  %tmp_6_cast = zext i3 %j_mid2 to i6
  %tmp_9 = add i6 %tmp_9_cast, %tmp_6_cast
  %tmp_10_cast = zext i6 %tmp_9 to i64
  %c_addr = getelementptr [16 x i32]* %c, i64 0, i64 %tmp_10_cast
  %b_0_addr = getelementptr [4 x i32]* %b_0, i64 0, i64 %tmp_6
  ...
  %b_1_addr = getelementptr [4 x i32]* %b_1, i64 0, i64 %tmp_6
  %b_copy_1_3_19 = load i32* %b_1_addr, align 4
  ...
  %b_2_addr = getelementptr [4 x i32]* %b_2, i64 0, i64 %tmp_6
  %b_copy_2_3_19 = load i32* %b_2_addr, align 4
  ...
  %b_3_addr = getelementptr [4 x i32]* %b_3, i64 0, i64 %tmp_6
  %b_copy_3_3_19 = load i32* %b_3_addr, align 4
...
entry:
  ...
  %empty_4 = zext i2 %1 to i5
  %empty_5 = shl i5 %empty, 2
  %empty_6 = or i5 %empty_5, %empty_4
  ret i5 %empty_6
}
