...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "filterbank_core_hwa.autotvin.dat"
	set constFileTvOut       "filterbank_core_hwa.autotvout.dat"
	set constFileHdlTvIn     "filterbank_core_hwa.autohdltvin.dat"
	set constFileHdlTvOut    "filterbank_core_hwa.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
