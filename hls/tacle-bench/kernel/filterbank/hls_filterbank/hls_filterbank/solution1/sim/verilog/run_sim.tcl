...
if {[file isfile filterbank_core_hwa.autotvin.dat]} {
	file delete -force filterbank_core_hwa.autotvin.dat
}

if {[file isfile filterbank_core_hwa.autotvout.dat]} {
	file delete -force filterbank_core_hwa.autotvout.dat
}
