...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.filterbank_core_hwa.autotvin_r.dat"
         "c.filterbank_core_hwa.autotvin_y.dat"
         "c.filterbank_core_hwa.autotvin_H.dat"
         "c.filterbank_core_hwa.autotvin_F.dat"
         "c.filterbank_core_hwa.autotvout_y.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.filterbank_core_hwa.autotvout_y.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
