...
(* CORE_GENERATION_INFO="matmul_hw,hls_ip_2016_4,{HLS_INPUT_TYPE=c,HLS_INPUT_FLOAT=1,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7a100tcsg324-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.263000,HLS_SYN_LAT=88,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=5,HLS_SYN_FF=1491,HLS_SYN_LUT=2654}" *)
...
wire   [2:0] tmp_1_mid2_v_fu_350_p3;
reg   [2:0] tmp_1_mid2_v_reg_1274;
wire   [4:0] tmp_1_fu_358_p3;
reg   [4:0] tmp_1_reg_1279;
wire   [1:0] tmp_fu_376_p1;
reg   [1:0] tmp_reg_1297;
wire   [0:0] tmp_3_fu_406_p2;
...
wire   [31:0] tmp_7_fu_709_p6;
reg   [31:0] tmp_7_reg_1385;
...
wire   [31:0] tmp_8_fu_901_p6;
reg   [31:0] tmp_8_reg_1410;
...
wire   [31:0] tmp_9_fu_1068_p6;
reg   [31:0] tmp_9_reg_1430;
wire   [31:0] grp_fu_290_p2;
reg   [31:0] tmp_s_reg_1435;
reg    ap_enable_reg_pp0_iter1;
reg   [31:0] tmp_2_1_reg_1440;
reg   [31:0] ap_pipeline_reg_pp0_iter2_tmp_2_1_reg_1440;
reg   [31:0] tmp_2_2_reg_1445;
reg   [31:0] ap_pipeline_reg_pp0_iter2_tmp_2_2_reg_1445;
reg   [31:0] ap_pipeline_reg_pp0_iter3_tmp_2_2_reg_1445;
reg   [31:0] tmp_2_3_reg_1450;
reg    ap_enable_reg_pp0_iter2;
reg   [31:0] ap_pipeline_reg_pp0_iter3_tmp_2_3_reg_1450;
reg   [31:0] ap_pipeline_reg_pp0_iter4_tmp_2_3_reg_1450;
reg   [31:0] ap_pipeline_reg_pp0_iter5_tmp_2_3_reg_1450;
wire   [31:0] grp_fu_285_p2;
reg   [31:0] tmp_5_reg_1455;
reg   [31:0] tmp_5_1_reg_1460;
reg    ap_enable_reg_pp0_iter3;
reg   [31:0] tmp_5_2_reg_1465;
reg    ap_enable_reg_pp0_iter5;
reg   [31:0] tmp_5_3_reg_1470;
...
wire   [31:0] tmp_7_fu_709_p1;
wire   [31:0] tmp_7_fu_709_p2;
wire   [31:0] tmp_7_fu_709_p3;
wire   [31:0] tmp_7_fu_709_p4;
wire   [4:0] tmp_15_fu_765_p2;
wire   [4:0] tmp_6_cast5_fu_790_p1;
wire   [4:0] tmp_19_fu_793_p2;
wire   [5:0] tmp_10_cast_fu_762_p1;
wire   [5:0] tmp_6_cast6_fu_787_p1;
...
wire   [31:0] tmp_8_fu_901_p1;
wire   [31:0] tmp_8_fu_901_p2;
wire   [31:0] tmp_8_fu_901_p3;
wire   [31:0] tmp_8_fu_901_p4;
...
wire   [31:0] tmp_9_fu_1068_p1;
wire   [31:0] tmp_9_fu_1068_p2;
wire   [31:0] tmp_9_fu_1068_p3;
wire   [31:0] tmp_9_fu_1068_p4;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == exitcond_flatten_fu_298_p2))) begin
        ...
        tmp_1_reg_1279[4 : 2] <= tmp_1_fu_358_p3[4 : 2];
...
always @ (posedge ap_clk) begin
    if ((((1'b1 == ap_CS_fsm_pp0_stage1) & (1'b1 == ap_enable_reg_pp0_iter0) & (exitcond_flatten_reg_1235 == 1'b0)) | ((1'b1 == ap_enable_reg_pp0_iter0) & (exitcond_flatten_reg_1235 == 1'b0) & (1'b1 == ap_CS_fsm_pp0_stage2)) | ((1'b1 == ap_enable_reg_pp0_iter0) & (exitcond_flatten_reg_1235 == 1'b0) & (1'b1 == ap_CS_fsm_pp0_stage3) & ~(1'b0 == tmp_3_reg_1313)))) begin
        reg_294 <= a_Dout_A;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_enable_reg_pp0_iter0)) begin
        if ((1'b1 == ap_CS_fsm_pp0_stage3)) begin
            a_Addr_A_orig = tmp_16_fu_770_p3;
        end else if ((1'b1 == ap_CS_fsm_pp0_stage2)) begin
            a_Addr_A_orig = tmp_14_fu_593_p3;
        end else if ((1'b1 == ap_CS_fsm_pp0_stage1)) begin
            a_Addr_A_orig = tmp_12_fu_397_p3;
        end else if ((1'b1 == ap_CS_fsm_pp0_stage0)) begin
            a_Addr_A_orig = tmp_10_fu_366_p1;
        end else begin
            a_Addr_A_orig = 'bx;
        end
    end else begin
...
always @ (*) begin
    if ((1'b1 == ap_enable_reg_pp0_iter0)) begin
        if ((1'b1 == ap_CS_fsm_pp0_stage3)) begin
            b_Addr_A_orig = tmp_19_cast_fu_799_p1;
        end else if ((1'b1 == ap_CS_fsm_pp0_stage2)) begin
            b_Addr_A_orig = tmp_18_fu_610_p3;
        end else if ((1'b1 == ap_CS_fsm_pp0_stage1)) begin
            b_Addr_A_orig = tmp_17_cast_fu_420_p1;
        end else if ((1'b1 == ap_CS_fsm_pp0_stage0)) begin
            b_Addr_A_orig = tmp_6_fu_371_p1;
        end else begin
            b_Addr_A_orig = 'bx;
        end
    end else begin
...
assign a_row_load_1_fu_779_p3 = ((tmp_3_reg_1313[0:0] === 1'b1) ? reg_294 : a_row_load_9_fu_92);

assign a_row_load_2_fu_969_p3 = ((tmp_3_reg_1313[0:0] === 1'b1) ? reg_294 : a_row_load_8_fu_96);

assign a_row_load_3_fu_962_p3 = ((tmp_3_reg_1313[0:0] === 1'b1) ? a_Dout_A : a_row_load_7_fu_100);

assign a_row_load_fu_602_p3 = ((tmp_3_reg_1313[0:0] === 1'b1) ? reg_294 : a_row_load_s_fu_88);
...
assign b_copy_0_3_15_fu_504_p3 = ((sel_tmp4_fu_451_p2[0:0] === 1'b1) ? b_Dout_A : b_copy_0_3_11_fu_104);
...
assign b_copy_0_3_5_fu_464_p3 = ((sel_tmp_fu_425_p2[0:0] === 1'b1) ? b_Dout_A : b_copy_0_3_12_fu_112);
...
assign b_copy_0_3_9_fu_488_p3 = ((sel_tmp2_fu_438_p2[0:0] === 1'b1) ? b_Dout_A : b_copy_0_3_8_fu_108);

assign b_copy_0_3_fu_430_p3 = ((sel_tmp_fu_425_p2[0:0] === 1'b1) ? b_copy_0_3_1_fu_116 : b_Dout_A);

assign b_copy_1_3_14_fu_667_p3 = ((sel_tmp4_reg_1349[0:0] === 1'b1) ? b_copy_1_3_8_fu_124 : b_copy_1_3_9_fu_660_p3);

assign b_copy_1_3_15_fu_674_p3 = ((sel_tmp4_reg_1349[0:0] === 1'b1) ? b_Dout_A : b_copy_1_3_11_fu_120);
...
assign b_copy_1_3_5_fu_639_p3 = ((sel_tmp_reg_1326[0:0] === 1'b1) ? b_Dout_A : b_copy_1_3_12_fu_128);
...
assign b_copy_1_3_9_fu_660_p3 = ((sel_tmp2_reg_1336[0:0] === 1'b1) ? b_Dout_A : b_copy_1_3_8_fu_124);

assign b_copy_1_3_fu_618_p3 = ((sel_tmp_reg_1326[0:0] === 1'b1) ? b_copy_1_3_1_fu_132 : b_Dout_A);

assign b_copy_2_3_14_fu_859_p3 = ((sel_tmp4_reg_1349[0:0] === 1'b1) ? b_copy_2_3_8_fu_140 : b_copy_2_3_9_fu_852_p3);

assign b_copy_2_3_15_fu_866_p3 = ((sel_tmp4_reg_1349[0:0] === 1'b1) ? b_Dout_A : b_copy_2_3_11_fu_136);
...
assign b_copy_2_3_5_fu_831_p3 = ((sel_tmp_reg_1326[0:0] === 1'b1) ? b_Dout_A : b_copy_2_3_12_fu_144);
...
assign b_copy_2_3_9_fu_852_p3 = ((sel_tmp2_reg_1336[0:0] === 1'b1) ? b_Dout_A : b_copy_2_3_8_fu_140);

assign b_copy_2_3_fu_810_p3 = ((sel_tmp_reg_1326[0:0] === 1'b1) ? b_copy_2_3_1_fu_148 : b_Dout_A);

assign b_copy_3_3_14_fu_1026_p3 = ((sel_tmp4_reg_1349[0:0] === 1'b1) ? b_copy_3_3_8_fu_156 : b_copy_3_3_9_fu_1019_p3);

assign b_copy_3_3_15_fu_1033_p3 = ((sel_tmp4_reg_1349[0:0] === 1'b1) ? b_Dout_A : b_copy_3_3_11_fu_152);
...
assign b_copy_3_3_5_fu_998_p3 = ((sel_tmp_reg_1326[0:0] === 1'b1) ? b_Dout_A : b_copy_3_3_12_fu_160);
...
assign b_copy_3_3_9_fu_1019_p3 = ((sel_tmp2_reg_1336[0:0] === 1'b1) ? b_Dout_A : b_copy_3_3_8_fu_156);

assign b_copy_3_3_fu_977_p3 = ((sel_tmp_reg_1326[0:0] === 1'b1) ? b_copy_3_3_1_fu_164 : b_Dout_A);

assign c_Addr_A = c_Addr_A_orig << ap_const_lv32_2;

assign c_Addr_A_orig = tmp_20_cast_fu_1111_p1;

assign c_Clk_A = ap_clk;

assign c_Din_A = tmp_5_3_reg_1470;
...
assign tmp_10_cast_fu_762_p1 = tmp_1_reg_1279;

assign tmp_10_fu_366_p1 = tmp_1_fu_358_p3;

assign tmp_11_fu_392_p2 = (tmp_1_reg_1279 | ap_const_lv5_1);

assign tmp_12_fu_397_p3 = {{ap_const_lv59_0}, {tmp_11_fu_392_p2}};

assign tmp_13_fu_588_p2 = (tmp_1_reg_1279 | ap_const_lv5_2);

assign tmp_14_fu_593_p3 = {{ap_const_lv59_0}, {tmp_13_fu_588_p2}};

assign tmp_15_fu_765_p2 = (tmp_1_reg_1279 | ap_const_lv5_3);

assign tmp_16_fu_770_p3 = {{ap_const_lv59_0}, {tmp_15_fu_765_p2}};

assign tmp_17_cast_fu_420_p1 = tmp_17_fu_414_p2;

assign tmp_17_fu_414_p2 = (ap_const_lv4_4 + tmp_6_cast_fu_411_p1);

assign tmp_18_fu_610_p3 = {{ap_const_lv61_1}, {j_mid2_reg_1244}};

assign tmp_19_cast_fu_799_p1 = tmp_19_fu_793_p2;

assign tmp_19_fu_793_p2 = (ap_const_lv5_C + tmp_6_cast5_fu_790_p1);

assign tmp_1_fu_358_p3 = {{tmp_1_mid2_v_fu_350_p3}, {ap_const_lv2_0}};

assign tmp_1_mid2_v_fu_350_p3 = ((exitcond_fu_316_p2[0:0] === 1'b1) ? i_1_fu_310_p2 : i_phi_fu_267_p4);

assign tmp_20_cast_fu_1111_p1 = ap_pipeline_reg_pp0_iter5_tmp_20_reg_1405;

assign tmp_20_fu_804_p2 = (tmp_10_cast_fu_762_p1 + tmp_6_cast6_fu_787_p1);

assign tmp_3_fu_406_p2 = ((j_mid2_reg_1244 == ap_const_lv3_0) ? 1'b1 : 1'b0);

assign tmp_4_fu_540_p1 = ((tmp_mid2_reg_1254[0:0] === 1'b1) ? b_copy_0_3_15_fu_504_p3 : b_copy_0_3_11_fu_104);

assign tmp_4_fu_540_p2 = ((tmp_mid2_reg_1254[0:0] === 1'b1) ? b_copy_0_3_14_fu_496_p3 : b_copy_0_3_8_fu_108);

assign tmp_4_fu_540_p3 = ((tmp_mid2_reg_1254[0:0] === 1'b1) ? b_copy_0_3_7_fu_480_p3 : b_copy_0_3_12_fu_112);

assign tmp_4_fu_540_p4 = ((tmp_mid2_reg_1254[0:0] === 1'b1) ? b_copy_0_3_2_fu_456_p3 : b_copy_0_3_1_fu_116);

assign tmp_6_cast5_fu_790_p1 = j_mid2_reg_1244;

assign tmp_6_cast6_fu_787_p1 = j_mid2_reg_1244;

assign tmp_6_cast_fu_411_p1 = j_mid2_reg_1244;

assign tmp_6_fu_371_p1 = j_mid2_fu_322_p3;

assign tmp_7_fu_709_p1 = ((tmp_mid2_reg_1254[0:0] === 1'b1) ? b_copy_1_3_15_fu_674_p3 : b_copy_1_3_11_fu_120);

assign tmp_7_fu_709_p2 = ((tmp_mid2_reg_1254[0:0] === 1'b1) ? b_copy_1_3_14_fu_667_p3 : b_copy_1_3_8_fu_124);

assign tmp_7_fu_709_p3 = ((tmp_mid2_reg_1254[0:0] === 1'b1) ? b_copy_1_3_7_fu_653_p3 : b_copy_1_3_12_fu_128);

assign tmp_7_fu_709_p4 = ((tmp_mid2_reg_1254[0:0] === 1'b1) ? b_copy_1_3_2_fu_632_p3 : b_copy_1_3_1_fu_132);

assign tmp_8_fu_901_p1 = ((tmp_mid2_reg_1254[0:0] === 1'b1) ? b_copy_2_3_15_fu_866_p3 : b_copy_2_3_11_fu_136);

assign tmp_8_fu_901_p2 = ((tmp_mid2_reg_1254[0:0] === 1'b1) ? b_copy_2_3_14_fu_859_p3 : b_copy_2_3_8_fu_140);

assign tmp_8_fu_901_p3 = ((tmp_mid2_reg_1254[0:0] === 1'b1) ? b_copy_2_3_7_fu_845_p3 : b_copy_2_3_12_fu_144);

assign tmp_8_fu_901_p4 = ((tmp_mid2_reg_1254[0:0] === 1'b1) ? b_copy_2_3_2_fu_824_p3 : b_copy_2_3_1_fu_148);

assign tmp_9_fu_1068_p1 = ((tmp_mid2_reg_1254[0:0] === 1'b1) ? b_copy_3_3_15_fu_1033_p3 : b_copy_3_3_11_fu_152);

assign tmp_9_fu_1068_p2 = ((tmp_mid2_reg_1254[0:0] === 1'b1) ? b_copy_3_3_14_fu_1026_p3 : b_copy_3_3_8_fu_156);

assign tmp_9_fu_1068_p3 = ((tmp_mid2_reg_1254[0:0] === 1'b1) ? b_copy_3_3_7_fu_1012_p3 : b_copy_3_3_12_fu_160);

assign tmp_9_fu_1068_p4 = ((tmp_mid2_reg_1254[0:0] === 1'b1) ? b_copy_3_3_2_fu_991_p3 : b_copy_3_3_1_fu_164);
