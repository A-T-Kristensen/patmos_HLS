...
define void @matmul_hw([16 x float]* %a, [16 x float]* %b, [16 x float]* %c) nounwind uwtable {
  ...
  call void (...)* @_ssdm_op_SpecBitsMap([16 x float]* %a) nounwind, !map !7
  call void (...)* @_ssdm_op_SpecBitsMap([16 x float]* %b) nounwind, !map !13
  call void (...)* @_ssdm_op_SpecBitsMap([16 x float]* %c) nounwind, !map !17
...
.preheader7.preheader:                            ; preds = %.preheader7
  ...
  %tmp_1 = call i5 @_ssdm_op_BitConcatenate.i5.i3.i2(i3 %tmp_1_mid2_v, i2 0)
  %tmp_10 = zext i5 %tmp_1 to i64
  %tmp_10_cast = zext i5 %tmp_1 to i6
  %a_addr = getelementptr [16 x float]* %a, i64 0, i64 %tmp_10
  %tmp_11 = or i5 %tmp_1, 1
  %tmp_12 = call i64 @_ssdm_op_BitConcatenate.i64.i59.i5(i59 0, i5 %tmp_11)
  %a_addr_1 = getelementptr [16 x float]* %a, i64 0, i64 %tmp_12
  %tmp_13 = or i5 %tmp_1, 2
  %tmp_14 = call i64 @_ssdm_op_BitConcatenate.i64.i59.i5(i59 0, i5 %tmp_13)
  %a_addr_2 = getelementptr [16 x float]* %a, i64 0, i64 %tmp_14
  %tmp_15 = or i5 %tmp_1, 3
  %tmp_16 = call i64 @_ssdm_op_BitConcatenate.i64.i59.i5(i59 0, i5 %tmp_15)
  %a_addr_3 = getelementptr [16 x float]* %a, i64 0, i64 %tmp_16
  ...
  %a_row_load_3 = select i1 %tmp_3, float %a_load_3, float %a_row_load_10
  %a_row_load_2 = select i1 %tmp_3, float %a_load_2, float %a_row_load_6
  %a_row_load_1 = select i1 %tmp_3, float %a_load_1, float %a_row_load_5
  %a_row_load = select i1 %tmp_3, float %a_load, float %a_row_load_4
  %tmp_6 = zext i3 %j_mid2 to i64
  %tmp_6_cast6 = zext i3 %j_mid2 to i6
  %tmp_6_cast5 = zext i3 %j_mid2 to i5
  %tmp_6_cast = zext i3 %j_mid2 to i4
  %b_addr = getelementptr [16 x float]* %b, i64 0, i64 %tmp_6
  %tmp_17 = add i4 4, %tmp_6_cast
  %tmp_17_cast = zext i4 %tmp_17 to i64
  %b_addr_1 = getelementptr [16 x float]* %b, i64 0, i64 %tmp_17_cast
  %tmp_18 = call i64 @_ssdm_op_BitConcatenate.i64.i61.i3(i61 1, i3 %j_mid2)
  %b_addr_2 = getelementptr [16 x float]* %b, i64 0, i64 %tmp_18
  %tmp_19 = add i5 12, %tmp_6_cast5
  %tmp_19_cast = zext i5 %tmp_19 to i64
  %b_addr_3 = getelementptr [16 x float]* %b, i64 0, i64 %tmp_19_cast
  %tmp_20 = add i6 %tmp_10_cast, %tmp_6_cast6
  %tmp_20_cast = zext i6 %tmp_20 to i64
  %c_addr = getelementptr [16 x float]* %c, i64 0, i64 %tmp_20_cast
  %b_copy_0_3_19 = load float* %b_addr, align 4
  ...
  %b_copy_1_3_19 = load float* %b_addr_1, align 4
  ...
  %b_copy_2_3_19 = load float* %b_addr_2, align 4
  ...
  %b_copy_3_3_19 = load float* %b_addr_3, align 4
  ...
  %tmp_4 = call float @_ssdm_op_Mux.ap_auto.4float.i2(float %b_copy_0_3_18, float %b_copy_0_3_17, float %b_copy_0_3_16, float %b_copy_0_3_3, i2 %tmp) nounwind
  %tmp_s = fmul float %a_row_load, %tmp_4
  %tmp_5 = fadd float %tmp_s, 0.000000e+00
  %tmp_7 = call float @_ssdm_op_Mux.ap_auto.4float.i2(float %b_copy_1_3_18, float %b_copy_1_3_17, float %b_copy_1_3_16, float %b_copy_1_3_3, i2 %tmp) nounwind
  %tmp_2_1 = fmul float %a_row_load_1, %tmp_7
  %tmp_5_1 = fadd float %tmp_5, %tmp_2_1
  %tmp_8 = call float @_ssdm_op_Mux.ap_auto.4float.i2(float %b_copy_2_3_18, float %b_copy_2_3_17, float %b_copy_2_3_16, float %b_copy_2_3_3, i2 %tmp) nounwind
  %tmp_2_2 = fmul float %a_row_load_2, %tmp_8
  %tmp_5_2 = fadd float %tmp_5_1, %tmp_2_2
  %tmp_9 = call float @_ssdm_op_Mux.ap_auto.4float.i2(float %b_copy_3_3_18, float %b_copy_3_3_17, float %b_copy_3_3_16, float %b_copy_3_3_3, i2 %tmp) nounwind
