; ModuleID = '/home/patmos/github/bachelor_project_HLS/hls/tacle-bench/kernel/matrix1_float/hls_matmul_float/matmul_3b/.autopilot/db/a.o.2.bc'
...
; <label>:1                                       ; preds = %5, %0
  ...
  %exitcond4 = icmp eq i2 %i, -2, !dbg !48        ; [#uses=1 type=i1] [debug line = 21:15]
...
.preheader7.preheader:                            ; preds = %1
  %tmp = icmp eq i2 %i, 0, !dbg !50               ; [#uses=4 type=i1] [debug line = 36:4]
  %tmp.1 = zext i2 %i to i64, !dbg !54            ; [#uses=3 type=i64] [debug line = 46:5]
  %a.addr = getelementptr [2 x [2 x float]]* %a, i64 0, i64 %tmp.1, i64 0, !dbg !55 ; [#uses=1 type=float*] [debug line = 32:6]
  %a.addr.1 = getelementptr [2 x [2 x float]]* %a, i64 0, i64 %tmp.1, i64 1, !dbg !55 ; [#uses=1 type=float*] [debug line = 32:6]
...
.preheader7:                                      ; preds = %_ifconv, %.preheader7.preheader
  ...
  %exitcond3 = icmp eq i2 %j, -2, !dbg !59        ; [#uses=1 type=i1] [debug line = 23:20]
...
_ifconv:                                          ; preds = %.preheader7
  ...
  %tmp.3 = icmp eq i2 %j, 0, !dbg !62             ; [#uses=2 type=i1] [debug line = 30:5]
  ...
  %tmp.6 = zext i2 %j to i64, !dbg !63            ; [#uses=3 type=i64] [debug line = 38:7]
  %b.addr = getelementptr [2 x [2 x float]]* %b, i64 0, i64 0, i64 %tmp.6, !dbg !63 ; [#uses=1 type=float*] [debug line = 38:7]
  %"b_copy[0][0]" = load float* %b.addr, align 4, !dbg !63 ; [#uses=2 type=float] [debug line = 38:7]
  %j.t = trunc i2 %j to i1                        ; [#uses=6 type=i1]
  call void @llvm.dbg.value(metadata !{float %"b_copy[0][0]"}, i64 0, metadata !67), !dbg !63 ; [debug line = 38:7] [debug variable = b_copy[0][0]]
  call void @llvm.dbg.value(metadata !{float %"b_copy[0][0]"}, i64 0, metadata !71), !dbg !63 ; [debug line = 38:7] [debug variable = b_copy[0][1]]
  %"b_copy[0][1].1" = select i1 %j.t, float %"b_copy[0][0]", float %b_copy.0.1.1, !dbg !63 ; [#uses=1 type=float] [debug line = 38:7]
  call void @llvm.dbg.value(metadata !{float %"b_copy[0][1].1"}, i64 0, metadata !71), !dbg !63 ; [debug line = 38:7] [debug variable = b_copy[0][1]]
  %"b_copy[0][1].2" = select i1 %j.t, float %b_copy.0.0.1, float %"b_copy[0][0]", !dbg !63 ; [#uses=1 type=float] [debug line = 38:7]
  call void @llvm.dbg.value(metadata !{float %"b_copy[0][1].2"}, i64 0, metadata !71), !dbg !63 ; [debug line = 38:7] [debug variable = b_copy[0][1]]
  %b.addr.1 = getelementptr [2 x [2 x float]]* %b, i64 0, i64 1, i64 %tmp.6, !dbg !63 ; [#uses=1 type=float*] [debug line = 38:7]
  %"b_copy[1][0]" = load float* %b.addr.1, align 4, !dbg !63 ; [#uses=2 type=float] [debug line = 38:7]
  call void @llvm.dbg.value(metadata !{float %"b_copy[1][0]"}, i64 0, metadata !72), !dbg !63 ; [debug line = 38:7] [debug variable = b_copy[1][0]]
  call void @llvm.dbg.value(metadata !{float %"b_copy[1][0]"}, i64 0, metadata !74), !dbg !63 ; [debug line = 38:7] [debug variable = b_copy[1][1]]
  %"b_copy[1][1].1" = select i1 %j.t, float %"b_copy[1][0]", float %b_copy.1.1.1, !dbg !63 ; [#uses=1 type=float] [debug line = 38:7]
  call void @llvm.dbg.value(metadata !{float %"b_copy[1][1].1"}, i64 0, metadata !74), !dbg !63 ; [debug line = 38:7] [debug variable = b_copy[1][1]]
  %"b_copy[1][1].2" = select i1 %j.t, float %b_copy.1.0.1, float %"b_copy[1][0]", !dbg !63 ; [#uses=1 type=float] [debug line = 38:7]
  call void @llvm.dbg.value(metadata !{float %"b_copy[1][1].2"}, i64 0, metadata !74), !dbg !63 ; [debug line = 38:7] [debug variable = b_copy[1][1]]
  %"b_copy[1][1].3" = select i1 %tmp, float %"b_copy[1][1].1", float %b_copy.1.1.1 ; [#uses=2 type=float]
  call void @llvm.dbg.value(metadata !{float %"b_copy[1][1].3"}, i64 0, metadata !74), !dbg !63 ; [debug line = 38:7] [debug variable = b_copy[1][1]]
  %"b_copy[1][1].4" = select i1 %tmp, float %"b_copy[1][1].2", float %b_copy.1.0.1 ; [#uses=2 type=float]
  call void @llvm.dbg.value(metadata !{float %"b_copy[1][1].4"}, i64 0, metadata !74), !dbg !63 ; [debug line = 38:7] [debug variable = b_copy[1][1]]
  %"b_copy[0][1].3" = select i1 %tmp, float %"b_copy[0][1].1", float %b_copy.0.1.1 ; [#uses=2 type=float]
  call void @llvm.dbg.value(metadata !{float %"b_copy[0][1].3"}, i64 0, metadata !71), !dbg !63 ; [debug line = 38:7] [debug variable = b_copy[0][1]]
  %"b_copy[0][1].4" = select i1 %tmp, float %"b_copy[0][1].2", float %b_copy.0.0.1 ; [#uses=2 type=float]
  call void @llvm.dbg.value(metadata !{float %"b_copy[0][1].4"}, i64 0, metadata !71), !dbg !63 ; [debug line = 38:7] [debug variable = b_copy[0][1]]
  %b_copy.load.0.phi = select i1 %j.t, float %"b_copy[0][1].3", float %"b_copy[0][1].4", !dbg !75 ; [#uses=1 type=float] [debug line = 43:4]
  %tmp. = fmul float %a_row.load, %b_copy.load.0.phi, !dbg !75 ; [#uses=1 type=float] [debug line = 43:4]
  %tmp.5 = fadd float %tmp., 0.000000e+00, !dbg !75 ; [#uses=1 type=float] [debug line = 43:4]
  %b_copy.load.1.phi = select i1 %j.t, float %"b_copy[1][1].3", float %"b_copy[1][1].4", !dbg !75 ; [#uses=1 type=float] [debug line = 43:4]
  %tmp.2.1 = fmul float %a_row.load.1, %b_copy.load.1.phi, !dbg !75 ; [#uses=1 type=float] [debug line = 43:4]
  %tmp.5.1 = fadd float %tmp.5, %tmp.2.1, !dbg !75 ; [#uses=1 type=float] [debug line = 43:4]
  %c.addr = getelementptr [2 x [2 x float]]* %c, i64 0, i64 %tmp.1, i64 %tmp.6, !dbg !54 ; [#uses=1 type=float*] [debug line = 46:5]
  store float %tmp.5.1, float* %c.addr, align 4, !dbg !54 ; [debug line = 46:5]
  %4 = call i32 (...)* @_ssdm_op_SpecRegionEnd([4 x i8]* @.str4, i32 %tmp.2) nounwind, !dbg !78 ; [#uses=0 type=i32] [debug line = 47:3]
  %j.1 = add i2 %j, 1, !dbg !79                   ; [#uses=1 type=i2] [debug line = 23:63]
  call void @llvm.dbg.value(metadata !{i2 %j.1}, i64 0, metadata !80), !dbg !79 ; [debug line = 23:63] [debug variable = j]
  br label %.preheader7, !dbg !79                 ; [debug line = 23:63]
...
; <label>:5                                       ; preds = %.preheader7
  ...
  %i.1 = add i2 %i, 1, !dbg !82                   ; [#uses=1 type=i2] [debug line = 21:58]
  call void @llvm.dbg.value(metadata !{i2 %i.1}, i64 0, metadata !83), !dbg !82 ; [debug line = 21:58] [debug variable = i]
  br label %1, !dbg !82                           ; [debug line = 21:58]

; <label>:6                                       ; preds = %1
  ret void, !dbg !84                              ; [debug line = 49:1]
}
...
!67 = metadata !{i32 790529, metadata !68, metadata !"b_copy[0][0]", null, i32 18, metadata !70, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
...
!71 = metadata !{i32 790529, metadata !68, metadata !"b_copy[0][1]", null, i32 18, metadata !70, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!72 = metadata !{i32 790529, metadata !73, metadata !"b_copy[1][0]", null, i32 18, metadata !70, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!73 = metadata !{i32 786688, metadata !47, metadata !"b_copy[1]", null, i32 18, metadata !69, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!74 = metadata !{i32 790529, metadata !73, metadata !"b_copy[1][1]", null, i32 18, metadata !70, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
...
!77 = metadata !{i32 786443, metadata !51, i32 42, i32 14, metadata !6, i32 11} ; [ DW_TAG_lexical_block ]
!78 = metadata !{i32 47, i32 3, metadata !51, null}
!79 = metadata !{i32 23, i32 63, metadata !52, null}
!80 = metadata !{i32 786688, metadata !52, metadata !"j", metadata !6, i32 23, metadata !81, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!81 = metadata !{i32 786468, null, metadata !"int", null, i32 0, i64 32, i64 32, i64 0, i32 0, i32 5} ; [ DW_TAG_base_type ]
!82 = metadata !{i32 21, i32 58, metadata !49, null}
!83 = metadata !{i32 786688, metadata !49, metadata !"i", metadata !6, i32 21, metadata !81, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!84 = metadata !{i32 49, i32 1, metadata !47, null}
