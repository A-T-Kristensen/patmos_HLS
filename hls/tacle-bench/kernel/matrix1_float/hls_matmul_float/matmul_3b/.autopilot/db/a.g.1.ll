; ModuleID = '/home/patmos/github/bachelor_project_HLS/hls/tacle-bench/kernel/matrix1_float/hls_matmul_float/matmul_3b/.autopilot/db/a.g.1.bc'
...
define void @matmul_hw([2 x float]* %a, [2 x float]* %b, [2 x float]* %c) nounwind uwtable {
  ...
  call void (...)* @_ssdm_op_SpecResource([2 x float]* %b, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([12 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 -1, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !38 ; [debug line = 12:1]
  ...
  call void (...)* @_ssdm_op_SpecResource([2 x float]* %c, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([12 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 -1, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !40 ; [debug line = 15:1]
...
; <label>:1                                       ; preds = %8, %0
  ...
  %exitcond4 = icmp eq i32 %i, 2, !dbg !47        ; [#uses=1 type=i1] [debug line = 21:15]
...
.preheader7:                                      ; preds = %7, %.preheader7.preheader
  ...
  %exitcond3 = icmp eq i32 %j, 2, !dbg !54        ; [#uses=1 type=i1] [debug line = 23:20]
...
.preheader5:                                      ; preds = %3, %.preheader5.preheader
  ...
  %exitcond2 = icmp eq i32 %k, 2, !dbg !58        ; [#uses=1 type=i1] [debug line = 31:28]
...
; <label>:3                                       ; preds = %.preheader5
  ...
  %a.addr = getelementptr inbounds [2 x float]* %a, i64 %tmp.1, i64 %tmp.4, !dbg !61 ; [#uses=1 type=float*] [debug line = 32:6]
  ...
  %a_row.addr = getelementptr inbounds [2 x float]* %a_row, i64 0, i64 %tmp.4, !dbg !61 ; [#uses=1 type=float*] [debug line = 32:6]
...
.preheader:                                       ; preds = %4, %.preheader.preheader
  ...
  %exitcond1 = icmp eq i32 %k1, 2, !dbg !71       ; [#uses=1 type=i1] [debug line = 37:29]
...
; <label>:4                                       ; preds = %.preheader
  ...
  %b.addr = getelementptr inbounds [2 x float]* %b, i64 %tmp.7, i64 %tmp.6, !dbg !67 ; [#uses=1 type=float*] [debug line = 38:7]
  ...
  %b_copy.addr = getelementptr inbounds [2 x [2 x float]]* %b_copy, i64 0, i64 %tmp.7, i64 %tmp.6, !dbg !67 ; [#uses=1 type=float*] [debug line = 38:7]
...
; <label>:5                                       ; preds = %6, %.loopexit
  ...
  %exitcond = icmp eq i32 %k2, 2, !dbg !79        ; [#uses=1 type=i1] [debug line = 42:27]
...
; <label>:6                                       ; preds = %5
  ...
  %a_row.addr.1 = getelementptr inbounds [2 x float]* %a_row, i64 0, i64 %tmp.12, !dbg !76 ; [#uses=1 type=float*] [debug line = 43:4]
  ...
  %b_copy.addr.1 = getelementptr inbounds [2 x [2 x float]]* %b_copy, i64 0, i64 %tmp.12, i64 %tmp.9, !dbg !76 ; [#uses=1 type=float*] [debug line = 43:4]
...
; <label>:7                                       ; preds = %5
  ...
  %c.addr = getelementptr inbounds [2 x float]* %c, i64 %tmp.1, i64 %tmp.9, !dbg !53 ; [#uses=1 type=float*] [debug line = 46:5]
