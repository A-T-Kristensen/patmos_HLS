; ModuleID = '/home/patmos/github/bachelor_project_HLS/hls/tacle-bench/kernel/matrix1_float/hls_matmul_float/matmul_9b_32x32/.autopilot/db/a.o.2.bc'
...
.preheader.preheader:                             ; preds = %.preheader7.preheader
  ...
  %tmp_6_cast5 = zext i6 %j_mid2 to i8
  %tmp_6_cast = zext i6 %j_mid2 to i7
  %b_0_addr = getelementptr [256 x float]* %b_0, i64 0, i64 %tmp_6
  %tmp_23 = add i7 %tmp_6_cast, 32
  %tmp_24_cast = zext i7 %tmp_23 to i64
  %b_0_addr_1 = getelementptr [256 x float]* %b_0, i64 0, i64 %tmp_24_cast
  %tmp_24 = call i64 @_ssdm_op_BitConcatenate.i64.i58.i6(i58 1, i6 %j_mid2)
  %b_0_addr_2 = getelementptr [256 x float]* %b_0, i64 0, i64 %tmp_24
  %tmp_25 = add i8 %tmp_6_cast5, 96
  %tmp_26_cast = zext i8 %tmp_25 to i64
  %b_0_addr_3 = getelementptr [256 x float]* %b_0, i64 0, i64 %tmp_26_cast
  %tmp_26 = call i64 @_ssdm_op_BitConcatenate.i64.i58.i6(i58 2, i6 %j_mid2)
  %b_0_addr_4 = getelementptr [256 x float]* %b_0, i64 0, i64 %tmp_26
  %tmp_27 = add i8 %tmp_6_cast5, -96
  %tmp_28_cast = zext i8 %tmp_27 to i64
  %b_0_addr_5 = getelementptr [256 x float]* %b_0, i64 0, i64 %tmp_28_cast
  %tmp_28 = call i64 @_ssdm_op_BitConcatenate.i64.i58.i6(i58 3, i6 %j_mid2)
  %b_0_addr_6 = getelementptr [256 x float]* %b_0, i64 0, i64 %tmp_28
  %tmp_29 = add i9 %tmp_6_cast6, 224
  %tmp_30_cast = zext i9 %tmp_29 to i64
  %b_0_addr_7 = getelementptr [256 x float]* %b_0, i64 0, i64 %tmp_30_cast
  %b_1_addr = getelementptr [256 x float]* %b_1, i64 0, i64 %tmp_6
  %b_1_addr_1 = getelementptr [256 x float]* %b_1, i64 0, i64 %tmp_24_cast
  %b_1_addr_2 = getelementptr [256 x float]* %b_1, i64 0, i64 %tmp_24
  %b_1_addr_3 = getelementptr [256 x float]* %b_1, i64 0, i64 %tmp_26_cast
  %b_1_addr_4 = getelementptr [256 x float]* %b_1, i64 0, i64 %tmp_26
  %b_1_addr_5 = getelementptr [256 x float]* %b_1, i64 0, i64 %tmp_28_cast
  %b_1_addr_6 = getelementptr [256 x float]* %b_1, i64 0, i64 %tmp_28
  %b_1_addr_7 = getelementptr [256 x float]* %b_1, i64 0, i64 %tmp_30_cast
  %b_2_addr = getelementptr [256 x float]* %b_2, i64 0, i64 %tmp_6
  %b_2_addr_1 = getelementptr [256 x float]* %b_2, i64 0, i64 %tmp_24_cast
  %b_2_addr_2 = getelementptr [256 x float]* %b_2, i64 0, i64 %tmp_24
  %b_2_addr_3 = getelementptr [256 x float]* %b_2, i64 0, i64 %tmp_26_cast
  %b_2_addr_4 = getelementptr [256 x float]* %b_2, i64 0, i64 %tmp_26
  %b_2_addr_5 = getelementptr [256 x float]* %b_2, i64 0, i64 %tmp_28_cast
  %b_2_addr_6 = getelementptr [256 x float]* %b_2, i64 0, i64 %tmp_28
  %b_2_addr_7 = getelementptr [256 x float]* %b_2, i64 0, i64 %tmp_30_cast
  %b_3_addr = getelementptr [256 x float]* %b_3, i64 0, i64 %tmp_6
  %b_3_addr_1 = getelementptr [256 x float]* %b_3, i64 0, i64 %tmp_24_cast
  %b_3_addr_2 = getelementptr [256 x float]* %b_3, i64 0, i64 %tmp_24
  %b_3_addr_3 = getelementptr [256 x float]* %b_3, i64 0, i64 %tmp_26_cast
  %b_3_addr_4 = getelementptr [256 x float]* %b_3, i64 0, i64 %tmp_26
  %b_3_addr_5 = getelementptr [256 x float]* %b_3, i64 0, i64 %tmp_28_cast
  %b_3_addr_6 = getelementptr [256 x float]* %b_3, i64 0, i64 %tmp_28
  %b_3_addr_7 = getelementptr [256 x float]* %b_3, i64 0, i64 %tmp_30_cast
...
.preheader7.preheader:                            ; preds = %.preheader7
  ...
  %a_0_addr = getelementptr [256 x float]* %a_0, i64 0, i64 %tmp_4
  %tmp_7 = or i9 %tmp_1, 1
  %tmp_8 = call i64 @_ssdm_op_BitConcatenate.i64.i55.i9(i55 0, i9 %tmp_7)
  %a_0_addr_1 = getelementptr [256 x float]* %a_0, i64 0, i64 %tmp_8
  %tmp_10 = or i9 %tmp_1, 2
  %tmp_11 = call i64 @_ssdm_op_BitConcatenate.i64.i55.i9(i55 0, i9 %tmp_10)
  %a_0_addr_2 = getelementptr [256 x float]* %a_0, i64 0, i64 %tmp_11
  %tmp_12 = or i9 %tmp_1, 3
  %tmp_13 = call i64 @_ssdm_op_BitConcatenate.i64.i55.i9(i55 0, i9 %tmp_12)
  %a_0_addr_3 = getelementptr [256 x float]* %a_0, i64 0, i64 %tmp_13
  %tmp_14 = or i9 %tmp_1, 4
  %tmp_15 = call i64 @_ssdm_op_BitConcatenate.i64.i55.i9(i55 0, i9 %tmp_14)
  %a_0_addr_4 = getelementptr [256 x float]* %a_0, i64 0, i64 %tmp_15
  %tmp_16 = or i9 %tmp_1, 5
  %tmp_17 = call i64 @_ssdm_op_BitConcatenate.i64.i55.i9(i55 0, i9 %tmp_16)
  %a_0_addr_5 = getelementptr [256 x float]* %a_0, i64 0, i64 %tmp_17
  %tmp_18 = or i9 %tmp_1, 6
  %tmp_19 = call i64 @_ssdm_op_BitConcatenate.i64.i55.i9(i55 0, i9 %tmp_18)
  %a_0_addr_6 = getelementptr [256 x float]* %a_0, i64 0, i64 %tmp_19
  %tmp_20 = or i9 %tmp_1, 7
  %tmp_21 = call i64 @_ssdm_op_BitConcatenate.i64.i55.i9(i55 0, i9 %tmp_20)
  %a_0_addr_7 = getelementptr [256 x float]* %a_0, i64 0, i64 %tmp_21
  %a_1_addr = getelementptr [256 x float]* %a_1, i64 0, i64 %tmp_4
  %a_1_addr_1 = getelementptr [256 x float]* %a_1, i64 0, i64 %tmp_8
  %a_1_addr_2 = getelementptr [256 x float]* %a_1, i64 0, i64 %tmp_11
  %a_1_addr_3 = getelementptr [256 x float]* %a_1, i64 0, i64 %tmp_13
  %a_1_addr_4 = getelementptr [256 x float]* %a_1, i64 0, i64 %tmp_15
  %a_1_addr_5 = getelementptr [256 x float]* %a_1, i64 0, i64 %tmp_17
  %a_1_addr_6 = getelementptr [256 x float]* %a_1, i64 0, i64 %tmp_19
  %a_1_addr_7 = getelementptr [256 x float]* %a_1, i64 0, i64 %tmp_21
  %a_2_addr = getelementptr [256 x float]* %a_2, i64 0, i64 %tmp_4
  %a_2_addr_1 = getelementptr [256 x float]* %a_2, i64 0, i64 %tmp_8
  %a_2_addr_2 = getelementptr [256 x float]* %a_2, i64 0, i64 %tmp_11
  %a_2_addr_3 = getelementptr [256 x float]* %a_2, i64 0, i64 %tmp_13
  %a_2_addr_4 = getelementptr [256 x float]* %a_2, i64 0, i64 %tmp_15
  %a_2_addr_5 = getelementptr [256 x float]* %a_2, i64 0, i64 %tmp_17
  %a_2_addr_6 = getelementptr [256 x float]* %a_2, i64 0, i64 %tmp_19
  %a_2_addr_7 = getelementptr [256 x float]* %a_2, i64 0, i64 %tmp_21
  %a_3_addr = getelementptr [256 x float]* %a_3, i64 0, i64 %tmp_4
  %a_3_addr_1 = getelementptr [256 x float]* %a_3, i64 0, i64 %tmp_8
  %a_3_addr_2 = getelementptr [256 x float]* %a_3, i64 0, i64 %tmp_11
  %a_3_addr_3 = getelementptr [256 x float]* %a_3, i64 0, i64 %tmp_13
  %a_3_addr_4 = getelementptr [256 x float]* %a_3, i64 0, i64 %tmp_15
  %a_3_addr_5 = getelementptr [256 x float]* %a_3, i64 0, i64 %tmp_17
  %a_3_addr_6 = getelementptr [256 x float]* %a_3, i64 0, i64 %tmp_19
  %a_3_addr_7 = getelementptr [256 x float]* %a_3, i64 0, i64 %tmp_21
  %tmp_22 = call i11 @_ssdm_op_BitConcatenate.i11.i6.i5(i6 %tmp_1_mid2_v, i5 0)
  %tmp_23_cast = zext i11 %tmp_22 to i12
  ...
  %a_row_load_31 = select i1 %tmp_3, float %a_3_load_7, float %a_row_load_93
  %a_row_load_30 = select i1 %tmp_3, float %a_3_load_6, float %a_row_load_92
  %a_row_load_29 = select i1 %tmp_3, float %a_3_load_5, float %a_row_load_91
  %a_row_load_28 = select i1 %tmp_3, float %a_3_load_4, float %a_row_load_90
  %a_row_load_27 = select i1 %tmp_3, float %a_3_load_3, float %a_row_load_89
  %a_row_load_26 = select i1 %tmp_3, float %a_3_load_2, float %a_row_load_88
  %a_row_load_25 = select i1 %tmp_3, float %a_3_load_1, float %a_row_load_87
  %a_row_load_24 = select i1 %tmp_3, float %a_3_load, float %a_row_load_86
  %a_row_load_23 = select i1 %tmp_3, float %a_2_load_7, float %a_row_load_85
  %a_row_load_22 = select i1 %tmp_3, float %a_2_load_6, float %a_row_load_84
  %a_row_load_21 = select i1 %tmp_3, float %a_2_load_5, float %a_row_load_83
  %a_row_load_20 = select i1 %tmp_3, float %a_2_load_4, float %a_row_load_82
  %a_row_load_19 = select i1 %tmp_3, float %a_2_load_3, float %a_row_load_81
  %a_row_load_18 = select i1 %tmp_3, float %a_2_load_2, float %a_row_load_80
  %a_row_load_17 = select i1 %tmp_3, float %a_2_load_1, float %a_row_load_79
  %a_row_load_16 = select i1 %tmp_3, float %a_2_load, float %a_row_load_78
  %a_row_load_15 = select i1 %tmp_3, float %a_1_load_7, float %a_row_load_77
  %a_row_load_14 = select i1 %tmp_3, float %a_1_load_6, float %a_row_load_76
  %a_row_load_13 = select i1 %tmp_3, float %a_1_load_5, float %a_row_load_75
  %a_row_load_12 = select i1 %tmp_3, float %a_1_load_4, float %a_row_load_74
  %a_row_load_11 = select i1 %tmp_3, float %a_1_load_3, float %a_row_load_73
  %a_row_load_10 = select i1 %tmp_3, float %a_1_load_2, float %a_row_load_72
  %a_row_load_9 = select i1 %tmp_3, float %a_1_load_1, float %a_row_load_71
  %a_row_load_8 = select i1 %tmp_3, float %a_1_load, float %a_row_load_70
