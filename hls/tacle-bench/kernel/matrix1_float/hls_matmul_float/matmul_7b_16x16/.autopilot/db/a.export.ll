...
.preheader.preheader:                             ; preds = %.preheader7.preheader
  ...
  %tmp_6_cast6 = zext i5 %j_mid2 to i7
  %tmp_6_cast = zext i5 %j_mid2 to i6
  %b_0_addr = getelementptr [96 x float]* %b_0, i64 0, i64 %tmp_6
  %tmp_23 = add i6 %tmp_6_cast, 16
  %tmp_24_cast = zext i6 %tmp_23 to i64
  %b_0_addr_1 = getelementptr [96 x float]* %b_0, i64 0, i64 %tmp_24_cast
  %tmp_24 = call i64 @_ssdm_op_BitConcatenate.i64.i59.i5(i59 1, i5 %j_mid2)
  %b_0_addr_2 = getelementptr [96 x float]* %b_0, i64 0, i64 %tmp_24
  %tmp_25 = add i7 %tmp_6_cast6, 48
  %tmp_26_cast = zext i7 %tmp_25 to i64
  %b_0_addr_3 = getelementptr [96 x float]* %b_0, i64 0, i64 %tmp_26_cast
  %tmp_26 = call i64 @_ssdm_op_BitConcatenate.i64.i59.i5(i59 2, i5 %j_mid2)
  %b_0_addr_4 = getelementptr [96 x float]* %b_0, i64 0, i64 %tmp_26
  %tmp_27 = add i7 %tmp_6_cast6, -48
  %tmp_28_cast = zext i7 %tmp_27 to i64
  %b_0_addr_5 = getelementptr [96 x float]* %b_0, i64 0, i64 %tmp_28_cast
  %b_1_addr = getelementptr [96 x float]* %b_1, i64 0, i64 %tmp_6
  %b_1_addr_1 = getelementptr [96 x float]* %b_1, i64 0, i64 %tmp_24_cast
  %b_1_addr_2 = getelementptr [96 x float]* %b_1, i64 0, i64 %tmp_24
  %b_1_addr_3 = getelementptr [96 x float]* %b_1, i64 0, i64 %tmp_26_cast
  %b_1_addr_4 = getelementptr [96 x float]* %b_1, i64 0, i64 %tmp_26
  %b_1_addr_5 = getelementptr [96 x float]* %b_1, i64 0, i64 %tmp_28_cast
  %b_2_addr = getelementptr [64 x float]* %b_2, i64 0, i64 %tmp_6
  %b_2_addr_1 = getelementptr [64 x float]* %b_2, i64 0, i64 %tmp_24_cast
  %b_2_addr_2 = getelementptr [64 x float]* %b_2, i64 0, i64 %tmp_24
  %b_2_addr_3 = getelementptr [64 x float]* %b_2, i64 0, i64 %tmp_26_cast
...
.preheader7.preheader:                            ; preds = %.preheader7
  ...
  %tmp_4 = call i6 @_ssdm_op_BitConcatenate.i6.i5.i1(i5 %tmp_1_mid2_v, i1 false)
  %p_shl1_cast = zext i6 %tmp_4 to i8
  %tmp_7 = sub i8 %tmp_1, %p_shl1_cast
  %tmp_7_cast = sext i8 %tmp_7 to i64
  %a_0_addr = getelementptr [96 x float]* %a_0, i64 0, i64 %tmp_7_cast
  %tmp_8 = or i8 %tmp_7, 1
  %tmp_8_cast = zext i8 %tmp_8 to i64
  %a_0_addr_1 = getelementptr [96 x float]* %a_0, i64 0, i64 %tmp_8_cast
  %tmp_10 = add i8 %tmp_7, 2
  %tmp_10_cast = sext i8 %tmp_10 to i64
  %a_0_addr_2 = getelementptr [96 x float]* %a_0, i64 0, i64 %tmp_10_cast
  %tmp_11 = add i8 %tmp_7, 3
  %tmp_11_cast = sext i8 %tmp_11 to i64
  %a_0_addr_3 = getelementptr [96 x float]* %a_0, i64 0, i64 %tmp_11_cast
  %tmp_12 = add i8 %tmp_7, 4
  %tmp_12_cast = sext i8 %tmp_12 to i64
  %a_0_addr_4 = getelementptr [96 x float]* %a_0, i64 0, i64 %tmp_12_cast
  %tmp_13 = add i8 %tmp_7, 5
  %tmp_13_cast = sext i8 %tmp_13 to i64
  %a_0_addr_5 = getelementptr [96 x float]* %a_0, i64 0, i64 %tmp_13_cast
  %a_1_addr = getelementptr [96 x float]* %a_1, i64 0, i64 %tmp_7_cast
  %a_1_addr_1 = getelementptr [96 x float]* %a_1, i64 0, i64 %tmp_8_cast
  %a_1_addr_2 = getelementptr [96 x float]* %a_1, i64 0, i64 %tmp_10_cast
  %a_1_addr_3 = getelementptr [96 x float]* %a_1, i64 0, i64 %tmp_11_cast
  %a_1_addr_4 = getelementptr [96 x float]* %a_1, i64 0, i64 %tmp_12_cast
  %a_1_addr_5 = getelementptr [96 x float]* %a_1, i64 0, i64 %tmp_13_cast
  %tmp_14 = call i7 @_ssdm_op_BitConcatenate.i7.i5.i2(i5 %tmp_1_mid2_v, i2 0)
  %tmp_15 = zext i7 %tmp_14 to i64
  %a_2_addr = getelementptr [64 x float]* %a_2, i64 0, i64 %tmp_15
  %tmp_16 = or i7 %tmp_14, 1
  %tmp_17 = call i64 @_ssdm_op_BitConcatenate.i64.i57.i7(i57 0, i7 %tmp_16)
  %a_2_addr_1 = getelementptr [64 x float]* %a_2, i64 0, i64 %tmp_17
  %tmp_18 = or i7 %tmp_14, 2
  %tmp_19 = call i64 @_ssdm_op_BitConcatenate.i64.i57.i7(i57 0, i7 %tmp_18)
  %a_2_addr_2 = getelementptr [64 x float]* %a_2, i64 0, i64 %tmp_19
  %tmp_20 = or i7 %tmp_14, 3
  %tmp_21 = call i64 @_ssdm_op_BitConcatenate.i64.i57.i7(i57 0, i7 %tmp_20)
  %a_2_addr_3 = getelementptr [64 x float]* %a_2, i64 0, i64 %tmp_21
  ...
  %a_row_load_15 = select i1 %tmp_3, float %a_2_load_3, float %a_row_load_45
  %a_row_load_14 = select i1 %tmp_3, float %a_2_load_2, float %a_row_load_44
  %a_row_load_13 = select i1 %tmp_3, float %a_2_load_1, float %a_row_load_43
  %a_row_load_12 = select i1 %tmp_3, float %a_2_load, float %a_row_load_42
  %a_row_load_11 = select i1 %tmp_3, float %a_1_load_5, float %a_row_load_41
  %a_row_load_10 = select i1 %tmp_3, float %a_1_load_4, float %a_row_load_40
  %a_row_load_9 = select i1 %tmp_3, float %a_1_load_3, float %a_row_load_39
  %a_row_load_8 = select i1 %tmp_3, float %a_1_load_2, float %a_row_load_38
  %a_row_load_7 = select i1 %tmp_3, float %a_1_load_1, float %a_row_load_37
  %a_row_load_6 = select i1 %tmp_3, float %a_1_load, float %a_row_load_36
...
entry:
  ...
  %empty_13 = zext i5 %1 to i64
  %empty_14 = shl i64 %empty, 5
...
entry:
  ...
  %empty_16 = zext i7 %1 to i64
  %empty_17 = shl i64 %empty, 7
...
entry:
  ...
  %empty_19 = zext i1 %1 to i6
  %empty_20 = shl i6 %empty, 1
