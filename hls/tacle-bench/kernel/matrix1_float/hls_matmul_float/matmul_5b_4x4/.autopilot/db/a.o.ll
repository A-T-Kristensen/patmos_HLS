; ModuleID = '/home/patmos/github/bachelor_project_HLS/hls/tacle-bench/kernel/matrix1_float/hls_matmul_float/matmul_5b_4x4/.autopilot/db/a.o.bc'
...
define void @matmul_hw([4 x float]* %a, [4 x float]* %b, [4 x float]* %c) nounwind uwtable {
  %1 = alloca [4 x float]*, align 8               ; [#uses=6 type=[4 x float]**]
  %2 = alloca [4 x float]*, align 8               ; [#uses=6 type=[4 x float]**]
  %3 = alloca [4 x float]*, align 8               ; [#uses=5 type=[4 x float]**]
  ...
  store [4 x float]* %b, [4 x float]** %2, align 8
  call void @llvm.dbg.declare(metadata !{[4 x float]** %2}, metadata !26), !dbg !27 ; [debug line = 4:138] [debug variable = b]
  store [4 x float]* %c, [4 x float]** %3, align 8
  call void @llvm.dbg.declare(metadata !{[4 x float]** %3}, metadata !28), !dbg !29 ; [debug line = 4:252] [debug variable = c]
  %4 = load [4 x float]** %1, align 8, !dbg !30   ; [#uses=1 type=[4 x float]*] [debug line = 5:2]
  call void (...)* @_ssdm_SpecArrayDimSize([4 x float]* %4, i32 4) nounwind, !dbg !30 ; [debug line = 5:2]
  %5 = load [4 x float]** %2, align 8, !dbg !32   ; [#uses=1 type=[4 x float]*] [debug line = 5:30]
  call void (...)* @_ssdm_SpecArrayDimSize([4 x float]* %5, i32 4) nounwind, !dbg !32 ; [debug line = 5:30]
  %6 = load [4 x float]** %3, align 8, !dbg !33   ; [#uses=1 type=[4 x float]*] [debug line = 5:58]
  call void (...)* @_ssdm_SpecArrayDimSize([4 x float]* %6, i32 4) nounwind, !dbg !33 ; [debug line = 5:58]
  %7 = load [4 x float]** %2, align 8, !dbg !34   ; [#uses=1 type=[4 x float]*] [debug line = 6:1]
  call void (...)* @_ssdm_SpecArrayPartition([4 x float]* %7, i32 1, i8* getelementptr inbounds ([6 x i8]* @.str, i32 0, i32 0), i32 2, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !34 ; [debug line = 6:1]
  %8 = load [4 x float]** %1, align 8, !dbg !34   ; [#uses=1 type=[4 x float]*] [debug line = 6:1]
  call void (...)* @_ssdm_SpecArrayPartition([4 x float]* %8, i32 2, i8* getelementptr inbounds ([6 x i8]* @.str, i32 0, i32 0), i32 2, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !34 ; [debug line = 6:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 0, i8* getelementptr inbounds ([11 x i8]* @.str2, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !34 ; [debug line = 6:1]
  %9 = load [4 x float]** %1, align 8, !dbg !35   ; [#uses=1 type=[4 x float]*] [debug line = 8:1]
  call void (...)* @_ssdm_op_SpecInterface([4 x float]* %9, i8* getelementptr inbounds ([5 x i8]* @.str3, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !35 ; [debug line = 8:1]
  %10 = load [4 x float]** %1, align 8, !dbg !36  ; [#uses=1 type=[4 x float]*] [debug line = 9:1]
  call void (...)* @_ssdm_op_SpecResource([4 x float]* %10, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([12 x i8]* @.str4, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 -1, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !36 ; [debug line = 9:1]
  %11 = load [4 x float]** %2, align 8, !dbg !37  ; [#uses=1 type=[4 x float]*] [debug line = 11:1]
  call void (...)* @_ssdm_op_SpecInterface([4 x float]* %11, i8* getelementptr inbounds ([5 x i8]* @.str3, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !37 ; [debug line = 11:1]
  %12 = load [4 x float]** %2, align 8, !dbg !38  ; [#uses=1 type=[4 x float]*] [debug line = 12:1]
  call void (...)* @_ssdm_op_SpecResource([4 x float]* %12, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([12 x i8]* @.str4, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 -1, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !38 ; [debug line = 12:1]
  %13 = load [4 x float]** %3, align 8, !dbg !39  ; [#uses=1 type=[4 x float]*] [debug line = 14:1]
  call void (...)* @_ssdm_op_SpecInterface([4 x float]* %13, i8* getelementptr inbounds ([5 x i8]* @.str3, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !39 ; [debug line = 14:1]
  %14 = load [4 x float]** %3, align 8, !dbg !40  ; [#uses=1 type=[4 x float]*] [debug line = 15:1]
  call void (...)* @_ssdm_op_SpecResource([4 x float]* %14, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([12 x i8]* @.str4, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 -1, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !40 ; [debug line = 15:1]
...
; <label>:15                                      ; preds = %110, %0
  ...
  %17 = icmp slt i32 %16, 4, !dbg !53             ; [#uses=1 type=i1] [debug line = 21:15]
  br i1 %17, label %18, label %113, !dbg !53      ; [debug line = 21:15]

; <label>:18                                      ; preds = %15
  br label %19, !dbg !54                          ; [debug line = 21:63]
...
; <label>:20                                      ; preds = %106, %19
  ...
  %22 = icmp slt i32 %21, 4, !dbg !59             ; [#uses=1 type=i1] [debug line = 23:20]
  br i1 %22, label %23, label %109, !dbg !59      ; [debug line = 23:20]

; <label>:23                                      ; preds = %20
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([4 x i8]* @.str5, i32 0, i32 0)) nounwind, !dbg !60 ; [debug line = 23:69]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([4 x i8]* @.str5, i32 0, i32 0)) nounwind, !dbg !60 ; [debug line = 23:69]
...
; <label>:28                                      ; preds = %43, %27
  ...
  %30 = icmp slt i32 %29, 4, !dbg !70             ; [#uses=1 type=i1] [debug line = 31:28]
...
; <label>:31                                      ; preds = %28
  ...
  %36 = load [4 x float]** %1, align 8, !dbg !71  ; [#uses=1 type=[4 x float]*] [debug line = 32:6]
  %37 = getelementptr inbounds [4 x float]* %36, i64 %35, !dbg !71 ; [#uses=1 type=[4 x float]*] [debug line = 32:6]
  %38 = getelementptr inbounds [4 x float]* %37, i32 0, i64 %33, !dbg !71 ; [#uses=1 type=float*] [debug line = 32:6]
  ...
  %42 = getelementptr inbounds [4 x float]* %a_row, i32 0, i64 %41, !dbg !71 ; [#uses=1 type=float*] [debug line = 32:6]
...
; <label>:43                                      ; preds = %31
  %44 = load i32* %k, align 4, !dbg !74           ; [#uses=1 type=i32] [debug line = 31:99]
  %45 = add nsw i32 %44, 1, !dbg !74              ; [#uses=1 type=i32] [debug line = 31:99]
  store i32 %45, i32* %k, align 4, !dbg !74       ; [debug line = 31:99]
  br label %28, !dbg !74                          ; [debug line = 31:99]
...
; <label>:52                                      ; preds = %70, %51
  ...
  %54 = icmp slt i32 %53, 4, !dbg !82             ; [#uses=1 type=i1] [debug line = 37:29]
  br i1 %54, label %55, label %73, !dbg !82       ; [debug line = 37:29]

; <label>:55                                      ; preds = %52
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([10 x i8]* @.str7, i32 0, i32 0)) nounwind, !dbg !83 ; [debug line = 37:106]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([10 x i8]* @.str7, i32 0, i32 0)) nounwind, !dbg !83 ; [debug line = 37:106]
  ...
  %60 = load [4 x float]** %2, align 8, !dbg !85  ; [#uses=1 type=[4 x float]*] [debug line = 38:7]
  %61 = getelementptr inbounds [4 x float]* %60, i64 %59, !dbg !85 ; [#uses=1 type=[4 x float]*] [debug line = 38:7]
  %62 = getelementptr inbounds [4 x float]* %61, i32 0, i64 %57, !dbg !85 ; [#uses=1 type=float*] [debug line = 38:7]
  ...
  %68 = getelementptr inbounds [4 x [4 x float]]* %b_copy, i32 0, i64 %67, !dbg !85 ; [#uses=1 type=[4 x float]*] [debug line = 38:7]
  %69 = getelementptr inbounds [4 x float]* %68, i32 0, i64 %65, !dbg !85 ; [#uses=1 type=float*] [debug line = 38:7]
...
; <label>:70                                      ; preds = %55
  %71 = load i32* %k1, align 4, !dbg !87          ; [#uses=1 type=i32] [debug line = 37:100]
  %72 = add nsw i32 %71, 1, !dbg !87              ; [#uses=1 type=i32] [debug line = 37:100]
  store i32 %72, i32* %k1, align 4, !dbg !87      ; [debug line = 37:100]
  br label %52, !dbg !87                          ; [debug line = 37:100]
...
; <label>:76                                      ; preds = %94, %75
  ...
  %78 = icmp slt i32 %77, 4, !dbg !92             ; [#uses=1 type=i1] [debug line = 42:27]
  br i1 %78, label %79, label %97, !dbg !92       ; [debug line = 42:27]

; <label>:79                                      ; preds = %76
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([8 x i8]* @.str8, i32 0, i32 0)) nounwind, !dbg !93 ; [debug line = 42:104]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([8 x i8]* @.str8, i32 0, i32 0)) nounwind, !dbg !93 ; [debug line = 42:104]
  ...
  %82 = getelementptr inbounds [4 x float]* %a_row, i32 0, i64 %81, !dbg !95 ; [#uses=1 type=float*] [debug line = 43:4]
  ...
  %88 = getelementptr inbounds [4 x [4 x float]]* %b_copy, i32 0, i64 %87, !dbg !95 ; [#uses=1 type=[4 x float]*] [debug line = 43:4]
  %89 = getelementptr inbounds [4 x float]* %88, i32 0, i64 %85, !dbg !95 ; [#uses=1 type=float*] [debug line = 43:4]
...
; <label>:94                                      ; preds = %79
  %95 = load i32* %k2, align 4, !dbg !97          ; [#uses=1 type=i32] [debug line = 42:98]
  %96 = add nsw i32 %95, 1, !dbg !97              ; [#uses=1 type=i32] [debug line = 42:98]
  store i32 %96, i32* %k2, align 4, !dbg !97      ; [debug line = 42:98]
  br label %76, !dbg !97                          ; [debug line = 42:98]
...
; <label>:97                                      ; preds = %76
  ...
  %103 = load [4 x float]** %3, align 8, !dbg !98 ; [#uses=1 type=[4 x float]*] [debug line = 46:5]
  %104 = getelementptr inbounds [4 x float]* %103, i64 %102, !dbg !98 ; [#uses=1 type=[4 x float]*] [debug line = 46:5]
  %105 = getelementptr inbounds [4 x float]* %104, i32 0, i64 %100, !dbg !98 ; [#uses=1 type=float*] [debug line = 46:5]
...
; <label>:106                                     ; preds = %97
  %107 = load i32* %j, align 4, !dbg !100         ; [#uses=1 type=i32] [debug line = 23:63]
  %108 = add nsw i32 %107, 1, !dbg !100           ; [#uses=1 type=i32] [debug line = 23:63]
  store i32 %108, i32* %j, align 4, !dbg !100     ; [debug line = 23:63]
  br label %20, !dbg !100                         ; [debug line = 23:63]

; <label>:109                                     ; preds = %20
  br label %110, !dbg !101                        ; [debug line = 48:2]

; <label>:110                                     ; preds = %109
  %111 = load i32* %i, align 4, !dbg !102         ; [#uses=1 type=i32] [debug line = 21:58]
  %112 = add nsw i32 %111, 1, !dbg !102           ; [#uses=1 type=i32] [debug line = 21:58]
  store i32 %112, i32* %i, align 4, !dbg !102     ; [debug line = 21:58]
  br label %15, !dbg !102                         ; [debug line = 21:58]
