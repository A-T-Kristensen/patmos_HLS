; ModuleID = '/home/patmos/github/bachelor_project_HLS/hls/tacle-bench/kernel/matrix1_float/hls_matmul_float/matmul_5b_4x4/.autopilot/db/a.o.2.bc'
...
; [#uses=0]
define void @matmul_hw([4 x [2 x float]]* %"a[0]", [4 x [2 x float]]* %"a[1]", [2 x [4 x float]]* %"b[0]", [2 x [4 x float]]* %"b[1]", [4 x [4 x float]]* %c) {
  call void (...)* @_ssdm_op_SpecBitsMap([4 x [2 x float]]* %"a[1]"), !map !24
  call void (...)* @_ssdm_op_SpecBitsMap([4 x [2 x float]]* %"a[0]"), !map !31
  call void (...)* @_ssdm_op_SpecBitsMap([2 x [4 x float]]* %"b[1]"), !map !37
  call void (...)* @_ssdm_op_SpecBitsMap([2 x [4 x float]]* %"b[0]"), !map !42
  call void (...)* @_ssdm_op_SpecBitsMap([4 x [4 x float]]* %c) nounwind, !map !47
  call void (...)* @_ssdm_op_SpecTopModule([10 x i8]* @matmul_hw.str) nounwind
  call void @llvm.dbg.value(metadata !{[4 x [2 x float]]* %"a[0]"}, i64 0, metadata !52), !dbg !57 ; [debug line = 4:25] [debug variable = a[0]]
  call void @llvm.dbg.value(metadata !{[4 x [2 x float]]* %"a[1]"}, i64 0, metadata !58), !dbg !57 ; [debug line = 4:25] [debug variable = a[1]]
  call void @llvm.dbg.value(metadata !{[2 x [4 x float]]* %"b[0]"}, i64 0, metadata !59), !dbg !61 ; [debug line = 4:138] [debug variable = b[0]]
  call void @llvm.dbg.value(metadata !{[2 x [4 x float]]* %"b[1]"}, i64 0, metadata !62), !dbg !61 ; [debug line = 4:138] [debug variable = b[1]]
  call void @llvm.dbg.value(metadata !{[4 x [4 x float]]* %c}, i64 0, metadata !63), !dbg !64 ; [debug line = 4:252] [debug variable = c]
  ...
  call void (...)* @_ssdm_op_SpecMemCore([4 x [2 x float]]* %"a[0]", [4 x [2 x float]]* %"a[1]", [1 x i8]* @.str1, [12 x i8]* @.str4, [1 x i8]* @.str1, i32 -1, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1)
  call void (...)* @_ssdm_op_SpecInterface([2 x [4 x float]]* %"b[0]", [2 x [4 x float]]* %"b[1]", [5 x i8]* @.str3, i32 0, i32 0, [1 x i8]* @.str1, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind
  call void (...)* @_ssdm_op_SpecMemCore([2 x [4 x float]]* %"b[0]", [2 x [4 x float]]* %"b[1]", [1 x i8]* @.str1, [12 x i8]* @.str4, [1 x i8]* @.str1, i32 -1, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1)
...
_ifconv:                                          ; preds = %.preheader7
  ...
  %"a[0].load" = load float* %"a[0].addr", align 4, !dbg !78 ; [#uses=1 type=float] [debug line = 32:6]
  %"a[0].load.1" = load float* %"a[0].addr.1", align 4, !dbg !78 ; [#uses=1 type=float] [debug line = 32:6]
  %"a[1].load" = load float* %"a[1].addr", align 4, !dbg !78 ; [#uses=1 type=float] [debug line = 32:6]
  %"a[1].load.1" = load float* %"a[1].addr.1", align 4, !dbg !78 ; [#uses=1 type=float] [debug line = 32:6]
  ...
  %tmp.6 = zext i3 %j to i64, !dbg !82            ; [#uses=5 type=i64] [debug line = 38:7]
  %"b[0].addr" = getelementptr [2 x [4 x float]]* %"b[0]", i64 0, i64 0, i64 %tmp.6 ; [#uses=1 type=float*]
  %"b_copy[0][3].16" = load float* %"b[0].addr", align 4, !dbg !82 ; [#uses=4 type=float] [debug line = 38:7]
  %j.t = trunc i3 %j to i2                        ; [#uses=7 type=i2]
  call void @llvm.dbg.value(metadata !{float %"b_copy[0][3].16"}, i64 0, metadata !86), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[0][3]]
  call void @llvm.dbg.value(metadata !{float %"b_copy[0][3].16"}, i64 0, metadata !90), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[0][0]]
  call void @llvm.dbg.value(metadata !{float %"b_copy[0][3].16"}, i64 0, metadata !91), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[0][1]]
  call void @llvm.dbg.value(metadata !{float %"b_copy[0][3].16"}, i64 0, metadata !92), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[0][2]]
  ...
  call void @llvm.dbg.value(metadata !{float %"b_copy[0][3]"}, i64 0, metadata !86), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[0][3]]
  ...
  call void @llvm.dbg.value(metadata !{float %"b_copy[0][3].4"}, i64 0, metadata !86), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[0][3]]
  ...
  call void @llvm.dbg.value(metadata !{float %"b_copy[0][3].2"}, i64 0, metadata !86), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[0][3]]
  %"b_copy[0][3].5" = select i1 %sel_tmp, float %"b_copy[0][3].16", float %"b_copy[0][2].1" ; [#uses=1 type=float]
  call void @llvm.dbg.value(metadata !{float %"b_copy[0][3].5"}, i64 0, metadata !86), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[0][3]]
  %"b_copy[0][3].6" = select i1 %sel_tmp2, float %"b_copy[0][2].1", float %"b_copy[0][3].5" ; [#uses=1 type=float]
  call void @llvm.dbg.value(metadata !{float %"b_copy[0][3].6"}, i64 0, metadata !86), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[0][3]]
  %"b_copy[0][3].7" = select i1 %sel_tmp4, float %"b_copy[0][2].1", float %"b_copy[0][3].6" ; [#uses=1 type=float]
  call void @llvm.dbg.value(metadata !{float %"b_copy[0][3].7"}, i64 0, metadata !86), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[0][3]]
  call void @llvm.dbg.value(metadata !{float %"b_copy[0][3].8"}, i64 0, metadata !86), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[0][3]]
  %"b_copy[0][3].9" = select i1 %sel_tmp2, float %"b_copy[0][3].16", float %"b_copy[0][3].8" ; [#uses=1 type=float]
  call void @llvm.dbg.value(metadata !{float %"b_copy[0][3].9"}, i64 0, metadata !86), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[0][3]]
  %"b_copy[0][3].10" = select i1 %sel_tmp4, float %"b_copy[0][3].8", float %"b_copy[0][3].9" ; [#uses=1 type=float]
  call void @llvm.dbg.value(metadata !{float %"b_copy[0][3].10"}, i64 0, metadata !86), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[0][3]]
  call void @llvm.dbg.value(metadata !{float %"b_copy[0][3].11"}, i64 0, metadata !86), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[0][3]]
  %"b_copy[0][3].12" = select i1 %sel_tmp4, float %"b_copy[0][3].16", float %"b_copy[0][3].11" ; [#uses=1 type=float]
  call void @llvm.dbg.value(metadata !{float %"b_copy[0][3].12"}, i64 0, metadata !86), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[0][3]]
  %"b[0].addr.1" = getelementptr [2 x [4 x float]]* %"b[0]", i64 0, i64 1, i64 %tmp.6 ; [#uses=1 type=float*]
  %"b_copy[1][3].16" = load float* %"b[0].addr.1", align 4, !dbg !82 ; [#uses=4 type=float] [debug line = 38:7]
  call void @llvm.dbg.value(metadata !{float %"b_copy[1][3].16"}, i64 0, metadata !93), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[1][3]]
  call void @llvm.dbg.value(metadata !{float %"b_copy[1][3].16"}, i64 0, metadata !95), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[1][0]]
  call void @llvm.dbg.value(metadata !{float %"b_copy[1][3].16"}, i64 0, metadata !96), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[1][1]]
  call void @llvm.dbg.value(metadata !{float %"b_copy[1][3].16"}, i64 0, metadata !97), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[1][2]]
  %"b_copy[1][3]" = select i1 %sel_tmp, float %"b_copy[1][3].1", float %"b_copy[1][3].16" ; [#uses=1 type=float]
  call void @llvm.dbg.value(metadata !{float %"b_copy[1][3]"}, i64 0, metadata !93), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[1][3]]
  %"b_copy[1][3].4" = select i1 %sel_tmp2, float %"b_copy[1][3].1", float %"b_copy[1][3]" ; [#uses=1 type=float]
  call void @llvm.dbg.value(metadata !{float %"b_copy[1][3].4"}, i64 0, metadata !93), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[1][3]]
  %"b_copy[1][3].2" = select i1 %sel_tmp4, float %"b_copy[1][3].1", float %"b_copy[1][3].4" ; [#uses=1 type=float]
  call void @llvm.dbg.value(metadata !{float %"b_copy[1][3].2"}, i64 0, metadata !93), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[1][3]]
  %"b_copy[1][3].5" = select i1 %sel_tmp, float %"b_copy[1][3].16", float %"b_copy[1][2].1" ; [#uses=1 type=float]
  call void @llvm.dbg.value(metadata !{float %"b_copy[1][3].5"}, i64 0, metadata !93), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[1][3]]
  %"b_copy[1][3].6" = select i1 %sel_tmp2, float %"b_copy[1][2].1", float %"b_copy[1][3].5" ; [#uses=1 type=float]
  call void @llvm.dbg.value(metadata !{float %"b_copy[1][3].6"}, i64 0, metadata !93), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[1][3]]
  %"b_copy[1][3].7" = select i1 %sel_tmp4, float %"b_copy[1][2].1", float %"b_copy[1][3].6" ; [#uses=1 type=float]
  call void @llvm.dbg.value(metadata !{float %"b_copy[1][3].7"}, i64 0, metadata !93), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[1][3]]
  call void @llvm.dbg.value(metadata !{float %"b_copy[1][3].8"}, i64 0, metadata !93), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[1][3]]
  %"b_copy[1][3].9" = select i1 %sel_tmp2, float %"b_copy[1][3].16", float %"b_copy[1][3].8" ; [#uses=1 type=float]
  call void @llvm.dbg.value(metadata !{float %"b_copy[1][3].9"}, i64 0, metadata !93), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[1][3]]
  %"b_copy[1][3].10" = select i1 %sel_tmp4, float %"b_copy[1][3].8", float %"b_copy[1][3].9" ; [#uses=1 type=float]
  call void @llvm.dbg.value(metadata !{float %"b_copy[1][3].10"}, i64 0, metadata !93), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[1][3]]
  call void @llvm.dbg.value(metadata !{float %"b_copy[1][3].11"}, i64 0, metadata !93), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[1][3]]
  %"b_copy[1][3].12" = select i1 %sel_tmp4, float %"b_copy[1][3].16", float %"b_copy[1][3].11" ; [#uses=1 type=float]
  call void @llvm.dbg.value(metadata !{float %"b_copy[1][3].12"}, i64 0, metadata !93), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[1][3]]
  %"b[1].addr" = getelementptr [2 x [4 x float]]* %"b[1]", i64 0, i64 0, i64 %tmp.6 ; [#uses=1 type=float*]
  %"b_copy[2][3].16" = load float* %"b[1].addr", align 4, !dbg !82 ; [#uses=4 type=float] [debug line = 38:7]
  call void @llvm.dbg.value(metadata !{float %"b_copy[2][3].16"}, i64 0, metadata !98), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[2][3]]
  call void @llvm.dbg.value(metadata !{float %"b_copy[2][3].16"}, i64 0, metadata !100), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[2][0]]
  call void @llvm.dbg.value(metadata !{float %"b_copy[2][3].16"}, i64 0, metadata !101), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[2][1]]
  call void @llvm.dbg.value(metadata !{float %"b_copy[2][3].16"}, i64 0, metadata !102), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[2][2]]
  %"b_copy[2][3]" = select i1 %sel_tmp, float %"b_copy[2][3].1", float %"b_copy[2][3].16" ; [#uses=1 type=float]
  call void @llvm.dbg.value(metadata !{float %"b_copy[2][3]"}, i64 0, metadata !98), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[2][3]]
  %"b_copy[2][3].4" = select i1 %sel_tmp2, float %"b_copy[2][3].1", float %"b_copy[2][3]" ; [#uses=1 type=float]
  call void @llvm.dbg.value(metadata !{float %"b_copy[2][3].4"}, i64 0, metadata !98), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[2][3]]
  %"b_copy[2][3].2" = select i1 %sel_tmp4, float %"b_copy[2][3].1", float %"b_copy[2][3].4" ; [#uses=1 type=float]
  call void @llvm.dbg.value(metadata !{float %"b_copy[2][3].2"}, i64 0, metadata !98), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[2][3]]
  %"b_copy[2][3].5" = select i1 %sel_tmp, float %"b_copy[2][3].16", float %"b_copy[2][2].1" ; [#uses=1 type=float]
  call void @llvm.dbg.value(metadata !{float %"b_copy[2][3].5"}, i64 0, metadata !98), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[2][3]]
  %"b_copy[2][3].6" = select i1 %sel_tmp2, float %"b_copy[2][2].1", float %"b_copy[2][3].5" ; [#uses=1 type=float]
  call void @llvm.dbg.value(metadata !{float %"b_copy[2][3].6"}, i64 0, metadata !98), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[2][3]]
  %"b_copy[2][3].7" = select i1 %sel_tmp4, float %"b_copy[2][2].1", float %"b_copy[2][3].6" ; [#uses=1 type=float]
  call void @llvm.dbg.value(metadata !{float %"b_copy[2][3].7"}, i64 0, metadata !98), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[2][3]]
  call void @llvm.dbg.value(metadata !{float %"b_copy[2][3].8"}, i64 0, metadata !98), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[2][3]]
  %"b_copy[2][3].9" = select i1 %sel_tmp2, float %"b_copy[2][3].16", float %"b_copy[2][3].8" ; [#uses=1 type=float]
  call void @llvm.dbg.value(metadata !{float %"b_copy[2][3].9"}, i64 0, metadata !98), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[2][3]]
  %"b_copy[2][3].10" = select i1 %sel_tmp4, float %"b_copy[2][3].8", float %"b_copy[2][3].9" ; [#uses=1 type=float]
  call void @llvm.dbg.value(metadata !{float %"b_copy[2][3].10"}, i64 0, metadata !98), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[2][3]]
  call void @llvm.dbg.value(metadata !{float %"b_copy[2][3].11"}, i64 0, metadata !98), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[2][3]]
  %"b_copy[2][3].12" = select i1 %sel_tmp4, float %"b_copy[2][3].16", float %"b_copy[2][3].11" ; [#uses=1 type=float]
  call void @llvm.dbg.value(metadata !{float %"b_copy[2][3].12"}, i64 0, metadata !98), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[2][3]]
  %"b[1].addr.1" = getelementptr [2 x [4 x float]]* %"b[1]", i64 0, i64 1, i64 %tmp.6 ; [#uses=1 type=float*]
  %"b_copy[3][3].16" = load float* %"b[1].addr.1", align 4, !dbg !82 ; [#uses=4 type=float] [debug line = 38:7]
  call void @llvm.dbg.value(metadata !{float %"b_copy[3][3].16"}, i64 0, metadata !103), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[3][3]]
  call void @llvm.dbg.value(metadata !{float %"b_copy[3][3].16"}, i64 0, metadata !105), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[3][0]]
  call void @llvm.dbg.value(metadata !{float %"b_copy[3][3].16"}, i64 0, metadata !106), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[3][1]]
  call void @llvm.dbg.value(metadata !{float %"b_copy[3][3].16"}, i64 0, metadata !107), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[3][2]]
  %"b_copy[3][3]" = select i1 %sel_tmp, float %"b_copy[3][3].1", float %"b_copy[3][3].16" ; [#uses=1 type=float]
  call void @llvm.dbg.value(metadata !{float %"b_copy[3][3]"}, i64 0, metadata !103), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[3][3]]
  %"b_copy[3][3].4" = select i1 %sel_tmp2, float %"b_copy[3][3].1", float %"b_copy[3][3]" ; [#uses=1 type=float]
  call void @llvm.dbg.value(metadata !{float %"b_copy[3][3].4"}, i64 0, metadata !103), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[3][3]]
  %"b_copy[3][3].2" = select i1 %sel_tmp4, float %"b_copy[3][3].1", float %"b_copy[3][3].4" ; [#uses=1 type=float]
  call void @llvm.dbg.value(metadata !{float %"b_copy[3][3].2"}, i64 0, metadata !103), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[3][3]]
  %"b_copy[3][3].5" = select i1 %sel_tmp, float %"b_copy[3][3].16", float %"b_copy[3][2].1" ; [#uses=1 type=float]
  call void @llvm.dbg.value(metadata !{float %"b_copy[3][3].5"}, i64 0, metadata !103), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[3][3]]
  %"b_copy[3][3].6" = select i1 %sel_tmp2, float %"b_copy[3][2].1", float %"b_copy[3][3].5" ; [#uses=1 type=float]
  call void @llvm.dbg.value(metadata !{float %"b_copy[3][3].6"}, i64 0, metadata !103), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[3][3]]
  %"b_copy[3][3].7" = select i1 %sel_tmp4, float %"b_copy[3][2].1", float %"b_copy[3][3].6" ; [#uses=1 type=float]
  call void @llvm.dbg.value(metadata !{float %"b_copy[3][3].7"}, i64 0, metadata !103), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[3][3]]
  call void @llvm.dbg.value(metadata !{float %"b_copy[3][3].8"}, i64 0, metadata !103), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[3][3]]
  %"b_copy[3][3].9" = select i1 %sel_tmp2, float %"b_copy[3][3].16", float %"b_copy[3][3].8" ; [#uses=1 type=float]
  call void @llvm.dbg.value(metadata !{float %"b_copy[3][3].9"}, i64 0, metadata !103), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[3][3]]
  %"b_copy[3][3].10" = select i1 %sel_tmp4, float %"b_copy[3][3].8", float %"b_copy[3][3].9" ; [#uses=1 type=float]
  call void @llvm.dbg.value(metadata !{float %"b_copy[3][3].10"}, i64 0, metadata !103), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[3][3]]
  call void @llvm.dbg.value(metadata !{float %"b_copy[3][3].11"}, i64 0, metadata !103), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[3][3]]
  %"b_copy[3][3].12" = select i1 %sel_tmp4, float %"b_copy[3][3].16", float %"b_copy[3][3].11" ; [#uses=1 type=float]
  call void @llvm.dbg.value(metadata !{float %"b_copy[3][3].12"}, i64 0, metadata !103), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[3][3]]
  %"b_copy[3][3].3" = select i1 %tmp, float %"b_copy[3][3].2", float %"b_copy[3][3].1" ; [#uses=2 type=float]
  call void @llvm.dbg.value(metadata !{float %"b_copy[3][3].3"}, i64 0, metadata !103), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[3][3]]
  %"b_copy[3][3].13" = select i1 %tmp, float %"b_copy[3][3].7", float %"b_copy[3][2].1" ; [#uses=2 type=float]
  call void @llvm.dbg.value(metadata !{float %"b_copy[3][3].13"}, i64 0, metadata !103), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[3][3]]
  %"b_copy[3][3].14" = select i1 %tmp, float %"b_copy[3][3].10", float %"b_copy[3][3].8" ; [#uses=2 type=float]
  call void @llvm.dbg.value(metadata !{float %"b_copy[3][3].14"}, i64 0, metadata !103), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[3][3]]
  %"b_copy[3][3].15" = select i1 %tmp, float %"b_copy[3][3].12", float %"b_copy[3][3].11" ; [#uses=2 type=float]
  call void @llvm.dbg.value(metadata !{float %"b_copy[3][3].15"}, i64 0, metadata !103), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[3][3]]
  %"b_copy[2][3].3" = select i1 %tmp, float %"b_copy[2][3].2", float %"b_copy[2][3].1" ; [#uses=2 type=float]
  call void @llvm.dbg.value(metadata !{float %"b_copy[2][3].3"}, i64 0, metadata !98), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[2][3]]
  %"b_copy[2][3].13" = select i1 %tmp, float %"b_copy[2][3].7", float %"b_copy[2][2].1" ; [#uses=2 type=float]
  call void @llvm.dbg.value(metadata !{float %"b_copy[2][3].13"}, i64 0, metadata !98), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[2][3]]
  %"b_copy[2][3].14" = select i1 %tmp, float %"b_copy[2][3].10", float %"b_copy[2][3].8" ; [#uses=2 type=float]
  call void @llvm.dbg.value(metadata !{float %"b_copy[2][3].14"}, i64 0, metadata !98), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[2][3]]
  %"b_copy[2][3].15" = select i1 %tmp, float %"b_copy[2][3].12", float %"b_copy[2][3].11" ; [#uses=2 type=float]
  call void @llvm.dbg.value(metadata !{float %"b_copy[2][3].15"}, i64 0, metadata !98), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[2][3]]
  %"b_copy[1][3].3" = select i1 %tmp, float %"b_copy[1][3].2", float %"b_copy[1][3].1" ; [#uses=2 type=float]
  call void @llvm.dbg.value(metadata !{float %"b_copy[1][3].3"}, i64 0, metadata !93), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[1][3]]
  %"b_copy[1][3].13" = select i1 %tmp, float %"b_copy[1][3].7", float %"b_copy[1][2].1" ; [#uses=2 type=float]
  call void @llvm.dbg.value(metadata !{float %"b_copy[1][3].13"}, i64 0, metadata !93), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[1][3]]
  %"b_copy[1][3].14" = select i1 %tmp, float %"b_copy[1][3].10", float %"b_copy[1][3].8" ; [#uses=2 type=float]
  call void @llvm.dbg.value(metadata !{float %"b_copy[1][3].14"}, i64 0, metadata !93), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[1][3]]
  %"b_copy[1][3].15" = select i1 %tmp, float %"b_copy[1][3].12", float %"b_copy[1][3].11" ; [#uses=2 type=float]
  call void @llvm.dbg.value(metadata !{float %"b_copy[1][3].15"}, i64 0, metadata !93), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[1][3]]
  %"b_copy[0][3].3" = select i1 %tmp, float %"b_copy[0][3].2", float %"b_copy[0][3].1" ; [#uses=2 type=float]
  call void @llvm.dbg.value(metadata !{float %"b_copy[0][3].3"}, i64 0, metadata !86), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[0][3]]
  %"b_copy[0][3].13" = select i1 %tmp, float %"b_copy[0][3].7", float %"b_copy[0][2].1" ; [#uses=2 type=float]
  call void @llvm.dbg.value(metadata !{float %"b_copy[0][3].13"}, i64 0, metadata !86), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[0][3]]
  %"b_copy[0][3].14" = select i1 %tmp, float %"b_copy[0][3].10", float %"b_copy[0][3].8" ; [#uses=2 type=float]
  call void @llvm.dbg.value(metadata !{float %"b_copy[0][3].14"}, i64 0, metadata !86), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[0][3]]
  %"b_copy[0][3].15" = select i1 %tmp, float %"b_copy[0][3].12", float %"b_copy[0][3].11" ; [#uses=2 type=float]
  call void @llvm.dbg.value(metadata !{float %"b_copy[0][3].15"}, i64 0, metadata !86), !dbg !82 ; [debug line = 38:7] [debug variable = b_copy[0][3]]
  ...
  %tmp. = fmul float %a_row.load, %tmp.4, !dbg !108 ; [#uses=1 type=float] [debug line = 43:4]
  %tmp.5 = fadd float %tmp., 0.000000e+00, !dbg !108 ; [#uses=1 type=float] [debug line = 43:4]
  ...
  %tmp.2.1 = fmul float %a_row.load.1, %tmp.7, !dbg !108 ; [#uses=1 type=float] [debug line = 43:4]
  %tmp.5.1 = fadd float %tmp.5, %tmp.2.1, !dbg !108 ; [#uses=1 type=float] [debug line = 43:4]
  ...
  %tmp.2.2 = fmul float %a_row.load.2, %tmp.8, !dbg !108 ; [#uses=1 type=float] [debug line = 43:4]
  %tmp.5.2 = fadd float %tmp.5.1, %tmp.2.2, !dbg !108 ; [#uses=1 type=float] [debug line = 43:4]
  ...
  %tmp.2.3 = fmul float %a_row.load.3, %tmp.9, !dbg !108 ; [#uses=1 type=float] [debug line = 43:4]
  %tmp.5.3 = fadd float %tmp.5.2, %tmp.2.3, !dbg !108 ; [#uses=1 type=float] [debug line = 43:4]
  %c.addr = getelementptr [4 x [4 x float]]* %c, i64 0, i64 %tmp.1, i64 %tmp.6, !dbg !73 ; [#uses=1 type=float*] [debug line = 46:5]
  store float %tmp.5.3, float* %c.addr, align 4, !dbg !73 ; [debug line = 46:5]
  %4 = call i32 (...)* @_ssdm_op_SpecRegionEnd([4 x i8]* @.str5, i32 %tmp.2) nounwind, !dbg !111 ; [#uses=0 type=i32] [debug line = 47:3]
  %j.1 = add i3 %j, 1, !dbg !112                  ; [#uses=1 type=i3] [debug line = 23:63]
  call void @llvm.dbg.value(metadata !{i3 %j.1}, i64 0, metadata !113), !dbg !112 ; [debug line = 23:63] [debug variable = j]
  br label %.preheader7, !dbg !112                ; [debug line = 23:63]
...
; <label>:5                                       ; preds = %.preheader7
  ...
  %i.1 = add i3 %i, 1, !dbg !115                  ; [#uses=1 type=i3] [debug line = 21:58]
  call void @llvm.dbg.value(metadata !{i3 %i.1}, i64 0, metadata !116), !dbg !115 ; [debug line = 21:58] [debug variable = i]
  br label %1, !dbg !115                          ; [debug line = 21:58]

; <label>:6                                       ; preds = %1
  ret void, !dbg !117                             ; [debug line = 49:1]
}
...
!83 = metadata !{i32 786443, metadata !84, i32 37, i32 105, metadata !6, i32 10} ; [ DW_TAG_lexical_block ]
!84 = metadata !{i32 786443, metadata !85, i32 37, i32 16, metadata !6, i32 9} ; [ DW_TAG_lexical_block ]
!85 = metadata !{i32 786443, metadata !70, i32 36, i32 16, metadata !6, i32 8} ; [ DW_TAG_lexical_block ]
!86 = metadata !{i32 790529, metadata !87, metadata !"b_copy[0][3]", null, i32 18, metadata !89, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!87 = metadata !{i32 786688, metadata !66, metadata !"b_copy[0]", null, i32 18, metadata !88, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!88 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 128, i64 32, i32 0, i32 0, metadata !11, metadata !55, i32 0, i32 0} ; [ DW_TAG_array_type ]
!89 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 32, i64 32, i32 0, i32 0, metadata !11, metadata !55, i32 0, i32 0} ; [ DW_TAG_array_type ]
!90 = metadata !{i32 790529, metadata !87, metadata !"b_copy[0][0]", null, i32 18, metadata !89, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!91 = metadata !{i32 790529, metadata !87, metadata !"b_copy[0][1]", null, i32 18, metadata !89, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!92 = metadata !{i32 790529, metadata !87, metadata !"b_copy[0][2]", null, i32 18, metadata !89, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!93 = metadata !{i32 790529, metadata !94, metadata !"b_copy[1][3]", null, i32 18, metadata !89, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!94 = metadata !{i32 786688, metadata !66, metadata !"b_copy[1]", null, i32 18, metadata !88, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!95 = metadata !{i32 790529, metadata !94, metadata !"b_copy[1][0]", null, i32 18, metadata !89, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!96 = metadata !{i32 790529, metadata !94, metadata !"b_copy[1][1]", null, i32 18, metadata !89, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!97 = metadata !{i32 790529, metadata !94, metadata !"b_copy[1][2]", null, i32 18, metadata !89, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!98 = metadata !{i32 790529, metadata !99, metadata !"b_copy[2][3]", null, i32 18, metadata !89, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!99 = metadata !{i32 786688, metadata !66, metadata !"b_copy[2]", null, i32 18, metadata !88, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!100 = metadata !{i32 790529, metadata !99, metadata !"b_copy[2][0]", null, i32 18, metadata !89, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!101 = metadata !{i32 790529, metadata !99, metadata !"b_copy[2][1]", null, i32 18, metadata !89, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!102 = metadata !{i32 790529, metadata !99, metadata !"b_copy[2][2]", null, i32 18, metadata !89, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!103 = metadata !{i32 790529, metadata !104, metadata !"b_copy[3][3]", null, i32 18, metadata !89, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!104 = metadata !{i32 786688, metadata !66, metadata !"b_copy[3]", null, i32 18, metadata !88, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!105 = metadata !{i32 790529, metadata !104, metadata !"b_copy[3][0]", null, i32 18, metadata !89, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!106 = metadata !{i32 790529, metadata !104, metadata !"b_copy[3][1]", null, i32 18, metadata !89, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!107 = metadata !{i32 790529, metadata !104, metadata !"b_copy[3][2]", null, i32 18, metadata !89, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!108 = metadata !{i32 43, i32 4, metadata !109, null}
!109 = metadata !{i32 786443, metadata !110, i32 42, i32 103, metadata !6, i32 12} ; [ DW_TAG_lexical_block ]
!110 = metadata !{i32 786443, metadata !70, i32 42, i32 14, metadata !6, i32 11} ; [ DW_TAG_lexical_block ]
!111 = metadata !{i32 47, i32 3, metadata !70, null}
!112 = metadata !{i32 23, i32 63, metadata !71, null}
!113 = metadata !{i32 786688, metadata !71, metadata !"j", metadata !6, i32 23, metadata !114, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!114 = metadata !{i32 786468, null, metadata !"int", null, i32 0, i64 32, i64 32, i64 0, i32 0, i32 5} ; [ DW_TAG_base_type ]
!115 = metadata !{i32 21, i32 58, metadata !68, null}
!116 = metadata !{i32 786688, metadata !68, metadata !"i", metadata !6, i32 21, metadata !114, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!117 = metadata !{i32 49, i32 1, metadata !66, null}
