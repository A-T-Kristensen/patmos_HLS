...
define void @matmul_hw([8 x float]* %a_0, [8 x float]* %a_1, [8 x float]* %b_0, [8 x float]* %b_1, [16 x float]* %c) {
  ...
  call void (...)* @_ssdm_op_SpecBitsMap([8 x float]* %a_1), !map !7
  call void (...)* @_ssdm_op_SpecBitsMap([8 x float]* %a_0), !map !14
  call void (...)* @_ssdm_op_SpecBitsMap([8 x float]* %b_1), !map !20
  call void (...)* @_ssdm_op_SpecBitsMap([8 x float]* %b_0), !map !25
  call void (...)* @_ssdm_op_SpecBitsMap([16 x float]* %c), !map !30
