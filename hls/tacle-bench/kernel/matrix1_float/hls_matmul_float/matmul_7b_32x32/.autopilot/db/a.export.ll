; ModuleID = '/home/patmos/github/bachelor_project_HLS/hls/tacle-bench/kernel/matrix1_float/hls_matmul_float/matmul_7b_32x32/.autopilot/db/a.o.2.bc'
...
.preheader.preheader:                             ; preds = %.preheader7.preheader
  ...
  %tmp_6_cast7 = zext i6 %j_mid2 to i9
  %tmp_6_cast6 = zext i6 %j_mid2 to i8
  %tmp_6_cast = zext i6 %j_mid2 to i7
  %b_0_addr = getelementptr [352 x float]* %b_0, i64 0, i64 %tmp_6
  %tmp_30 = add i7 %tmp_6_cast, 32
  %tmp_31_cast = zext i7 %tmp_30 to i64
  %b_0_addr_1 = getelementptr [352 x float]* %b_0, i64 0, i64 %tmp_31_cast
  %tmp_31 = call i64 @_ssdm_op_BitConcatenate.i64.i58.i6(i58 1, i6 %j_mid2)
  %b_0_addr_2 = getelementptr [352 x float]* %b_0, i64 0, i64 %tmp_31
  %tmp_32 = add i8 %tmp_6_cast6, 96
  %tmp_33_cast = zext i8 %tmp_32 to i64
  %b_0_addr_3 = getelementptr [352 x float]* %b_0, i64 0, i64 %tmp_33_cast
  %tmp_33 = call i64 @_ssdm_op_BitConcatenate.i64.i58.i6(i58 2, i6 %j_mid2)
  %b_0_addr_4 = getelementptr [352 x float]* %b_0, i64 0, i64 %tmp_33
  %tmp_34 = add i8 %tmp_6_cast6, -96
  %tmp_35_cast = zext i8 %tmp_34 to i64
  %b_0_addr_5 = getelementptr [352 x float]* %b_0, i64 0, i64 %tmp_35_cast
  %tmp_35 = call i64 @_ssdm_op_BitConcatenate.i64.i58.i6(i58 3, i6 %j_mid2)
  %b_0_addr_6 = getelementptr [352 x float]* %b_0, i64 0, i64 %tmp_35
  %tmp_36 = add i9 %tmp_6_cast7, 224
  %tmp_37_cast = zext i9 %tmp_36 to i64
  %b_0_addr_7 = getelementptr [352 x float]* %b_0, i64 0, i64 %tmp_37_cast
  %tmp_37 = call i64 @_ssdm_op_BitConcatenate.i64.i58.i6(i58 4, i6 %j_mid2)
  %b_0_addr_8 = getelementptr [352 x float]* %b_0, i64 0, i64 %tmp_37
  %tmp_38 = add i9 %tmp_6_cast7, -224
  %tmp_39_cast = zext i9 %tmp_38 to i64
  %b_0_addr_9 = getelementptr [352 x float]* %b_0, i64 0, i64 %tmp_39_cast
  %tmp_39 = call i64 @_ssdm_op_BitConcatenate.i64.i58.i6(i58 5, i6 %j_mid2)
  %b_0_addr_10 = getelementptr [352 x float]* %b_0, i64 0, i64 %tmp_39
  %b_1_addr = getelementptr [352 x float]* %b_1, i64 0, i64 %tmp_6
  %b_1_addr_1 = getelementptr [352 x float]* %b_1, i64 0, i64 %tmp_31_cast
  %b_1_addr_2 = getelementptr [352 x float]* %b_1, i64 0, i64 %tmp_31
  %b_1_addr_3 = getelementptr [352 x float]* %b_1, i64 0, i64 %tmp_33_cast
  %b_1_addr_4 = getelementptr [352 x float]* %b_1, i64 0, i64 %tmp_33
  %b_1_addr_5 = getelementptr [352 x float]* %b_1, i64 0, i64 %tmp_35_cast
  %b_1_addr_6 = getelementptr [352 x float]* %b_1, i64 0, i64 %tmp_35
  %b_1_addr_7 = getelementptr [352 x float]* %b_1, i64 0, i64 %tmp_37_cast
  %b_1_addr_8 = getelementptr [352 x float]* %b_1, i64 0, i64 %tmp_37
  %b_1_addr_9 = getelementptr [352 x float]* %b_1, i64 0, i64 %tmp_39_cast
  %b_1_addr_10 = getelementptr [352 x float]* %b_1, i64 0, i64 %tmp_39
  %b_2_addr = getelementptr [320 x float]* %b_2, i64 0, i64 %tmp_6
  %b_2_addr_1 = getelementptr [320 x float]* %b_2, i64 0, i64 %tmp_31_cast
  %b_2_addr_2 = getelementptr [320 x float]* %b_2, i64 0, i64 %tmp_31
  %b_2_addr_3 = getelementptr [320 x float]* %b_2, i64 0, i64 %tmp_33_cast
  %b_2_addr_4 = getelementptr [320 x float]* %b_2, i64 0, i64 %tmp_33
  %b_2_addr_5 = getelementptr [320 x float]* %b_2, i64 0, i64 %tmp_35_cast
  %b_2_addr_6 = getelementptr [320 x float]* %b_2, i64 0, i64 %tmp_35
  %b_2_addr_7 = getelementptr [320 x float]* %b_2, i64 0, i64 %tmp_37_cast
  %b_2_addr_8 = getelementptr [320 x float]* %b_2, i64 0, i64 %tmp_37
  %b_2_addr_9 = getelementptr [320 x float]* %b_2, i64 0, i64 %tmp_39_cast
...
.preheader7.preheader:                            ; preds = %.preheader7
  ...
  %tmp2 = icmp eq i6 %i, 0
  %tmp_mid2 = select i1 %exitcond, i1 %tmp_mid1, i1 %tmp2
  ...
  %a_0_addr = getelementptr [352 x float]* %a_0, i64 0, i64 %tmp_1_cast
  %tmp_4 = add i10 %tmp_1, 1
  %tmp_4_cast = sext i10 %tmp_4 to i64
  %a_0_addr_1 = getelementptr [352 x float]* %a_0, i64 0, i64 %tmp_4_cast
  %tmp_7 = add i10 %tmp_1, 2
  %tmp_7_cast = sext i10 %tmp_7 to i64
  %a_0_addr_2 = getelementptr [352 x float]* %a_0, i64 0, i64 %tmp_7_cast
  %tmp_8 = add i10 %tmp_1, 3
  %tmp_8_cast = sext i10 %tmp_8 to i64
  %a_0_addr_3 = getelementptr [352 x float]* %a_0, i64 0, i64 %tmp_8_cast
  %tmp_10 = add i10 %tmp_1, 4
  %tmp_10_cast = sext i10 %tmp_10 to i64
  %a_0_addr_4 = getelementptr [352 x float]* %a_0, i64 0, i64 %tmp_10_cast
  %tmp_11 = add i10 %tmp_1, 5
  %tmp_11_cast = sext i10 %tmp_11 to i64
  %a_0_addr_5 = getelementptr [352 x float]* %a_0, i64 0, i64 %tmp_11_cast
  %tmp_12 = add i10 %tmp_1, 6
  %tmp_12_cast = sext i10 %tmp_12 to i64
  %a_0_addr_6 = getelementptr [352 x float]* %a_0, i64 0, i64 %tmp_12_cast
  %tmp_13 = add i10 %tmp_1, 7
  %tmp_13_cast = sext i10 %tmp_13 to i64
  %a_0_addr_7 = getelementptr [352 x float]* %a_0, i64 0, i64 %tmp_13_cast
  %tmp_14 = add i10 %tmp_1, 8
  %tmp_14_cast = sext i10 %tmp_14 to i64
  %a_0_addr_8 = getelementptr [352 x float]* %a_0, i64 0, i64 %tmp_14_cast
  %tmp_15 = add i10 %tmp_1, 9
  %tmp_15_cast = sext i10 %tmp_15 to i64
  %a_0_addr_9 = getelementptr [352 x float]* %a_0, i64 0, i64 %tmp_15_cast
  %tmp_16 = add i10 %tmp_1, 10
  %tmp_16_cast = sext i10 %tmp_16 to i64
  %a_0_addr_10 = getelementptr [352 x float]* %a_0, i64 0, i64 %tmp_16_cast
  %a_1_addr = getelementptr [352 x float]* %a_1, i64 0, i64 %tmp_1_cast
  %a_1_addr_1 = getelementptr [352 x float]* %a_1, i64 0, i64 %tmp_4_cast
  %a_1_addr_2 = getelementptr [352 x float]* %a_1, i64 0, i64 %tmp_7_cast
  %a_1_addr_3 = getelementptr [352 x float]* %a_1, i64 0, i64 %tmp_8_cast
  %a_1_addr_4 = getelementptr [352 x float]* %a_1, i64 0, i64 %tmp_10_cast
  %a_1_addr_5 = getelementptr [352 x float]* %a_1, i64 0, i64 %tmp_11_cast
  %a_1_addr_6 = getelementptr [352 x float]* %a_1, i64 0, i64 %tmp_12_cast
  %a_1_addr_7 = getelementptr [352 x float]* %a_1, i64 0, i64 %tmp_13_cast
  %a_1_addr_8 = getelementptr [352 x float]* %a_1, i64 0, i64 %tmp_14_cast
  %a_1_addr_9 = getelementptr [352 x float]* %a_1, i64 0, i64 %tmp_15_cast
  %a_1_addr_10 = getelementptr [352 x float]* %a_1, i64 0, i64 %tmp_16_cast
  %tmp_17 = call i9 @_ssdm_op_BitConcatenate.i9.i6.i3(i6 %tmp_1_mid2_v, i3 0)
  %p_shl_cast = zext i9 %tmp_17 to i10
  %tmp_18 = call i7 @_ssdm_op_BitConcatenate.i7.i6.i1(i6 %tmp_1_mid2_v, i1 false)
  %p_shl1_cast = zext i7 %tmp_18 to i10
  %tmp_19 = add i10 %p_shl1_cast, %p_shl_cast
  %tmp_19_cast = zext i10 %tmp_19 to i64
  %a_2_addr = getelementptr [320 x float]* %a_2, i64 0, i64 %tmp_19_cast
  %tmp_20 = or i10 %tmp_19, 1
  %tmp_20_cast = zext i10 %tmp_20 to i64
  %a_2_addr_1 = getelementptr [320 x float]* %a_2, i64 0, i64 %tmp_20_cast
  %tmp_21 = add i10 %tmp_19, 2
  %tmp_21_cast = sext i10 %tmp_21 to i64
  %a_2_addr_2 = getelementptr [320 x float]* %a_2, i64 0, i64 %tmp_21_cast
  %tmp_22 = add i10 %tmp_19, 3
  %tmp_22_cast = sext i10 %tmp_22 to i64
  %a_2_addr_3 = getelementptr [320 x float]* %a_2, i64 0, i64 %tmp_22_cast
  %tmp_23 = add i10 %tmp_19, 4
  %tmp_23_cast = sext i10 %tmp_23 to i64
  %a_2_addr_4 = getelementptr [320 x float]* %a_2, i64 0, i64 %tmp_23_cast
  %tmp_24 = add i10 %tmp_19, 5
  %tmp_24_cast = sext i10 %tmp_24 to i64
  %a_2_addr_5 = getelementptr [320 x float]* %a_2, i64 0, i64 %tmp_24_cast
  %tmp_25 = add i10 %tmp_19, 6
  %tmp_25_cast = sext i10 %tmp_25 to i64
  %a_2_addr_6 = getelementptr [320 x float]* %a_2, i64 0, i64 %tmp_25_cast
  %tmp_26 = add i10 %tmp_19, 7
  %tmp_26_cast = sext i10 %tmp_26 to i64
  %a_2_addr_7 = getelementptr [320 x float]* %a_2, i64 0, i64 %tmp_26_cast
  %tmp_27 = add i10 %tmp_19, 8
  %tmp_27_cast = sext i10 %tmp_27 to i64
  %a_2_addr_8 = getelementptr [320 x float]* %a_2, i64 0, i64 %tmp_27_cast
  %tmp_28 = add i10 %tmp_19, 9
  %tmp_28_cast = sext i10 %tmp_28 to i64
  %a_2_addr_9 = getelementptr [320 x float]* %a_2, i64 0, i64 %tmp_28_cast
  %tmp_29 = call i11 @_ssdm_op_BitConcatenate.i11.i6.i5(i6 %tmp_1_mid2_v, i5 0)
  %tmp_30_cast = zext i11 %tmp_29 to i12
  ...
  %a_2_load_8 = load float* %a_2_addr_8, align 4
  %a_2_load_9 = load float* %a_2_addr_9, align 4
  %a_row_load_31 = select i1 %tmp_3, float %a_2_load_9, float %a_row_load_93
  %a_row_load_30 = select i1 %tmp_3, float %a_2_load_8, float %a_row_load_92
  %a_row_load_29 = select i1 %tmp_3, float %a_2_load_7, float %a_row_load_91
  %a_row_load_28 = select i1 %tmp_3, float %a_2_load_6, float %a_row_load_90
  %a_row_load_27 = select i1 %tmp_3, float %a_2_load_5, float %a_row_load_89
  %a_row_load_26 = select i1 %tmp_3, float %a_2_load_4, float %a_row_load_88
  %a_row_load_25 = select i1 %tmp_3, float %a_2_load_3, float %a_row_load_87
  %a_row_load_24 = select i1 %tmp_3, float %a_2_load_2, float %a_row_load_86
  %a_row_load_23 = select i1 %tmp_3, float %a_2_load_1, float %a_row_load_85
  %a_row_load_22 = select i1 %tmp_3, float %a_2_load, float %a_row_load_84
  %a_row_load_21 = select i1 %tmp_3, float %a_1_load_10, float %a_row_load_83
  %a_row_load_20 = select i1 %tmp_3, float %a_1_load_9, float %a_row_load_82
  %a_row_load_19 = select i1 %tmp_3, float %a_1_load_8, float %a_row_load_81
  %a_row_load_18 = select i1 %tmp_3, float %a_1_load_7, float %a_row_load_80
  %a_row_load_17 = select i1 %tmp_3, float %a_1_load_6, float %a_row_load_79
  %a_row_load_16 = select i1 %tmp_3, float %a_1_load_5, float %a_row_load_78
  %a_row_load_15 = select i1 %tmp_3, float %a_1_load_4, float %a_row_load_77
  %a_row_load_14 = select i1 %tmp_3, float %a_1_load_3, float %a_row_load_76
  %a_row_load_13 = select i1 %tmp_3, float %a_1_load_2, float %a_row_load_75
  %a_row_load_12 = select i1 %tmp_3, float %a_1_load_1, float %a_row_load_74
  %a_row_load_11 = select i1 %tmp_3, float %a_1_load, float %a_row_load_73
