; ModuleID = '/home/patmos/github/bachelor_project_HLS/hls/tacle-bench/kernel/matrix1_float/hls_matmul_float/matmul_7b_32x32/.autopilot/db/a.g.bc'
...
define void @matmul_hw([32 x float]* %a, [32 x float]* %b, [32 x float]* %c) nounwind uwtable {
  ...
  call void (...)* @_ssdm_SpecArrayPartition([32 x float]* %7, i32 1, i8* getelementptr inbounds ([6 x i8]* @.str, i32 0, i32 0), i32 3, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !34 ; [debug line = 6:1]
  %8 = load [32 x float]** %1, align 8, !dbg !34  ; [#uses=1 type=[32 x float]*] [debug line = 6:1]
  call void (...)* @_ssdm_SpecArrayPartition([32 x float]* %8, i32 2, i8* getelementptr inbounds ([6 x i8]* @.str, i32 0, i32 0), i32 3, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !34 ; [debug line = 6:1]
