...
.preheader.preheader:                             ; preds = %.preheader7.preheader
  ...
  %b_0_addr = getelementptr [128 x float]* %b_0, i64 0, i64 %tmp_6
  %tmp_23 = add i6 %tmp_6_cast, 16
  %tmp_24_cast = zext i6 %tmp_23 to i64
  %b_0_addr_1 = getelementptr [128 x float]* %b_0, i64 0, i64 %tmp_24_cast
  %tmp_24 = call i64 @_ssdm_op_BitConcatenate.i64.i59.i5(i59 1, i5 %j_mid2)
  %b_0_addr_2 = getelementptr [128 x float]* %b_0, i64 0, i64 %tmp_24
  %tmp_25 = add i7 %tmp_6_cast5, 48
  %tmp_26_cast = zext i7 %tmp_25 to i64
  %b_0_addr_3 = getelementptr [128 x float]* %b_0, i64 0, i64 %tmp_26_cast
  %tmp_26 = call i64 @_ssdm_op_BitConcatenate.i64.i59.i5(i59 2, i5 %j_mid2)
  %b_0_addr_4 = getelementptr [128 x float]* %b_0, i64 0, i64 %tmp_26
  %tmp_27 = add i7 %tmp_6_cast5, -48
  %tmp_28_cast = zext i7 %tmp_27 to i64
  %b_0_addr_5 = getelementptr [128 x float]* %b_0, i64 0, i64 %tmp_28_cast
  %tmp_28 = call i64 @_ssdm_op_BitConcatenate.i64.i59.i5(i59 3, i5 %j_mid2)
  %b_0_addr_6 = getelementptr [128 x float]* %b_0, i64 0, i64 %tmp_28
  %tmp_29 = add i8 %tmp_6_cast6, 112
  %tmp_30_cast = zext i8 %tmp_29 to i64
  %b_0_addr_7 = getelementptr [128 x float]* %b_0, i64 0, i64 %tmp_30_cast
  %b_1_addr = getelementptr [128 x float]* %b_1, i64 0, i64 %tmp_6
  %b_1_addr_1 = getelementptr [128 x float]* %b_1, i64 0, i64 %tmp_24_cast
  %b_1_addr_2 = getelementptr [128 x float]* %b_1, i64 0, i64 %tmp_24
  %b_1_addr_3 = getelementptr [128 x float]* %b_1, i64 0, i64 %tmp_26_cast
  %b_1_addr_4 = getelementptr [128 x float]* %b_1, i64 0, i64 %tmp_26
  %b_1_addr_5 = getelementptr [128 x float]* %b_1, i64 0, i64 %tmp_28_cast
  %b_1_addr_6 = getelementptr [128 x float]* %b_1, i64 0, i64 %tmp_28
  %b_1_addr_7 = getelementptr [128 x float]* %b_1, i64 0, i64 %tmp_30_cast
...
.loopexit:                                        ; preds = %.preheader.preheader, %.preheader7.preheader
  ...
  %tmp_30 = add i10 %tmp_23_cast, %tmp_9_cast
  %tmp_31_cast = zext i10 %tmp_30 to i64
  %c_addr = getelementptr [256 x float]* %c, i64 0, i64 %tmp_31_cast
...
.preheader7.preheader:                            ; preds = %.preheader7
  ...
  %tmp_1 = call i8 @_ssdm_op_BitConcatenate.i8.i5.i3(i5 %tmp_1_mid2_v, i3 0)
  %tmp_4 = zext i8 %tmp_1 to i64
  %a_0_addr = getelementptr [128 x float]* %a_0, i64 0, i64 %tmp_4
  %tmp_7 = or i8 %tmp_1, 1
  %tmp_8 = call i64 @_ssdm_op_BitConcatenate.i64.i56.i8(i56 0, i8 %tmp_7)
  %a_0_addr_1 = getelementptr [128 x float]* %a_0, i64 0, i64 %tmp_8
  %tmp_10 = or i8 %tmp_1, 2
  %tmp_11 = call i64 @_ssdm_op_BitConcatenate.i64.i56.i8(i56 0, i8 %tmp_10)
  %a_0_addr_2 = getelementptr [128 x float]* %a_0, i64 0, i64 %tmp_11
  %tmp_12 = or i8 %tmp_1, 3
  %tmp_13 = call i64 @_ssdm_op_BitConcatenate.i64.i56.i8(i56 0, i8 %tmp_12)
  %a_0_addr_3 = getelementptr [128 x float]* %a_0, i64 0, i64 %tmp_13
  %tmp_14 = or i8 %tmp_1, 4
  %tmp_15 = call i64 @_ssdm_op_BitConcatenate.i64.i56.i8(i56 0, i8 %tmp_14)
  %a_0_addr_4 = getelementptr [128 x float]* %a_0, i64 0, i64 %tmp_15
  %tmp_16 = or i8 %tmp_1, 5
  %tmp_17 = call i64 @_ssdm_op_BitConcatenate.i64.i56.i8(i56 0, i8 %tmp_16)
  %a_0_addr_5 = getelementptr [128 x float]* %a_0, i64 0, i64 %tmp_17
  %tmp_18 = or i8 %tmp_1, 6
  %tmp_19 = call i64 @_ssdm_op_BitConcatenate.i64.i56.i8(i56 0, i8 %tmp_18)
  %a_0_addr_6 = getelementptr [128 x float]* %a_0, i64 0, i64 %tmp_19
  %tmp_20 = or i8 %tmp_1, 7
  %tmp_21 = call i64 @_ssdm_op_BitConcatenate.i64.i56.i8(i56 0, i8 %tmp_20)
  %a_0_addr_7 = getelementptr [128 x float]* %a_0, i64 0, i64 %tmp_21
  %a_1_addr = getelementptr [128 x float]* %a_1, i64 0, i64 %tmp_4
  %a_1_addr_1 = getelementptr [128 x float]* %a_1, i64 0, i64 %tmp_8
  %a_1_addr_2 = getelementptr [128 x float]* %a_1, i64 0, i64 %tmp_11
  %a_1_addr_3 = getelementptr [128 x float]* %a_1, i64 0, i64 %tmp_13
  %a_1_addr_4 = getelementptr [128 x float]* %a_1, i64 0, i64 %tmp_15
  %a_1_addr_5 = getelementptr [128 x float]* %a_1, i64 0, i64 %tmp_17
  %a_1_addr_6 = getelementptr [128 x float]* %a_1, i64 0, i64 %tmp_19
  %a_1_addr_7 = getelementptr [128 x float]* %a_1, i64 0, i64 %tmp_21
  %tmp_22 = call i9 @_ssdm_op_BitConcatenate.i9.i5.i4(i5 %tmp_1_mid2_v, i4 0)
  %tmp_23_cast = zext i9 %tmp_22 to i10
  ...
  %a_row_load_15 = select i1 %tmp_3, float %a_1_load_7, float %a_row_load_45
  %a_row_load_14 = select i1 %tmp_3, float %a_1_load_6, float %a_row_load_44
  %a_row_load_13 = select i1 %tmp_3, float %a_1_load_5, float %a_row_load_43
  %a_row_load_12 = select i1 %tmp_3, float %a_1_load_4, float %a_row_load_42
  %a_row_load_11 = select i1 %tmp_3, float %a_1_load_3, float %a_row_load_41
  %a_row_load_10 = select i1 %tmp_3, float %a_1_load_2, float %a_row_load_40
  %a_row_load_9 = select i1 %tmp_3, float %a_1_load_1, float %a_row_load_39
  %a_row_load_8 = select i1 %tmp_3, float %a_1_load, float %a_row_load_38
  %a_row_load_7 = select i1 %tmp_3, float %a_0_load_7, float %a_row_load_37
  %a_row_load_6 = select i1 %tmp_3, float %a_0_load_6, float %a_row_load_36
  %a_row_load_5 = select i1 %tmp_3, float %a_0_load_5, float %a_row_load_35
  %a_row_load_4 = select i1 %tmp_3, float %a_0_load_4, float %a_row_load_34
...
entry:
  ...
  %empty_7 = zext i3 %1 to i8
  %empty_8 = shl i8 %empty, 3
...
entry:
  ...
  %empty_13 = zext i8 %1 to i64
  %empty_14 = shl i64 %empty, 8
