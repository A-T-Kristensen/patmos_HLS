...
define void @matmul_hw([4 x float]* %a_0, [4 x float]* %a_1, [4 x float]* %a_2, [4 x float]* %a_3, [4 x float]* %b_0, [4 x float]* %b_1, [4 x float]* %b_2, [4 x float]* %b_3, [16 x float]* %c) {
  ...
  call void (...)* @_ssdm_op_SpecBitsMap([4 x float]* %a_3), !map !7
  call void (...)* @_ssdm_op_SpecBitsMap([4 x float]* %a_2), !map !14
  call void (...)* @_ssdm_op_SpecBitsMap([4 x float]* %a_1), !map !20
  call void (...)* @_ssdm_op_SpecBitsMap([4 x float]* %a_0), !map !26
  call void (...)* @_ssdm_op_SpecBitsMap([4 x float]* %b_3), !map !32
  call void (...)* @_ssdm_op_SpecBitsMap([4 x float]* %b_2), !map !37
  call void (...)* @_ssdm_op_SpecBitsMap([4 x float]* %b_1), !map !42
  call void (...)* @_ssdm_op_SpecBitsMap([4 x float]* %b_0), !map !47
  call void (...)* @_ssdm_op_SpecBitsMap([16 x float]* %c), !map !52
...
.preheader7.preheader:                            ; preds = %.preheader7
  ...
  %a_0_addr = getelementptr [4 x float]* %a_0, i64 0, i64 %tmp_1_mid2
  %a_0_load = load float* %a_0_addr, align 4
  %a_1_addr = getelementptr [4 x float]* %a_1, i64 0, i64 %tmp_1_mid2
  %a_1_load = load float* %a_1_addr, align 4
  %a_2_addr = getelementptr [4 x float]* %a_2, i64 0, i64 %tmp_1_mid2
  %a_2_load = load float* %a_2_addr, align 4
  %a_3_addr = getelementptr [4 x float]* %a_3, i64 0, i64 %tmp_1_mid2
  %a_3_load = load float* %a_3_addr, align 4
  %a_row_load_3 = select i1 %tmp_3, float %a_3_load, float %a_row_load_10
  %a_row_load_2 = select i1 %tmp_3, float %a_2_load, float %a_row_load_6
  %a_row_load_1 = select i1 %tmp_3, float %a_1_load, float %a_row_load_5
  %a_row_load = select i1 %tmp_3, float %a_0_load, float %a_row_load_4
  %tmp_6 = zext i3 %j_mid2 to i64
  %tmp_6_cast = zext i3 %j_mid2 to i6
  %tmp_10 = add i6 %tmp_10_cast, %tmp_6_cast
  %tmp_11_cast = zext i6 %tmp_10 to i64
  %c_addr = getelementptr [16 x float]* %c, i64 0, i64 %tmp_11_cast
  %b_0_addr = getelementptr [4 x float]* %b_0, i64 0, i64 %tmp_6
  ...
  %b_1_addr = getelementptr [4 x float]* %b_1, i64 0, i64 %tmp_6
  %b_copy_1_3_19 = load float* %b_1_addr, align 4
  ...
  %b_2_addr = getelementptr [4 x float]* %b_2, i64 0, i64 %tmp_6
  %b_copy_2_3_19 = load float* %b_2_addr, align 4
  ...
  %b_3_addr = getelementptr [4 x float]* %b_3, i64 0, i64 %tmp_6
  %b_copy_3_3_19 = load float* %b_3_addr, align 4
