...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "matmul_hw.autotvin.dat"
	set constFileTvOut       "matmul_hw.autotvout.dat"
	set constFileHdlTvIn     "matmul_hw.autohdltvin.dat"
	set constFileHdlTvOut    "matmul_hw.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
