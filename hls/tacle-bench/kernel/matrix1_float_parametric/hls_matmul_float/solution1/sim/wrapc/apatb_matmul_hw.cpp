			...
			if (i > 0)
			{
				// RTL Name: c
				{
					...
					// {
						// celement: c(31, 0)
						// {
							sc_lv<32>* c_lv0_0_1023_1 = new sc_lv<32>[1024];
						// }
					// }
					...
					// bitslice(31, 0)
					{
						...
						// celement: c(31, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 1023; i_0 += 1)
							{
								...
								{
									c_lv0_0_1023_1[hls_map_index++].range(31, 0) = sc_bv<32>(c_pc_buffer[hls_map_index].range(31, 0));
								}
							}
						}
					}
					...
					// bitslice(31, 0)
					{
						...
						// celement: c(31, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 1023; i_0 += 1)
							{
								...
								// output_type_conversion : (c_lv0_0_1023_1[hls_map_index++]).to_uint64()
								if (&(c[0]) != NULL) // check the null address if the c port is array or others
								{
									*(int*)&c[i_0] = (c_lv0_0_1023_1[hls_map_index++]).to_uint64();
								}
							}
						}
					}
