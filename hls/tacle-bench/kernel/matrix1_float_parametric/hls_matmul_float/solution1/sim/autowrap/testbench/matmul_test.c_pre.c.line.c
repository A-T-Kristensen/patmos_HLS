#pragma line 1 "/home/patmos/github/bachelor_project_HLS/hls/tacle-bench/kernel/matrix1_float_parametric/matmul_test.c"
...
#pragma empty_line
#pragma line 3 "/home/patmos/github/bachelor_project_HLS/hls/tacle-bench/kernel/matrix1_float_parametric/matmul_test.c" 2
...
#pragma line 4 "/home/patmos/github/bachelor_project_HLS/hls/tacle-bench/kernel/matrix1_float_parametric/matmul_test.c" 2
#pragma empty_line
void matrix_init(mat_type matrix_A[4*4], mat_type matrix_B[4*4])
{
#pragma empty_line
...
#pragma empty_line
#pragma empty_line
void matmul_sw(mat_type a[4*4], mat_type b[4*4],
     mat_type sw_result[4*4])
{
  int i, j, k;
#pragma empty_line
...
int main()
{
 mat_type matrix_A[4*4];
 mat_type matrix_B[4*4];
 mat_type sw_result[4*4];
 mat_type hw_result[4*4];
#pragma empty_line
 int err_cnt = 0;
 int i, j;
#pragma empty_line
...
#pragma empty_line
   printf("Run HwA\n\n");
#pragma empty_line
   matmul_hw(matrix_A, matrix_B, hw_result, 4);
#pragma empty_line
#pragma empty_line
