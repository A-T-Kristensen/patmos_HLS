...
if {[file isfile matmul_hw.autotvin.dat]} {
	file delete -force matmul_hw.autotvin.dat
}

if {[file isfile matmul_hw.autotvout.dat]} {
	file delete -force matmul_hw.autotvout.dat
}
