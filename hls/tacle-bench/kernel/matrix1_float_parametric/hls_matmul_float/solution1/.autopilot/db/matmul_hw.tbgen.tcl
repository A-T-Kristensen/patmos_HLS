set C_TypeInfoList {{ 
"matmul_hw" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"a": [[], {"array": ["0", [1024]]}] }, {"b": [[], {"array": ["0", [1024]]}] }, {"c": [[], {"array": ["0", [1024]]}] }, {"size": [[], {"scalar": "int"}] }],[],""], 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "69", "Max" : "38117"}
	, {"Name" : "Interval", "Min" : "70", "Max" : "38118"}
]}
