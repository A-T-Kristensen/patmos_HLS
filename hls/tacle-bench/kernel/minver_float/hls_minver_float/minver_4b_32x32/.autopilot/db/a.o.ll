; ModuleID = '/home/patmos/github/bachelor_project_HLS/hls/tacle-bench/kernel/minver_float/hls_minver_float/minver_4b_32x32/.autopilot/db/a.o.bc'
...
define i32 @minver_hwa([32 x float]* %a) nounwind uwtable {
  ...
  call void (...)* @_ssdm_SpecArrayPartition([32 x float]* %4, i32 2, i8* getelementptr inbounds ([6 x i8]* @.str, i32 0, i32 0), i32 4, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !1148 ; [debug line = 37:1]
