; ModuleID = '/home/patmos/github/bachelor_project_HLS/hls/tacle-bench/kernel/minver_float/hls_minver_float/minver_4b_32x32/.autopilot/db/a.g.1.bc'
...
define i32 @minver_hwa([32 x float]* %a) nounwind uwtable {
  ...
  call void (...)* @_ssdm_SpecArrayPartition([32 x float]* %a, i32 2, i8* getelementptr inbounds ([6 x i8]* @.str, i64 0, i64 0), i32 4, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !84 ; [debug line = 37:1]
...
; <label>:2                                       ; preds = %1
  ...
  %rend22 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str5, i64 0, i64 0), i32 %rbegin1) nounwind, !dbg !102 ; [#uses=0 type=i32] [debug line = 53:3]
...
._crit_edge:                                      ; preds = %._crit_edge18, %11
  %rend24 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str9, i64 0, i64 0), i32 %rbegin5) nounwind, !dbg !171 ; [#uses=0 type=i32] [debug line = 104:5]
