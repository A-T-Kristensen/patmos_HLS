; ModuleID = '/home/patmos/github/bachelor_project_HLS/hls/tacle-bench/kernel/minver_float/hls_minver_float/minver_2b_3x3/.autopilot/db/a.o.3.bc'
...
@minver_hw = common global [9 x float] zeroinitializer ; [#uses=0 type=[9 x float]*]
...
; [#uses=0]
define i32 @minver_hwa([6 x float]* %a_0, [3 x float]* %a_1) {
  call void (...)* @_ssdm_op_SpecBitsMap([3 x float]* %a_1), !map !31
  call void (...)* @_ssdm_op_SpecBitsMap([6 x float]* %a_0), !map !37
  ...
  call void @llvm.dbg.value(metadata !{[6 x float]* %a_0}, i64 0, metadata !49), !dbg !67 ; [debug line = 35:25] [debug variable = a[0]]
  call void @llvm.dbg.value(metadata !{[3 x float]* %a_1}, i64 0, metadata !68), !dbg !67 ; [debug line = 35:25] [debug variable = a[1]]
  call void (...)* @_ssdm_op_SpecMemCore([6 x float]* %a_0, [3 x float]* %a_1, [1 x i8]* @p_str1, [12 x i8]* @p_str2, [1 x i8]* @p_str1, i32 -1, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1)
  call void (...)* @_ssdm_op_SpecInterface([6 x float]* %a_0, [3 x float]* %a_1, [5 x i8]* @p_str3, i32 0, i32 0, [1 x i8]* @p_str1, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1, [1 x i8]* @p_str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str1, [1 x i8]* @p_str1)
  ...
  call void @llvm.dbg.declare(metadata !{[500 x i2]* %work}, metadata !71), !dbg !75 ; [debug line = 41:6] [debug variable = work]
...
; <label>:1                                       ; preds = %2, %0
  ...
  %i_1 = add i2 %i, 1, !dbg !78                   ; [#uses=1 type=i2] [debug line = 50:23]
...
; <label>:2                                       ; preds = %1
  ...
  %work_addr = getelementptr [500 x i2]* %work, i64 0, i64 %tmp, !dbg !85 ; [#uses=1 type=i2*] [debug line = 52:2]
  store i2 %i, i2* %work_addr, align 1, !dbg !85  ; [debug line = 52:2]
  %empty_7 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str5, i32 %tmp_6) nounwind, !dbg !86 ; [#uses=0 type=i32] [debug line = 53:3]
  call void @llvm.dbg.value(metadata !{i2 %i_1}, i64 0, metadata !87), !dbg !78 ; [debug line = 50:23] [debug variable = i]
  br label %1, !dbg !78                           ; [debug line = 50:23]

.preheader13:                                     ; preds = %14, %.preheader13.preheader
  %i_5 = phi i2 [ %k, %14 ], [ 0, %.preheader13.preheader ] ; [#uses=15 type=i2]
  %tmp_2 = icmp eq i2 %i_5, -1, !dbg !80          ; [#uses=1 type=i1] [debug line = 56:9]
  %k = add i2 %i_5, 1, !dbg !88                   ; [#uses=1 type=i2] [debug line = 56:23]
...
.preheader12.preheader:                           ; preds = %.preheader13
  %i_5_cast = zext i2 %i_5 to i32, !dbg !91       ; [#uses=2 type=i32] [debug line = 59:11]
  call void @llvm.dbg.value(metadata !{i2 %i_5}, i64 0, metadata !87), !dbg !91 ; [debug line = 59:11] [debug variable = i]
  %empty_8 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 1, i64 3, i64 2) nounwind ; [#uses=0 type=i32]
  %tmp_3 = zext i2 %i_5 to i64, !dbg !94          ; [#uses=2 type=i64] [debug line = 61:6]
  %tmp_3_cast = zext i2 %i_5 to i3                ; [#uses=3 type=i3]
  %tmp_7 = call i3 @_ssdm_op_BitConcatenate.i3.i2.i1(i2 %i_5, i1 false) ; [#uses=2 type=i3]
  %tmp_11 = zext i3 %tmp_7 to i64, !dbg !96       ; [#uses=1 type=i64] [debug line = 82:2]
  %tmp_30 = or i3 %tmp_7, 1                       ; [#uses=1 type=i3]
  %tmp_35 = call i64 @_ssdm_op_BitConcatenate.i64.i61.i3(i61 0, i3 %tmp_30) ; [#uses=1 type=i64]
  %a_0_addr_11 = getelementptr [6 x float]* %a_0, i64 0, i64 %tmp_35 ; [#uses=1 type=float*]
  %a_0_addr_9 = getelementptr [6 x float]* %a_0, i64 0, i64 %tmp_11 ; [#uses=1 type=float*]
  %a_1_addr_9 = getelementptr [3 x float]* %a_1, i64 0, i64 %tmp_3 ; [#uses=1 type=float*]
  %tmp_40 = trunc i2 %i_5 to i1                   ; [#uses=5 type=i1]
  %newIndex4_cast = zext i1 %tmp_40 to i3         ; [#uses=4 type=i3]
  %tmp_42 = call i3 @_ssdm_op_BitConcatenate.i3.i2.i1(i2 %i_5, i1 %tmp_40) ; [#uses=1 type=i3]
  %tmp_49 = zext i3 %tmp_42 to i64, !dbg !100     ; [#uses=1 type=i64] [debug line = 105:5]
  %a_0_addr_7 = getelementptr [6 x float]* %a_0, i64 0, i64 %tmp_49, !dbg !100 ; [#uses=1 type=float*] [debug line = 105:5]
  %tmp_53 = add i3 %tmp_3_cast, %newIndex4_cast, !dbg !100 ; [#uses=1 type=i3] [debug line = 105:5]
  %tmp_59_cast = zext i3 %tmp_53 to i64, !dbg !100 ; [#uses=1 type=i64] [debug line = 105:5]
  %a_1_addr_7 = getelementptr [3 x float]* %a_1, i64 0, i64 %tmp_59_cast, !dbg !100 ; [#uses=1 type=float*] [debug line = 105:5]
  %tmp_54 = call i1 @_ssdm_op_BitSelect.i1.i2.i32(i2 %i_5, i32 1), !dbg !94 ; [#uses=5 type=i1] [debug line = 61:6]
...
.preheader12:                                     ; preds = %_ifconv, %.preheader12.preheader
  ...
  %r_1 = phi i32 [ %i_6, %_ifconv ], [ %i_5_cast, %.preheader12.preheader ] ; [#uses=5 type=i32]
  %exitcond6 = icmp eq i32 %r_1, 3, !dbg !91      ; [#uses=1 type=i1] [debug line = 59:11]
  br i1 %exitcond6, label %_ifconv4, label %_ifconv, !dbg !91 ; [debug line = 59:11]

_ifconv:                                          ; preds = %.preheader12
  %r_load_1 = load i32* %r, !dbg !101             ; [#uses=1 type=i32] [debug line = 62:7]
  %empty_9 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 1, i64 3, i64 0) nounwind ; [#uses=0 type=i32]
  ...
  %tmp_66 = trunc i32 %r_1 to i3                  ; [#uses=1 type=i3]
  %tmp_63 = call i33 @_ssdm_op_BitConcatenate.i33.i32.i1(i32 %r_1, i1 %tmp_40) ; [#uses=1 type=i33]
  %tmp_64 = sext i33 %tmp_63 to i64, !dbg !94     ; [#uses=1 type=i64] [debug line = 61:6]
  %a_0_addr_1 = getelementptr [6 x float]* %a_0, i64 0, i64 %tmp_64, !dbg !94 ; [#uses=1 type=float*] [debug line = 61:6]
  %tmp_65 = add i3 %newIndex4_cast, %tmp_66, !dbg !94 ; [#uses=1 type=i3] [debug line = 61:6]
  %tmp_65_cast = sext i3 %tmp_65 to i64, !dbg !94 ; [#uses=1 type=i64] [debug line = 61:6]
  %a_1_addr_1 = getelementptr [3 x float]* %a_1, i64 0, i64 %tmp_65_cast, !dbg !94 ; [#uses=1 type=float*] [debug line = 61:6]
  ...
  %n_assign_1 = select i1 %tmp_54, float %a_1_load_1, float %a_0_load_1, !dbg !94 ; [#uses=3 type=float] [debug line = 61:6]
  ...
  %tmp_69 = trunc i32 %n_assign_1_to_int to i23   ; [#uses=1 type=i23]
  %notlhs = icmp ne i8 %tmp_34, -1                ; [#uses=1 type=i1]
  %notrhs = icmp eq i23 %tmp_69, 0                ; [#uses=1 type=i1]
  ...
  %tmp_88 = trunc i32 %w_3_to_int to i23          ; [#uses=1 type=i23]
  ...
  %tmp_89 = trunc i32 %wmax_to_int to i23         ; [#uses=1 type=i23]
  %notlhs3 = icmp ne i8 %tmp_39, -1               ; [#uses=1 type=i1]
  %notrhs3 = icmp eq i23 %tmp_88, 0               ; [#uses=1 type=i1]
  %tmp_43 = or i1 %notrhs3, %notlhs3              ; [#uses=1 type=i1]
  %notlhs4 = icmp ne i8 %tmp_41, -1               ; [#uses=1 type=i1]
  %notrhs4 = icmp eq i23 %tmp_89, 0               ; [#uses=1 type=i1]
  ...
  %r_2 = select i1 %tmp_47, i32 %r_1, i32 %r_load_1, !dbg !101 ; [#uses=1 type=i32] [debug line = 62:7]
  call void @llvm.dbg.value(metadata !{i32 %r_2}, i64 0, metadata !79), !dbg !101 ; [debug line = 62:7] [debug variable = r]
  %empty_10 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str6, i32 %tmp_12) nounwind, !dbg !120 ; [#uses=0 type=i32] [debug line = 66:5]
...
_ifconv4:                                         ; preds = %.preheader12
  ...
  %tmp_4 = sext i32 %r_load to i64, !dbg !122     ; [#uses=1 type=i64] [debug line = 68:5]
  %tmp_57 = trunc i32 %r_load to i3               ; [#uses=2 type=i3]
  %tmp_58 = call i33 @_ssdm_op_BitConcatenate.i33.i32.i1(i32 %r_load, i1 %tmp_40) ; [#uses=1 type=i33]
  %tmp_59 = sext i33 %tmp_58 to i64, !dbg !122    ; [#uses=1 type=i64] [debug line = 68:5]
  %a_0_addr = getelementptr [6 x float]* %a_0, i64 0, i64 %tmp_59, !dbg !122 ; [#uses=1 type=float*] [debug line = 68:5]
  %tmp_60 = add i3 %newIndex4_cast, %tmp_57, !dbg !122 ; [#uses=1 type=i3] [debug line = 68:5]
  %tmp_62_cast = sext i3 %tmp_60 to i64, !dbg !122 ; [#uses=1 type=i64] [debug line = 68:5]
  %a_1_addr = getelementptr [3 x float]* %a_1, i64 0, i64 %tmp_62_cast, !dbg !122 ; [#uses=1 type=float*] [debug line = 68:5]
  ...
  %pivot = select i1 %tmp_54, float %a_1_load, float %a_0_load, !dbg !100 ; [#uses=6 type=float] [debug line = 105:5]
  ...
  %tmp_61 = trunc i32 %pivot_to_int to i23        ; [#uses=1 type=i23]
  %notlhs1 = icmp ne i8 %tmp_9, -1                ; [#uses=1 type=i1]
  %notrhs1 = icmp eq i23 %tmp_61, 0               ; [#uses=1 type=i1]
  ...
  %tmp_62 = trunc i64 %tmp_5_to_int to i52        ; [#uses=1 type=i52]
  %notlhs2 = icmp ne i11 %tmp_29, -1              ; [#uses=1 type=i1]
  %notrhs2 = icmp eq i52 %tmp_62, 0               ; [#uses=1 type=i1]
...
; <label>:3                                       ; preds = %_ifconv4
  %tmp_1 = icmp eq i32 %r_load, %i_5_cast, !dbg !132 ; [#uses=1 type=i1] [debug line = 75:5]
  br i1 %tmp_1, label %.loopexit11, label %4, !dbg !132 ; [debug line = 75:5]

; <label>:4                                       ; preds = %3
  %work_addr_3 = getelementptr [500 x i2]* %work, i64 0, i64 %tmp_3, !dbg !133 ; [#uses=2 type=i2*] [debug line = 77:7]
  %work_load_2 = load i2* %work_addr_3, align 1   ; [#uses=1 type=i2]
  %work_addr_4 = getelementptr [500 x i2]* %work, i64 0, i64 %tmp_4, !dbg !134 ; [#uses=2 type=i2*] [debug line = 78:7]
  %work_load_3 = load i2* %work_addr_4, align 1   ; [#uses=1 type=i2]
  store i2 %work_load_3, i2* %work_addr_3, align 1, !dbg !134 ; [debug line = 78:7]
  store i2 %work_load_2, i2* %work_addr_4, align 1, !dbg !135 ; [debug line = 79:7]
  br label %5, !dbg !136                          ; [debug line = 80:13]

; <label>:5                                       ; preds = %6, %4
  %j = phi i2 [ 0, %4 ], [ %j_1, %6 ]             ; [#uses=4 type=i2]
  %exitcond5 = icmp eq i2 %j, -1, !dbg !136       ; [#uses=1 type=i1] [debug line = 80:13]
  %j_1 = add i2 %j, 1, !dbg !137                  ; [#uses=1 type=i2] [debug line = 80:27]
...
_ifconv1:                                         ; preds = %5
  ...
  %tmp_94 = trunc i2 %j to i1                     ; [#uses=3 type=i1]
  %newIndex9_cast = zext i1 %tmp_94 to i3         ; [#uses=2 type=i3]
  %tmp_72 = call i3 @_ssdm_op_BitConcatenate.i3.i2.i1(i2 %i_5, i1 %tmp_94) ; [#uses=1 type=i3]
  %tmp_73 = zext i3 %tmp_72 to i64, !dbg !96      ; [#uses=1 type=i64] [debug line = 82:2]
  %a_0_addr_4 = getelementptr [6 x float]* %a_0, i64 0, i64 %tmp_73, !dbg !96 ; [#uses=2 type=float*] [debug line = 82:2]
  %tmp_74 = call i33 @_ssdm_op_BitConcatenate.i33.i32.i1(i32 %r_load_2, i1 %tmp_94) ; [#uses=1 type=i33]
  %tmp_75 = sext i33 %tmp_74 to i64, !dbg !140    ; [#uses=1 type=i64] [debug line = 83:9]
  %a_0_addr_6 = getelementptr [6 x float]* %a_0, i64 0, i64 %tmp_75, !dbg !140 ; [#uses=2 type=float*] [debug line = 83:9]
  %tmp_76 = add i3 %tmp_3_cast, %newIndex9_cast, !dbg !96 ; [#uses=1 type=i3] [debug line = 82:2]
  %tmp_76_cast = zext i3 %tmp_76 to i64, !dbg !96 ; [#uses=1 type=i64] [debug line = 82:2]
  %a_1_addr_4 = getelementptr [3 x float]* %a_1, i64 0, i64 %tmp_76_cast, !dbg !96 ; [#uses=2 type=float*] [debug line = 82:2]
  %tmp_77 = add i3 %tmp_57, %newIndex9_cast, !dbg !140 ; [#uses=1 type=i3] [debug line = 83:9]
  %tmp_77_cast = sext i3 %tmp_77 to i64, !dbg !140 ; [#uses=1 type=i64] [debug line = 83:9]
  %a_1_addr_6 = getelementptr [3 x float]* %a_1, i64 0, i64 %tmp_77_cast, !dbg !140 ; [#uses=2 type=float*] [debug line = 83:9]
  %tmp_95 = call i1 @_ssdm_op_BitSelect.i1.i2.i32(i2 %j, i32 1), !dbg !96 ; [#uses=3 type=i1] [debug line = 82:2]
  ...
  %w = select i1 %tmp_95, float %a_1_load_4, float %a_0_load_4, !dbg !96 ; [#uses=2 type=float] [debug line = 82:2]
  ...
  %a_load_2_phi = select i1 %tmp_95, float %a_1_load_6, float %a_0_load_6, !dbg !140 ; [#uses=2 type=float] [debug line = 83:9]
  br i1 %tmp_95, label %branch37, label %branch36, !dbg !140 ; [debug line = 83:9]

; <label>:6                                       ; preds = %branch37, %branch36
  %empty_12 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str7, i32 %tmp_21) nounwind, !dbg !141 ; [#uses=0 type=i32] [debug line = 85:7]
  call void @llvm.dbg.value(metadata !{i2 %j_1}, i64 0, metadata !142), !dbg !137 ; [debug line = 80:27] [debug variable = j]
...
; <label>:7                                       ; preds = %8, %.loopexit11
  %i_2 = phi i2 [ 0, %.loopexit11 ], [ %i_8, %8 ] ; [#uses=4 type=i2]
  %exitcond4 = icmp eq i2 %i_2, -1, !dbg !143     ; [#uses=1 type=i1] [debug line = 88:11]
  %i_8 = add i2 %i_2, 1, !dbg !145                ; [#uses=1 type=i2] [debug line = 88:25]
  br i1 %exitcond4, label %.preheader10.preheader, label %_ifconv2, !dbg !143 ; [debug line = 88:11]

.preheader10.preheader:                           ; preds = %7
  %tmp_24 = icmp eq i2 %i_5, 0, !dbg !146         ; [#uses=1 type=i1] [debug line = 99:13]
  %tmp_20_1 = icmp eq i2 %i_5, 1, !dbg !146       ; [#uses=1 type=i1] [debug line = 99:13]
  %tmp_20_2 = icmp eq i2 %i_5, -2, !dbg !146      ; [#uses=1 type=i1] [debug line = 99:13]
...
_ifconv2:                                         ; preds = %7
  ...
  %tmp_96 = trunc i2 %i_2 to i1                   ; [#uses=2 type=i1]
  %newIndex2_cast = zext i1 %tmp_96 to i3         ; [#uses=1 type=i3]
  %tmp_78 = call i3 @_ssdm_op_BitConcatenate.i3.i2.i1(i2 %i_5, i1 %tmp_96) ; [#uses=1 type=i3]
  %tmp_79 = zext i3 %tmp_78 to i64, !dbg !157     ; [#uses=1 type=i64] [debug line = 90:2]
  %a_0_addr_5 = getelementptr [6 x float]* %a_0, i64 0, i64 %tmp_79, !dbg !157 ; [#uses=2 type=float*] [debug line = 90:2]
  %tmp_80 = add i3 %newIndex2_cast, %tmp_3_cast, !dbg !157 ; [#uses=1 type=i3] [debug line = 90:2]
  %tmp_80_cast = zext i3 %tmp_80 to i64, !dbg !157 ; [#uses=1 type=i64] [debug line = 90:2]
  %a_1_addr_5 = getelementptr [3 x float]* %a_1, i64 0, i64 %tmp_80_cast, !dbg !157 ; [#uses=2 type=float*] [debug line = 90:2]
  %tmp_97 = call i1 @_ssdm_op_BitSelect.i1.i2.i32(i2 %i_2, i32 1), !dbg !157 ; [#uses=2 type=i1] [debug line = 90:2]
  ...
  %a_load_5_phi = select i1 %tmp_97, float %a_1_load_5, float %a_0_load_5, !dbg !157 ; [#uses=1 type=float] [debug line = 90:2]
  %tmp_13 = fdiv float %a_load_5_phi, %pivot, !dbg !157 ; [#uses=2 type=float] [debug line = 90:2]
  br i1 %tmp_97, label %branch29, label %branch28, !dbg !157 ; [debug line = 90:2]

; <label>:8                                       ; preds = %branch29, %branch28
  %empty_14 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str8, i32 %tmp_22) nounwind, !dbg !158 ; [#uses=0 type=i32] [debug line = 91:5]
  call void @llvm.dbg.value(metadata !{i2 %i_8}, i64 0, metadata !87), !dbg !145 ; [debug line = 88:25] [debug variable = i]
  br label %7, !dbg !145                          ; [debug line = 88:25]

.preheader10:                                     ; preds = %._crit_edge, %.preheader10.preheader
  %i_3 = phi i2 [ %i_9, %._crit_edge ], [ 0, %.preheader10.preheader ] ; [#uses=7 type=i2]
  %exitcond3 = icmp eq i2 %i_3, -1, !dbg !153     ; [#uses=1 type=i1] [debug line = 93:11]
  %i_9 = add i2 %i_3, 1, !dbg !159                ; [#uses=1 type=i2] [debug line = 93:25]
  br i1 %exitcond3, label %13, label %9, !dbg !153 ; [debug line = 93:11]
...
; <label>:9                                       ; preds = %.preheader10
  ...
  %tmp_15 = icmp eq i2 %i_3, %i_5, !dbg !162      ; [#uses=1 type=i1] [debug line = 95:2]
  br i1 %tmp_15, label %._crit_edge, label %_ifconv3, !dbg !162 ; [debug line = 95:2]

_ifconv3:                                         ; preds = %9
  %tmp_16 = zext i2 %i_3 to i64, !dbg !163        ; [#uses=1 type=i64] [debug line = 96:9]
  %tmp_16_cast = zext i2 %i_3 to i3               ; [#uses=1 type=i3]
  %tmp_81 = call i3 @_ssdm_op_BitConcatenate.i3.i2.i1(i2 %i_3, i1 false) ; [#uses=2 type=i3]
  %tmp_82 = zext i3 %tmp_81 to i64, !dbg !163     ; [#uses=1 type=i64] [debug line = 96:9]
  %tmp_83 = call i3 @_ssdm_op_BitConcatenate.i3.i2.i1(i2 %i_3, i1 %tmp_40) ; [#uses=1 type=i3]
  %tmp_84 = zext i3 %tmp_83 to i64, !dbg !163     ; [#uses=1 type=i64] [debug line = 96:9]
  %a_0_addr_8 = getelementptr [6 x float]* %a_0, i64 0, i64 %tmp_84, !dbg !163 ; [#uses=2 type=float*] [debug line = 96:9]
  %a_0_addr_10 = getelementptr [6 x float]* %a_0, i64 0, i64 %tmp_82 ; [#uses=2 type=float*]
  %tmp_85 = or i3 %tmp_81, 1                      ; [#uses=1 type=i3]
  %tmp_86 = call i64 @_ssdm_op_BitConcatenate.i64.i61.i3(i61 0, i3 %tmp_85) ; [#uses=1 type=i64]
  %a_0_addr_12 = getelementptr [6 x float]* %a_0, i64 0, i64 %tmp_86 ; [#uses=2 type=float*]
  %tmp_87 = add i3 %tmp_16_cast, %newIndex4_cast, !dbg !163 ; [#uses=1 type=i3] [debug line = 96:9]
  %tmp_87_cast = zext i3 %tmp_87 to i64, !dbg !163 ; [#uses=1 type=i64] [debug line = 96:9]
  %a_1_addr_8 = getelementptr [3 x float]* %a_1, i64 0, i64 %tmp_87_cast, !dbg !163 ; [#uses=2 type=float*] [debug line = 96:9]
  %a_1_addr_10 = getelementptr [3 x float]* %a_1, i64 0, i64 %tmp_16 ; [#uses=2 type=float*]
  ...
  %w_1 = select i1 %tmp_54, float %a_1_load_8, float %a_0_load_8, !dbg !163 ; [#uses=5 type=float] [debug line = 96:9]
  ...
  %tmp_98 = trunc i32 %w_1_to_int to i23          ; [#uses=1 type=i23]
  %notlhs5 = icmp ne i8 %tmp_48, -1               ; [#uses=1 type=i1]
  %notrhs5 = icmp eq i23 %tmp_98, 0               ; [#uses=1 type=i1]
...
.preheader9.3:                                    ; preds = %12, %.preheader9.2
  ...
  br i1 %tmp_54, label %branch25, label %branch24, !dbg !166 ; [debug line = 101:11]

.preheader9.348:                                  ; preds = %branch25, %branch24
  br label %._crit_edge18, !dbg !167              ; [debug line = 102:9]

._crit_edge18:                                    ; preds = %.preheader9.348, %_ifconv3
  br label %._crit_edge, !dbg !168                ; [debug line = 103:7]

._crit_edge:                                      ; preds = %._crit_edge18, %9
  %empty_16 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str9, i32 %tmp_23) nounwind, !dbg !169 ; [#uses=0 type=i32] [debug line = 104:5]
  call void @llvm.dbg.value(metadata !{i2 %i_9}, i64 0, metadata !87), !dbg !159 ; [debug line = 93:25] [debug variable = i]
...
; <label>:13                                      ; preds = %.preheader10
  ...
  br i1 %tmp_54, label %branch21, label %branch20, !dbg !100 ; [debug line = 105:5]

; <label>:14                                      ; preds = %branch21, %branch20
  call void @llvm.dbg.value(metadata !{i2 %k}, i64 0, metadata !170), !dbg !88 ; [debug line = 56:23] [debug variable = k]
...
.preheader8:                                      ; preds = %.preheader8.loopexit, %.preheader8.preheader
  %i_4 = phi i2 [ %i_7, %.preheader8.loopexit ], [ 0, %.preheader8.preheader ] ; [#uses=6 type=i2]
  %exitcond1 = icmp eq i2 %i_4, -1, !dbg !89      ; [#uses=1 type=i1] [debug line = 109:9]
  %i_7 = add i2 %i_4, 1, !dbg !171                ; [#uses=1 type=i2] [debug line = 129:5]
  call void @llvm.dbg.value(metadata !{i2 %i_7}, i64 0, metadata !87), !dbg !171 ; [debug line = 129:5] [debug variable = i]
...
.preheader.preheader:                             ; preds = %.preheader8
  %empty_17 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 3, i64 3, i64 3) nounwind ; [#uses=0 type=i32]
  %tmp_s = zext i2 %i_4 to i64, !dbg !173         ; [#uses=1 type=i64] [debug line = 114:2]
  %work_addr_1 = getelementptr [500 x i2]* %work, i64 0, i64 %tmp_s, !dbg !173 ; [#uses=2 type=i2*] [debug line = 114:2]
  %tmp_55 = trunc i2 %i_4 to i1                   ; [#uses=2 type=i1]
  %newIndex6_cast = zext i1 %tmp_55 to i3, !dbg !175 ; [#uses=1 type=i3] [debug line = 123:9]
  %tmp_56 = call i1 @_ssdm_op_BitSelect.i1.i2.i32(i2 %i_4, i32 1), !dbg !175 ; [#uses=6 type=i1] [debug line = 123:9]
  br label %.preheader, !dbg !178                 ; [debug line = 111:18]

.preheader:                                       ; preds = %18, %.preheader.preheader
  %work_load = load i2* %work_addr_1, align 1     ; [#uses=8 type=i2]
  %extLd8 = zext i2 %work_load to i3              ; [#uses=2 type=i3]
  %tmp_8 = icmp eq i2 %work_load, %i_4, !dbg !179 ; [#uses=1 type=i1] [debug line = 116:7]
...
_ifconv5:                                         ; preds = %.preheader
  ...
  %tmp_10 = zext i2 %work_load to i64, !dbg !181  ; [#uses=1 type=i64] [debug line = 118:7]
  %tmp_90 = call i3 @_ssdm_op_BitConcatenate.i3.i2.i1(i2 %work_load, i1 %tmp_55) ; [#uses=1 type=i3]
  %tmp_67 = zext i3 %tmp_90 to i64, !dbg !175     ; [#uses=1 type=i64] [debug line = 123:9]
  %a_0_addr_2 = getelementptr [6 x float]* %a_0, i64 0, i64 %tmp_67, !dbg !175 ; [#uses=6 type=float*] [debug line = 123:9]
  %tmp_68 = add i3 %extLd8, %newIndex6_cast, !dbg !175 ; [#uses=1 type=i3] [debug line = 123:9]
  %tmp_68_cast = sext i3 %tmp_68 to i64, !dbg !175 ; [#uses=1 type=i64] [debug line = 123:9]
  %a_1_addr_2 = getelementptr [3 x float]* %a_1, i64 0, i64 %tmp_68_cast, !dbg !175 ; [#uses=6 type=float*] [debug line = 123:9]
  %work_addr_2 = getelementptr [500 x i2]* %work, i64 0, i64 %tmp_10, !dbg !181 ; [#uses=2 type=i2*] [debug line = 118:7]
  %work_load_1 = load i2* %work_addr_2, align 1   ; [#uses=1 type=i2]
  store i2 %work_load, i2* %work_addr_2, align 1, !dbg !182 ; [debug line = 119:7]
  store i2 %work_load_1, i2* %work_addr_1, align 1, !dbg !183 ; [debug line = 120:7]
  %tmp_91 = trunc i2 %work_load to i1             ; [#uses=2 type=i1]
  %newIndex7_cast = zext i1 %tmp_91 to i3         ; [#uses=1 type=i3]
  %tmp_92 = call i3 @_ssdm_op_BitConcatenate.i3.i2.i1(i2 %work_load, i1 %tmp_91) ; [#uses=1 type=i3]
  %tmp_70 = zext i3 %tmp_92 to i64, !dbg !184     ; [#uses=1 type=i64] [debug line = 124:9]
  %a_0_addr_3 = getelementptr [6 x float]* %a_0, i64 0, i64 %tmp_70, !dbg !184 ; [#uses=4 type=float*] [debug line = 124:9]
  %tmp_71 = add i3 %extLd8, %newIndex7_cast, !dbg !184 ; [#uses=1 type=i3] [debug line = 124:9]
  %tmp_71_cast = sext i3 %tmp_71 to i64, !dbg !184 ; [#uses=1 type=i64] [debug line = 124:9]
  %a_1_addr_3 = getelementptr [3 x float]* %a_1, i64 0, i64 %tmp_71_cast, !dbg !184 ; [#uses=4 type=float*] [debug line = 124:9]
  ...
  %w_4_0_phi = select i1 %tmp_56, float %a_1_load_2, float %a_0_load_2, !dbg !175 ; [#uses=4 type=float] [debug line = 123:9]
  %tmp_93 = call i1 @_ssdm_op_BitSelect.i1.i2.i32(i2 %work_load, i32 1), !dbg !184 ; [#uses=4 type=i1] [debug line = 124:9]
  ...
  %a_load_4_0_phi = select i1 %tmp_93, float %a_1_load_3, float %a_0_load_3, !dbg !184 ; [#uses=2 type=float] [debug line = 124:9]
  br i1 %tmp_56, label %branch17, label %branch16, !dbg !184 ; [debug line = 124:9]

; <label>:15                                      ; preds = %branch17, %branch16
  br i1 %tmp_93, label %branch5, label %branch4, !dbg !185 ; [debug line = 125:9]

_ifconv6:                                         ; preds = %branch5, %branch4
  ...
  %w_4_1_phi = select i1 %tmp_56, float %a_1_load_7, float %a_0_load_7, !dbg !175 ; [#uses=4 type=float] [debug line = 123:9]
  br i1 %tmp_56, label %branch13, label %branch12, !dbg !184 ; [debug line = 124:9]

; <label>:16                                      ; preds = %branch13, %branch12
  br i1 %tmp_93, label %branch3, label %branch2, !dbg !185 ; [debug line = 125:9]

_ifconv7:                                         ; preds = %branch3, %branch2
  ...
  %w_4_2_phi = select i1 %tmp_56, float %a_1_load_9, float %a_0_load_13, !dbg !175 ; [#uses=2 type=float] [debug line = 123:9]
  br i1 %tmp_56, label %branch9, label %branch8, !dbg !184 ; [debug line = 124:9]

; <label>:17                                      ; preds = %branch9, %branch8
  br i1 %tmp_93, label %branch1, label %branch0, !dbg !185 ; [debug line = 125:9]

; <label>:18                                      ; preds = %branch1, %branch0
  %empty_18 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str10, i32 %tmp_20) nounwind, !dbg !186 ; [#uses=0 type=i32] [debug line = 127:5]
...
branch0:                                          ; preds = %17
  ...
  br label %18, !dbg !185                         ; [debug line = 125:9]
...
entry:
  ...
  %empty_21 = shl i2 1, %empty                    ; [#uses=1 type=i2]
  %empty_22 = and i2 %0, %empty_21                ; [#uses=1 type=i2]
  %empty_23 = icmp ne i2 %empty_22, 0             ; [#uses=1 type=i1]
  ret i1 %empty_23
}
...
entry:
  ...
  %empty_24 = zext i3 %1 to i64                   ; [#uses=1 type=i64]
  %empty_25 = shl i64 %empty, 3                   ; [#uses=1 type=i64]
...
entry:
  ...
  %empty_27 = zext i1 %1 to i33                   ; [#uses=1 type=i33]
  %empty_28 = shl i33 %empty, 1                   ; [#uses=1 type=i33]
  %empty_29 = or i33 %empty_28, %empty_27         ; [#uses=1 type=i33]
  ret i33 %empty_29
}
...
entry:
  ...
  %empty_30 = zext i1 %1 to i3                    ; [#uses=1 type=i3]
  %empty_31 = shl i3 %empty, 1                    ; [#uses=1 type=i3]
  %empty_32 = or i3 %empty_31, %empty_30          ; [#uses=1 type=i3]
  ret i3 %empty_32
}
...
!57 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 96, i64 32, i32 0, i32 0, metadata !58, metadata !60, i32 0, i32 0} ; [ DW_TAG_array_type ]
...
!61 = metadata !{i32 786465, i64 0, i64 2}        ; [ DW_TAG_subrange_type ]
!62 = metadata !{metadata !63}
!63 = metadata !{i32 786468}                      ; [ DW_TAG_base_type ]
!64 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 288, i64 32, i32 0, i32 0, metadata !58, metadata !65, i32 0, i32 0} ; [ DW_TAG_array_type ]
!65 = metadata !{metadata !61, metadata !61}
!66 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 144, i64 32, i32 0, i32 0, metadata !58, metadata !65, i32 0, i32 0} ; [ DW_TAG_array_type ]
