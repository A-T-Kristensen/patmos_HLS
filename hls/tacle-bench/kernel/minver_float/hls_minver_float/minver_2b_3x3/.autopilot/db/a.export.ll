...
; <label>:2                                       ; preds = %1
  ...
  %empty_7 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str5, i32 %tmp_6) nounwind
  br label %1
...
.preheader12.preheader:                           ; preds = %.preheader13
  %i_5_cast = zext i2 %i_5 to i32
  %empty_8 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 1, i64 3, i64 2) nounwind
  %tmp_3 = zext i2 %i_5 to i64
  %tmp_3_cast = zext i2 %i_5 to i3
  %tmp_7 = call i3 @_ssdm_op_BitConcatenate.i3.i2.i1(i2 %i_5, i1 false)
  %tmp_11 = zext i3 %tmp_7 to i64
  %tmp_30 = or i3 %tmp_7, 1
  %tmp_35 = call i64 @_ssdm_op_BitConcatenate.i64.i61.i3(i61 0, i3 %tmp_30)
  %a_0_addr_11 = getelementptr [6 x float]* %a_0, i64 0, i64 %tmp_35
  %a_0_addr_9 = getelementptr [6 x float]* %a_0, i64 0, i64 %tmp_11
  %a_1_addr_9 = getelementptr [3 x float]* %a_1, i64 0, i64 %tmp_3
  %tmp_40 = trunc i2 %i_5 to i1
  %newIndex4_cast = zext i1 %tmp_40 to i3
  %tmp_42 = call i3 @_ssdm_op_BitConcatenate.i3.i2.i1(i2 %i_5, i1 %tmp_40)
  %tmp_49 = zext i3 %tmp_42 to i64
  %a_0_addr_7 = getelementptr [6 x float]* %a_0, i64 0, i64 %tmp_49
  %tmp_53 = add i3 %tmp_3_cast, %newIndex4_cast
  %tmp_59_cast = zext i3 %tmp_53 to i64
  %a_1_addr_7 = getelementptr [3 x float]* %a_1, i64 0, i64 %tmp_59_cast
  %tmp_54 = call i1 @_ssdm_op_BitSelect.i1.i2.i32(i2 %i_5, i32 1)
...
_ifconv:                                          ; preds = %.preheader12
  ...
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str1) nounwind
  %tmp_66 = trunc i32 %r_1 to i3
  %tmp_63 = call i33 @_ssdm_op_BitConcatenate.i33.i32.i1(i32 %r_1, i1 %tmp_40)
  %tmp_64 = sext i33 %tmp_63 to i64
  %a_0_addr_1 = getelementptr [6 x float]* %a_0, i64 0, i64 %tmp_64
  %tmp_65 = add i3 %newIndex4_cast, %tmp_66
  %tmp_65_cast = sext i3 %tmp_65 to i64
  %a_1_addr_1 = getelementptr [3 x float]* %a_1, i64 0, i64 %tmp_65_cast
  %a_0_load_1 = load float* %a_0_addr_1, align 4
  %a_1_load_1 = load float* %a_1_addr_1, align 4
  %n_assign_1 = select i1 %tmp_54, float %a_1_load_1, float %a_0_load_1
  ...
  %tmp_69 = trunc i32 %n_assign_1_to_int to i23
  %notlhs = icmp ne i8 %tmp_34, -1
  %notrhs = icmp eq i23 %tmp_69, 0
  ...
  %empty_10 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str6, i32 %tmp_12) nounwind
...
_ifconv4:                                         ; preds = %.preheader12
  ...
  %tmp_57 = trunc i32 %r_load to i3
  %tmp_58 = call i33 @_ssdm_op_BitConcatenate.i33.i32.i1(i32 %r_load, i1 %tmp_40)
  %tmp_59 = sext i33 %tmp_58 to i64
  %a_0_addr = getelementptr [6 x float]* %a_0, i64 0, i64 %tmp_59
  %tmp_60 = add i3 %newIndex4_cast, %tmp_57
  %tmp_62_cast = sext i3 %tmp_60 to i64
  %a_1_addr = getelementptr [3 x float]* %a_1, i64 0, i64 %tmp_62_cast
  %a_0_load = load float* %a_0_addr, align 4
  %a_1_load = load float* %a_1_addr, align 4
  %pivot = select i1 %tmp_54, float %a_1_load, float %a_0_load
  %pivot_to_int = bitcast float %pivot to i32
  %tmp_9 = call i8 @_ssdm_op_PartSelect.i8.i32.i32.i32(i32 %pivot_to_int, i32 23, i32 30)
  %tmp_61 = trunc i32 %pivot_to_int to i23
  %notlhs1 = icmp ne i8 %tmp_9, -1
  %notrhs1 = icmp eq i23 %tmp_61, 0
  ...
  %tmp_62 = trunc i64 %tmp_5_to_int to i52
  %notlhs2 = icmp ne i11 %tmp_29, -1
  %notrhs2 = icmp eq i52 %tmp_62, 0
...
_ifconv1:                                         ; preds = %5
  ...
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str1) nounwind
  %tmp_94 = trunc i2 %j to i1
  %newIndex9_cast = zext i1 %tmp_94 to i3
  %tmp_72 = call i3 @_ssdm_op_BitConcatenate.i3.i2.i1(i2 %i_5, i1 %tmp_94)
  %tmp_73 = zext i3 %tmp_72 to i64
  %a_0_addr_4 = getelementptr [6 x float]* %a_0, i64 0, i64 %tmp_73
  %tmp_74 = call i33 @_ssdm_op_BitConcatenate.i33.i32.i1(i32 %r_load_2, i1 %tmp_94)
  %tmp_75 = sext i33 %tmp_74 to i64
  %a_0_addr_6 = getelementptr [6 x float]* %a_0, i64 0, i64 %tmp_75
  %tmp_76 = add i3 %tmp_3_cast, %newIndex9_cast
  %tmp_76_cast = zext i3 %tmp_76 to i64
  %a_1_addr_4 = getelementptr [3 x float]* %a_1, i64 0, i64 %tmp_76_cast
  %tmp_77 = add i3 %tmp_57, %newIndex9_cast
  %tmp_77_cast = sext i3 %tmp_77 to i64
  %a_1_addr_6 = getelementptr [3 x float]* %a_1, i64 0, i64 %tmp_77_cast
  %tmp_95 = call i1 @_ssdm_op_BitSelect.i1.i2.i32(i2 %j, i32 1)
  %a_0_load_4 = load float* %a_0_addr_4, align 4
  %a_1_load_4 = load float* %a_1_addr_4, align 4
  %w = select i1 %tmp_95, float %a_1_load_4, float %a_0_load_4
  %a_0_load_6 = load float* %a_0_addr_6, align 4
  %a_1_load_6 = load float* %a_1_addr_6, align 4
  %a_load_2_phi = select i1 %tmp_95, float %a_1_load_6, float %a_0_load_6
  br i1 %tmp_95, label %branch37, label %branch36

; <label>:6                                       ; preds = %branch37, %branch36
  %empty_12 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str7, i32 %tmp_21) nounwind
  br label %5
...
_ifconv2:                                         ; preds = %7
  ...
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str1) nounwind
  %tmp_96 = trunc i2 %i_2 to i1
  %newIndex2_cast = zext i1 %tmp_96 to i3
  %tmp_78 = call i3 @_ssdm_op_BitConcatenate.i3.i2.i1(i2 %i_5, i1 %tmp_96)
  %tmp_79 = zext i3 %tmp_78 to i64
  %a_0_addr_5 = getelementptr [6 x float]* %a_0, i64 0, i64 %tmp_79
  %tmp_80 = add i3 %newIndex2_cast, %tmp_3_cast
  %tmp_80_cast = zext i3 %tmp_80 to i64
  %a_1_addr_5 = getelementptr [3 x float]* %a_1, i64 0, i64 %tmp_80_cast
  %tmp_97 = call i1 @_ssdm_op_BitSelect.i1.i2.i32(i2 %i_2, i32 1)
  %a_0_load_5 = load float* %a_0_addr_5, align 4
  %a_1_load_5 = load float* %a_1_addr_5, align 4
  %a_load_5_phi = select i1 %tmp_97, float %a_1_load_5, float %a_0_load_5
  %tmp_13 = fdiv float %a_load_5_phi, %pivot
  br i1 %tmp_97, label %branch29, label %branch28

; <label>:8                                       ; preds = %branch29, %branch28
  %empty_14 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str8, i32 %tmp_22) nounwind
  br label %7
...
.preheader10:                                     ; preds = %._crit_edge, %.preheader10.preheader
  ...
  %i_9 = add i2 %i_3, 1
  br i1 %exitcond3, label %13, label %9
...
_ifconv3:                                         ; preds = %9
  %tmp_16 = zext i2 %i_3 to i64
  %tmp_16_cast = zext i2 %i_3 to i3
  %tmp_81 = call i3 @_ssdm_op_BitConcatenate.i3.i2.i1(i2 %i_3, i1 false)
  %tmp_82 = zext i3 %tmp_81 to i64
  %tmp_83 = call i3 @_ssdm_op_BitConcatenate.i3.i2.i1(i2 %i_3, i1 %tmp_40)
  %tmp_84 = zext i3 %tmp_83 to i64
  %a_0_addr_8 = getelementptr [6 x float]* %a_0, i64 0, i64 %tmp_84
  %a_0_addr_10 = getelementptr [6 x float]* %a_0, i64 0, i64 %tmp_82
  %tmp_85 = or i3 %tmp_81, 1
  %tmp_86 = call i64 @_ssdm_op_BitConcatenate.i64.i61.i3(i61 0, i3 %tmp_85)
  %a_0_addr_12 = getelementptr [6 x float]* %a_0, i64 0, i64 %tmp_86
  %tmp_87 = add i3 %tmp_16_cast, %newIndex4_cast
  %tmp_87_cast = zext i3 %tmp_87 to i64
  %a_1_addr_8 = getelementptr [3 x float]* %a_1, i64 0, i64 %tmp_87_cast
  %a_1_addr_10 = getelementptr [3 x float]* %a_1, i64 0, i64 %tmp_16
  %a_0_load_8 = load float* %a_0_addr_8, align 4
  %a_1_load_8 = load float* %a_1_addr_8, align 4
  %w_1 = select i1 %tmp_54, float %a_1_load_8, float %a_0_load_8
  %w_1_to_int = bitcast float %w_1 to i32
  %tmp_48 = call i8 @_ssdm_op_PartSelect.i8.i32.i32.i32(i32 %w_1_to_int, i32 23, i32 30)
  %tmp_98 = trunc i32 %w_1_to_int to i23
  %notlhs5 = icmp ne i8 %tmp_48, -1
  %notrhs5 = icmp eq i23 %tmp_98, 0
...
.preheader9.3:                                    ; preds = %12, %.preheader9.2
  ...
  br i1 %tmp_54, label %branch25, label %branch24
...
._crit_edge:                                      ; preds = %._crit_edge18, %9
  %empty_16 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str9, i32 %tmp_23) nounwind
  br label %.preheader10

; <label>:13                                      ; preds = %.preheader10
  %tmp_14 = fdiv float 1.000000e+00, %pivot
  br i1 %tmp_54, label %branch21, label %branch20
...
.preheader.preheader:                             ; preds = %.preheader8
  ...
  %tmp_55 = trunc i2 %i_4 to i1
  %newIndex6_cast = zext i1 %tmp_55 to i3
  %tmp_56 = call i1 @_ssdm_op_BitSelect.i1.i2.i32(i2 %i_4, i32 1)
  br label %.preheader

.preheader:                                       ; preds = %18, %.preheader.preheader
  %work_load = load i2* %work_addr_1, align 1
  %extLd8 = zext i2 %work_load to i3
...
_ifconv5:                                         ; preds = %.preheader
  ...
  %tmp_90 = call i3 @_ssdm_op_BitConcatenate.i3.i2.i1(i2 %work_load, i1 %tmp_55)
  %tmp_67 = zext i3 %tmp_90 to i64
  %a_0_addr_2 = getelementptr [6 x float]* %a_0, i64 0, i64 %tmp_67
  %tmp_68 = add i3 %extLd8, %newIndex6_cast
  %tmp_68_cast = sext i3 %tmp_68 to i64
  %a_1_addr_2 = getelementptr [3 x float]* %a_1, i64 0, i64 %tmp_68_cast
  ...
  %tmp_91 = trunc i2 %work_load to i1
  %newIndex7_cast = zext i1 %tmp_91 to i3
  %tmp_92 = call i3 @_ssdm_op_BitConcatenate.i3.i2.i1(i2 %work_load, i1 %tmp_91)
  %tmp_70 = zext i3 %tmp_92 to i64
  %a_0_addr_3 = getelementptr [6 x float]* %a_0, i64 0, i64 %tmp_70
  %tmp_71 = add i3 %extLd8, %newIndex7_cast
  %tmp_71_cast = sext i3 %tmp_71 to i64
  %a_1_addr_3 = getelementptr [3 x float]* %a_1, i64 0, i64 %tmp_71_cast
  %a_0_load_2 = load float* %a_0_addr_2, align 4
  %a_1_load_2 = load float* %a_1_addr_2, align 4
  %w_4_0_phi = select i1 %tmp_56, float %a_1_load_2, float %a_0_load_2
  %tmp_93 = call i1 @_ssdm_op_BitSelect.i1.i2.i32(i2 %work_load, i32 1)
  %a_0_load_3 = load float* %a_0_addr_3, align 4
  %a_1_load_3 = load float* %a_1_addr_3, align 4
  %a_load_4_0_phi = select i1 %tmp_93, float %a_1_load_3, float %a_0_load_3
  br i1 %tmp_56, label %branch17, label %branch16

; <label>:15                                      ; preds = %branch17, %branch16
  br i1 %tmp_93, label %branch5, label %branch4

_ifconv6:                                         ; preds = %branch5, %branch4
  %a_0_load_7 = load float* %a_0_addr_2, align 4
  %a_1_load_7 = load float* %a_1_addr_2, align 4
  %w_4_1_phi = select i1 %tmp_56, float %a_1_load_7, float %a_0_load_7
  br i1 %tmp_56, label %branch13, label %branch12

; <label>:16                                      ; preds = %branch13, %branch12
  br i1 %tmp_93, label %branch3, label %branch2

_ifconv7:                                         ; preds = %branch3, %branch2
  %a_0_load_13 = load float* %a_0_addr_2, align 4
  %a_1_load_9 = load float* %a_1_addr_2, align 4
  %w_4_2_phi = select i1 %tmp_56, float %a_1_load_9, float %a_0_load_13
  br i1 %tmp_56, label %branch9, label %branch8

; <label>:17                                      ; preds = %branch9, %branch8
  br i1 %tmp_93, label %branch1, label %branch0

; <label>:18                                      ; preds = %branch1, %branch0
  %empty_18 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str10, i32 %tmp_20) nounwind
  br label %.preheader
...
entry:
  ...
  %empty_21 = shl i2 1, %empty
  %empty_22 = and i2 %0, %empty_21
  %empty_23 = icmp ne i2 %empty_22, 0
  ret i1 %empty_23
}
...
entry:
  ...
  %empty_24 = zext i3 %1 to i64
  %empty_25 = shl i64 %empty, 3
...
entry:
  ...
  %empty_27 = zext i1 %1 to i33
  %empty_28 = shl i33 %empty, 1
  %empty_29 = or i33 %empty_28, %empty_27
  ret i33 %empty_29
}
...
entry:
  ...
  %empty_30 = zext i1 %1 to i3
  %empty_31 = shl i3 %empty, 1
  %empty_32 = or i3 %empty_31, %empty_30
  ret i3 %empty_32
}
