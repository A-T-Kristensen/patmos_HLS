; ModuleID = '/home/patmos/github/bachelor_project_HLS/hls/tacle-bench/kernel/minver_float/hls_minver_float/minver_2b_3x3/.autopilot/db/a.o.2.bc'
...
; [#uses=0]
define i32 @minver_hwa([3 x [2 x float]]* %"a[0]", [3 x [1 x float]]* %"a[1]") {
  call void (...)* @_ssdm_op_SpecBitsMap([3 x [1 x float]]* %"a[1]"), !map !49
  call void (...)* @_ssdm_op_SpecBitsMap([3 x [2 x float]]* %"a[0]"), !map !55
  ...
  call void @llvm.dbg.value(metadata !{[3 x [2 x float]]* %"a[0]"}, i64 0, metadata !67), !dbg !78 ; [debug line = 35:25] [debug variable = a[0]]
  call void @llvm.dbg.value(metadata !{[3 x [1 x float]]* %"a[1]"}, i64 0, metadata !79), !dbg !78 ; [debug line = 35:25] [debug variable = a[1]]
  call void (...)* @_ssdm_op_SpecMemCore([3 x [2 x float]]* %"a[0]", [3 x [1 x float]]* %"a[1]", [1 x i8]* @.str1, [12 x i8]* @.str2, [1 x i8]* @.str1, i32 -1, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1)
  call void (...)* @_ssdm_op_SpecInterface([3 x [2 x float]]* %"a[0]", [3 x [1 x float]]* %"a[1]", [5 x i8]* @.str3, i32 0, i32 0, [1 x i8]* @.str1, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind
  ...
  call void @llvm.dbg.declare(metadata !{[500 x i3]* %work}, metadata !82), !dbg !86 ; [debug line = 41:6] [debug variable = work]
  br label %1, !dbg !87                           ; [debug line = 50:9]

; <label>:1                                       ; preds = %3, %0
  %i = phi i2 [ 0, %0 ], [ %i.1, %3 ]             ; [#uses=4 type=i2]
  %exitcond7 = icmp eq i2 %i, -1, !dbg !87        ; [#uses=1 type=i1] [debug line = 50:9]
...
; <label>:3                                       ; preds = %1
  ...
  %tmp = zext i2 %i to i64, !dbg !96              ; [#uses=1 type=i64] [debug line = 52:2]
  %work.addr = getelementptr [500 x i3]* %work, i64 0, i64 %tmp, !dbg !96 ; [#uses=1 type=i3*] [debug line = 52:2]
  %i.cast13.cast = zext i2 %i to i3, !dbg !96     ; [#uses=1 type=i3] [debug line = 52:2]
  store i3 %i.cast13.cast, i3* %work.addr, align 1, !dbg !96 ; [debug line = 52:2]
  %4 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str5, i32 %tmp.6) nounwind, !dbg !97 ; [#uses=0 type=i32] [debug line = 53:3]
  %i.1 = add i2 %i, 1, !dbg !98                   ; [#uses=1 type=i2] [debug line = 50:23]
  call void @llvm.dbg.value(metadata !{i2 %i.1}, i64 0, metadata !99), !dbg !98 ; [debug line = 50:23] [debug variable = i]
  br label %1, !dbg !98                           ; [debug line = 50:23]

.preheader13:                                     ; preds = %26, %.preheader13.preheader
  %r = phi i32 [ %r.1.lcssa, %26 ], [ 0, %.preheader13.preheader ] ; [#uses=1 type=i32]
  %i.5 = phi i2 [ %k, %26 ], [ 0, %.preheader13.preheader ] ; [#uses=10 type=i2]
  %i.5.cast = zext i2 %i.5 to i32, !dbg !89       ; [#uses=2 type=i32] [debug line = 59:11]
  call void @llvm.dbg.value(metadata !{i2 %i.5}, i64 0, metadata !99), !dbg !89 ; [debug line = 59:11] [debug variable = i]
  %tmp.2 = icmp eq i2 %i.5, -1, !dbg !100         ; [#uses=1 type=i1] [debug line = 56:9]
  %5 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 1, i64 3, i64 2) nounwind ; [#uses=0 type=i32]
  br i1 %tmp.2, label %.preheader8.preheader, label %.preheader12.preheader, !dbg !100 ; [debug line = 56:9]

.preheader8.preheader:                            ; preds = %.preheader13
  br label %.preheader8, !dbg !101                ; [debug line = 109:9]

.preheader12.preheader:                           ; preds = %.preheader13
  %tmp.3 = zext i2 %i.5 to i64, !dbg !103         ; [#uses=10 type=i64] [debug line = 61:6]
  %newIndex3 = trunc i2 %i.5 to i1                ; [#uses=1 type=i1]
  %newIndex4 = zext i1 %newIndex3 to i64          ; [#uses=8 type=i64]
  %cond2 = icmp sgt i2 %i.5, -1, !dbg !103        ; [#uses=5 type=i1] [debug line = 61:6]
...
.preheader12:                                     ; preds = %_ifconv, %.preheader12.preheader
  ...
  %exitcond6 = icmp eq i32 %r.3, 3, !dbg !89      ; [#uses=1 type=i1] [debug line = 59:11]
...
_ifconv:                                          ; preds = %.preheader12
  ...
  %"a[0].addr.1" = getelementptr [3 x [2 x float]]* %"a[0]", i64 0, i64 %tmp.7, i64 %newIndex4, !dbg !103 ; [#uses=1 type=float*] [debug line = 61:6]
  %"a[1].addr.1" = getelementptr [3 x [1 x float]]* %"a[1]", i64 0, i64 %tmp.7, i64 %newIndex4, !dbg !103 ; [#uses=1 type=float*] [debug line = 61:6]
...
_ifconv4:                                         ; preds = %.preheader12
  ...
  %"a[0].addr" = getelementptr [3 x [2 x float]]* %"a[0]", i64 0, i64 %tmp.4, i64 %newIndex4, !dbg !127 ; [#uses=1 type=float*] [debug line = 68:5]
  %"a[1].addr" = getelementptr [3 x [1 x float]]* %"a[1]", i64 0, i64 %tmp.4, i64 %newIndex4, !dbg !127 ; [#uses=1 type=float*] [debug line = 68:5]
  ...
  br i1 %tmp.33, label %.loopexit.loopexit40, label %8, !dbg !137 ; [debug line = 70:5]
...
; <label>:9                                       ; preds = %8
  %work.addr.3 = getelementptr [500 x i3]* %work, i64 0, i64 %tmp.3, !dbg !139 ; [#uses=2 type=i3*] [debug line = 77:7]
  %work.load.2 = load i3* %work.addr.3, align 1   ; [#uses=1 type=i3]
  %work.addr.4 = getelementptr [500 x i3]* %work, i64 0, i64 %tmp.4, !dbg !141 ; [#uses=2 type=i3*] [debug line = 78:7]
  %work.load.3 = load i3* %work.addr.4, align 1   ; [#uses=1 type=i3]
  store i3 %work.load.3, i3* %work.addr.3, align 1, !dbg !141 ; [debug line = 78:7]
  store i3 %work.load.2, i3* %work.addr.4, align 1, !dbg !142 ; [debug line = 79:7]
  br label %10, !dbg !143                         ; [debug line = 80:13]

; <label>:10                                      ; preds = %13, %9
  %j = phi i2 [ 0, %9 ], [ %j.1, %13 ]            ; [#uses=4 type=i2]
  %exitcond5 = icmp eq i2 %j, -1, !dbg !143       ; [#uses=1 type=i1] [debug line = 80:13]
...
_ifconv1:                                         ; preds = %10
  ...
  %newIndex8 = trunc i2 %j to i1                  ; [#uses=1 type=i1]
  %newIndex9 = zext i1 %newIndex8 to i64          ; [#uses=4 type=i64]
  %"a[0].addr.4" = getelementptr [3 x [2 x float]]* %"a[0]", i64 0, i64 %tmp.3, i64 %newIndex9, !dbg !148 ; [#uses=2 type=float*] [debug line = 82:2]
  %"a[1].addr.4" = getelementptr [3 x [1 x float]]* %"a[1]", i64 0, i64 %tmp.3, i64 %newIndex9, !dbg !148 ; [#uses=2 type=float*] [debug line = 82:2]
  %cond4 = icmp sgt i2 %j, -1, !dbg !148          ; [#uses=4 type=i1] [debug line = 82:2]
  ...
  %"a[0].addr.6" = getelementptr [3 x [2 x float]]* %"a[0]", i64 0, i64 %tmp.4, i64 %newIndex9, !dbg !149 ; [#uses=2 type=float*] [debug line = 83:9]
  %"a[1].addr.6" = getelementptr [3 x [1 x float]]* %"a[1]", i64 0, i64 %tmp.4, i64 %newIndex9, !dbg !149 ; [#uses=2 type=float*] [debug line = 83:9]
  ...
  br i1 %cond4, label %branch36, label %branch37, !dbg !149 ; [debug line = 83:9]

; <label>:12                                      ; preds = %branch37, %branch36
  br i1 %cond4, label %branch32, label %branch33, !dbg !150 ; [debug line = 84:9]

; <label>:13                                      ; preds = %branch33, %branch32
  %14 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str7, i32 %tmp.21) nounwind, !dbg !151 ; [#uses=0 type=i32] [debug line = 85:7]
  %j.1 = add i2 %j, 1, !dbg !152                  ; [#uses=1 type=i2] [debug line = 80:27]
  call void @llvm.dbg.value(metadata !{i2 %j.1}, i64 0, metadata !153), !dbg !152 ; [debug line = 80:27] [debug variable = j]
  br label %10, !dbg !152                         ; [debug line = 80:27]

.loopexit11.loopexit:                             ; preds = %10
  br label %.loopexit11

.loopexit11:                                      ; preds = %.loopexit11.loopexit, %8
  br label %15, !dbg !154                         ; [debug line = 88:11]

; <label>:15                                      ; preds = %17, %.loopexit11
  %i.2 = phi i2 [ 0, %.loopexit11 ], [ %i.8, %17 ] ; [#uses=4 type=i2]
  %exitcond4 = icmp eq i2 %i.2, -1, !dbg !154     ; [#uses=1 type=i1] [debug line = 88:11]
...
.preheader10.preheader:                           ; preds = %15
  %tmp.24 = icmp eq i2 %i.5, 0, !dbg !156         ; [#uses=1 type=i1] [debug line = 99:13]
  %tmp.20.1 = icmp eq i2 %i.5, 1, !dbg !156       ; [#uses=1 type=i1] [debug line = 99:13]
  %tmp.20.2 = icmp eq i2 %i.5, -2, !dbg !156      ; [#uses=1 type=i1] [debug line = 99:13]
  %"a[1].addr.9" = getelementptr [3 x [1 x float]]* %"a[1]", i64 0, i64 %tmp.3, i64 0 ; [#uses=1 type=float*]
  %"a[0].addr.11" = getelementptr [3 x [2 x float]]* %"a[0]", i64 0, i64 %tmp.3, i64 1 ; [#uses=1 type=float*]
  %"a[0].addr.9" = getelementptr [3 x [2 x float]]* %"a[0]", i64 0, i64 %tmp.3, i64 0 ; [#uses=1 type=float*]
...
_ifconv2:                                         ; preds = %15
  ...
  %newIndex1 = trunc i2 %i.2 to i1                ; [#uses=1 type=i1]
  %newIndex2 = zext i1 %newIndex1 to i64          ; [#uses=2 type=i64]
  %"a[0].addr.5" = getelementptr [3 x [2 x float]]* %"a[0]", i64 0, i64 %tmp.3, i64 %newIndex2, !dbg !167 ; [#uses=2 type=float*] [debug line = 90:2]
  %"a[1].addr.5" = getelementptr [3 x [1 x float]]* %"a[1]", i64 0, i64 %tmp.3, i64 %newIndex2, !dbg !167 ; [#uses=2 type=float*] [debug line = 90:2]
  %cond5 = icmp sgt i2 %i.2, -1, !dbg !167        ; [#uses=2 type=i1] [debug line = 90:2]
  ...
  br i1 %cond5, label %branch28, label %branch29, !dbg !167 ; [debug line = 90:2]

; <label>:17                                      ; preds = %branch29, %branch28
  %18 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str8, i32 %tmp.22) nounwind, !dbg !168 ; [#uses=0 type=i32] [debug line = 91:5]
  %i.8 = add i2 %i.2, 1, !dbg !169                ; [#uses=1 type=i2] [debug line = 88:25]
  call void @llvm.dbg.value(metadata !{i2 %i.8}, i64 0, metadata !99), !dbg !169 ; [debug line = 88:25] [debug variable = i]
  br label %15, !dbg !169                         ; [debug line = 88:25]

.preheader10:                                     ; preds = %._crit_edge, %.preheader10.preheader
  %i.3 = phi i2 [ %i.9, %._crit_edge ], [ 0, %.preheader10.preheader ] ; [#uses=4 type=i2]
  %exitcond3 = icmp eq i2 %i.3, -1, !dbg !163     ; [#uses=1 type=i1] [debug line = 93:11]
  %19 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 3, i64 3, i64 3) nounwind ; [#uses=0 type=i32]
  br i1 %exitcond3, label %25, label %20, !dbg !163 ; [debug line = 93:11]
...
; <label>:20                                      ; preds = %.preheader10
  ...
  %tmp.15 = icmp eq i2 %i.3, %i.5, !dbg !172      ; [#uses=1 type=i1] [debug line = 95:2]
  br i1 %tmp.15, label %._crit_edge, label %_ifconv3, !dbg !172 ; [debug line = 95:2]

_ifconv3:                                         ; preds = %20
  %tmp.16 = zext i2 %i.3 to i64, !dbg !173        ; [#uses=5 type=i64] [debug line = 96:9]
  %"a[0].addr.8" = getelementptr [3 x [2 x float]]* %"a[0]", i64 0, i64 %tmp.16, i64 %newIndex4, !dbg !173 ; [#uses=2 type=float*] [debug line = 96:9]
  %"a[1].addr.8" = getelementptr [3 x [1 x float]]* %"a[1]", i64 0, i64 %tmp.16, i64 %newIndex4, !dbg !173 ; [#uses=2 type=float*] [debug line = 96:9]
  ...
  %w.1 = select i1 %cond2, float %"a[0].load.8", float %"a[1].load.8", !dbg !173 ; [#uses=6 type=float] [debug line = 96:9]
...
.preheader9.0:                                    ; preds = %_ifconv3
  br i1 %tmp.24, label %.preheader9.1, label %21, !dbg !156 ; [debug line = 99:13]
...
; <label>:21                                      ; preds = %.preheader9.0
  ...
  %"a[0].addr.10" = getelementptr [3 x [2 x float]]* %"a[0]", i64 0, i64 %tmp.16, i64 0 ; [#uses=2 type=float*]
...
.preheader9.1:                                    ; preds = %21, %.preheader9.0
  br i1 %tmp.20.1, label %.preheader9.2, label %22, !dbg !156 ; [debug line = 99:13]
...
; <label>:22                                      ; preds = %.preheader9.1
  ...
  %"a[0].addr.12" = getelementptr [3 x [2 x float]]* %"a[0]", i64 0, i64 %tmp.16, i64 1 ; [#uses=2 type=float*]
...
.preheader9.2:                                    ; preds = %22, %.preheader9.1
  br i1 %tmp.20.2, label %.preheader9.3, label %23, !dbg !156 ; [debug line = 99:13]
...
; <label>:23                                      ; preds = %.preheader9.2
  ...
  %"a[1].addr.10" = getelementptr [3 x [1 x float]]* %"a[1]", i64 0, i64 %tmp.16, i64 0 ; [#uses=2 type=float*]
...
.preheader9.3:                                    ; preds = %23, %.preheader9.2
  ...
  br i1 %cond2, label %branch24, label %branch25, !dbg !176 ; [debug line = 101:11]
...
._crit_edge:                                      ; preds = %._crit_edge18, %20
  %24 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str9, i32 %tmp.23) nounwind, !dbg !179 ; [#uses=0 type=i32] [debug line = 104:5]
  %i.9 = add i2 %i.3, 1, !dbg !180                ; [#uses=1 type=i2] [debug line = 93:25]
  call void @llvm.dbg.value(metadata !{i2 %i.9}, i64 0, metadata !99), !dbg !180 ; [debug line = 93:25] [debug variable = i]
...
; <label>:25                                      ; preds = %.preheader10
  ...
  %"a[0].addr.7" = getelementptr [3 x [2 x float]]* %"a[0]", i64 0, i64 %tmp.3, i64 %newIndex4, !dbg !128 ; [#uses=1 type=float*] [debug line = 105:5]
  %"a[1].addr.7" = getelementptr [3 x [1 x float]]* %"a[1]", i64 0, i64 %tmp.3, i64 %newIndex4, !dbg !128 ; [#uses=1 type=float*] [debug line = 105:5]
  br i1 %cond2, label %branch20, label %branch21, !dbg !128 ; [debug line = 105:5]

; <label>:26                                      ; preds = %branch21, %branch20
  %k = add i2 %i.5, 1, !dbg !181                  ; [#uses=1 type=i2] [debug line = 56:23]
  call void @llvm.dbg.value(metadata !{i2 %k}, i64 0, metadata !182), !dbg !181 ; [debug line = 56:23] [debug variable = k]
  br label %.preheader13, !dbg !181               ; [debug line = 56:23]

.preheader8:                                      ; preds = %33, %.preheader8.preheader
  %i.4 = phi i2 [ %i.7, %33 ], [ 0, %.preheader8.preheader ] ; [#uses=6 type=i2]
  %i.4.cast8.cast = zext i2 %i.4 to i3, !dbg !101 ; [#uses=1 type=i3] [debug line = 109:9]
  %exitcond1 = icmp eq i2 %i.4, -1, !dbg !101     ; [#uses=1 type=i1] [debug line = 109:9]
  %27 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 3, i64 3, i64 3) nounwind ; [#uses=0 type=i32]
...
.preheader.preheader:                             ; preds = %.preheader8
  %tmp. = zext i2 %i.4 to i64, !dbg !183          ; [#uses=1 type=i64] [debug line = 114:2]
  %work.addr.1 = getelementptr [500 x i3]* %work, i64 0, i64 %tmp., !dbg !183 ; [#uses=2 type=i3*] [debug line = 114:2]
  %newIndex5 = trunc i2 %i.4 to i1                ; [#uses=1 type=i1]
  %newIndex6 = zext i1 %newIndex5 to i64          ; [#uses=2 type=i64]
  %cond = icmp sgt i2 %i.4, -1, !dbg !186         ; [#uses=6 type=i1] [debug line = 123:9]
...
.preheader:                                       ; preds = %31, %.preheader.preheader
  ...
  %work.load = load i3* %work.addr.1, align 1     ; [#uses=5 type=i3]
  %tmp.8 = icmp eq i3 %work.load, %i.4.cast8.cast, !dbg !191 ; [#uses=1 type=i1] [debug line = 116:7]
  br i1 %tmp.8, label %33, label %_ifconv5, !dbg !191 ; [debug line = 116:7]

_ifconv5:                                         ; preds = %.preheader
  %tmp.10 = sext i3 %work.load to i64, !dbg !192  ; [#uses=5 type=i64] [debug line = 118:7]
  %work.addr.2 = getelementptr [500 x i3]* %work, i64 0, i64 %tmp.10, !dbg !192 ; [#uses=2 type=i3*] [debug line = 118:7]
  %work.load.1 = load i3* %work.addr.2, align 1   ; [#uses=1 type=i3]
  store i3 %work.load, i3* %work.addr.2, align 1, !dbg !193 ; [debug line = 119:7]
  store i3 %work.load.1, i3* %work.addr.1, align 1, !dbg !194 ; [debug line = 120:7]
  %"a[0].addr.2" = getelementptr [3 x [2 x float]]* %"a[0]", i64 0, i64 %tmp.10, i64 %newIndex6, !dbg !186 ; [#uses=6 type=float*] [debug line = 123:9]
  %"a[1].addr.2" = getelementptr [3 x [1 x float]]* %"a[1]", i64 0, i64 %tmp.10, i64 %newIndex6, !dbg !186 ; [#uses=6 type=float*] [debug line = 123:9]
  %newIndex = trunc i3 %work.load to i1           ; [#uses=1 type=i1]
  %newIndex7 = zext i1 %newIndex to i64           ; [#uses=2 type=i64]
  %"a[0].addr.3" = getelementptr [3 x [2 x float]]* %"a[0]", i64 0, i64 %tmp.10, i64 %newIndex7, !dbg !195 ; [#uses=4 type=float*] [debug line = 124:9]
  %"a[1].addr.3" = getelementptr [3 x [1 x float]]* %"a[1]", i64 0, i64 %tmp.10, i64 %newIndex7, !dbg !195 ; [#uses=4 type=float*] [debug line = 124:9]
  ...
  %cond3 = icmp ult i3 %work.load, 2, !dbg !195   ; [#uses=4 type=i1] [debug line = 124:9]
  ...
  br i1 %cond, label %branch16, label %branch17, !dbg !195 ; [debug line = 124:9]

; <label>:28                                      ; preds = %branch17, %branch16
...
_ifconv6:                                         ; preds = %branch5, %branch4
  ...
  br i1 %cond, label %branch12, label %branch13, !dbg !195 ; [debug line = 124:9]

; <label>:29                                      ; preds = %branch13, %branch12
...
_ifconv7:                                         ; preds = %branch3, %branch2
  ...
  %w.4.2.phi = select i1 %cond, float %"a[0].load.13", float %"a[1].load.9", !dbg !186 ; [#uses=2 type=float] [debug line = 123:9]
  br i1 %cond, label %branch8, label %branch9, !dbg !195 ; [debug line = 124:9]

; <label>:30                                      ; preds = %branch9, %branch8
  br i1 %cond3, label %branch0, label %branch1, !dbg !196 ; [debug line = 125:9]

; <label>:31                                      ; preds = %branch1, %branch0
  %32 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str10, i32 %tmp.20) nounwind, !dbg !197 ; [#uses=0 type=i32] [debug line = 127:5]
  br label %.preheader, !dbg !197                 ; [debug line = 127:5]

; <label>:33                                      ; preds = %.preheader
  %i.7 = add i2 %i.4, 1, !dbg !198                ; [#uses=1 type=i2] [debug line = 129:5]
  call void @llvm.dbg.value(metadata !{i2 %i.7}, i64 0, metadata !99), !dbg !198 ; [debug line = 129:5] [debug variable = i]
  br label %.preheader8, !dbg !199                ; [debug line = 130:3]

.loopexit.loopexit:                               ; preds = %.preheader8
  br label %.loopexit

.loopexit.loopexit40:                             ; preds = %_ifconv4
  br label %.loopexit

.loopexit:                                        ; preds = %.loopexit.loopexit40, %.loopexit.loopexit
  ret i32 1, !dbg !200                            ; [debug line = 133:1]

branch0:                                          ; preds = %30
  store float %w.4.2.phi, float* %"a[0].addr.3", align 4, !dbg !196 ; [debug line = 125:9]
  br label %31, !dbg !196                         ; [debug line = 125:9]
...
branch8:                                          ; preds = %_ifconv7
  ...
  br label %30, !dbg !195                         ; [debug line = 124:9]
...
branch12:                                         ; preds = %_ifconv6
  ...
  br label %29, !dbg !195                         ; [debug line = 124:9]
...
branch16:                                         ; preds = %_ifconv5
  ...
  br label %28, !dbg !195                         ; [debug line = 124:9]
...
branch20:                                         ; preds = %25
  ...
  br label %26, !dbg !128                         ; [debug line = 105:5]
...
branch24:                                         ; preds = %.preheader9.3
  ...
  br label %.preheader9.348, !dbg !176            ; [debug line = 101:11]
...
branch28:                                         ; preds = %_ifconv2
  ...
  br label %17, !dbg !167                         ; [debug line = 90:2]
...
branch32:                                         ; preds = %12
  ...
  br label %13, !dbg !150                         ; [debug line = 84:9]
...
branch36:                                         ; preds = %_ifconv1
  ...
  br label %12, !dbg !149                         ; [debug line = 83:9]
...
!73 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 96, i64 32, i32 0, i32 0, metadata !36, metadata !74, i32 0, i32 0} ; [ DW_TAG_array_type ]
!74 = metadata !{metadata !40}
!75 = metadata !{metadata !76}
!76 = metadata !{i32 786468}                      ; [ DW_TAG_base_type ]
!77 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 144, i64 32, i32 0, i32 0, metadata !36, metadata !39, i32 0, i32 0} ; [ DW_TAG_array_type ]
