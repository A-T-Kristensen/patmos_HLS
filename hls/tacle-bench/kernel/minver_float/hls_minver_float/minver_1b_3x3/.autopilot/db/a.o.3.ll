; ModuleID = '/home/patmos/github/bachelor_project_HLS/hls/tacle-bench/kernel/minver_float/hls_minver_float/minver_1b_3x3/.autopilot/db/a.o.3.bc'
...
define i32 @minver_hwa([9 x float]* %a) nounwind uwtable {
  ...
  call void @llvm.dbg.value(metadata !{[9 x float]* %a}, i64 0, metadata !41), !dbg !57 ; [debug line = 35:25] [debug variable = a]
  ...
  call void @llvm.dbg.declare(metadata !{[500 x i2]* %work}, metadata !60), !dbg !64 ; [debug line = 41:6] [debug variable = work]
  br label %1, !dbg !65                           ; [debug line = 50:9]

; <label>:1                                       ; preds = %2, %0
  %i = phi i2 [ 0, %0 ], [ %i_1, %2 ]             ; [#uses=4 type=i2]
  %exitcond7 = icmp eq i2 %i, -1, !dbg !65        ; [#uses=1 type=i1] [debug line = 50:9]
  %i_1 = add i2 %i, 1, !dbg !67                   ; [#uses=1 type=i2] [debug line = 50:23]
...
; <label>:2                                       ; preds = %1
  ...
  %tmp = zext i2 %i to i64, !dbg !74              ; [#uses=1 type=i64] [debug line = 52:2]
  %work_addr = getelementptr [500 x i2]* %work, i64 0, i64 %tmp, !dbg !74 ; [#uses=1 type=i2*] [debug line = 52:2]
  store i2 %i, i2* %work_addr, align 1, !dbg !74  ; [debug line = 52:2]
  %empty_7 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str4, i32 %tmp_6) nounwind, !dbg !75 ; [#uses=0 type=i32] [debug line = 53:3]
  call void @llvm.dbg.value(metadata !{i2 %i_1}, i64 0, metadata !76), !dbg !67 ; [debug line = 50:23] [debug variable = i]
  br label %1, !dbg !67                           ; [debug line = 50:23]

.preheader13:                                     ; preds = %14, %.preheader13.preheader
  %i_5 = phi i2 [ %k, %14 ], [ 0, %.preheader13.preheader ] ; [#uses=10 type=i2]
  %tmp_2 = icmp eq i2 %i_5, -1, !dbg !69          ; [#uses=1 type=i1] [debug line = 56:9]
  %k = add i2 %i_5, 1, !dbg !77                   ; [#uses=1 type=i2] [debug line = 56:23]
...
.preheader12.preheader:                           ; preds = %.preheader13
  %i_5_cast6 = zext i2 %i_5 to i32, !dbg !80      ; [#uses=2 type=i32] [debug line = 59:11]
  call void @llvm.dbg.value(metadata !{i2 %i_5}, i64 0, metadata !76), !dbg !80 ; [debug line = 59:11] [debug variable = i]
  %empty_8 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 1, i64 3, i64 2) nounwind ; [#uses=0 type=i32]
  %tmp_3 = zext i2 %i_5 to i64, !dbg !83          ; [#uses=1 type=i64] [debug line = 61:6]
  %tmp_3_cast = zext i2 %i_5 to i5                ; [#uses=4 type=i5]
  %tmp_7 = call i4 @_ssdm_op_BitConcatenate.i4.i2.i2(i2 %i_5, i2 0) ; [#uses=2 type=i4]
  %p_shl = zext i4 %tmp_7 to i64, !dbg !85        ; [#uses=1 type=i64] [debug line = 82:2]
  %p_shl_cast = zext i4 %tmp_7 to i5, !dbg !85    ; [#uses=1 type=i5] [debug line = 82:2]
  %tmp_11 = sub i5 %p_shl_cast, %tmp_3_cast, !dbg !85 ; [#uses=5 type=i5] [debug line = 82:2]
  %tmp_56_cast = sext i5 %tmp_11 to i64, !dbg !85 ; [#uses=1 type=i64] [debug line = 82:2]
  %tmp_12 = add i5 %tmp_11, 2, !dbg !89           ; [#uses=1 type=i5] [debug line = 99:27]
  %tmp_57_cast = sext i5 %tmp_12 to i64, !dbg !89 ; [#uses=1 type=i64] [debug line = 99:27]
  %a_addr_13 = getelementptr [9 x float]* %a, i64 0, i64 %tmp_57_cast, !dbg !89 ; [#uses=1 type=float*] [debug line = 99:27]
  %tmp_16 = add i5 %tmp_11, 1, !dbg !89           ; [#uses=1 type=i5] [debug line = 99:27]
  %tmp_58_cast = sext i5 %tmp_16 to i64, !dbg !89 ; [#uses=1 type=i64] [debug line = 99:27]
  %a_addr_11 = getelementptr [9 x float]* %a, i64 0, i64 %tmp_58_cast, !dbg !89 ; [#uses=1 type=float*] [debug line = 99:27]
  %a_addr_9 = getelementptr [9 x float]* %a, i64 0, i64 %tmp_56_cast, !dbg !89 ; [#uses=1 type=float*] [debug line = 99:27]
  %a_addr_7 = getelementptr [9 x float]* %a, i64 0, i64 %p_shl, !dbg !96 ; [#uses=1 type=float*] [debug line = 105:5]
...
.preheader12:                                     ; preds = %_ifconv, %.preheader12.preheader
  ...
  %r_1 = phi i32 [ %i_6, %_ifconv ], [ %i_5_cast6, %.preheader12.preheader ] ; [#uses=5 type=i32]
  %exitcond6 = icmp eq i32 %r_1, 3, !dbg !80      ; [#uses=1 type=i1] [debug line = 59:11]
...
_ifconv:                                          ; preds = %.preheader12
  ...
  %tmp_55 = trunc i32 %r_1 to i5                  ; [#uses=1 type=i5]
  %tmp_56 = trunc i32 %r_1 to i3                  ; [#uses=1 type=i3]
  %p_shl2_cast = call i5 @_ssdm_op_BitConcatenate.i5.i3.i2(i3 %tmp_56, i2 0), !dbg !83 ; [#uses=1 type=i5] [debug line = 61:6]
  %tmp_57 = sub i5 %p_shl2_cast, %tmp_55, !dbg !83 ; [#uses=1 type=i5] [debug line = 61:6]
  %tmp_58 = add i5 %tmp_3_cast, %tmp_57, !dbg !83 ; [#uses=1 type=i5] [debug line = 61:6]
  %tmp_64_cast = sext i5 %tmp_58 to i64, !dbg !83 ; [#uses=1 type=i64] [debug line = 61:6]
  %a_addr_1 = getelementptr [9 x float]* %a, i64 0, i64 %tmp_64_cast, !dbg !83 ; [#uses=1 type=float*] [debug line = 61:6]
  %a_load_7 = load float* %a_addr_1, align 4, !dbg !83 ; [#uses=3 type=float] [debug line = 61:6]
  call void @llvm.dbg.value(metadata !{float %a_load_7}, i64 0, metadata !100), !dbg !106 ; [debug line = 8:31@61:6] [debug variable = n]
  %n_assign_1_to_int = bitcast float %a_load_7 to i32 ; [#uses=3 type=i32]
  %tmp_36 = call i8 @_ssdm_op_PartSelect.i8.i32.i32.i32(i32 %n_assign_1_to_int, i32 23, i32 30) ; [#uses=1 type=i8]
  %tmp_59 = trunc i32 %n_assign_1_to_int to i23   ; [#uses=1 type=i23]
  %notlhs = icmp ne i8 %tmp_36, -1                ; [#uses=1 type=i1]
  %notrhs = icmp eq i23 %tmp_59, 0                ; [#uses=1 type=i1]
  %tmp_38 = or i1 %notrhs, %notlhs                ; [#uses=1 type=i1]
  %tmp_39 = fcmp oge float %a_load_7, 0.000000e+00, !dbg !107 ; [#uses=1 type=i1] [debug line = 11:3@61:6]
  ...
  %w_3 = select i1 %tmp_40, float %a_load_7, float %f_1, !dbg !111 ; [#uses=3 type=float] [debug line = 63:9]
  ...
  %tmp_60 = trunc i32 %w_3_to_int to i23          ; [#uses=1 type=i23]
  ...
  %tmp_61 = trunc i32 %wmax_to_int to i23         ; [#uses=1 type=i23]
  %notlhs3 = icmp ne i8 %tmp_41, -1               ; [#uses=1 type=i1]
  %notrhs3 = icmp eq i23 %tmp_60, 0               ; [#uses=1 type=i1]
  %tmp_45 = or i1 %notrhs3, %notlhs3              ; [#uses=1 type=i1]
  %notlhs4 = icmp ne i8 %tmp_43, -1               ; [#uses=1 type=i1]
  %notrhs4 = icmp eq i23 %tmp_61, 0               ; [#uses=1 type=i1]
...
_ifconv1:                                         ; preds = %.preheader12
  ...
  %tmp_17 = trunc i32 %r_load to i5               ; [#uses=1 type=i5]
  %tmp_32 = trunc i32 %r_load to i3               ; [#uses=1 type=i3]
  %p_shl3_cast = call i5 @_ssdm_op_BitConcatenate.i5.i3.i2(i3 %tmp_32, i2 0), !dbg !118 ; [#uses=1 type=i5] [debug line = 68:5]
  %tmp_37 = sub i5 %p_shl3_cast, %tmp_17, !dbg !118 ; [#uses=2 type=i5] [debug line = 68:5]
  %tmp_42 = add i5 %tmp_3_cast, %tmp_37, !dbg !118 ; [#uses=1 type=i5] [debug line = 68:5]
  %tmp_61_cast = sext i5 %tmp_42 to i64, !dbg !118 ; [#uses=1 type=i64] [debug line = 68:5]
  %a_addr = getelementptr [9 x float]* %a, i64 0, i64 %tmp_61_cast, !dbg !118 ; [#uses=1 type=float*] [debug line = 68:5]
  ...
  %tmp_44 = trunc i32 %pivot_to_int to i23        ; [#uses=1 type=i23]
  %notlhs1 = icmp ne i8 %tmp_9, -1                ; [#uses=1 type=i1]
  %notrhs1 = icmp eq i23 %tmp_44, 0               ; [#uses=1 type=i1]
  ...
  %tmp_51 = trunc i64 %tmp_5_to_int to i52        ; [#uses=1 type=i52]
  %notlhs2 = icmp ne i11 %tmp_31, -1              ; [#uses=1 type=i1]
  %notrhs2 = icmp eq i52 %tmp_51, 0               ; [#uses=1 type=i1]
  ...
  br i1 %tmp_35, label %.loopexit.loopexit22, label %3, !dbg !127 ; [debug line = 70:5]
...
; <label>:4                                       ; preds = %3
  %work_addr_3 = getelementptr [500 x i2]* %work, i64 0, i64 %tmp_3, !dbg !129 ; [#uses=2 type=i2*] [debug line = 77:7]
  %work_load_2 = load i2* %work_addr_3, align 1   ; [#uses=1 type=i2]
  %work_addr_4 = getelementptr [500 x i2]* %work, i64 0, i64 %tmp_4, !dbg !130 ; [#uses=2 type=i2*] [debug line = 78:7]
  %work_load_3 = load i2* %work_addr_4, align 1   ; [#uses=1 type=i2]
  store i2 %work_load_3, i2* %work_addr_3, align 1, !dbg !130 ; [debug line = 78:7]
  store i2 %work_load_2, i2* %work_addr_4, align 1, !dbg !131 ; [debug line = 79:7]
  br label %5, !dbg !132                          ; [debug line = 80:13]

; <label>:5                                       ; preds = %6, %4
  %j = phi i2 [ 0, %4 ], [ %j_1, %6 ]             ; [#uses=3 type=i2]
  %exitcond5 = icmp eq i2 %j, -1, !dbg !132       ; [#uses=1 type=i1] [debug line = 80:13]
  %j_1 = add i2 %j, 1, !dbg !133                  ; [#uses=1 type=i2] [debug line = 80:27]
...
; <label>:6                                       ; preds = %5
  ...
  %tmp_11_cast = zext i2 %j to i5, !dbg !85       ; [#uses=2 type=i5] [debug line = 82:2]
  %tmp_66 = add i5 %tmp_11, %tmp_11_cast, !dbg !85 ; [#uses=1 type=i5] [debug line = 82:2]
  %tmp_68_cast = sext i5 %tmp_66 to i64, !dbg !85 ; [#uses=1 type=i64] [debug line = 82:2]
  %a_addr_4 = getelementptr [9 x float]* %a, i64 0, i64 %tmp_68_cast, !dbg !85 ; [#uses=2 type=float*] [debug line = 82:2]
  %tmp_67 = add i5 %tmp_37, %tmp_11_cast, !dbg !136 ; [#uses=1 type=i5] [debug line = 83:9]
  %tmp_69_cast = sext i5 %tmp_67 to i64, !dbg !136 ; [#uses=1 type=i64] [debug line = 83:9]
  %a_addr_5 = getelementptr [9 x float]* %a, i64 0, i64 %tmp_69_cast, !dbg !136 ; [#uses=2 type=float*] [debug line = 83:9]
  ...
  call void @llvm.dbg.value(metadata !{i2 %j_1}, i64 0, metadata !139), !dbg !133 ; [debug line = 80:27] [debug variable = j]
...
; <label>:7                                       ; preds = %8, %.loopexit11
  %i_2 = phi i2 [ 0, %.loopexit11 ], [ %i_8, %8 ] ; [#uses=3 type=i2]
  %exitcond4 = icmp eq i2 %i_2, -1, !dbg !140     ; [#uses=1 type=i1] [debug line = 88:11]
  %i_8 = add i2 %i_2, 1, !dbg !142                ; [#uses=1 type=i2] [debug line = 88:25]
  br i1 %exitcond4, label %.preheader10.preheader, label %8, !dbg !140 ; [debug line = 88:11]

.preheader10.preheader:                           ; preds = %7
  %tmp_26 = icmp eq i2 %i_5, 0, !dbg !143         ; [#uses=1 type=i1] [debug line = 99:13]
  %tmp_20_1 = icmp eq i2 %i_5, 1, !dbg !143       ; [#uses=1 type=i1] [debug line = 99:13]
  %tmp_20_2 = icmp eq i2 %i_5, -2, !dbg !143      ; [#uses=1 type=i1] [debug line = 99:13]
...
; <label>:8                                       ; preds = %7
  ...
  %tmp_12_cast = zext i2 %i_2 to i5, !dbg !148    ; [#uses=1 type=i5] [debug line = 90:2]
  %tmp_68 = add i5 %tmp_11, %tmp_12_cast, !dbg !148 ; [#uses=1 type=i5] [debug line = 90:2]
  %tmp_70_cast = sext i5 %tmp_68 to i64, !dbg !148 ; [#uses=1 type=i64] [debug line = 90:2]
  %a_addr_6 = getelementptr [9 x float]* %a, i64 0, i64 %tmp_70_cast, !dbg !148 ; [#uses=2 type=float*] [debug line = 90:2]
  ...
  call void @llvm.dbg.value(metadata !{i2 %i_8}, i64 0, metadata !76), !dbg !142 ; [debug line = 88:25] [debug variable = i]
  br label %7, !dbg !142                          ; [debug line = 88:25]

.preheader10:                                     ; preds = %._crit_edge, %.preheader10.preheader
  %i_3 = phi i2 [ %i_9, %._crit_edge ], [ 0, %.preheader10.preheader ] ; [#uses=5 type=i2]
  %exitcond3 = icmp eq i2 %i_3, -1, !dbg !144     ; [#uses=1 type=i1] [debug line = 93:11]
  %i_9 = add i2 %i_3, 1, !dbg !150                ; [#uses=1 type=i2] [debug line = 93:25]
  br i1 %exitcond3, label %14, label %9, !dbg !144 ; [debug line = 93:11]
...
; <label>:9                                       ; preds = %.preheader10
  ...
  %tmp_15 = icmp eq i2 %i_3, %i_5, !dbg !153      ; [#uses=1 type=i1] [debug line = 95:2]
  br i1 %tmp_15, label %._crit_edge, label %10, !dbg !153 ; [debug line = 95:2]

; <label>:10                                      ; preds = %9
  %tmp_16_cast = zext i2 %i_3 to i5               ; [#uses=1 type=i5]
  %tmp_69 = call i4 @_ssdm_op_BitConcatenate.i4.i2.i2(i2 %i_3, i2 0) ; [#uses=1 type=i4]
  %p_shl4_cast = zext i4 %tmp_69 to i5, !dbg !154 ; [#uses=1 type=i5] [debug line = 96:9]
  %tmp_70 = sub i5 %p_shl4_cast, %tmp_16_cast, !dbg !154 ; [#uses=4 type=i5] [debug line = 96:9]
  %tmp_72_cast = sext i5 %tmp_70 to i64, !dbg !154 ; [#uses=1 type=i64] [debug line = 96:9]
  %tmp_71 = add i5 %tmp_3_cast, %tmp_70, !dbg !154 ; [#uses=1 type=i5] [debug line = 96:9]
  %tmp_73_cast = sext i5 %tmp_71 to i64, !dbg !154 ; [#uses=1 type=i64] [debug line = 96:9]
  %a_addr_8 = getelementptr [9 x float]* %a, i64 0, i64 %tmp_73_cast, !dbg !154 ; [#uses=2 type=float*] [debug line = 96:9]
  %a_addr_10 = getelementptr [9 x float]* %a, i64 0, i64 %tmp_72_cast, !dbg !89 ; [#uses=2 type=float*] [debug line = 99:27]
  %tmp_72 = add i5 1, %tmp_70, !dbg !89           ; [#uses=1 type=i5] [debug line = 99:27]
  %tmp_74_cast = sext i5 %tmp_72 to i64, !dbg !89 ; [#uses=1 type=i64] [debug line = 99:27]
  %a_addr_12 = getelementptr [9 x float]* %a, i64 0, i64 %tmp_74_cast, !dbg !89 ; [#uses=2 type=float*] [debug line = 99:27]
  %tmp_73 = add i5 2, %tmp_70, !dbg !89           ; [#uses=1 type=i5] [debug line = 99:27]
  %tmp_75_cast = sext i5 %tmp_73 to i64, !dbg !89 ; [#uses=1 type=i64] [debug line = 99:27]
  %a_addr_14 = getelementptr [9 x float]* %a, i64 0, i64 %tmp_75_cast, !dbg !89 ; [#uses=2 type=float*] [debug line = 99:27]
  %w_2 = load float* %a_addr_8, align 4, !dbg !154 ; [#uses=5 type=float] [debug line = 96:9]
  ...
  %tmp_74 = trunc i32 %w_2_to_int to i23          ; [#uses=1 type=i23]
  %notlhs5 = icmp ne i8 %tmp_50, -1               ; [#uses=1 type=i1]
  %notrhs5 = icmp eq i23 %tmp_74, 0               ; [#uses=1 type=i1]
...
; <label>:11                                      ; preds = %.preheader9.0
  %a_load_9 = load float* %a_addr_9, align 4, !dbg !89 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp_27 = fmul float %w_2, %a_load_9, !dbg !89  ; [#uses=1 type=float] [debug line = 99:27]
  %a_load_10 = load float* %a_addr_10, align 4, !dbg !89 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp_28 = fsub float %a_load_10, %tmp_27, !dbg !89 ; [#uses=1 type=float] [debug line = 99:27]
...
; <label>:12                                      ; preds = %.preheader9.1
  %a_load_11 = load float* %a_addr_11, align 4, !dbg !89 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp_22_1 = fmul float %w_2, %a_load_11, !dbg !89 ; [#uses=1 type=float] [debug line = 99:27]
  %a_load_12 = load float* %a_addr_12, align 4, !dbg !89 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp_23_1 = fsub float %a_load_12, %tmp_22_1, !dbg !89 ; [#uses=1 type=float] [debug line = 99:27]
...
; <label>:13                                      ; preds = %.preheader9.2
  %a_load_13 = load float* %a_addr_13, align 4, !dbg !89 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp_22_2 = fmul float %w_2, %a_load_13, !dbg !89 ; [#uses=1 type=float] [debug line = 99:27]
  %a_load_14 = load float* %a_addr_14, align 4, !dbg !89 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp_23_2 = fsub float %a_load_14, %tmp_22_2, !dbg !89 ; [#uses=1 type=float] [debug line = 99:27]
...
._crit_edge:                                      ; preds = %._crit_edge18, %9
  ...
  call void @llvm.dbg.value(metadata !{i2 %i_9}, i64 0, metadata !76), !dbg !150 ; [debug line = 93:25] [debug variable = i]
...
; <label>:14                                      ; preds = %.preheader10
  ...
  call void @llvm.dbg.value(metadata !{i2 %k}, i64 0, metadata !160), !dbg !77 ; [debug line = 56:23] [debug variable = k]
...
.preheader8:                                      ; preds = %.preheader8.loopexit, %.preheader8.preheader
  ...
  %exitcond1 = icmp eq i2 %i_4, -1, !dbg !78      ; [#uses=1 type=i1] [debug line = 109:9]
  %i_7 = add i2 %i_4, 1, !dbg !161                ; [#uses=1 type=i2] [debug line = 129:5]
  call void @llvm.dbg.value(metadata !{i2 %i_7}, i64 0, metadata !76), !dbg !161 ; [debug line = 129:5] [debug variable = i]
...
.preheader.preheader:                             ; preds = %.preheader8
  ...
  %tmp_s = zext i2 %i_4 to i64, !dbg !163         ; [#uses=1 type=i64] [debug line = 114:2]
  %tmp_cast = zext i2 %i_4 to i5, !dbg !163       ; [#uses=1 type=i5] [debug line = 114:2]
  %work_addr_1 = getelementptr [500 x i2]* %work, i64 0, i64 %tmp_s, !dbg !163 ; [#uses=2 type=i2*] [debug line = 114:2]
...
.preheader:                                       ; preds = %15, %.preheader.preheader
  ...
  %tmp_8 = icmp eq i2 %work_load, %i_4, !dbg !166 ; [#uses=1 type=i1] [debug line = 116:7]
  br i1 %tmp_8, label %.preheader8.loopexit, label %15, !dbg !166 ; [debug line = 116:7]
...
; <label>:15                                      ; preds = %.preheader
  ...
  %tmp_10 = zext i2 %work_load to i64, !dbg !168  ; [#uses=1 type=i64] [debug line = 118:7]
  %tmp_10_cast = zext i2 %work_load to i5         ; [#uses=1 type=i5]
  %tmp_62 = call i4 @_ssdm_op_BitConcatenate.i4.i2.i2(i2 %work_load, i2 0) ; [#uses=2 type=i4]
  %tmp_63 = zext i4 %tmp_62 to i5                 ; [#uses=1 type=i5]
  %p_shl5 = zext i4 %tmp_62 to i64, !dbg !169     ; [#uses=1 type=i64] [debug line = 123:9]
  %tmp_64 = sub i5 %tmp_63, %tmp_10_cast, !dbg !169 ; [#uses=1 type=i5] [debug line = 123:9]
  %tmp_65 = add i5 %tmp_cast, %tmp_64, !dbg !169  ; [#uses=1 type=i5] [debug line = 123:9]
  %tmp_67_cast = sext i5 %tmp_65 to i64, !dbg !169 ; [#uses=1 type=i64] [debug line = 123:9]
  %a_addr_2 = getelementptr [9 x float]* %a, i64 0, i64 %tmp_67_cast, !dbg !169 ; [#uses=6 type=float*] [debug line = 123:9]
  %a_addr_3 = getelementptr [9 x float]* %a, i64 0, i64 %p_shl5, !dbg !172 ; [#uses=4 type=float*] [debug line = 124:9]
  %work_addr_2 = getelementptr [500 x i2]* %work, i64 0, i64 %tmp_10, !dbg !168 ; [#uses=2 type=i2*] [debug line = 118:7]
  %work_load_1 = load i2* %work_addr_2, align 1   ; [#uses=1 type=i2]
  store i2 %work_load, i2* %work_addr_2, align 1, !dbg !173 ; [debug line = 119:7]
  store i2 %work_load_1, i2* %work_addr_1, align 1, !dbg !174 ; [debug line = 120:7]
  ...
  %a_load_6 = load float* %a_addr_2, align 4, !dbg !169 ; [#uses=1 type=float] [debug line = 123:9]
...
entry:
  ...
  %empty_21 = zext i2 %1 to i5                    ; [#uses=1 type=i5]
  %empty_22 = shl i5 %empty, 2                    ; [#uses=1 type=i5]
...
!48 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 96, i64 32, i32 0, i32 0, metadata !49, metadata !51, i32 0, i32 0} ; [ DW_TAG_array_type ]
...
!55 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 288, i64 32, i32 0, i32 0, metadata !49, metadata !56, i32 0, i32 0} ; [ DW_TAG_array_type ]
