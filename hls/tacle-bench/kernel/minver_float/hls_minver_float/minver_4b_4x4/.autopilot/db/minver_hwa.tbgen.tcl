set C_TypeInfoList {{ 
"minver_hwa" : [[], {"return": [[], {"scalar": "int"}] }, [{"ExternC" : 0}], [ {"a": [[], {"array": [ {"array": ["0", [4]]}, [4]]}] }],[],""], 
...
set C_modelArgList {
	{ a_0 float 32 regular {bram 4 { 2 } 1 1 }  }
	{ a_1 float 32 regular {bram 4 { 2 } 1 1 }  }
	{ a_2 float 32 regular {bram 4 { 2 } 1 1 }  }
	{ a_3 float 32 regular {bram 4 { 2 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "a_0", "interface" : "bram", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "a","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 3,"step" : 1},{"low" : 0,"up" : 0,"step" : 2}]}]}]} , 
 	{ "Name" : "a_1", "interface" : "bram", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "a","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 3,"step" : 1},{"low" : 1,"up" : 1,"step" : 2}]}]}]} , 
 	{ "Name" : "a_2", "interface" : "bram", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "a","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 3,"step" : 1},{"low" : 2,"up" : 2,"step" : 2}]}]}]} , 
 	{ "Name" : "a_3", "interface" : "bram", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "a","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 3,"step" : 1},{"low" : 3,"up" : 3,"step" : 2}]}]}]} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "6", "7", "8", "9"],
		...
		{"Name" : "a_0", "Type" : "Bram", "Direction" : "IO",
			"SubConnect" : [
			{"ID" : "2", "SubInstance" : "grp_aesl_mux_load_4_4_x_s_fu_414", "Port" : "empty_7"}]},
		{"Name" : "a_1", "Type" : "Bram", "Direction" : "IO",
			"SubConnect" : [
			{"ID" : "2", "SubInstance" : "grp_aesl_mux_load_4_4_x_s_fu_414", "Port" : "empty_8"}]},
		{"Name" : "a_2", "Type" : "Bram", "Direction" : "IO",
			"SubConnect" : [
			{"ID" : "2", "SubInstance" : "grp_aesl_mux_load_4_4_x_s_fu_414", "Port" : "empty_9"}]},
		{"Name" : "a_3", "Type" : "Bram", "Direction" : "IO",
			"SubConnect" : [
			{"ID" : "2", "SubInstance" : "grp_aesl_mux_load_4_4_x_s_fu_414", "Port" : "empty_10"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.work_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_aesl_mux_load_4_4_x_s_fu_414", "Parent" : "0",
	...
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.minver_hwa_fsub_3ncg_U3", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.minver_hwa_fmul_3ocq_U4", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.minver_hwa_fdiv_3pcA_U5", "Parent" : "0"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.minver_hwa_fpext_qcK_U6", "Parent" : "0"},
	{"ID" : "7", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.minver_hwa_fcmp_3rcU_U7", "Parent" : "0"},
	{"ID" : "8", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.minver_hwa_fcmp_3rcU_U8", "Parent" : "0"},
	{"ID" : "9", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.minver_hwa_dcmp_6sc4_U9", "Parent" : "0"}]}
