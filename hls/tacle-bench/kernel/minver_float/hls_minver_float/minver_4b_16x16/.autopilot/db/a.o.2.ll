...
; [#uses=0]
define i32 @minver_hwa([16 x [4 x float]]* %"a[0]", [16 x [4 x float]]* %"a[1]", [16 x [4 x float]]* %"a[2]", [16 x [4 x float]]* %"a[3]") {
  call void (...)* @_ssdm_op_SpecBitsMap([16 x [4 x float]]* %"a[3]"), !map !49
  call void (...)* @_ssdm_op_SpecBitsMap([16 x [4 x float]]* %"a[2]"), !map !55
  call void (...)* @_ssdm_op_SpecBitsMap([16 x [4 x float]]* %"a[1]"), !map !61
  call void (...)* @_ssdm_op_SpecBitsMap([16 x [4 x float]]* %"a[0]"), !map !67
  ...
  call void @llvm.dbg.value(metadata !{[16 x [4 x float]]* %"a[0]"}, i64 0, metadata !79), !dbg !90 ; [debug line = 35:25] [debug variable = a[0]]
  call void @llvm.dbg.value(metadata !{[16 x [4 x float]]* %"a[1]"}, i64 0, metadata !91), !dbg !90 ; [debug line = 35:25] [debug variable = a[1]]
  call void @llvm.dbg.value(metadata !{[16 x [4 x float]]* %"a[2]"}, i64 0, metadata !92), !dbg !90 ; [debug line = 35:25] [debug variable = a[2]]
  call void @llvm.dbg.value(metadata !{[16 x [4 x float]]* %"a[3]"}, i64 0, metadata !93), !dbg !90 ; [debug line = 35:25] [debug variable = a[3]]
  call void (...)* @_ssdm_op_SpecMemCore([16 x [4 x float]]* %"a[0]", [16 x [4 x float]]* %"a[1]", [16 x [4 x float]]* %"a[2]", [16 x [4 x float]]* %"a[3]", [1 x i8]* @.str1, [12 x i8]* @.str2, [1 x i8]* @.str1, i32 -1, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1)
  call void (...)* @_ssdm_op_SpecInterface([16 x [4 x float]]* %"a[0]", [16 x [4 x float]]* %"a[1]", [16 x [4 x float]]* %"a[2]", [16 x [4 x float]]* %"a[3]", [5 x i8]* @.str3, i32 0, i32 0, [1 x i8]* @.str1, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1) nounwind
  ...
  call void @llvm.dbg.declare(metadata !{[500 x i6]* %work}, metadata !96), !dbg !100 ; [debug line = 41:6] [debug variable = work]
  br label %1, !dbg !101                          ; [debug line = 50:9]

; <label>:1                                       ; preds = %3, %0
  %i = phi i5 [ 0, %0 ], [ %i.1, %3 ]             ; [#uses=4 type=i5]
  %exitcond7 = icmp eq i5 %i, -16, !dbg !101      ; [#uses=1 type=i1] [debug line = 50:9]
...
; <label>:3                                       ; preds = %1
  ...
  %tmp = zext i5 %i to i64, !dbg !110             ; [#uses=1 type=i64] [debug line = 52:2]
  %work.addr = getelementptr [500 x i6]* %work, i64 0, i64 %tmp, !dbg !110 ; [#uses=1 type=i6*] [debug line = 52:2]
  %i.cast11.cast = zext i5 %i to i6, !dbg !110    ; [#uses=1 type=i6] [debug line = 52:2]
  store i6 %i.cast11.cast, i6* %work.addr, align 1, !dbg !110 ; [debug line = 52:2]
  %4 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str5, i32 %tmp.6) nounwind, !dbg !111 ; [#uses=0 type=i32] [debug line = 53:3]
  %i.1 = add i5 %i, 1, !dbg !112                  ; [#uses=1 type=i5] [debug line = 50:24]
  call void @llvm.dbg.value(metadata !{i5 %i.1}, i64 0, metadata !113), !dbg !112 ; [debug line = 50:24] [debug variable = i]
  br label %1, !dbg !112                          ; [debug line = 50:24]

.preheader13:                                     ; preds = %41, %.preheader13.preheader
  %r = phi i32 [ %r., %41 ], [ 0, %.preheader13.preheader ] ; [#uses=1 type=i32]
  %i.5 = phi i5 [ %k, %41 ], [ 0, %.preheader13.preheader ] ; [#uses=25 type=i5]
  %i.5.cast = zext i5 %i.5 to i32, !dbg !103      ; [#uses=2 type=i32] [debug line = 59:11]
  call void @llvm.dbg.value(metadata !{i5 %i.5}, i64 0, metadata !113), !dbg !103 ; [debug line = 59:11] [debug variable = i]
  %tmp.2 = icmp sgt i5 %i.5, -1, !dbg !114        ; [#uses=1 type=i1] [debug line = 56:9]
...
.preheader12.preheader:                           ; preds = %.preheader13
  %tmp.3 = zext i5 %i.5 to i64, !dbg !117         ; [#uses=29 type=i64] [debug line = 61:6]
  %arrayNo2 = lshr i5 %i.5, 2                     ; [#uses=4 type=i5]
  %arrayNo2.cast9 = trunc i5 %arrayNo2 to i3      ; [#uses=2 type=i3]
  %newIndex3 = trunc i5 %i.5 to i2                ; [#uses=4 type=i2]
  %newIndex4 = zext i2 %newIndex3 to i64          ; [#uses=8 type=i64]
...
.preheader12:                                     ; preds = %_ifconv, %.preheader12.preheader
  ...
  %exitcond6 = icmp eq i32 %r.3, 16, !dbg !103    ; [#uses=1 type=i1] [debug line = 59:11]
...
_ifconv:                                          ; preds = %.preheader12
  ...
  %arrayNo2.cast.cast2 = zext i5 %arrayNo2 to i30 ; [#uses=1 type=i30]
  %n.assign.1 = call fastcc float @"aesl_mux_load.4[16 x [4 x float]]P.i32.i64.i64"([16 x [4 x float]]* %"a[0]", [16 x [4 x float]]* %"a[1]", [16 x [4 x float]]* %"a[2]", [16 x [4 x float]]* %"a[3]", i30 %arrayNo2.cast.cast2, i32 %r.3, i2 %newIndex3) ; [#uses=4 type=float]
  ...
  %tmp.52 = call i8 @_ssdm_op_PartSelect.i8.i32.i32.i32(i32 %n.assign.1_to_int, i32 23, i32 30) ; [#uses=1 type=i8]
  %tmp.53 = trunc i32 %n.assign.1_to_int to i23   ; [#uses=1 type=i23]
  %notlhs = icmp ne i8 %tmp.52, -1                ; [#uses=1 type=i1]
  %notrhs = icmp eq i23 %tmp.53, 0                ; [#uses=1 type=i1]
  %tmp.54 = or i1 %notrhs, %notlhs                ; [#uses=1 type=i1]
  %tmp.55 = fcmp oge float %n.assign.1, 0.000000e+00, !dbg !128 ; [#uses=1 type=i1] [debug line = 11:3@61:6]
  %tmp.56 = and i1 %tmp.54, %tmp.55, !dbg !128    ; [#uses=1 type=i1] [debug line = 11:3@61:6]
  ...
  %w.3 = select i1 %tmp.56, float %n.assign.1, float %f.1, !dbg !132 ; [#uses=3 type=float] [debug line = 63:9]
  ...
  %tmp.57 = call i8 @_ssdm_op_PartSelect.i8.i32.i32.i32(i32 %w.3_to_int, i32 23, i32 30) ; [#uses=1 type=i8]
  %tmp.58 = trunc i32 %w.3_to_int to i23          ; [#uses=1 type=i23]
  %wmax_to_int = bitcast float %wmax to i32       ; [#uses=2 type=i32]
  %tmp.59 = call i8 @_ssdm_op_PartSelect.i8.i32.i32.i32(i32 %wmax_to_int, i32 23, i32 30) ; [#uses=1 type=i8]
  %tmp.60 = trunc i32 %wmax_to_int to i23         ; [#uses=1 type=i23]
  %notlhs3 = icmp ne i8 %tmp.57, -1               ; [#uses=1 type=i1]
  %notrhs3 = icmp eq i23 %tmp.58, 0               ; [#uses=1 type=i1]
  %tmp.61 = or i1 %notrhs3, %notlhs3              ; [#uses=1 type=i1]
  %notlhs4 = icmp ne i8 %tmp.59, -1               ; [#uses=1 type=i1]
  %notrhs4 = icmp eq i23 %tmp.60, 0               ; [#uses=1 type=i1]
  %tmp.62 = or i1 %notrhs4, %notlhs4              ; [#uses=1 type=i1]
  %tmp.63 = and i1 %tmp.61, %tmp.62               ; [#uses=1 type=i1]
  %tmp.64 = fcmp ogt float %w.3, %wmax, !dbg !135 ; [#uses=1 type=i1] [debug line = 62:7]
  %tmp.65 = and i1 %tmp.63, %tmp.64, !dbg !135    ; [#uses=2 type=i1] [debug line = 62:7]
  ...
  %wmax.1 = select i1 %tmp.65, float %w.3, float %wmax, !dbg !135 ; [#uses=1 type=float] [debug line = 62:7]
  call void @llvm.dbg.value(metadata !{float %wmax.1}, i64 0, metadata !136), !dbg !135 ; [debug line = 62:7] [debug variable = wmax]
  %r.2 = select i1 %tmp.65, i32 %r.3, i32 %r.1, !dbg !135 ; [#uses=1 type=i32] [debug line = 62:7]
...
_ifconv1:                                         ; preds = %.preheader12
  ...
  %arrayNo2.cast.cast1 = zext i5 %arrayNo2 to i30 ; [#uses=1 type=i30]
  %pivot = call fastcc float @"aesl_mux_load.4[16 x [4 x float]]P.i32.i64.i64"([16 x [4 x float]]* %"a[0]", [16 x [4 x float]]* %"a[1]", [16 x [4 x float]]* %"a[2]", [16 x [4 x float]]* %"a[3]", i30 %arrayNo2.cast.cast1, i32 %r.1.lcssa, i2 %newIndex3) ; [#uses=7 type=float]
  ...
  %tmp.47 = call i11 @_ssdm_op_PartSelect.i11.i64.i32.i32(i64 %tmp.5_to_int, i32 52, i32 62) ; [#uses=1 type=i11]
  %tmp.48 = trunc i64 %tmp.5_to_int to i52        ; [#uses=1 type=i52]
  %notlhs2 = icmp ne i11 %tmp.47, -1              ; [#uses=1 type=i1]
  %notrhs2 = icmp eq i52 %tmp.48, 0               ; [#uses=1 type=i1]
  %tmp.49 = or i1 %notrhs2, %notlhs2              ; [#uses=1 type=i1]
  %tmp.50 = fcmp ole double %tmp.5, 1.000000e-06, !dbg !150 ; [#uses=1 type=i1] [debug line = 70:5]
  %tmp.51 = and i1 %tmp.49, %tmp.50, !dbg !150    ; [#uses=1 type=i1] [debug line = 70:5]
  br i1 %tmp.51, label %.loopexit.loopexit94, label %8, !dbg !150 ; [debug line = 70:5]
...
; <label>:9                                       ; preds = %8
  %work.addr.2 = getelementptr [500 x i6]* %work, i64 0, i64 %tmp.3, !dbg !152 ; [#uses=2 type=i6*] [debug line = 77:7]
  %work.load.1 = load i6* %work.addr.2, align 1   ; [#uses=1 type=i6]
  %work.addr.3 = getelementptr [500 x i6]* %work, i64 0, i64 %tmp.4, !dbg !154 ; [#uses=2 type=i6*] [debug line = 78:7]
  %work.load.2 = load i6* %work.addr.3, align 1   ; [#uses=1 type=i6]
  store i6 %work.load.2, i6* %work.addr.2, align 1, !dbg !154 ; [debug line = 78:7]
  store i6 %work.load.1, i6* %work.addr.3, align 1, !dbg !155 ; [debug line = 79:7]
  br label %10, !dbg !156                         ; [debug line = 80:13]

; <label>:10                                      ; preds = %13, %9
  %j = phi i5 [ 0, %9 ], [ %j.1, %13 ]            ; [#uses=4 type=i5]
  %exitcond5 = icmp eq i5 %j, -16, !dbg !156      ; [#uses=1 type=i1] [debug line = 80:13]
...
; <label>:12                                      ; preds = %10
  ...
  %arrayNo4 = lshr i5 %j, 2                       ; [#uses=3 type=i5]
  %arrayNo4.cast7 = trunc i5 %arrayNo4 to i3      ; [#uses=1 type=i3]
  %newIndex8 = trunc i5 %j to i2                  ; [#uses=3 type=i2]
  %newIndex9 = zext i2 %newIndex8 to i64          ; [#uses=8 type=i64]
  %"a[0].addr.2" = getelementptr [16 x [4 x float]]* %"a[0]", i64 0, i64 %tmp.3, i64 %newIndex9, !dbg !161 ; [#uses=1 type=float*] [debug line = 82:2]
  %"a[1].addr.2" = getelementptr [16 x [4 x float]]* %"a[1]", i64 0, i64 %tmp.3, i64 %newIndex9, !dbg !161 ; [#uses=1 type=float*] [debug line = 82:2]
  %"a[2].addr.2" = getelementptr [16 x [4 x float]]* %"a[2]", i64 0, i64 %tmp.3, i64 %newIndex9, !dbg !161 ; [#uses=1 type=float*] [debug line = 82:2]
  %"a[3].addr.2" = getelementptr [16 x [4 x float]]* %"a[3]", i64 0, i64 %tmp.3, i64 %newIndex9, !dbg !161 ; [#uses=1 type=float*] [debug line = 82:2]
  %arrayNo4.cast.cast1 = zext i5 %arrayNo4 to i30 ; [#uses=1 type=i30]
  %tmp.3.cast1 = zext i5 %i.5 to i32              ; [#uses=1 type=i32]
  %w = call fastcc float @"aesl_mux_load.4[16 x [4 x float]]P.i32.i64.i64"([16 x [4 x float]]* %"a[0]", [16 x [4 x float]]* %"a[1]", [16 x [4 x float]]* %"a[2]", [16 x [4 x float]]* %"a[3]", i30 %arrayNo4.cast.cast1, i32 %tmp.3.cast1, i2 %newIndex8) ; [#uses=4 type=float]
  call void @llvm.dbg.value(metadata !{float %w}, i64 0, metadata !134), !dbg !161 ; [debug line = 82:2] [debug variable = w]
  %"a[0].addr.3" = getelementptr [16 x [4 x float]]* %"a[0]", i64 0, i64 %tmp.4, i64 %newIndex9, !dbg !162 ; [#uses=1 type=float*] [debug line = 83:9]
  %"a[1].addr.3" = getelementptr [16 x [4 x float]]* %"a[1]", i64 0, i64 %tmp.4, i64 %newIndex9, !dbg !162 ; [#uses=1 type=float*] [debug line = 83:9]
  %"a[2].addr.3" = getelementptr [16 x [4 x float]]* %"a[2]", i64 0, i64 %tmp.4, i64 %newIndex9, !dbg !162 ; [#uses=1 type=float*] [debug line = 83:9]
  %"a[3].addr.3" = getelementptr [16 x [4 x float]]* %"a[3]", i64 0, i64 %tmp.4, i64 %newIndex9, !dbg !162 ; [#uses=1 type=float*] [debug line = 83:9]
  %arrayNo4.cast.cast = zext i5 %arrayNo4 to i30  ; [#uses=1 type=i30]
  %tmp.25 = call fastcc float @"aesl_mux_load.4[16 x [4 x float]]P.i32.i64.i64"([16 x [4 x float]]* %"a[0]", [16 x [4 x float]]* %"a[1]", [16 x [4 x float]]* %"a[2]", [16 x [4 x float]]* %"a[3]", i30 %arrayNo4.cast.cast, i32 %r.1.lcssa, i2 %newIndex8) ; [#uses=4 type=float]
  switch i3 %arrayNo4.cast7, label %branch147 [
    i3 0, label %branch144
    i3 1, label %branch145
    i3 2, label %branch146
  ], !dbg !162                                    ; [debug line = 83:9]

; <label>:13                                      ; preds = %branch147, %branch146, %branch145, %branch144
  %14 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str7, i32 %tmp.24) nounwind, !dbg !163 ; [#uses=0 type=i32] [debug line = 85:7]
  %j.1 = add i5 %j, 1, !dbg !164                  ; [#uses=1 type=i5] [debug line = 80:28]
  call void @llvm.dbg.value(metadata !{i5 %j.1}, i64 0, metadata !165), !dbg !164 ; [debug line = 80:28] [debug variable = j]
...
; <label>:15                                      ; preds = %18, %.loopexit11
  %i.2 = phi i5 [ 0, %.loopexit11 ], [ %i.8, %18 ] ; [#uses=4 type=i5]
  %exitcond4 = icmp eq i5 %i.2, -16, !dbg !166    ; [#uses=1 type=i1] [debug line = 88:11]
...
.preheader10.preheader:                           ; preds = %15
  %tmp.27 = icmp eq i5 %i.5, 0, !dbg !168         ; [#uses=1 type=i1] [debug line = 99:13]
  %tmp.20.1 = icmp eq i5 %i.5, 1, !dbg !168       ; [#uses=1 type=i1] [debug line = 99:13]
  %tmp.20.2 = icmp eq i5 %i.5, 2, !dbg !168       ; [#uses=1 type=i1] [debug line = 99:13]
  %tmp.20.3 = icmp eq i5 %i.5, 3, !dbg !168       ; [#uses=1 type=i1] [debug line = 99:13]
  %tmp.20.4 = icmp eq i5 %i.5, 4, !dbg !168       ; [#uses=1 type=i1] [debug line = 99:13]
  %tmp.20.5 = icmp eq i5 %i.5, 5, !dbg !168       ; [#uses=1 type=i1] [debug line = 99:13]
  %tmp.20.6 = icmp eq i5 %i.5, 6, !dbg !168       ; [#uses=1 type=i1] [debug line = 99:13]
  %tmp.20.7 = icmp eq i5 %i.5, 7, !dbg !168       ; [#uses=1 type=i1] [debug line = 99:13]
  %tmp.20.8 = icmp eq i5 %i.5, 8, !dbg !168       ; [#uses=1 type=i1] [debug line = 99:13]
  %tmp.20.9 = icmp eq i5 %i.5, 9, !dbg !168       ; [#uses=1 type=i1] [debug line = 99:13]
  %tmp.20. = icmp eq i5 %i.5, 10, !dbg !168       ; [#uses=1 type=i1] [debug line = 99:13]
  %tmp.20.10 = icmp eq i5 %i.5, 11, !dbg !168     ; [#uses=1 type=i1] [debug line = 99:13]
  %tmp.20.11 = icmp eq i5 %i.5, 12, !dbg !168     ; [#uses=1 type=i1] [debug line = 99:13]
  %tmp.20.12 = icmp eq i5 %i.5, 13, !dbg !168     ; [#uses=1 type=i1] [debug line = 99:13]
  %tmp.20.13 = icmp eq i5 %i.5, 14, !dbg !168     ; [#uses=1 type=i1] [debug line = 99:13]
  %tmp.20.14 = icmp eq i5 %i.5, 15, !dbg !168     ; [#uses=1 type=i1] [debug line = 99:13]
  %"a[3].addr.13" = getelementptr [16 x [4 x float]]* %"a[3]", i64 0, i64 %tmp.3, i64 3 ; [#uses=1 type=float*]
  %"a[3].addr.11" = getelementptr [16 x [4 x float]]* %"a[3]", i64 0, i64 %tmp.3, i64 2 ; [#uses=1 type=float*]
  %"a[3].addr.9" = getelementptr [16 x [4 x float]]* %"a[3]", i64 0, i64 %tmp.3, i64 1 ; [#uses=1 type=float*]
  %"a[3].addr.7" = getelementptr [16 x [4 x float]]* %"a[3]", i64 0, i64 %tmp.3, i64 0 ; [#uses=1 type=float*]
  %"a[2].addr.13" = getelementptr [16 x [4 x float]]* %"a[2]", i64 0, i64 %tmp.3, i64 3 ; [#uses=1 type=float*]
  %"a[2].addr.11" = getelementptr [16 x [4 x float]]* %"a[2]", i64 0, i64 %tmp.3, i64 2 ; [#uses=1 type=float*]
  %"a[2].addr.9" = getelementptr [16 x [4 x float]]* %"a[2]", i64 0, i64 %tmp.3, i64 1 ; [#uses=1 type=float*]
  %"a[2].addr.7" = getelementptr [16 x [4 x float]]* %"a[2]", i64 0, i64 %tmp.3, i64 0 ; [#uses=1 type=float*]
  %"a[1].addr.13" = getelementptr [16 x [4 x float]]* %"a[1]", i64 0, i64 %tmp.3, i64 3 ; [#uses=1 type=float*]
  %"a[1].addr.11" = getelementptr [16 x [4 x float]]* %"a[1]", i64 0, i64 %tmp.3, i64 2 ; [#uses=1 type=float*]
  %"a[1].addr.9" = getelementptr [16 x [4 x float]]* %"a[1]", i64 0, i64 %tmp.3, i64 1 ; [#uses=1 type=float*]
  %"a[1].addr.7" = getelementptr [16 x [4 x float]]* %"a[1]", i64 0, i64 %tmp.3, i64 0 ; [#uses=1 type=float*]
  %"a[0].addr.13" = getelementptr [16 x [4 x float]]* %"a[0]", i64 0, i64 %tmp.3, i64 3 ; [#uses=1 type=float*]
  %"a[0].addr.11" = getelementptr [16 x [4 x float]]* %"a[0]", i64 0, i64 %tmp.3, i64 2 ; [#uses=1 type=float*]
  %"a[0].addr.9" = getelementptr [16 x [4 x float]]* %"a[0]", i64 0, i64 %tmp.3, i64 1 ; [#uses=1 type=float*]
  %"a[0].addr.7" = getelementptr [16 x [4 x float]]* %"a[0]", i64 0, i64 %tmp.3, i64 0 ; [#uses=1 type=float*]
...
; <label>:17                                      ; preds = %15
  ...
  %arrayNo5 = lshr i5 %i.2, 2                     ; [#uses=2 type=i5]
  %arrayNo5.cast5 = trunc i5 %arrayNo5 to i3      ; [#uses=1 type=i3]
  %newIndex1 = trunc i5 %i.2 to i2                ; [#uses=2 type=i2]
  %newIndex2 = zext i2 %newIndex1 to i64          ; [#uses=4 type=i64]
  %"a[0].addr.4" = getelementptr [16 x [4 x float]]* %"a[0]", i64 0, i64 %tmp.3, i64 %newIndex2, !dbg !179 ; [#uses=1 type=float*] [debug line = 90:2]
  %"a[1].addr.4" = getelementptr [16 x [4 x float]]* %"a[1]", i64 0, i64 %tmp.3, i64 %newIndex2, !dbg !179 ; [#uses=1 type=float*] [debug line = 90:2]
  %"a[2].addr.4" = getelementptr [16 x [4 x float]]* %"a[2]", i64 0, i64 %tmp.3, i64 %newIndex2, !dbg !179 ; [#uses=1 type=float*] [debug line = 90:2]
  %"a[3].addr.4" = getelementptr [16 x [4 x float]]* %"a[3]", i64 0, i64 %tmp.3, i64 %newIndex2, !dbg !179 ; [#uses=1 type=float*] [debug line = 90:2]
  %arrayNo5.cast.cast = zext i5 %arrayNo5 to i30  ; [#uses=1 type=i30]
  %tmp.3.cast = zext i5 %i.5 to i32               ; [#uses=1 type=i32]
  %tmp.29 = call fastcc float @"aesl_mux_load.4[16 x [4 x float]]P.i32.i64.i64"([16 x [4 x float]]* %"a[0]", [16 x [4 x float]]* %"a[1]", [16 x [4 x float]]* %"a[2]", [16 x [4 x float]]* %"a[3]", i30 %arrayNo5.cast.cast, i32 %tmp.3.cast, i2 %newIndex1) ; [#uses=1 type=float]
  %tmp.12 = fdiv float %tmp.29, %pivot, !dbg !179 ; [#uses=4 type=float] [debug line = 90:2]
  switch i3 %arrayNo5.cast5, label %branch139 [
    i3 0, label %branch136
    i3 1, label %branch137
    i3 2, label %branch138
  ], !dbg !179                                    ; [debug line = 90:2]

; <label>:18                                      ; preds = %branch139, %branch138, %branch137, %branch136
  %19 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str8, i32 %tmp.28) nounwind, !dbg !180 ; [#uses=0 type=i32] [debug line = 91:5]
  %i.8 = add i5 %i.2, 1, !dbg !181                ; [#uses=1 type=i5] [debug line = 88:26]
  call void @llvm.dbg.value(metadata !{i5 %i.8}, i64 0, metadata !113), !dbg !181 ; [debug line = 88:26] [debug variable = i]
  br label %15, !dbg !181                         ; [debug line = 88:26]

.preheader10:                                     ; preds = %._crit_edge, %.preheader10.preheader
  %i.3 = phi i5 [ %i.9, %._crit_edge ], [ 0, %.preheader10.preheader ] ; [#uses=5 type=i5]
  %exitcond3 = icmp eq i5 %i.3, -16, !dbg !175    ; [#uses=1 type=i1] [debug line = 93:11]
  %20 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 16, i64 16, i64 16) nounwind ; [#uses=0 type=i32]
  br i1 %exitcond3, label %40, label %21, !dbg !175 ; [debug line = 93:11]
...
; <label>:21                                      ; preds = %.preheader10
  ...
  %tmp.14 = icmp eq i5 %i.3, %i.5, !dbg !184      ; [#uses=1 type=i1] [debug line = 95:2]
  br i1 %tmp.14, label %._crit_edge, label %22, !dbg !184 ; [debug line = 95:2]

; <label>:22                                      ; preds = %21
  %tmp.15 = zext i5 %i.3 to i64, !dbg !185        ; [#uses=20 type=i64] [debug line = 96:9]
  %"a[0].addr.6" = getelementptr [16 x [4 x float]]* %"a[0]", i64 0, i64 %tmp.15, i64 %newIndex4, !dbg !185 ; [#uses=1 type=float*] [debug line = 96:9]
  %"a[1].addr.6" = getelementptr [16 x [4 x float]]* %"a[1]", i64 0, i64 %tmp.15, i64 %newIndex4, !dbg !185 ; [#uses=1 type=float*] [debug line = 96:9]
  %"a[2].addr.6" = getelementptr [16 x [4 x float]]* %"a[2]", i64 0, i64 %tmp.15, i64 %newIndex4, !dbg !185 ; [#uses=1 type=float*] [debug line = 96:9]
  %"a[3].addr.6" = getelementptr [16 x [4 x float]]* %"a[3]", i64 0, i64 %tmp.15, i64 %newIndex4, !dbg !185 ; [#uses=1 type=float*] [debug line = 96:9]
  %arrayNo2.cast.cast = zext i5 %arrayNo2 to i30  ; [#uses=1 type=i30]
  %tmp.15.cast = zext i5 %i.3 to i32              ; [#uses=1 type=i32]
  %w.1 = call fastcc float @"aesl_mux_load.4[16 x [4 x float]]P.i32.i64.i64"([16 x [4 x float]]* %"a[0]", [16 x [4 x float]]* %"a[1]", [16 x [4 x float]]* %"a[2]", [16 x [4 x float]]* %"a[3]", i30 %arrayNo2.cast.cast, i32 %tmp.15.cast, i2 %newIndex3) ; [#uses=19 type=float]
  ...
  %tmp.69 = call i8 @_ssdm_op_PartSelect.i8.i32.i32.i32(i32 %w.1_to_int, i32 23, i32 30) ; [#uses=1 type=i8]
  %tmp.70 = trunc i32 %w.1_to_int to i23          ; [#uses=1 type=i23]
  %notlhs5 = icmp ne i8 %tmp.69, -1               ; [#uses=1 type=i1]
  %notrhs5 = icmp eq i23 %tmp.70, 0               ; [#uses=1 type=i1]
  %tmp.71 = or i1 %notrhs5, %notlhs5              ; [#uses=1 type=i1]
  %tmp.72 = fcmp oeq float %w.1, 0.000000e+00, !dbg !186 ; [#uses=1 type=i1] [debug line = 97:9]
  %tmp.73 = and i1 %tmp.71, %tmp.72, !dbg !186    ; [#uses=1 type=i1] [debug line = 97:9]
  br i1 %tmp.73, label %._crit_edge18, label %.preheader9.0, !dbg !186 ; [debug line = 97:9]
...
; <label>:23                                      ; preds = %.preheader9.0
  ...
  %"a[0].addr.8" = getelementptr [16 x [4 x float]]* %"a[0]", i64 0, i64 %tmp.15, i64 0 ; [#uses=2 type=float*]
...
; <label>:24                                      ; preds = %.preheader9.1
  ...
  %"a[0].addr.10" = getelementptr [16 x [4 x float]]* %"a[0]", i64 0, i64 %tmp.15, i64 1 ; [#uses=2 type=float*]
...
; <label>:25                                      ; preds = %.preheader9.2
  ...
  %"a[0].addr.12" = getelementptr [16 x [4 x float]]* %"a[0]", i64 0, i64 %tmp.15, i64 2 ; [#uses=2 type=float*]
...
; <label>:26                                      ; preds = %.preheader9.3
  ...
  %"a[0].addr.14" = getelementptr [16 x [4 x float]]* %"a[0]", i64 0, i64 %tmp.15, i64 3 ; [#uses=2 type=float*]
...
; <label>:27                                      ; preds = %.preheader9.4
  ...
  %tmp.22.4 = fmul float %w.1, %"a[1].load", !dbg !187 ; [#uses=1 type=float] [debug line = 99:27]
  %"a[1].addr.8" = getelementptr [16 x [4 x float]]* %"a[1]", i64 0, i64 %tmp.15, i64 0 ; [#uses=2 type=float*]
  %"a[1].load.1" = load float* %"a[1].addr.8", align 4, !dbg !187 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp.23.4 = fsub float %"a[1].load.1", %tmp.22.4, !dbg !187 ; [#uses=1 type=float] [debug line = 99:27]
  store float %tmp.23.4, float* %"a[1].addr.8", align 4, !dbg !187 ; [debug line = 99:27]
...
; <label>:28                                      ; preds = %.preheader9.5
  ...
  %tmp.22.5 = fmul float %w.1, %"a[1].load.2", !dbg !187 ; [#uses=1 type=float] [debug line = 99:27]
  %"a[1].addr.10" = getelementptr [16 x [4 x float]]* %"a[1]", i64 0, i64 %tmp.15, i64 1 ; [#uses=2 type=float*]
  %"a[1].load.3" = load float* %"a[1].addr.10", align 4, !dbg !187 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp.23.5 = fsub float %"a[1].load.3", %tmp.22.5, !dbg !187 ; [#uses=1 type=float] [debug line = 99:27]
  store float %tmp.23.5, float* %"a[1].addr.10", align 4, !dbg !187 ; [debug line = 99:27]
...
; <label>:29                                      ; preds = %.preheader9.6
  ...
  %tmp.22.6 = fmul float %w.1, %"a[1].load.4", !dbg !187 ; [#uses=1 type=float] [debug line = 99:27]
  %"a[1].addr.12" = getelementptr [16 x [4 x float]]* %"a[1]", i64 0, i64 %tmp.15, i64 2 ; [#uses=2 type=float*]
  %"a[1].load.5" = load float* %"a[1].addr.12", align 4, !dbg !187 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp.23.6 = fsub float %"a[1].load.5", %tmp.22.6, !dbg !187 ; [#uses=1 type=float] [debug line = 99:27]
  store float %tmp.23.6, float* %"a[1].addr.12", align 4, !dbg !187 ; [debug line = 99:27]
...
; <label>:30                                      ; preds = %.preheader9.7
  ...
  %tmp.22.7 = fmul float %w.1, %"a[1].load.6", !dbg !187 ; [#uses=1 type=float] [debug line = 99:27]
  %"a[1].addr.14" = getelementptr [16 x [4 x float]]* %"a[1]", i64 0, i64 %tmp.15, i64 3 ; [#uses=2 type=float*]
  %"a[1].load.7" = load float* %"a[1].addr.14", align 4, !dbg !187 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp.23.7 = fsub float %"a[1].load.7", %tmp.22.7, !dbg !187 ; [#uses=1 type=float] [debug line = 99:27]
  store float %tmp.23.7, float* %"a[1].addr.14", align 4, !dbg !187 ; [debug line = 99:27]
...
; <label>:31                                      ; preds = %.preheader9.8
  ...
  %tmp.22.8 = fmul float %w.1, %"a[2].load", !dbg !187 ; [#uses=1 type=float] [debug line = 99:27]
  %"a[2].addr.8" = getelementptr [16 x [4 x float]]* %"a[2]", i64 0, i64 %tmp.15, i64 0 ; [#uses=2 type=float*]
  %"a[2].load.1" = load float* %"a[2].addr.8", align 4, !dbg !187 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp.23.8 = fsub float %"a[2].load.1", %tmp.22.8, !dbg !187 ; [#uses=1 type=float] [debug line = 99:27]
  store float %tmp.23.8, float* %"a[2].addr.8", align 4, !dbg !187 ; [debug line = 99:27]
...
; <label>:32                                      ; preds = %.preheader9.9
  ...
  %tmp.22.9 = fmul float %w.1, %"a[2].load.2", !dbg !187 ; [#uses=1 type=float] [debug line = 99:27]
  %"a[2].addr.10" = getelementptr [16 x [4 x float]]* %"a[2]", i64 0, i64 %tmp.15, i64 1 ; [#uses=2 type=float*]
  %"a[2].load.3" = load float* %"a[2].addr.10", align 4, !dbg !187 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp.23.9 = fsub float %"a[2].load.3", %tmp.22.9, !dbg !187 ; [#uses=1 type=float] [debug line = 99:27]
  store float %tmp.23.9, float* %"a[2].addr.10", align 4, !dbg !187 ; [debug line = 99:27]
...
; <label>:33                                      ; preds = %.preheader9.10
  ...
  %tmp.22. = fmul float %w.1, %"a[2].load.4", !dbg !187 ; [#uses=1 type=float] [debug line = 99:27]
  %"a[2].addr.12" = getelementptr [16 x [4 x float]]* %"a[2]", i64 0, i64 %tmp.15, i64 2 ; [#uses=2 type=float*]
  %"a[2].load.5" = load float* %"a[2].addr.12", align 4, !dbg !187 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp.23. = fsub float %"a[2].load.5", %tmp.22., !dbg !187 ; [#uses=1 type=float] [debug line = 99:27]
  store float %tmp.23., float* %"a[2].addr.12", align 4, !dbg !187 ; [debug line = 99:27]
...
; <label>:34                                      ; preds = %.preheader9.11
  ...
  %tmp.22.10 = fmul float %w.1, %"a[2].load.6", !dbg !187 ; [#uses=1 type=float] [debug line = 99:27]
  %"a[2].addr.14" = getelementptr [16 x [4 x float]]* %"a[2]", i64 0, i64 %tmp.15, i64 3 ; [#uses=2 type=float*]
  %"a[2].load.7" = load float* %"a[2].addr.14", align 4, !dbg !187 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp.23.10 = fsub float %"a[2].load.7", %tmp.22.10, !dbg !187 ; [#uses=1 type=float] [debug line = 99:27]
  store float %tmp.23.10, float* %"a[2].addr.14", align 4, !dbg !187 ; [debug line = 99:27]
...
; <label>:35                                      ; preds = %.preheader9.12
  ...
  %tmp.22.11 = fmul float %w.1, %"a[3].load", !dbg !187 ; [#uses=1 type=float] [debug line = 99:27]
  %"a[3].addr.8" = getelementptr [16 x [4 x float]]* %"a[3]", i64 0, i64 %tmp.15, i64 0 ; [#uses=2 type=float*]
  %"a[3].load.1" = load float* %"a[3].addr.8", align 4, !dbg !187 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp.23.11 = fsub float %"a[3].load.1", %tmp.22.11, !dbg !187 ; [#uses=1 type=float] [debug line = 99:27]
  store float %tmp.23.11, float* %"a[3].addr.8", align 4, !dbg !187 ; [debug line = 99:27]
...
; <label>:36                                      ; preds = %.preheader9.13
  ...
  %tmp.22.12 = fmul float %w.1, %"a[3].load.2", !dbg !187 ; [#uses=1 type=float] [debug line = 99:27]
  %"a[3].addr.10" = getelementptr [16 x [4 x float]]* %"a[3]", i64 0, i64 %tmp.15, i64 1 ; [#uses=2 type=float*]
  %"a[3].load.3" = load float* %"a[3].addr.10", align 4, !dbg !187 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp.23.12 = fsub float %"a[3].load.3", %tmp.22.12, !dbg !187 ; [#uses=1 type=float] [debug line = 99:27]
  store float %tmp.23.12, float* %"a[3].addr.10", align 4, !dbg !187 ; [debug line = 99:27]
...
; <label>:37                                      ; preds = %.preheader9.14
  ...
  %tmp.22.13 = fmul float %w.1, %"a[3].load.4", !dbg !187 ; [#uses=1 type=float] [debug line = 99:27]
  %"a[3].addr.12" = getelementptr [16 x [4 x float]]* %"a[3]", i64 0, i64 %tmp.15, i64 2 ; [#uses=2 type=float*]
  %"a[3].load.5" = load float* %"a[3].addr.12", align 4, !dbg !187 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp.23.13 = fsub float %"a[3].load.5", %tmp.22.13, !dbg !187 ; [#uses=1 type=float] [debug line = 99:27]
  store float %tmp.23.13, float* %"a[3].addr.12", align 4, !dbg !187 ; [debug line = 99:27]
...
; <label>:38                                      ; preds = %.preheader9.15
  ...
  %tmp.22.14 = fmul float %w.1, %"a[3].load.6", !dbg !187 ; [#uses=1 type=float] [debug line = 99:27]
  %"a[3].addr.14" = getelementptr [16 x [4 x float]]* %"a[3]", i64 0, i64 %tmp.15, i64 3 ; [#uses=2 type=float*]
  %"a[3].load.7" = load float* %"a[3].addr.14", align 4, !dbg !187 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp.23.14 = fsub float %"a[3].load.7", %tmp.22.14, !dbg !187 ; [#uses=1 type=float] [debug line = 99:27]
  store float %tmp.23.14, float* %"a[3].addr.14", align 4, !dbg !187 ; [debug line = 99:27]
...
.preheader9.16:                                   ; preds = %38, %.preheader9.15
  ...
  switch i3 %arrayNo2.cast9, label %branch135 [
...
._crit_edge18:                                    ; preds = %.preheader9.16188, %22
  br label %._crit_edge, !dbg !190                ; [debug line = 103:7]

._crit_edge:                                      ; preds = %._crit_edge18, %21
  %39 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str9, i32 %tmp.30) nounwind, !dbg !191 ; [#uses=0 type=i32] [debug line = 104:5]
  %i.9 = add i5 %i.3, 1, !dbg !192                ; [#uses=1 type=i5] [debug line = 93:26]
  call void @llvm.dbg.value(metadata !{i5 %i.9}, i64 0, metadata !113), !dbg !192 ; [debug line = 93:26] [debug variable = i]
...
; <label>:40                                      ; preds = %.preheader10
  ...
  %"a[0].addr.5" = getelementptr [16 x [4 x float]]* %"a[0]", i64 0, i64 %tmp.3, i64 %newIndex4, !dbg !193 ; [#uses=1 type=float*] [debug line = 105:5]
  %"a[1].addr.5" = getelementptr [16 x [4 x float]]* %"a[1]", i64 0, i64 %tmp.3, i64 %newIndex4, !dbg !193 ; [#uses=1 type=float*] [debug line = 105:5]
  %"a[2].addr.5" = getelementptr [16 x [4 x float]]* %"a[2]", i64 0, i64 %tmp.3, i64 %newIndex4, !dbg !193 ; [#uses=1 type=float*] [debug line = 105:5]
  %"a[3].addr.5" = getelementptr [16 x [4 x float]]* %"a[3]", i64 0, i64 %tmp.3, i64 %newIndex4, !dbg !193 ; [#uses=1 type=float*] [debug line = 105:5]
  switch i3 %arrayNo2.cast9, label %branch131 [
    i3 0, label %branch128
    i3 1, label %branch129
    i3 2, label %branch130
  ], !dbg !193                                    ; [debug line = 105:5]

; <label>:41                                      ; preds = %branch131, %branch130, %branch129, %branch128
  %k = add i5 %i.5, 1, !dbg !194                  ; [#uses=1 type=i5] [debug line = 56:24]
  call void @llvm.dbg.value(metadata !{i5 %k}, i64 0, metadata !195), !dbg !194 ; [debug line = 56:24] [debug variable = k]
  br label %.preheader13, !dbg !194               ; [debug line = 56:24]

.preheader8:                                      ; preds = %77, %.preheader8.preheader
  %i.4 = phi i5 [ %i.7, %77 ], [ 0, %.preheader8.preheader ] ; [#uses=6 type=i5]
  %i.4.cast3.cast = zext i5 %i.4 to i6, !dbg !115 ; [#uses=1 type=i6] [debug line = 109:9]
  %exitcond1 = icmp eq i5 %i.4, -16, !dbg !115    ; [#uses=1 type=i1] [debug line = 109:9]
...
.preheader.preheader:                             ; preds = %.preheader8
  %tmp. = zext i5 %i.4 to i64, !dbg !196          ; [#uses=1 type=i64] [debug line = 114:2]
  %work.addr.1 = getelementptr [500 x i6]* %work, i64 0, i64 %tmp., !dbg !196 ; [#uses=2 type=i6*] [debug line = 114:2]
  %arrayNo3 = lshr i5 %i.4, 2                     ; [#uses=17 type=i5]
  %arrayNo3.cast2 = trunc i5 %arrayNo3 to i3      ; [#uses=16 type=i3]
  %newIndex5 = trunc i5 %i.4 to i2                ; [#uses=17 type=i2]
  %newIndex6 = zext i2 %newIndex5 to i64          ; [#uses=4 type=i64]
  br label %.preheader, !dbg !199                 ; [debug line = 111:18]

.preheader:                                       ; preds = %75, %.preheader.preheader
  ...
  %work.load = load i6* %work.addr.1, align 1     ; [#uses=22 type=i6]
  %tmp.8 = icmp eq i6 %work.load, %i.4.cast3.cast, !dbg !201 ; [#uses=1 type=i1] [debug line = 116:7]
  br i1 %tmp.8, label %77, label %43, !dbg !201   ; [debug line = 116:7]

; <label>:43                                      ; preds = %.preheader
  %tmp.10 = sext i6 %work.load to i64, !dbg !202  ; [#uses=9 type=i64] [debug line = 118:7]
  %work.addr.4 = getelementptr [500 x i6]* %work, i64 0, i64 %tmp.10, !dbg !202 ; [#uses=2 type=i6*] [debug line = 118:7]
  %work.load.3 = load i6* %work.addr.4, align 1   ; [#uses=1 type=i6]
  store i6 %work.load, i6* %work.addr.4, align 1, !dbg !203 ; [debug line = 119:7]
  store i6 %work.load.3, i6* %work.addr.1, align 1, !dbg !204 ; [debug line = 120:7]
  %"a[0].addr" = getelementptr [16 x [4 x float]]* %"a[0]", i64 0, i64 %tmp.10, i64 %newIndex6, !dbg !205 ; [#uses=16 type=float*] [debug line = 123:9]
  %"a[1].addr" = getelementptr [16 x [4 x float]]* %"a[1]", i64 0, i64 %tmp.10, i64 %newIndex6, !dbg !205 ; [#uses=16 type=float*] [debug line = 123:9]
  %"a[2].addr" = getelementptr [16 x [4 x float]]* %"a[2]", i64 0, i64 %tmp.10, i64 %newIndex6, !dbg !205 ; [#uses=16 type=float*] [debug line = 123:9]
  %"a[3].addr" = getelementptr [16 x [4 x float]]* %"a[3]", i64 0, i64 %tmp.10, i64 %newIndex6, !dbg !205 ; [#uses=16 type=float*] [debug line = 123:9]
  %tmp.66 = lshr i6 %work.load, 2                 ; [#uses=1 type=i6]
  %tmp.67 = trunc i6 %tmp.66 to i4                ; [#uses=1 type=i4]
  %tmp.68 = sext i4 %tmp.67 to i30                ; [#uses=17 type=i30]
  %newIndex = trunc i6 %work.load to i2           ; [#uses=2 type=i2]
  %newIndex7 = zext i2 %newIndex to i64           ; [#uses=4 type=i64]
  %"a[0].addr.1" = getelementptr [16 x [4 x float]]* %"a[0]", i64 0, i64 %tmp.10, i64 %newIndex7, !dbg !208 ; [#uses=16 type=float*] [debug line = 124:9]
  %"a[1].addr.1" = getelementptr [16 x [4 x float]]* %"a[1]", i64 0, i64 %tmp.10, i64 %newIndex7, !dbg !208 ; [#uses=16 type=float*] [debug line = 124:9]
  %"a[2].addr.1" = getelementptr [16 x [4 x float]]* %"a[2]", i64 0, i64 %tmp.10, i64 %newIndex7, !dbg !208 ; [#uses=16 type=float*] [debug line = 124:9]
  %"a[3].addr.1" = getelementptr [16 x [4 x float]]* %"a[3]", i64 0, i64 %tmp.10, i64 %newIndex7, !dbg !208 ; [#uses=16 type=float*] [debug line = 124:9]
  %arrayNo3.cast.cast1 = zext i5 %arrayNo3 to i30 ; [#uses=1 type=i30]
  %tmp.10.cast1 = sext i6 %work.load to i32       ; [#uses=1 type=i32]
  %tmp.22 = call fastcc float @"aesl_mux_load.4[16 x [4 x float]]P.i32.i64.i64"([16 x [4 x float]]* %"a[0]", [16 x [4 x float]]* %"a[1]", [16 x [4 x float]]* %"a[2]", [16 x [4 x float]]* %"a[3]", i30 %arrayNo3.cast.cast1, i32 %tmp.10.cast1, i2 %newIndex5) ; [#uses=8 type=float]
  %tmp.10.cast2 = sext i6 %work.load to i32       ; [#uses=1 type=i32]
  %tmp.23 = call fastcc float @"aesl_mux_load.4[16 x [4 x float]]P.i32.i64.i64"([16 x [4 x float]]* %"a[0]", [16 x [4 x float]]* %"a[1]", [16 x [4 x float]]* %"a[2]", [16 x [4 x float]]* %"a[3]", i30 %tmp.68, i32 %tmp.10.cast2, i2 %newIndex) ; [#uses=4 type=float]
  switch i3 %arrayNo3.cast2, label %branch127 [
    i3 0, label %branch124
    i3 1, label %branch125
    i3 2, label %branch126
  ], !dbg !208                                    ; [debug line = 124:9]

; <label>:44                                      ; preds = %branch127, %branch126, %branch125, %branch124
  switch i30 %tmp.68, label %branch63 [
    i30 0, label %branch60
    i30 1, label %branch61
    i30 2, label %branch62
  ], !dbg !209                                    ; [debug line = 125:9]

; <label>:45                                      ; preds = %branch63, %branch62, %branch61, %branch60
  %arrayNo3.cast.cast2 = zext i5 %arrayNo3 to i30 ; [#uses=1 type=i30]
  %tmp.10.cast3 = sext i6 %work.load to i32       ; [#uses=1 type=i32]
  %tmp.26 = call fastcc float @"aesl_mux_load.4[16 x [4 x float]]P.i32.i64.i64"([16 x [4 x float]]* %"a[0]", [16 x [4 x float]]* %"a[1]", [16 x [4 x float]]* %"a[2]", [16 x [4 x float]]* %"a[3]", i30 %arrayNo3.cast.cast2, i32 %tmp.10.cast3, i2 %newIndex5) ; [#uses=8 type=float]
  switch i3 %arrayNo3.cast2, label %branch123 [
    i3 0, label %branch120
    i3 1, label %branch121
    i3 2, label %branch122
  ], !dbg !208                                    ; [debug line = 124:9]

; <label>:46                                      ; preds = %branch123, %branch122, %branch121, %branch120
  switch i30 %tmp.68, label %branch59 [
    i30 0, label %branch56
    i30 1, label %branch57
    i30 2, label %branch58
  ], !dbg !209                                    ; [debug line = 125:9]

; <label>:47                                      ; preds = %branch59, %branch58, %branch57, %branch56
  %arrayNo3.cast.cast3 = zext i5 %arrayNo3 to i30 ; [#uses=1 type=i30]
  %tmp.10.cast4 = sext i6 %work.load to i32       ; [#uses=1 type=i32]
  %tmp.31 = call fastcc float @"aesl_mux_load.4[16 x [4 x float]]P.i32.i64.i64"([16 x [4 x float]]* %"a[0]", [16 x [4 x float]]* %"a[1]", [16 x [4 x float]]* %"a[2]", [16 x [4 x float]]* %"a[3]", i30 %arrayNo3.cast.cast3, i32 %tmp.10.cast4, i2 %newIndex5) ; [#uses=8 type=float]
  switch i3 %arrayNo3.cast2, label %branch119 [
    i3 0, label %branch116
    i3 1, label %branch117
    i3 2, label %branch118
  ], !dbg !208                                    ; [debug line = 124:9]

; <label>:48                                      ; preds = %branch119, %branch118, %branch117, %branch116
  switch i30 %tmp.68, label %branch55 [
    i30 0, label %branch52
    i30 1, label %branch53
    i30 2, label %branch54
  ], !dbg !209                                    ; [debug line = 125:9]

; <label>:49                                      ; preds = %branch55, %branch54, %branch53, %branch52
  %arrayNo3.cast.cast4 = zext i5 %arrayNo3 to i30 ; [#uses=1 type=i30]
  %tmp.10.cast5 = sext i6 %work.load to i32       ; [#uses=1 type=i32]
  %tmp.34 = call fastcc float @"aesl_mux_load.4[16 x [4 x float]]P.i32.i64.i64"([16 x [4 x float]]* %"a[0]", [16 x [4 x float]]* %"a[1]", [16 x [4 x float]]* %"a[2]", [16 x [4 x float]]* %"a[3]", i30 %arrayNo3.cast.cast4, i32 %tmp.10.cast5, i2 %newIndex5) ; [#uses=8 type=float]
  switch i3 %arrayNo3.cast2, label %branch115 [
    i3 0, label %branch112
    i3 1, label %branch113
    i3 2, label %branch114
  ], !dbg !208                                    ; [debug line = 124:9]

; <label>:50                                      ; preds = %branch115, %branch114, %branch113, %branch112
  switch i30 %tmp.68, label %branch51 [
    i30 0, label %branch48
    i30 1, label %branch49
    i30 2, label %branch50
  ], !dbg !209                                    ; [debug line = 125:9]

; <label>:51                                      ; preds = %branch51, %branch50, %branch49, %branch48
  %arrayNo3.cast.cast5 = zext i5 %arrayNo3 to i30 ; [#uses=1 type=i30]
  %tmp.10.cast6 = sext i6 %work.load to i32       ; [#uses=1 type=i32]
  %tmp.35 = call fastcc float @"aesl_mux_load.4[16 x [4 x float]]P.i32.i64.i64"([16 x [4 x float]]* %"a[0]", [16 x [4 x float]]* %"a[1]", [16 x [4 x float]]* %"a[2]", [16 x [4 x float]]* %"a[3]", i30 %arrayNo3.cast.cast5, i32 %tmp.10.cast6, i2 %newIndex5) ; [#uses=8 type=float]
  switch i3 %arrayNo3.cast2, label %branch111 [
    i3 0, label %branch108
    i3 1, label %branch109
    i3 2, label %branch110
  ], !dbg !208                                    ; [debug line = 124:9]

; <label>:52                                      ; preds = %branch111, %branch110, %branch109, %branch108
  switch i30 %tmp.68, label %branch47 [
    i30 0, label %branch44
    i30 1, label %branch45
    i30 2, label %branch46
  ], !dbg !209                                    ; [debug line = 125:9]

; <label>:53                                      ; preds = %branch47, %branch46, %branch45, %branch44
  %arrayNo3.cast.cast6 = zext i5 %arrayNo3 to i30 ; [#uses=1 type=i30]
  %tmp.10.cast7 = sext i6 %work.load to i32       ; [#uses=1 type=i32]
  %tmp.36 = call fastcc float @"aesl_mux_load.4[16 x [4 x float]]P.i32.i64.i64"([16 x [4 x float]]* %"a[0]", [16 x [4 x float]]* %"a[1]", [16 x [4 x float]]* %"a[2]", [16 x [4 x float]]* %"a[3]", i30 %arrayNo3.cast.cast6, i32 %tmp.10.cast7, i2 %newIndex5) ; [#uses=8 type=float]
  switch i3 %arrayNo3.cast2, label %branch107 [
    i3 0, label %branch104
    i3 1, label %branch105
    i3 2, label %branch106
  ], !dbg !208                                    ; [debug line = 124:9]

; <label>:54                                      ; preds = %branch107, %branch106, %branch105, %branch104
  switch i30 %tmp.68, label %branch43 [
    i30 0, label %branch40
    i30 1, label %branch41
    i30 2, label %branch42
  ], !dbg !209                                    ; [debug line = 125:9]

; <label>:55                                      ; preds = %branch43, %branch42, %branch41, %branch40
  %arrayNo3.cast.cast7 = zext i5 %arrayNo3 to i30 ; [#uses=1 type=i30]
  %tmp.10.cast8 = sext i6 %work.load to i32       ; [#uses=1 type=i32]
  %tmp.37 = call fastcc float @"aesl_mux_load.4[16 x [4 x float]]P.i32.i64.i64"([16 x [4 x float]]* %"a[0]", [16 x [4 x float]]* %"a[1]", [16 x [4 x float]]* %"a[2]", [16 x [4 x float]]* %"a[3]", i30 %arrayNo3.cast.cast7, i32 %tmp.10.cast8, i2 %newIndex5) ; [#uses=8 type=float]
  switch i3 %arrayNo3.cast2, label %branch103 [
    i3 0, label %branch100
    i3 1, label %branch101
    i3 2, label %branch102
  ], !dbg !208                                    ; [debug line = 124:9]

; <label>:56                                      ; preds = %branch103, %branch102, %branch101, %branch100
  switch i30 %tmp.68, label %branch39 [
    i30 0, label %branch36
    i30 1, label %branch37
    i30 2, label %branch38
  ], !dbg !209                                    ; [debug line = 125:9]

; <label>:57                                      ; preds = %branch39, %branch38, %branch37, %branch36
  %arrayNo3.cast.cast8 = zext i5 %arrayNo3 to i30 ; [#uses=1 type=i30]
  %tmp.10.cast9 = sext i6 %work.load to i32       ; [#uses=1 type=i32]
  %tmp.38 = call fastcc float @"aesl_mux_load.4[16 x [4 x float]]P.i32.i64.i64"([16 x [4 x float]]* %"a[0]", [16 x [4 x float]]* %"a[1]", [16 x [4 x float]]* %"a[2]", [16 x [4 x float]]* %"a[3]", i30 %arrayNo3.cast.cast8, i32 %tmp.10.cast9, i2 %newIndex5) ; [#uses=8 type=float]
  switch i3 %arrayNo3.cast2, label %branch99 [
    i3 0, label %branch96
    i3 1, label %branch97
    i3 2, label %branch98
  ], !dbg !208                                    ; [debug line = 124:9]

; <label>:58                                      ; preds = %branch99, %branch98, %branch97, %branch96
  switch i30 %tmp.68, label %branch35 [
    i30 0, label %branch32
    i30 1, label %branch33
    i30 2, label %branch34
  ], !dbg !209                                    ; [debug line = 125:9]

; <label>:59                                      ; preds = %branch35, %branch34, %branch33, %branch32
  %arrayNo3.cast.cast9 = zext i5 %arrayNo3 to i30 ; [#uses=1 type=i30]
  %tmp.10.cast10 = sext i6 %work.load to i32      ; [#uses=1 type=i32]
  %tmp.39 = call fastcc float @"aesl_mux_load.4[16 x [4 x float]]P.i32.i64.i64"([16 x [4 x float]]* %"a[0]", [16 x [4 x float]]* %"a[1]", [16 x [4 x float]]* %"a[2]", [16 x [4 x float]]* %"a[3]", i30 %arrayNo3.cast.cast9, i32 %tmp.10.cast10, i2 %newIndex5) ; [#uses=8 type=float]
  switch i3 %arrayNo3.cast2, label %branch95 [
    i3 0, label %branch92
    i3 1, label %branch93
    i3 2, label %branch94
  ], !dbg !208                                    ; [debug line = 124:9]

; <label>:60                                      ; preds = %branch95, %branch94, %branch93, %branch92
  switch i30 %tmp.68, label %branch31 [
    i30 0, label %branch28
    i30 1, label %branch29
    i30 2, label %branch30
  ], !dbg !209                                    ; [debug line = 125:9]

; <label>:61                                      ; preds = %branch31, %branch30, %branch29, %branch28
  %arrayNo3.cast.cast10 = zext i5 %arrayNo3 to i30 ; [#uses=1 type=i30]
  %tmp.10.cast11 = sext i6 %work.load to i32      ; [#uses=1 type=i32]
  %tmp.40 = call fastcc float @"aesl_mux_load.4[16 x [4 x float]]P.i32.i64.i64"([16 x [4 x float]]* %"a[0]", [16 x [4 x float]]* %"a[1]", [16 x [4 x float]]* %"a[2]", [16 x [4 x float]]* %"a[3]", i30 %arrayNo3.cast.cast10, i32 %tmp.10.cast11, i2 %newIndex5) ; [#uses=8 type=float]
  switch i3 %arrayNo3.cast2, label %branch91 [
    i3 0, label %branch88
    i3 1, label %branch89
    i3 2, label %branch90
  ], !dbg !208                                    ; [debug line = 124:9]

; <label>:62                                      ; preds = %branch91, %branch90, %branch89, %branch88
  switch i30 %tmp.68, label %branch27 [
    i30 0, label %branch24
    i30 1, label %branch25
    i30 2, label %branch26
  ], !dbg !209                                    ; [debug line = 125:9]

; <label>:63                                      ; preds = %branch27, %branch26, %branch25, %branch24
  %arrayNo3.cast.cast11 = zext i5 %arrayNo3 to i30 ; [#uses=1 type=i30]
  %tmp.10.cast12 = sext i6 %work.load to i32      ; [#uses=1 type=i32]
  %tmp.41 = call fastcc float @"aesl_mux_load.4[16 x [4 x float]]P.i32.i64.i64"([16 x [4 x float]]* %"a[0]", [16 x [4 x float]]* %"a[1]", [16 x [4 x float]]* %"a[2]", [16 x [4 x float]]* %"a[3]", i30 %arrayNo3.cast.cast11, i32 %tmp.10.cast12, i2 %newIndex5) ; [#uses=8 type=float]
  switch i3 %arrayNo3.cast2, label %branch87 [
    i3 0, label %branch84
    i3 1, label %branch85
    i3 2, label %branch86
  ], !dbg !208                                    ; [debug line = 124:9]

; <label>:64                                      ; preds = %branch87, %branch86, %branch85, %branch84
  switch i30 %tmp.68, label %branch23 [
    i30 0, label %branch20
    i30 1, label %branch21
    i30 2, label %branch22
  ], !dbg !209                                    ; [debug line = 125:9]

; <label>:65                                      ; preds = %branch23, %branch22, %branch21, %branch20
  %arrayNo3.cast.cast12 = zext i5 %arrayNo3 to i30 ; [#uses=1 type=i30]
  %tmp.10.cast13 = sext i6 %work.load to i32      ; [#uses=1 type=i32]
  %tmp.42 = call fastcc float @"aesl_mux_load.4[16 x [4 x float]]P.i32.i64.i64"([16 x [4 x float]]* %"a[0]", [16 x [4 x float]]* %"a[1]", [16 x [4 x float]]* %"a[2]", [16 x [4 x float]]* %"a[3]", i30 %arrayNo3.cast.cast12, i32 %tmp.10.cast13, i2 %newIndex5) ; [#uses=8 type=float]
  switch i3 %arrayNo3.cast2, label %branch83 [
    i3 0, label %branch80
    i3 1, label %branch81
    i3 2, label %branch82
  ], !dbg !208                                    ; [debug line = 124:9]

; <label>:66                                      ; preds = %branch83, %branch82, %branch81, %branch80
  switch i30 %tmp.68, label %branch19 [
    i30 0, label %branch16
    i30 1, label %branch17
    i30 2, label %branch18
  ], !dbg !209                                    ; [debug line = 125:9]

; <label>:67                                      ; preds = %branch19, %branch18, %branch17, %branch16
  %arrayNo3.cast.cast13 = zext i5 %arrayNo3 to i30 ; [#uses=1 type=i30]
  %tmp.10.cast14 = sext i6 %work.load to i32      ; [#uses=1 type=i32]
  %tmp.43 = call fastcc float @"aesl_mux_load.4[16 x [4 x float]]P.i32.i64.i64"([16 x [4 x float]]* %"a[0]", [16 x [4 x float]]* %"a[1]", [16 x [4 x float]]* %"a[2]", [16 x [4 x float]]* %"a[3]", i30 %arrayNo3.cast.cast13, i32 %tmp.10.cast14, i2 %newIndex5) ; [#uses=8 type=float]
  switch i3 %arrayNo3.cast2, label %branch79 [
    i3 0, label %branch76
    i3 1, label %branch77
    i3 2, label %branch78
  ], !dbg !208                                    ; [debug line = 124:9]

; <label>:68                                      ; preds = %branch79, %branch78, %branch77, %branch76
  switch i30 %tmp.68, label %branch15 [
    i30 0, label %branch12
    i30 1, label %branch13
    i30 2, label %branch14
  ], !dbg !209                                    ; [debug line = 125:9]

; <label>:69                                      ; preds = %branch15, %branch14, %branch13, %branch12
  %arrayNo3.cast.cast14 = zext i5 %arrayNo3 to i30 ; [#uses=1 type=i30]
  %tmp.10.cast15 = sext i6 %work.load to i32      ; [#uses=1 type=i32]
  %tmp.44 = call fastcc float @"aesl_mux_load.4[16 x [4 x float]]P.i32.i64.i64"([16 x [4 x float]]* %"a[0]", [16 x [4 x float]]* %"a[1]", [16 x [4 x float]]* %"a[2]", [16 x [4 x float]]* %"a[3]", i30 %arrayNo3.cast.cast14, i32 %tmp.10.cast15, i2 %newIndex5) ; [#uses=8 type=float]
  switch i3 %arrayNo3.cast2, label %branch75 [
    i3 0, label %branch72
    i3 1, label %branch73
    i3 2, label %branch74
  ], !dbg !208                                    ; [debug line = 124:9]

; <label>:70                                      ; preds = %branch75, %branch74, %branch73, %branch72
  switch i30 %tmp.68, label %branch11 [
    i30 0, label %branch8
    i30 1, label %branch9
    i30 2, label %branch10
  ], !dbg !209                                    ; [debug line = 125:9]

; <label>:71                                      ; preds = %branch11, %branch10, %branch9, %branch8
  %arrayNo3.cast.cast15 = zext i5 %arrayNo3 to i30 ; [#uses=1 type=i30]
  %tmp.10.cast16 = sext i6 %work.load to i32      ; [#uses=1 type=i32]
  %tmp.45 = call fastcc float @"aesl_mux_load.4[16 x [4 x float]]P.i32.i64.i64"([16 x [4 x float]]* %"a[0]", [16 x [4 x float]]* %"a[1]", [16 x [4 x float]]* %"a[2]", [16 x [4 x float]]* %"a[3]", i30 %arrayNo3.cast.cast15, i32 %tmp.10.cast16, i2 %newIndex5) ; [#uses=8 type=float]
  switch i3 %arrayNo3.cast2, label %branch71 [
    i3 0, label %branch68
    i3 1, label %branch69
    i3 2, label %branch70
  ], !dbg !208                                    ; [debug line = 124:9]

; <label>:72                                      ; preds = %branch71, %branch70, %branch69, %branch68
  switch i30 %tmp.68, label %branch7 [
    i30 0, label %branch4
    i30 1, label %branch5
    i30 2, label %branch6
  ], !dbg !209                                    ; [debug line = 125:9]

; <label>:73                                      ; preds = %branch7, %branch6, %branch5, %branch4
  %arrayNo3.cast.cast = zext i5 %arrayNo3 to i30  ; [#uses=1 type=i30]
  %tmp.10.cast = sext i6 %work.load to i32        ; [#uses=1 type=i32]
  %tmp.46 = call fastcc float @"aesl_mux_load.4[16 x [4 x float]]P.i32.i64.i64"([16 x [4 x float]]* %"a[0]", [16 x [4 x float]]* %"a[1]", [16 x [4 x float]]* %"a[2]", [16 x [4 x float]]* %"a[3]", i30 %arrayNo3.cast.cast, i32 %tmp.10.cast, i2 %newIndex5) ; [#uses=4 type=float]
  switch i3 %arrayNo3.cast2, label %branch67 [
    i3 0, label %branch64
    i3 1, label %branch65
    i3 2, label %branch66
  ], !dbg !208                                    ; [debug line = 124:9]

; <label>:74                                      ; preds = %branch67, %branch66, %branch65, %branch64
  switch i30 %tmp.68, label %branch3 [
    i30 0, label %branch0
    i30 1, label %branch1
    i30 2, label %branch2
  ], !dbg !209                                    ; [debug line = 125:9]

; <label>:75                                      ; preds = %branch3, %branch2, %branch1, %branch0
  %76 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str10, i32 %tmp.21) nounwind, !dbg !210 ; [#uses=0 type=i32] [debug line = 127:5]
  br label %.preheader, !dbg !210                 ; [debug line = 127:5]

; <label>:77                                      ; preds = %.preheader
  %i.7 = add i5 %i.4, 1, !dbg !211                ; [#uses=1 type=i5] [debug line = 129:5]
  call void @llvm.dbg.value(metadata !{i5 %i.7}, i64 0, metadata !113), !dbg !211 ; [debug line = 129:5] [debug variable = i]
  br label %.preheader8, !dbg !212                ; [debug line = 130:3]

.loopexit.loopexit:                               ; preds = %.preheader8
  br label %.loopexit

.loopexit.loopexit94:                             ; preds = %_ifconv1
  br label %.loopexit

.loopexit:                                        ; preds = %.loopexit.loopexit94, %.loopexit.loopexit
...
branch32:                                         ; preds = %58
  ...
  br label %59, !dbg !209                         ; [debug line = 125:9]
...
branch36:                                         ; preds = %56
  ...
  br label %57, !dbg !209                         ; [debug line = 125:9]
...
branch40:                                         ; preds = %54
  ...
  br label %55, !dbg !209                         ; [debug line = 125:9]
...
branch44:                                         ; preds = %52
  ...
  br label %53, !dbg !209                         ; [debug line = 125:9]
...
branch48:                                         ; preds = %50
  ...
  br label %51, !dbg !209                         ; [debug line = 125:9]
...
branch52:                                         ; preds = %48
  ...
  br label %49, !dbg !209                         ; [debug line = 125:9]
...
branch56:                                         ; preds = %46
  ...
  br label %47, !dbg !209                         ; [debug line = 125:9]
...
branch60:                                         ; preds = %44
  ...
  br label %45, !dbg !209                         ; [debug line = 125:9]
...
branch96:                                         ; preds = %57
  ...
  br label %58, !dbg !208                         ; [debug line = 124:9]
...
branch100:                                        ; preds = %55
  ...
  br label %56, !dbg !208                         ; [debug line = 124:9]
...
branch104:                                        ; preds = %53
  ...
  br label %54, !dbg !208                         ; [debug line = 124:9]
...
branch108:                                        ; preds = %51
  ...
  br label %52, !dbg !208                         ; [debug line = 124:9]
...
branch112:                                        ; preds = %49
  ...
  br label %50, !dbg !208                         ; [debug line = 124:9]
...
branch116:                                        ; preds = %47
  ...
  br label %48, !dbg !208                         ; [debug line = 124:9]
...
branch120:                                        ; preds = %45
  ...
  br label %46, !dbg !208                         ; [debug line = 124:9]
...
branch124:                                        ; preds = %43
  ...
  br label %44, !dbg !208                         ; [debug line = 124:9]
...
branch128:                                        ; preds = %40
  ...
  br label %41, !dbg !193                         ; [debug line = 105:5]
...
branch132:                                        ; preds = %.preheader9.16
  ...
  br label %.preheader9.16188, !dbg !188          ; [debug line = 101:11]
...
; [#uses=23]
define internal fastcc float @"aesl_mux_load.4[16 x [4 x float]]P.i32.i64.i64"([16 x [4 x float]]* nocapture, [16 x [4 x float]]*, [16 x [4 x float]]*, [16 x [4 x float]]*, i30, i32, i2) readonly {
entry_ifconv:
  %.cast2 = zext i2 %6 to i64                     ; [#uses=5 type=i64]
  ...
  call void (...)* @_ssdm_op_SpecMemCore([16 x [4 x float]]* %3, [1 x i8]* @.str1, [12 x i8]* @.str2, [1 x i8]* @.str1, i32 -1, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1)
  call void (...)* @_ssdm_op_SpecMemCore([16 x [4 x float]]* %2, [1 x i8]* @.str1, [12 x i8]* @.str2, [1 x i8]* @.str1, i32 -1, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1)
  call void (...)* @_ssdm_op_SpecMemCore([16 x [4 x float]]* %1, [1 x i8]* @.str1, [12 x i8]* @.str2, [1 x i8]* @.str1, i32 -1, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1)
  call void (...)* @_ssdm_op_SpecMemCore([16 x [4 x float]]* %0, [1 x i8]* @.str1, [12 x i8]* @.str2, [1 x i8]* @.str1, i32 -1, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1)
  call void (...)* @_ssdm_op_SpecInterface([16 x [4 x float]]* %3, [5 x i8]* @.str3, i32 0, i32 0, [1 x i8]* @.str1, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1)
  call void (...)* @_ssdm_op_SpecInterface([16 x [4 x float]]* %2, [5 x i8]* @.str3, i32 0, i32 0, [1 x i8]* @.str1, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1)
  call void (...)* @_ssdm_op_SpecInterface([16 x [4 x float]]* %1, [5 x i8]* @.str3, i32 0, i32 0, [1 x i8]* @.str1, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1)
  call void (...)* @_ssdm_op_SpecInterface([16 x [4 x float]]* %0, [5 x i8]* @.str3, i32 0, i32 0, [1 x i8]* @.str1, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1, [1 x i8]* @.str1, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str1, [1 x i8]* @.str1)
  call void (...)* @_ssdm_SpecMemSelectRead()
  %.addr = getelementptr [16 x [4 x float]]* %3, i64 0, i64 %.cast1, i64 %.cast2 ; [#uses=1 type=float*]
  %7 = load float* %.addr, align 4                ; [#uses=1 type=float]
  %.addr.1 = getelementptr [16 x [4 x float]]* %0, i64 0, i64 %.cast1, i64 %.cast2 ; [#uses=1 type=float*]
  %8 = load float* %.addr.1, align 4              ; [#uses=1 type=float]
  %.addr.2 = getelementptr [16 x [4 x float]]* %1, i64 0, i64 %.cast1, i64 %.cast2 ; [#uses=1 type=float*]
  %9 = load float* %.addr.2, align 4              ; [#uses=1 type=float]
  %.addr.3 = getelementptr [16 x [4 x float]]* %2, i64 0, i64 %.cast1, i64 %.cast2 ; [#uses=1 type=float*]
...
!85 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 512, i64 32, i32 0, i32 0, metadata !36, metadata !86, i32 0, i32 0} ; [ DW_TAG_array_type ]
!86 = metadata !{metadata !40}
!87 = metadata !{metadata !88}
!88 = metadata !{i32 786468}                      ; [ DW_TAG_base_type ]
!89 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 2048, i64 32, i32 0, i32 0, metadata !36, metadata !39, i32 0, i32 0} ; [ DW_TAG_array_type ]
...
!216 = metadata !{i2 -2, i2 1, i2 0, i2 -1}       ; [ DW_TAG_class_type ]
