; ModuleID = '/home/patmos/github/bachelor_project_HLS/hls/tacle-bench/kernel/minver_float/hls_minver_float/minver_4b_16x16/.autopilot/db/a.g.1.bc'
...
define i32 @minver_hwa([16 x float]* %a) nounwind uwtable {
  ...
  call void (...)* @_ssdm_SpecArrayPartition([16 x float]* %a, i32 2, i8* getelementptr inbounds ([6 x i8]* @.str, i64 0, i64 0), i32 4, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !84 ; [debug line = 37:1]
...
; <label>:2                                       ; preds = %1
  ...
  %rend24 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str5, i64 0, i64 0), i32 %rbegin1) nounwind, !dbg !102 ; [#uses=0 type=i32] [debug line = 53:3]
...
; <label>:3                                       ; preds = %.preheader12
  %rbegin2 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str6, i64 0, i64 0)) nounwind, !dbg !110 ; [#uses=1 type=i32] [debug line = 59:33]
...
; <label>:8                                       ; preds = %7
  ...
  %rend22 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str7, i64 0, i64 0), i32 %rbegin4) nounwind, !dbg !141 ; [#uses=0 type=i32] [debug line = 85:7]
...
; <label>:10                                      ; preds = %9
  %rbegin5 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str8, i64 0, i64 0)) nounwind, !dbg !148 ; [#uses=1 type=i32] [debug line = 88:33]
  ...
  %rend26 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str8, i64 0, i64 0), i32 %rbegin5) nounwind, !dbg !152 ; [#uses=0 type=i32] [debug line = 91:5]
...
; <label>:11                                      ; preds = %.preheader10
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str9, i64 0, i64 0)) nounwind, !dbg !154 ; [#uses=1 type=i32] [debug line = 93:33]
...
._crit_edge:                                      ; preds = %._crit_edge18, %11
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str9, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !171 ; [#uses=0 type=i32] [debug line = 104:5]
...
.preheader:                                       ; preds = %20, %.preheader.preheader
  %rbegin3 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str10, i64 0, i64 0)) nounwind, !dbg !178 ; [#uses=1 type=i32] [debug line = 111:18]
...
; <label>:20                                      ; preds = %18
  %rend28 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str10, i64 0, i64 0), i32 %rbegin3) nounwind, !dbg !191 ; [#uses=0 type=i32] [debug line = 127:5]
