...
define i32 @minver_hwa([32 x float]* %a) nounwind uwtable {
  ...
  call void (...)* @_ssdm_SpecArrayPartition([32 x float]* %4, i32 2, i8* getelementptr inbounds ([6 x i8]* @.str, i32 0, i32 0), i32 2, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !1148 ; [debug line = 37:1]
  %5 = load [32 x float]** %2, align 8, !dbg !1148 ; [#uses=1 type=[32 x float]*] [debug line = 37:1]
  ...
  %6 = load [32 x float]** %2, align 8, !dbg !1149 ; [#uses=1 type=[32 x float]*] [debug line = 38:1]
  ...
  br label %7, !dbg !1180                         ; [debug line = 50:9]

; <label>:7                                       ; preds = %15, %0
  %8 = load i32* %i, align 4, !dbg !1180          ; [#uses=1 type=i32] [debug line = 50:9]
  %9 = icmp slt i32 %8, 32, !dbg !1180            ; [#uses=1 type=i1] [debug line = 50:9]
  br i1 %9, label %10, label %18, !dbg !1180      ; [debug line = 50:9]

; <label>:10                                      ; preds = %7
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str5, i32 0, i32 0)) nounwind, !dbg !1182 ; [debug line = 50:31]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !1184 ; [debug line = 51:1]
  %11 = load i32* %i, align 4, !dbg !1185         ; [#uses=1 type=i32] [debug line = 52:2]
  %12 = load i32* %i, align 4, !dbg !1185         ; [#uses=1 type=i32] [debug line = 52:2]
  %13 = sext i32 %12 to i64, !dbg !1185           ; [#uses=1 type=i64] [debug line = 52:2]
  %14 = getelementptr inbounds [500 x i32]* %work, i32 0, i64 %13, !dbg !1185 ; [#uses=1 type=i32*] [debug line = 52:2]
  store i32 %11, i32* %14, align 4, !dbg !1185    ; [debug line = 52:2]
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str5, i32 0, i32 0)) nounwind, !dbg !1186 ; [debug line = 53:3]
  br label %15, !dbg !1186                        ; [debug line = 53:3]

; <label>:15                                      ; preds = %10
  %16 = load i32* %i, align 4, !dbg !1187         ; [#uses=1 type=i32] [debug line = 50:24]
  %17 = add nsw i32 %16, 1, !dbg !1187            ; [#uses=1 type=i32] [debug line = 50:24]
  store i32 %17, i32* %i, align 4, !dbg !1187     ; [debug line = 50:24]
  br label %7, !dbg !1187                         ; [debug line = 50:24]

; <label>:18                                      ; preds = %7
  store i32 0, i32* %k, align 4, !dbg !1188       ; [debug line = 56:9]
  br label %19, !dbg !1188                        ; [debug line = 56:9]

; <label>:19                                      ; preds = %226, %18
  %20 = load i32* %k, align 4, !dbg !1188         ; [#uses=1 type=i32] [debug line = 56:9]
  %21 = icmp slt i32 %20, 32, !dbg !1188          ; [#uses=1 type=i1] [debug line = 56:9]
  br i1 %21, label %22, label %229, !dbg !1188    ; [debug line = 56:9]

; <label>:22                                      ; preds = %19
  store float 0.000000e+00, float* %wmax, align 4, !dbg !1190 ; [debug line = 58:5]
  %23 = load i32* %k, align 4, !dbg !1192         ; [#uses=1 type=i32] [debug line = 59:11]
  store i32 %23, i32* %i, align 4, !dbg !1192     ; [debug line = 59:11]
  br label %24, !dbg !1192                        ; [debug line = 59:11]

; <label>:24                                      ; preds = %44, %22
  %25 = load i32* %i, align 4, !dbg !1192         ; [#uses=1 type=i32] [debug line = 59:11]
  %26 = icmp slt i32 %25, 32, !dbg !1192          ; [#uses=1 type=i1] [debug line = 59:11]
  br i1 %26, label %27, label %47, !dbg !1192     ; [debug line = 59:11]

; <label>:27                                      ; preds = %24
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str6, i32 0, i32 0)) nounwind, !dbg !1194 ; [debug line = 59:33]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !1196 ; [debug line = 60:1]
  %28 = load i32* %k, align 4, !dbg !1197         ; [#uses=1 type=i32] [debug line = 61:6]
  %29 = sext i32 %28 to i64, !dbg !1197           ; [#uses=1 type=i64] [debug line = 61:6]
  %30 = load i32* %i, align 4, !dbg !1197         ; [#uses=1 type=i32] [debug line = 61:6]
  %31 = sext i32 %30 to i64, !dbg !1197           ; [#uses=1 type=i64] [debug line = 61:6]
  %32 = load [32 x float]** %2, align 8, !dbg !1197 ; [#uses=1 type=[32 x float]*] [debug line = 61:6]
  %33 = getelementptr inbounds [32 x float]* %32, i64 %31, !dbg !1197 ; [#uses=1 type=[32 x float]*] [debug line = 61:6]
  %34 = getelementptr inbounds [32 x float]* %33, i32 0, i64 %29, !dbg !1197 ; [#uses=1 type=float*] [debug line = 61:6]
  %35 = load float* %34, align 4, !dbg !1197      ; [#uses=1 type=float] [debug line = 61:6]
  %36 = call float @minver_fabs(float %35), !dbg !1197 ; [#uses=1 type=float] [debug line = 61:6]
  store float %36, float* %w, align 4, !dbg !1197 ; [debug line = 61:6]
  %37 = load float* %w, align 4, !dbg !1198       ; [#uses=1 type=float] [debug line = 62:7]
  %38 = load float* %wmax, align 4, !dbg !1198    ; [#uses=1 type=float] [debug line = 62:7]
  %39 = fcmp ogt float %37, %38, !dbg !1198       ; [#uses=1 type=i1] [debug line = 62:7]
  br i1 %39, label %40, label %43, !dbg !1198     ; [debug line = 62:7]

; <label>:40                                      ; preds = %27
  %41 = load float* %w, align 4, !dbg !1199       ; [#uses=1 type=float] [debug line = 63:9]
  store float %41, float* %wmax, align 4, !dbg !1199 ; [debug line = 63:9]
  %42 = load i32* %i, align 4, !dbg !1201         ; [#uses=1 type=i32] [debug line = 64:9]
  store i32 %42, i32* %r, align 4, !dbg !1201     ; [debug line = 64:9]
  br label %43, !dbg !1202                        ; [debug line = 65:7]

; <label>:43                                      ; preds = %40, %27
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str6, i32 0, i32 0)) nounwind, !dbg !1203 ; [debug line = 66:5]
  br label %44, !dbg !1203                        ; [debug line = 66:5]

; <label>:44                                      ; preds = %43
  %45 = load i32* %i, align 4, !dbg !1204         ; [#uses=1 type=i32] [debug line = 59:26]
  %46 = add nsw i32 %45, 1, !dbg !1204            ; [#uses=1 type=i32] [debug line = 59:26]
  store i32 %46, i32* %i, align 4, !dbg !1204     ; [debug line = 59:26]
  br label %24, !dbg !1204                        ; [debug line = 59:26]

; <label>:47                                      ; preds = %24
  %48 = load i32* %k, align 4, !dbg !1205         ; [#uses=1 type=i32] [debug line = 68:5]
  %49 = sext i32 %48 to i64, !dbg !1205           ; [#uses=1 type=i64] [debug line = 68:5]
  %50 = load i32* %r, align 4, !dbg !1205         ; [#uses=1 type=i32] [debug line = 68:5]
  %51 = sext i32 %50 to i64, !dbg !1205           ; [#uses=1 type=i64] [debug line = 68:5]
  %52 = load [32 x float]** %2, align 8, !dbg !1205 ; [#uses=1 type=[32 x float]*] [debug line = 68:5]
  %53 = getelementptr inbounds [32 x float]* %52, i64 %51, !dbg !1205 ; [#uses=1 type=[32 x float]*] [debug line = 68:5]
  %54 = getelementptr inbounds [32 x float]* %53, i32 0, i64 %49, !dbg !1205 ; [#uses=1 type=float*] [debug line = 68:5]
  %55 = load float* %54, align 4, !dbg !1205      ; [#uses=1 type=float] [debug line = 68:5]
  store float %55, float* %pivot, align 4, !dbg !1205 ; [debug line = 68:5]
  %56 = load float* %pivot, align 4, !dbg !1206   ; [#uses=1 type=float] [debug line = 69:11]
  %57 = call float @minver_fabs(float %56), !dbg !1206 ; [#uses=1 type=float] [debug line = 69:11]
  store float %57, float* %api, align 4, !dbg !1206 ; [debug line = 69:11]
  %58 = load float* %api, align 4, !dbg !1207     ; [#uses=1 type=float] [debug line = 70:5]
  %59 = fpext float %58 to double, !dbg !1207     ; [#uses=1 type=double] [debug line = 70:5]
  %60 = fcmp ole double %59, 1.000000e-06, !dbg !1207 ; [#uses=1 type=i1] [debug line = 70:5]
  br i1 %60, label %61, label %63, !dbg !1207     ; [debug line = 70:5]

; <label>:61                                      ; preds = %47
  %62 = load float* %w1, align 4, !dbg !1208      ; [#uses=1 type=float] [debug line = 71:7]
  store float %62, float* %minver_det, align 4, !dbg !1208 ; [debug line = 71:7]
  store i32 1, i32* %1, !dbg !1210                ; [debug line = 72:7]
  br label %303, !dbg !1210                       ; [debug line = 72:7]

; <label>:63                                      ; preds = %47
  %64 = load float* %pivot, align 4, !dbg !1211   ; [#uses=1 type=float] [debug line = 74:5]
  %65 = load float* %w1, align 4, !dbg !1211      ; [#uses=1 type=float] [debug line = 74:5]
  %66 = fmul float %65, %64, !dbg !1211           ; [#uses=1 type=float] [debug line = 74:5]
  store float %66, float* %w1, align 4, !dbg !1211 ; [debug line = 74:5]
  %67 = load i32* %r, align 4, !dbg !1212         ; [#uses=1 type=i32] [debug line = 75:5]
  %68 = load i32* %k, align 4, !dbg !1212         ; [#uses=1 type=i32] [debug line = 75:5]
  %69 = icmp ne i32 %67, %68, !dbg !1212          ; [#uses=1 type=i1] [debug line = 75:5]
  br i1 %69, label %70, label %127, !dbg !1212    ; [debug line = 75:5]

; <label>:70                                      ; preds = %63
  %71 = load float* %w, align 4, !dbg !1213       ; [#uses=1 type=float] [debug line = 76:7]
  %72 = fsub float -0.000000e+00, %71, !dbg !1213 ; [#uses=1 type=float] [debug line = 76:7]
  store float %72, float* %w1, align 4, !dbg !1213 ; [debug line = 76:7]
  %73 = load i32* %k, align 4, !dbg !1215         ; [#uses=1 type=i32] [debug line = 77:7]
  %74 = sext i32 %73 to i64, !dbg !1215           ; [#uses=1 type=i64] [debug line = 77:7]
  %75 = getelementptr inbounds [500 x i32]* %work, i32 0, i64 %74, !dbg !1215 ; [#uses=1 type=i32*] [debug line = 77:7]
  %76 = load i32* %75, align 4, !dbg !1215        ; [#uses=1 type=i32] [debug line = 77:7]
  store i32 %76, i32* %iw, align 4, !dbg !1215    ; [debug line = 77:7]
  %77 = load i32* %r, align 4, !dbg !1216         ; [#uses=1 type=i32] [debug line = 78:7]
  %78 = sext i32 %77 to i64, !dbg !1216           ; [#uses=1 type=i64] [debug line = 78:7]
  %79 = getelementptr inbounds [500 x i32]* %work, i32 0, i64 %78, !dbg !1216 ; [#uses=1 type=i32*] [debug line = 78:7]
  %80 = load i32* %79, align 4, !dbg !1216        ; [#uses=1 type=i32] [debug line = 78:7]
  %81 = load i32* %k, align 4, !dbg !1216         ; [#uses=1 type=i32] [debug line = 78:7]
  %82 = sext i32 %81 to i64, !dbg !1216           ; [#uses=1 type=i64] [debug line = 78:7]
  %83 = getelementptr inbounds [500 x i32]* %work, i32 0, i64 %82, !dbg !1216 ; [#uses=1 type=i32*] [debug line = 78:7]
  store i32 %80, i32* %83, align 4, !dbg !1216    ; [debug line = 78:7]
  %84 = load i32* %iw, align 4, !dbg !1217        ; [#uses=1 type=i32] [debug line = 79:7]
  %85 = load i32* %r, align 4, !dbg !1217         ; [#uses=1 type=i32] [debug line = 79:7]
  %86 = sext i32 %85 to i64, !dbg !1217           ; [#uses=1 type=i64] [debug line = 79:7]
  %87 = getelementptr inbounds [500 x i32]* %work, i32 0, i64 %86, !dbg !1217 ; [#uses=1 type=i32*] [debug line = 79:7]
  store i32 %84, i32* %87, align 4, !dbg !1217    ; [debug line = 79:7]
  store i32 0, i32* %j, align 4, !dbg !1218       ; [debug line = 80:13]
  br label %88, !dbg !1218                        ; [debug line = 80:13]

; <label>:88                                      ; preds = %123, %70
  %89 = load i32* %j, align 4, !dbg !1218         ; [#uses=1 type=i32] [debug line = 80:13]
  %90 = icmp slt i32 %89, 32, !dbg !1218          ; [#uses=1 type=i1] [debug line = 80:13]
  br i1 %90, label %91, label %126, !dbg !1218    ; [debug line = 80:13]

; <label>:91                                      ; preds = %88
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str7, i32 0, i32 0)) nounwind, !dbg !1220 ; [debug line = 80:35]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !1222 ; [debug line = 81:1]
  %92 = load i32* %j, align 4, !dbg !1223         ; [#uses=1 type=i32] [debug line = 82:2]
  %93 = sext i32 %92 to i64, !dbg !1223           ; [#uses=1 type=i64] [debug line = 82:2]
  %94 = load i32* %k, align 4, !dbg !1223         ; [#uses=1 type=i32] [debug line = 82:2]
  %95 = sext i32 %94 to i64, !dbg !1223           ; [#uses=1 type=i64] [debug line = 82:2]
  %96 = load [32 x float]** %2, align 8, !dbg !1223 ; [#uses=1 type=[32 x float]*] [debug line = 82:2]
  %97 = getelementptr inbounds [32 x float]* %96, i64 %95, !dbg !1223 ; [#uses=1 type=[32 x float]*] [debug line = 82:2]
  %98 = getelementptr inbounds [32 x float]* %97, i32 0, i64 %93, !dbg !1223 ; [#uses=1 type=float*] [debug line = 82:2]
  %99 = load float* %98, align 4, !dbg !1223      ; [#uses=1 type=float] [debug line = 82:2]
  store float %99, float* %w, align 4, !dbg !1223 ; [debug line = 82:2]
  %100 = load i32* %j, align 4, !dbg !1224        ; [#uses=1 type=i32] [debug line = 83:9]
  %101 = sext i32 %100 to i64, !dbg !1224         ; [#uses=1 type=i64] [debug line = 83:9]
  %102 = load i32* %r, align 4, !dbg !1224        ; [#uses=1 type=i32] [debug line = 83:9]
  %103 = sext i32 %102 to i64, !dbg !1224         ; [#uses=1 type=i64] [debug line = 83:9]
  %104 = load [32 x float]** %2, align 8, !dbg !1224 ; [#uses=1 type=[32 x float]*] [debug line = 83:9]
  %105 = getelementptr inbounds [32 x float]* %104, i64 %103, !dbg !1224 ; [#uses=1 type=[32 x float]*] [debug line = 83:9]
  %106 = getelementptr inbounds [32 x float]* %105, i32 0, i64 %101, !dbg !1224 ; [#uses=1 type=float*] [debug line = 83:9]
  %107 = load float* %106, align 4, !dbg !1224    ; [#uses=1 type=float] [debug line = 83:9]
  %108 = load i32* %j, align 4, !dbg !1224        ; [#uses=1 type=i32] [debug line = 83:9]
  %109 = sext i32 %108 to i64, !dbg !1224         ; [#uses=1 type=i64] [debug line = 83:9]
  %110 = load i32* %k, align 4, !dbg !1224        ; [#uses=1 type=i32] [debug line = 83:9]
  %111 = sext i32 %110 to i64, !dbg !1224         ; [#uses=1 type=i64] [debug line = 83:9]
  %112 = load [32 x float]** %2, align 8, !dbg !1224 ; [#uses=1 type=[32 x float]*] [debug line = 83:9]
  %113 = getelementptr inbounds [32 x float]* %112, i64 %111, !dbg !1224 ; [#uses=1 type=[32 x float]*] [debug line = 83:9]
  %114 = getelementptr inbounds [32 x float]* %113, i32 0, i64 %109, !dbg !1224 ; [#uses=1 type=float*] [debug line = 83:9]
  store float %107, float* %114, align 4, !dbg !1224 ; [debug line = 83:9]
  %115 = load float* %w, align 4, !dbg !1225      ; [#uses=1 type=float] [debug line = 84:9]
  %116 = load i32* %j, align 4, !dbg !1225        ; [#uses=1 type=i32] [debug line = 84:9]
  %117 = sext i32 %116 to i64, !dbg !1225         ; [#uses=1 type=i64] [debug line = 84:9]
  %118 = load i32* %r, align 4, !dbg !1225        ; [#uses=1 type=i32] [debug line = 84:9]
  %119 = sext i32 %118 to i64, !dbg !1225         ; [#uses=1 type=i64] [debug line = 84:9]
  %120 = load [32 x float]** %2, align 8, !dbg !1225 ; [#uses=1 type=[32 x float]*] [debug line = 84:9]
  %121 = getelementptr inbounds [32 x float]* %120, i64 %119, !dbg !1225 ; [#uses=1 type=[32 x float]*] [debug line = 84:9]
  %122 = getelementptr inbounds [32 x float]* %121, i32 0, i64 %117, !dbg !1225 ; [#uses=1 type=float*] [debug line = 84:9]
  store float %115, float* %122, align 4, !dbg !1225 ; [debug line = 84:9]
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str7, i32 0, i32 0)) nounwind, !dbg !1226 ; [debug line = 85:7]
  br label %123, !dbg !1226                       ; [debug line = 85:7]

; <label>:123                                     ; preds = %91
  %124 = load i32* %j, align 4, !dbg !1227        ; [#uses=1 type=i32] [debug line = 80:28]
  %125 = add nsw i32 %124, 1, !dbg !1227          ; [#uses=1 type=i32] [debug line = 80:28]
  store i32 %125, i32* %j, align 4, !dbg !1227    ; [debug line = 80:28]
  br label %88, !dbg !1227                        ; [debug line = 80:28]

; <label>:126                                     ; preds = %88
  br label %127, !dbg !1228                       ; [debug line = 86:5]

; <label>:127                                     ; preds = %126, %63
  store i32 0, i32* %i, align 4, !dbg !1229       ; [debug line = 88:11]
  br label %128, !dbg !1229                       ; [debug line = 88:11]

; <label>:128                                     ; preds = %142, %127
  %129 = load i32* %i, align 4, !dbg !1229        ; [#uses=1 type=i32] [debug line = 88:11]
  %130 = icmp slt i32 %129, 32, !dbg !1229        ; [#uses=1 type=i1] [debug line = 88:11]
  br i1 %130, label %131, label %145, !dbg !1229  ; [debug line = 88:11]

; <label>:131                                     ; preds = %128
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str8, i32 0, i32 0)) nounwind, !dbg !1231 ; [debug line = 88:33]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !1233 ; [debug line = 89:1]
  %132 = load float* %pivot, align 4, !dbg !1234  ; [#uses=1 type=float] [debug line = 90:2]
  %133 = load i32* %i, align 4, !dbg !1234        ; [#uses=1 type=i32] [debug line = 90:2]
  %134 = sext i32 %133 to i64, !dbg !1234         ; [#uses=1 type=i64] [debug line = 90:2]
  %135 = load i32* %k, align 4, !dbg !1234        ; [#uses=1 type=i32] [debug line = 90:2]
  %136 = sext i32 %135 to i64, !dbg !1234         ; [#uses=1 type=i64] [debug line = 90:2]
  %137 = load [32 x float]** %2, align 8, !dbg !1234 ; [#uses=1 type=[32 x float]*] [debug line = 90:2]
  %138 = getelementptr inbounds [32 x float]* %137, i64 %136, !dbg !1234 ; [#uses=1 type=[32 x float]*] [debug line = 90:2]
  %139 = getelementptr inbounds [32 x float]* %138, i32 0, i64 %134, !dbg !1234 ; [#uses=2 type=float*] [debug line = 90:2]
  %140 = load float* %139, align 4, !dbg !1234    ; [#uses=1 type=float] [debug line = 90:2]
  %141 = fdiv float %140, %132, !dbg !1234        ; [#uses=1 type=float] [debug line = 90:2]
  store float %141, float* %139, align 4, !dbg !1234 ; [debug line = 90:2]
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str8, i32 0, i32 0)) nounwind, !dbg !1235 ; [debug line = 91:5]
  br label %142, !dbg !1235                       ; [debug line = 91:5]

; <label>:142                                     ; preds = %131
  %143 = load i32* %i, align 4, !dbg !1236        ; [#uses=1 type=i32] [debug line = 88:26]
  %144 = add nsw i32 %143, 1, !dbg !1236          ; [#uses=1 type=i32] [debug line = 88:26]
  store i32 %144, i32* %i, align 4, !dbg !1236    ; [debug line = 88:26]
  br label %128, !dbg !1236                       ; [debug line = 88:26]

; <label>:145                                     ; preds = %128
  store i32 0, i32* %i, align 4, !dbg !1237       ; [debug line = 93:11]
  br label %146, !dbg !1237                       ; [debug line = 93:11]

; <label>:146                                     ; preds = %211, %145
  %147 = load i32* %i, align 4, !dbg !1237        ; [#uses=1 type=i32] [debug line = 93:11]
  %148 = icmp slt i32 %147, 32, !dbg !1237        ; [#uses=1 type=i1] [debug line = 93:11]
  br i1 %148, label %149, label %214, !dbg !1237  ; [debug line = 93:11]

; <label>:149                                     ; preds = %146
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str9, i32 0, i32 0)) nounwind, !dbg !1239 ; [debug line = 93:33]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !1241 ; [debug line = 94:1]
  %150 = load i32* %i, align 4, !dbg !1242        ; [#uses=1 type=i32] [debug line = 95:2]
  %151 = load i32* %k, align 4, !dbg !1242        ; [#uses=1 type=i32] [debug line = 95:2]
  %152 = icmp ne i32 %150, %151, !dbg !1242       ; [#uses=1 type=i1] [debug line = 95:2]
  br i1 %152, label %153, label %210, !dbg !1242  ; [debug line = 95:2]

; <label>:153                                     ; preds = %149
  %154 = load i32* %k, align 4, !dbg !1243        ; [#uses=1 type=i32] [debug line = 96:9]
  %155 = sext i32 %154 to i64, !dbg !1243         ; [#uses=1 type=i64] [debug line = 96:9]
  %156 = load i32* %i, align 4, !dbg !1243        ; [#uses=1 type=i32] [debug line = 96:9]
  %157 = sext i32 %156 to i64, !dbg !1243         ; [#uses=1 type=i64] [debug line = 96:9]
  %158 = load [32 x float]** %2, align 8, !dbg !1243 ; [#uses=1 type=[32 x float]*] [debug line = 96:9]
  %159 = getelementptr inbounds [32 x float]* %158, i64 %157, !dbg !1243 ; [#uses=1 type=[32 x float]*] [debug line = 96:9]
  %160 = getelementptr inbounds [32 x float]* %159, i32 0, i64 %155, !dbg !1243 ; [#uses=1 type=float*] [debug line = 96:9]
  %161 = load float* %160, align 4, !dbg !1243    ; [#uses=1 type=float] [debug line = 96:9]
  store float %161, float* %w, align 4, !dbg !1243 ; [debug line = 96:9]
  %162 = load float* %w, align 4, !dbg !1245      ; [#uses=1 type=float] [debug line = 97:9]
  %163 = fpext float %162 to double, !dbg !1245   ; [#uses=1 type=double] [debug line = 97:9]
  %164 = fcmp une double %163, 0.000000e+00, !dbg !1245 ; [#uses=1 type=i1] [debug line = 97:9]
  br i1 %164, label %165, label %209, !dbg !1245  ; [debug line = 97:9]

; <label>:165                                     ; preds = %153
  store i32 0, i32* %j, align 4, !dbg !1246       ; [debug line = 98:17]
  br label %166, !dbg !1246                       ; [debug line = 98:17]

; <label>:166                                     ; preds = %194, %165
  %167 = load i32* %j, align 4, !dbg !1246        ; [#uses=1 type=i32] [debug line = 98:17]
  %168 = icmp slt i32 %167, 32, !dbg !1246        ; [#uses=1 type=i1] [debug line = 98:17]
  br i1 %168, label %169, label %197, !dbg !1246  ; [debug line = 98:17]

; <label>:169                                     ; preds = %166
  %170 = load i32* %j, align 4, !dbg !1249        ; [#uses=1 type=i32] [debug line = 99:13]
  %171 = load i32* %k, align 4, !dbg !1249        ; [#uses=1 type=i32] [debug line = 99:13]
  %172 = icmp ne i32 %170, %171, !dbg !1249       ; [#uses=1 type=i1] [debug line = 99:13]
  br i1 %172, label %173, label %193, !dbg !1249  ; [debug line = 99:13]

; <label>:173                                     ; preds = %169
  %174 = load float* %w, align 4, !dbg !1251      ; [#uses=1 type=float] [debug line = 99:27]
  %175 = load i32* %j, align 4, !dbg !1251        ; [#uses=1 type=i32] [debug line = 99:27]
  %176 = sext i32 %175 to i64, !dbg !1251         ; [#uses=1 type=i64] [debug line = 99:27]
  %177 = load i32* %k, align 4, !dbg !1251        ; [#uses=1 type=i32] [debug line = 99:27]
  %178 = sext i32 %177 to i64, !dbg !1251         ; [#uses=1 type=i64] [debug line = 99:27]
  %179 = load [32 x float]** %2, align 8, !dbg !1251 ; [#uses=1 type=[32 x float]*] [debug line = 99:27]
  %180 = getelementptr inbounds [32 x float]* %179, i64 %178, !dbg !1251 ; [#uses=1 type=[32 x float]*] [debug line = 99:27]
  %181 = getelementptr inbounds [32 x float]* %180, i32 0, i64 %176, !dbg !1251 ; [#uses=1 type=float*] [debug line = 99:27]
  %182 = load float* %181, align 4, !dbg !1251    ; [#uses=1 type=float] [debug line = 99:27]
  %183 = fmul float %174, %182, !dbg !1251        ; [#uses=1 type=float] [debug line = 99:27]
  %184 = load i32* %j, align 4, !dbg !1251        ; [#uses=1 type=i32] [debug line = 99:27]
  %185 = sext i32 %184 to i64, !dbg !1251         ; [#uses=1 type=i64] [debug line = 99:27]
  %186 = load i32* %i, align 4, !dbg !1251        ; [#uses=1 type=i32] [debug line = 99:27]
  %187 = sext i32 %186 to i64, !dbg !1251         ; [#uses=1 type=i64] [debug line = 99:27]
  %188 = load [32 x float]** %2, align 8, !dbg !1251 ; [#uses=1 type=[32 x float]*] [debug line = 99:27]
  %189 = getelementptr inbounds [32 x float]* %188, i64 %187, !dbg !1251 ; [#uses=1 type=[32 x float]*] [debug line = 99:27]
  %190 = getelementptr inbounds [32 x float]* %189, i32 0, i64 %185, !dbg !1251 ; [#uses=2 type=float*] [debug line = 99:27]
  %191 = load float* %190, align 4, !dbg !1251    ; [#uses=1 type=float] [debug line = 99:27]
  %192 = fsub float %191, %183, !dbg !1251        ; [#uses=1 type=float] [debug line = 99:27]
  store float %192, float* %190, align 4, !dbg !1251 ; [debug line = 99:27]
  br label %193, !dbg !1251                       ; [debug line = 99:27]

; <label>:193                                     ; preds = %173, %169
  br label %194, !dbg !1252                       ; [debug line = 100:11]

; <label>:194                                     ; preds = %193
  %195 = load i32* %j, align 4, !dbg !1253        ; [#uses=1 type=i32] [debug line = 98:32]
  %196 = add nsw i32 %195, 1, !dbg !1253          ; [#uses=1 type=i32] [debug line = 98:32]
  store i32 %196, i32* %j, align 4, !dbg !1253    ; [debug line = 98:32]
  br label %166, !dbg !1253                       ; [debug line = 98:32]

; <label>:197                                     ; preds = %166
  %198 = load float* %w, align 4, !dbg !1254      ; [#uses=1 type=float] [debug line = 101:11]
  %199 = fsub float -0.000000e+00, %198, !dbg !1254 ; [#uses=1 type=float] [debug line = 101:11]
  %200 = load float* %pivot, align 4, !dbg !1254  ; [#uses=1 type=float] [debug line = 101:11]
  %201 = fdiv float %199, %200, !dbg !1254        ; [#uses=1 type=float] [debug line = 101:11]
  %202 = load i32* %k, align 4, !dbg !1254        ; [#uses=1 type=i32] [debug line = 101:11]
  %203 = sext i32 %202 to i64, !dbg !1254         ; [#uses=1 type=i64] [debug line = 101:11]
  %204 = load i32* %i, align 4, !dbg !1254        ; [#uses=1 type=i32] [debug line = 101:11]
  %205 = sext i32 %204 to i64, !dbg !1254         ; [#uses=1 type=i64] [debug line = 101:11]
  %206 = load [32 x float]** %2, align 8, !dbg !1254 ; [#uses=1 type=[32 x float]*] [debug line = 101:11]
  %207 = getelementptr inbounds [32 x float]* %206, i64 %205, !dbg !1254 ; [#uses=1 type=[32 x float]*] [debug line = 101:11]
  %208 = getelementptr inbounds [32 x float]* %207, i32 0, i64 %203, !dbg !1254 ; [#uses=1 type=float*] [debug line = 101:11]
  store float %201, float* %208, align 4, !dbg !1254 ; [debug line = 101:11]
  br label %209, !dbg !1255                       ; [debug line = 102:9]

; <label>:209                                     ; preds = %197, %153
  br label %210, !dbg !1256                       ; [debug line = 103:7]

; <label>:210                                     ; preds = %209, %149
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str9, i32 0, i32 0)) nounwind, !dbg !1257 ; [debug line = 104:5]
  br label %211, !dbg !1257                       ; [debug line = 104:5]

; <label>:211                                     ; preds = %210
  %212 = load i32* %i, align 4, !dbg !1258        ; [#uses=1 type=i32] [debug line = 93:26]
  %213 = add nsw i32 %212, 1, !dbg !1258          ; [#uses=1 type=i32] [debug line = 93:26]
  store i32 %213, i32* %i, align 4, !dbg !1258    ; [debug line = 93:26]
  br label %146, !dbg !1258                       ; [debug line = 93:26]

; <label>:214                                     ; preds = %146
  %215 = load float* %pivot, align 4, !dbg !1259  ; [#uses=1 type=float] [debug line = 105:5]
  %216 = fpext float %215 to double, !dbg !1259   ; [#uses=1 type=double] [debug line = 105:5]
  %217 = fdiv double 1.000000e+00, %216, !dbg !1259 ; [#uses=1 type=double] [debug line = 105:5]
  %218 = fptrunc double %217 to float, !dbg !1259 ; [#uses=1 type=float] [debug line = 105:5]
  %219 = load i32* %k, align 4, !dbg !1259        ; [#uses=1 type=i32] [debug line = 105:5]
  %220 = sext i32 %219 to i64, !dbg !1259         ; [#uses=1 type=i64] [debug line = 105:5]
  %221 = load i32* %k, align 4, !dbg !1259        ; [#uses=1 type=i32] [debug line = 105:5]
  %222 = sext i32 %221 to i64, !dbg !1259         ; [#uses=1 type=i64] [debug line = 105:5]
  %223 = load [32 x float]** %2, align 8, !dbg !1259 ; [#uses=1 type=[32 x float]*] [debug line = 105:5]
  %224 = getelementptr inbounds [32 x float]* %223, i64 %222, !dbg !1259 ; [#uses=1 type=[32 x float]*] [debug line = 105:5]
  %225 = getelementptr inbounds [32 x float]* %224, i32 0, i64 %220, !dbg !1259 ; [#uses=1 type=float*] [debug line = 105:5]
  store float %218, float* %225, align 4, !dbg !1259 ; [debug line = 105:5]
  br label %226, !dbg !1260                       ; [debug line = 107:3]

; <label>:226                                     ; preds = %214
  %227 = load i32* %k, align 4, !dbg !1261        ; [#uses=1 type=i32] [debug line = 56:24]
  %228 = add nsw i32 %227, 1, !dbg !1261          ; [#uses=1 type=i32] [debug line = 56:24]
  store i32 %228, i32* %k, align 4, !dbg !1261    ; [debug line = 56:24]
  br label %19, !dbg !1261                        ; [debug line = 56:24]

; <label>:229                                     ; preds = %19
  store i32 0, i32* %i, align 4, !dbg !1262       ; [debug line = 109:9]
  br label %230, !dbg !1262                       ; [debug line = 109:9]

; <label>:230                                     ; preds = %298, %229
  %231 = load i32* %i, align 4, !dbg !1262        ; [#uses=1 type=i32] [debug line = 109:9]
  %232 = icmp slt i32 %231, 32, !dbg !1262        ; [#uses=1 type=i1] [debug line = 109:9]
  br i1 %232, label %233, label %301, !dbg !1262  ; [debug line = 109:9]

; <label>:233                                     ; preds = %230
  br label %234, !dbg !1264                       ; [debug line = 111:5]

; <label>:234                                     ; preds = %297, %233
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str10, i32 0, i32 0)) nounwind, !dbg !1266 ; [debug line = 111:18]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !1268 ; [debug line = 112:1]
  %235 = load i32* %i, align 4, !dbg !1269        ; [#uses=1 type=i32] [debug line = 114:2]
  %236 = sext i32 %235 to i64, !dbg !1269         ; [#uses=1 type=i64] [debug line = 114:2]
  %237 = getelementptr inbounds [500 x i32]* %work, i32 0, i64 %236, !dbg !1269 ; [#uses=1 type=i32*] [debug line = 114:2]
  %238 = load i32* %237, align 4, !dbg !1269      ; [#uses=1 type=i32] [debug line = 114:2]
  store i32 %238, i32* %k, align 4, !dbg !1269    ; [debug line = 114:2]
  %239 = load i32* %k, align 4, !dbg !1270        ; [#uses=1 type=i32] [debug line = 116:7]
  %240 = load i32* %i, align 4, !dbg !1270        ; [#uses=1 type=i32] [debug line = 116:7]
  %241 = icmp eq i32 %239, %240, !dbg !1270       ; [#uses=1 type=i1] [debug line = 116:7]
  br i1 %241, label %242, label %243, !dbg !1270  ; [debug line = 116:7]

; <label>:242                                     ; preds = %234
  br label %298, !dbg !1271                       ; [debug line = 116:21]

; <label>:243                                     ; preds = %234
  %244 = load i32* %k, align 4, !dbg !1272        ; [#uses=1 type=i32] [debug line = 118:7]
  %245 = sext i32 %244 to i64, !dbg !1272         ; [#uses=1 type=i64] [debug line = 118:7]
  %246 = getelementptr inbounds [500 x i32]* %work, i32 0, i64 %245, !dbg !1272 ; [#uses=1 type=i32*] [debug line = 118:7]
  %247 = load i32* %246, align 4, !dbg !1272      ; [#uses=1 type=i32] [debug line = 118:7]
  store i32 %247, i32* %iw, align 4, !dbg !1272   ; [debug line = 118:7]
  %248 = load i32* %i, align 4, !dbg !1273        ; [#uses=1 type=i32] [debug line = 119:7]
  %249 = sext i32 %248 to i64, !dbg !1273         ; [#uses=1 type=i64] [debug line = 119:7]
  %250 = getelementptr inbounds [500 x i32]* %work, i32 0, i64 %249, !dbg !1273 ; [#uses=1 type=i32*] [debug line = 119:7]
  %251 = load i32* %250, align 4, !dbg !1273      ; [#uses=1 type=i32] [debug line = 119:7]
  %252 = load i32* %k, align 4, !dbg !1273        ; [#uses=1 type=i32] [debug line = 119:7]
  %253 = sext i32 %252 to i64, !dbg !1273         ; [#uses=1 type=i64] [debug line = 119:7]
  %254 = getelementptr inbounds [500 x i32]* %work, i32 0, i64 %253, !dbg !1273 ; [#uses=1 type=i32*] [debug line = 119:7]
  store i32 %251, i32* %254, align 4, !dbg !1273  ; [debug line = 119:7]
  %255 = load i32* %iw, align 4, !dbg !1274       ; [#uses=1 type=i32] [debug line = 120:7]
  %256 = load i32* %i, align 4, !dbg !1274        ; [#uses=1 type=i32] [debug line = 120:7]
  %257 = sext i32 %256 to i64, !dbg !1274         ; [#uses=1 type=i64] [debug line = 120:7]
  %258 = getelementptr inbounds [500 x i32]* %work, i32 0, i64 %257, !dbg !1274 ; [#uses=1 type=i32*] [debug line = 120:7]
  store i32 %255, i32* %258, align 4, !dbg !1274  ; [debug line = 120:7]
  store i32 0, i32* %j, align 4, !dbg !1275       ; [debug line = 122:13]
  br label %259, !dbg !1275                       ; [debug line = 122:13]

; <label>:259                                     ; preds = %294, %243
  %260 = load i32* %j, align 4, !dbg !1275        ; [#uses=1 type=i32] [debug line = 122:13]
  %261 = icmp slt i32 %260, 32, !dbg !1275        ; [#uses=1 type=i1] [debug line = 122:13]
  br i1 %261, label %262, label %297, !dbg !1275  ; [debug line = 122:13]

; <label>:262                                     ; preds = %259
  %263 = load i32* %i, align 4, !dbg !1277        ; [#uses=1 type=i32] [debug line = 123:9]
  %264 = sext i32 %263 to i64, !dbg !1277         ; [#uses=1 type=i64] [debug line = 123:9]
  %265 = load i32* %k, align 4, !dbg !1277        ; [#uses=1 type=i32] [debug line = 123:9]
  %266 = sext i32 %265 to i64, !dbg !1277         ; [#uses=1 type=i64] [debug line = 123:9]
  %267 = load [32 x float]** %2, align 8, !dbg !1277 ; [#uses=1 type=[32 x float]*] [debug line = 123:9]
  %268 = getelementptr inbounds [32 x float]* %267, i64 %266, !dbg !1277 ; [#uses=1 type=[32 x float]*] [debug line = 123:9]
  %269 = getelementptr inbounds [32 x float]* %268, i32 0, i64 %264, !dbg !1277 ; [#uses=1 type=float*] [debug line = 123:9]
  %270 = load float* %269, align 4, !dbg !1277    ; [#uses=1 type=float] [debug line = 123:9]
  store float %270, float* %w, align 4, !dbg !1277 ; [debug line = 123:9]
  %271 = load i32* %k, align 4, !dbg !1279        ; [#uses=1 type=i32] [debug line = 124:9]
  %272 = sext i32 %271 to i64, !dbg !1279         ; [#uses=1 type=i64] [debug line = 124:9]
  %273 = load i32* %k, align 4, !dbg !1279        ; [#uses=1 type=i32] [debug line = 124:9]
  %274 = sext i32 %273 to i64, !dbg !1279         ; [#uses=1 type=i64] [debug line = 124:9]
  %275 = load [32 x float]** %2, align 8, !dbg !1279 ; [#uses=1 type=[32 x float]*] [debug line = 124:9]
  %276 = getelementptr inbounds [32 x float]* %275, i64 %274, !dbg !1279 ; [#uses=1 type=[32 x float]*] [debug line = 124:9]
  %277 = getelementptr inbounds [32 x float]* %276, i32 0, i64 %272, !dbg !1279 ; [#uses=1 type=float*] [debug line = 124:9]
  %278 = load float* %277, align 4, !dbg !1279    ; [#uses=1 type=float] [debug line = 124:9]
  %279 = load i32* %i, align 4, !dbg !1279        ; [#uses=1 type=i32] [debug line = 124:9]
  %280 = sext i32 %279 to i64, !dbg !1279         ; [#uses=1 type=i64] [debug line = 124:9]
  %281 = load i32* %k, align 4, !dbg !1279        ; [#uses=1 type=i32] [debug line = 124:9]
  %282 = sext i32 %281 to i64, !dbg !1279         ; [#uses=1 type=i64] [debug line = 124:9]
  %283 = load [32 x float]** %2, align 8, !dbg !1279 ; [#uses=1 type=[32 x float]*] [debug line = 124:9]
  %284 = getelementptr inbounds [32 x float]* %283, i64 %282, !dbg !1279 ; [#uses=1 type=[32 x float]*] [debug line = 124:9]
  %285 = getelementptr inbounds [32 x float]* %284, i32 0, i64 %280, !dbg !1279 ; [#uses=1 type=float*] [debug line = 124:9]
  store float %278, float* %285, align 4, !dbg !1279 ; [debug line = 124:9]
  %286 = load float* %w, align 4, !dbg !1280      ; [#uses=1 type=float] [debug line = 125:9]
  %287 = load i32* %k, align 4, !dbg !1280        ; [#uses=1 type=i32] [debug line = 125:9]
  %288 = sext i32 %287 to i64, !dbg !1280         ; [#uses=1 type=i64] [debug line = 125:9]
  %289 = load i32* %k, align 4, !dbg !1280        ; [#uses=1 type=i32] [debug line = 125:9]
  %290 = sext i32 %289 to i64, !dbg !1280         ; [#uses=1 type=i64] [debug line = 125:9]
  %291 = load [32 x float]** %2, align 8, !dbg !1280 ; [#uses=1 type=[32 x float]*] [debug line = 125:9]
  %292 = getelementptr inbounds [32 x float]* %291, i64 %290, !dbg !1280 ; [#uses=1 type=[32 x float]*] [debug line = 125:9]
  %293 = getelementptr inbounds [32 x float]* %292, i32 0, i64 %288, !dbg !1280 ; [#uses=1 type=float*] [debug line = 125:9]
  store float %286, float* %293, align 4, !dbg !1280 ; [debug line = 125:9]
  br label %294, !dbg !1281                       ; [debug line = 126:7]

; <label>:294                                     ; preds = %262
  %295 = load i32* %j, align 4, !dbg !1282        ; [#uses=1 type=i32] [debug line = 122:28]
  %296 = add nsw i32 %295, 1, !dbg !1282          ; [#uses=1 type=i32] [debug line = 122:28]
  store i32 %296, i32* %j, align 4, !dbg !1282    ; [debug line = 122:28]
  br label %259, !dbg !1282                       ; [debug line = 122:28]

; <label>:297                                     ; preds = %259
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str10, i32 0, i32 0)) nounwind, !dbg !1283 ; [debug line = 127:5]
  br label %234, !dbg !1283                       ; [debug line = 127:5]

; <label>:298                                     ; preds = %242
  %299 = load i32* %i, align 4, !dbg !1284        ; [#uses=1 type=i32] [debug line = 129:5]
  %300 = add nsw i32 %299, 1, !dbg !1284          ; [#uses=1 type=i32] [debug line = 129:5]
  store i32 %300, i32* %i, align 4, !dbg !1284    ; [debug line = 129:5]
  br label %230, !dbg !1285                       ; [debug line = 130:3]

; <label>:301                                     ; preds = %230
  %302 = load float* %w1, align 4, !dbg !1286     ; [#uses=1 type=float] [debug line = 132:3]
  store float %302, float* %minver_det, align 4, !dbg !1286 ; [debug line = 132:3]
  br label %303, !dbg !1287                       ; [debug line = 133:1]

; <label>:303                                     ; preds = %301, %61
  %304 = load i32* %1, !dbg !1287                 ; [#uses=1 type=i32] [debug line = 133:1]
  ret i32 %304, !dbg !1287                        ; [debug line = 133:1]
}
