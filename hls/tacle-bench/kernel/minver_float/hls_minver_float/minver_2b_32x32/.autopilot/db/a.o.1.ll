...
define i32 @minver_hwa([32 x float]* %a) nounwind uwtable {
  ...
  call void @llvm.dbg.value(metadata !{[32 x float]* %a}, i64 0, metadata !80), !dbg !81 ; [debug line = 35:25] [debug variable = a]
  call void (...)* @_ssdm_SpecArrayDimSize([32 x float]* %a, i32 32) nounwind, !dbg !82 ; [debug line = 36:2]
  call void (...)* @_ssdm_SpecArrayPartition([32 x float]* %a, i32 2, i8* getelementptr inbounds ([6 x i8]* @.str, i64 0, i64 0), i32 2, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !84 ; [debug line = 37:1]
  call void (...)* @_ssdm_op_SpecResource([32 x float]* %a, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([12 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 -1, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !84 ; [debug line = 37:1]
...
; <label>:1                                       ; preds = %2, %0
  ...
  %exitcond7 = icmp eq i32 %i, 32, !dbg !92       ; [#uses=1 type=i1] [debug line = 50:9]
...
; <label>:2                                       ; preds = %1
  ...
  %rend30 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str5, i64 0, i64 0), i32 %rbegin1) nounwind, !dbg !102 ; [#uses=0 type=i32] [debug line = 53:3]
...
.preheader13:                                     ; preds = %16, %.preheader13.preheader
  ...
  %tmp.2 = icmp slt i32 %i.6, 32, !dbg !105       ; [#uses=1 type=i1] [debug line = 56:9]
...
.preheader12:                                     ; preds = %3, %.preheader12.preheader
  ...
  %exitcond6 = icmp eq i32 %r.3, 32, !dbg !94     ; [#uses=1 type=i1] [debug line = 59:11]
...
; <label>:3                                       ; preds = %.preheader12
  ...
  %a.addr.1 = getelementptr inbounds [32 x float]* %a, i64 %tmp.7, i64 %tmp.3, !dbg !108 ; [#uses=1 type=float*] [debug line = 61:6]
  ...
  %rend24 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str6, i64 0, i64 0), i32 %rbegin2) nounwind, !dbg !119 ; [#uses=0 type=i32] [debug line = 66:5]
...
; <label>:4                                       ; preds = %.preheader12
  ...
  %a.addr = getelementptr inbounds [32 x float]* %a, i64 %tmp.4, i64 %tmp.3, !dbg !121 ; [#uses=1 type=float*] [debug line = 68:5]
...
; <label>:7                                       ; preds = %8, %6
  ...
  %exitcond5 = icmp eq i32 %j, 32, !dbg !133      ; [#uses=1 type=i1] [debug line = 80:13]
...
; <label>:8                                       ; preds = %7
  ...
  %a.addr.5 = getelementptr inbounds [32 x float]* %a, i64 %tmp.4, i64 %tmp.16, !dbg !139 ; [#uses=2 type=float*] [debug line = 83:9]
...
; <label>:9                                       ; preds = %10, %.loopexit11
  ...
  %exitcond4 = icmp eq i32 %i.2, 32, !dbg !144    ; [#uses=1 type=i1] [debug line = 88:11]
...
.preheader10:                                     ; preds = %._crit_edge, %.preheader10.preheader
  ...
  %exitcond3 = icmp eq i32 %i.3, 32, !dbg !146    ; [#uses=1 type=i1] [debug line = 93:11]
...
; <label>:12                                      ; preds = %11
  ...
  %a.addr.8 = getelementptr inbounds [32 x float]* %a, i64 %tmp.25, i64 %tmp.3, !dbg !158 ; [#uses=2 type=float*] [debug line = 96:9]
...
.preheader9:                                      ; preds = %._crit_edge19, %.preheader9.preheader
  ...
  %exitcond2 = icmp eq i32 %j.1, 32, !dbg !161    ; [#uses=1 type=i1] [debug line = 98:17]
...
; <label>:14                                      ; preds = %13
  ...
  %a.addr.9 = getelementptr inbounds [32 x float]* %a, i64 %tmp.3, i64 %tmp.30, !dbg !166 ; [#uses=1 type=float*] [debug line = 99:27]
  ...
  %a.addr.10 = getelementptr inbounds [32 x float]* %a, i64 %tmp.25, i64 %tmp.30, !dbg !166 ; [#uses=2 type=float*] [debug line = 99:27]
...
._crit_edge:                                      ; preds = %._crit_edge18, %11
  %rend26 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str9, i64 0, i64 0), i32 %rbegin5) nounwind, !dbg !171 ; [#uses=0 type=i32] [debug line = 104:5]
...
; <label>:16                                      ; preds = %.preheader10
  ...
  %a.addr.7 = getelementptr inbounds [32 x float]* %a, i64 %tmp.3, i64 %tmp.3, !dbg !122 ; [#uses=1 type=float*] [debug line = 105:5]
...
.preheader8:                                      ; preds = %21, %.preheader8.preheader
  ...
  %exitcond1 = icmp eq i32 %i.4, 32, !dbg !106    ; [#uses=1 type=i1] [debug line = 109:9]
...
; <label>:17                                      ; preds = %.preheader
  ...
  %a.addr.2 = getelementptr inbounds [32 x float]* %a, i64 %tmp.15, i64 %tmp.11, !dbg !184 ; [#uses=2 type=float*] [debug line = 123:9]
  %a.addr.3 = getelementptr inbounds [32 x float]* %a, i64 %tmp.15, i64 %tmp.15, !dbg !187 ; [#uses=2 type=float*] [debug line = 124:9]
  br label %18, !dbg !188                         ; [debug line = 122:13]

; <label>:18                                      ; preds = %19, %17
  %j.2 = phi i32 [ 0, %17 ], [ %j.4, %19 ]        ; [#uses=2 type=i32]
  %exitcond = icmp eq i32 %j.2, 32, !dbg !188     ; [#uses=1 type=i1] [debug line = 122:13]
...
; <label>:20                                      ; preds = %18
  %rend22 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str10, i64 0, i64 0), i32 %rbegin3) nounwind, !dbg !191 ; [#uses=0 type=i32] [debug line = 127:5]
