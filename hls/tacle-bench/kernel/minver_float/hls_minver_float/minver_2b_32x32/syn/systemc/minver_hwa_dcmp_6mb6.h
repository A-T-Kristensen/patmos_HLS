...
#ifndef __minver_hwa_dcmp_6mb6__HH__
#define __minver_hwa_dcmp_6mb6__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(minver_hwa_dcmp_6mb6) {
    ...
    SC_CTOR(minver_hwa_dcmp_6mb6):  ACMP_dcmp_comb_U ("ACMP_dcmp_comb_U") {
