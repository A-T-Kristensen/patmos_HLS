; ModuleID = '/home/patmos/github/bachelor_project_HLS/hls/tacle-bench/kernel/minver_float/hls_minver_float/minver_1b_4x4/.autopilot/db/a.o.3.bc'
...
define i32 @minver_hwa([16 x float]* %a) nounwind uwtable {
  ...
  call void @llvm.dbg.value(metadata !{[16 x float]* %a}, i64 0, metadata !41), !dbg !57 ; [debug line = 35:25] [debug variable = a]
  ...
  call void @llvm.dbg.declare(metadata !{[500 x i3]* %work}, metadata !60), !dbg !64 ; [debug line = 41:6] [debug variable = work]
  br label %1, !dbg !65                           ; [debug line = 50:9]

; <label>:1                                       ; preds = %2, %0
  %i = phi i3 [ 0, %0 ], [ %i_1, %2 ]             ; [#uses=4 type=i3]
  %exitcond7 = icmp eq i3 %i, -4, !dbg !65        ; [#uses=1 type=i1] [debug line = 50:9]
  %i_1 = add i3 %i, 1, !dbg !67                   ; [#uses=1 type=i3] [debug line = 50:23]
...
; <label>:2                                       ; preds = %1
  ...
  %tmp_6 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @p_str4) nounwind, !dbg !71 ; [#uses=1 type=i32] [debug line = 50:30]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str) nounwind, !dbg !73 ; [debug line = 51:1]
  %tmp = zext i3 %i to i64, !dbg !74              ; [#uses=1 type=i64] [debug line = 52:2]
  %work_addr = getelementptr [500 x i3]* %work, i64 0, i64 %tmp, !dbg !74 ; [#uses=1 type=i3*] [debug line = 52:2]
  store i3 %i, i3* %work_addr, align 1, !dbg !74  ; [debug line = 52:2]
  %empty_7 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str4, i32 %tmp_6) nounwind, !dbg !75 ; [#uses=0 type=i32] [debug line = 53:3]
  call void @llvm.dbg.value(metadata !{i3 %i_1}, i64 0, metadata !76), !dbg !67 ; [debug line = 50:23] [debug variable = i]
  br label %1, !dbg !67                           ; [debug line = 50:23]

.preheader13:                                     ; preds = %15, %.preheader13.preheader
  %i_5 = phi i3 [ %k, %15 ], [ 0, %.preheader13.preheader ] ; [#uses=11 type=i3]
  %tmp_2 = call i1 @_ssdm_op_BitSelect.i1.i3.i32(i3 %i_5, i32 2), !dbg !69 ; [#uses=1 type=i1] [debug line = 56:9]
  %k = add i3 %i_5, 1, !dbg !77                   ; [#uses=1 type=i3] [debug line = 56:23]
...
.preheader12.preheader:                           ; preds = %.preheader13
  %i_5_cast6 = zext i3 %i_5 to i32, !dbg !80      ; [#uses=2 type=i32] [debug line = 59:11]
  call void @llvm.dbg.value(metadata !{i3 %i_5}, i64 0, metadata !76), !dbg !80 ; [debug line = 59:11] [debug variable = i]
  %empty_8 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 1, i64 4, i64 2) nounwind ; [#uses=0 type=i32]
  %tmp_3 = zext i3 %i_5 to i64, !dbg !83          ; [#uses=1 type=i64] [debug line = 61:6]
  %tmp_3_cast = zext i3 %i_5 to i6                ; [#uses=4 type=i6]
  %tmp_7 = call i5 @_ssdm_op_BitConcatenate.i5.i3.i2(i3 %i_5, i2 0) ; [#uses=5 type=i5]
  %tmp_11 = zext i5 %tmp_7 to i64, !dbg !85       ; [#uses=1 type=i64] [debug line = 82:2]
  %tmp_16_cast = zext i5 %tmp_7 to i6             ; [#uses=3 type=i6]
  %tmp_12 = or i5 %tmp_7, 3                       ; [#uses=1 type=i5]
  %tmp_16 = call i64 @_ssdm_op_BitConcatenate.i64.i59.i5(i59 0, i5 %tmp_12), !dbg !89 ; [#uses=1 type=i64] [debug line = 99:27]
  %a_addr_15 = getelementptr [16 x float]* %a, i64 0, i64 %tmp_16, !dbg !89 ; [#uses=1 type=float*] [debug line = 99:27]
  %tmp_17 = or i5 %tmp_7, 2                       ; [#uses=1 type=i5]
  %tmp_32 = call i64 @_ssdm_op_BitConcatenate.i64.i59.i5(i59 0, i5 %tmp_17), !dbg !89 ; [#uses=1 type=i64] [debug line = 99:27]
  %a_addr_13 = getelementptr [16 x float]* %a, i64 0, i64 %tmp_32, !dbg !89 ; [#uses=1 type=float*] [debug line = 99:27]
  %tmp_37 = or i5 %tmp_7, 1                       ; [#uses=1 type=i5]
  %tmp_42 = call i64 @_ssdm_op_BitConcatenate.i64.i59.i5(i59 0, i5 %tmp_37), !dbg !89 ; [#uses=1 type=i64] [debug line = 99:27]
  %a_addr_11 = getelementptr [16 x float]* %a, i64 0, i64 %tmp_42, !dbg !89 ; [#uses=1 type=float*] [debug line = 99:27]
  %a_addr_9 = getelementptr [16 x float]* %a, i64 0, i64 %tmp_11, !dbg !89 ; [#uses=1 type=float*] [debug line = 99:27]
  %tmp_44 = add i6 %tmp_3_cast, %tmp_16_cast, !dbg !96 ; [#uses=1 type=i6] [debug line = 105:5]
  %tmp_61_cast = zext i6 %tmp_44 to i64, !dbg !96 ; [#uses=1 type=i64] [debug line = 105:5]
  %a_addr_7 = getelementptr [16 x float]* %a, i64 0, i64 %tmp_61_cast, !dbg !96 ; [#uses=1 type=float*] [debug line = 105:5]
...
.preheader12:                                     ; preds = %_ifconv, %.preheader12.preheader
  ...
  %exitcond6 = icmp eq i32 %r_1, 4, !dbg !80      ; [#uses=1 type=i1] [debug line = 59:11]
...
_ifconv:                                          ; preds = %.preheader12
  ...
  %empty_9 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 1, i64 4, i64 0) nounwind ; [#uses=0 type=i32]
  %tmp_21 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @p_str5) nounwind, !dbg !98 ; [#uses=1 type=i32] [debug line = 59:32]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str) nounwind, !dbg !99 ; [debug line = 60:1]
  %tmp_58 = trunc i32 %r_1 to i4                  ; [#uses=1 type=i4]
  %tmp_66_cast = call i6 @_ssdm_op_BitConcatenate.i6.i4.i2(i4 %tmp_58, i2 0), !dbg !83 ; [#uses=1 type=i6] [debug line = 61:6]
  %tmp_59 = add i6 %tmp_66_cast, %tmp_3_cast, !dbg !83 ; [#uses=1 type=i6] [debug line = 61:6]
  %tmp_67_cast = sext i6 %tmp_59 to i64, !dbg !83 ; [#uses=1 type=i64] [debug line = 61:6]
  %a_addr_1 = getelementptr [16 x float]* %a, i64 0, i64 %tmp_67_cast, !dbg !83 ; [#uses=1 type=float*] [debug line = 61:6]
  %a_load_8 = load float* %a_addr_1, align 4, !dbg !83 ; [#uses=3 type=float] [debug line = 61:6]
  call void @llvm.dbg.value(metadata !{float %a_load_8}, i64 0, metadata !100), !dbg !106 ; [debug line = 8:31@61:6] [debug variable = n]
  %n_assign_1_to_int = bitcast float %a_load_8 to i32 ; [#uses=3 type=i32]
  %tmp_36 = call i8 @_ssdm_op_PartSelect.i8.i32.i32.i32(i32 %n_assign_1_to_int, i32 23, i32 30) ; [#uses=1 type=i8]
  %tmp_60 = trunc i32 %n_assign_1_to_int to i23   ; [#uses=1 type=i23]
  %notlhs = icmp ne i8 %tmp_36, -1                ; [#uses=1 type=i1]
  %notrhs = icmp eq i23 %tmp_60, 0                ; [#uses=1 type=i1]
  %tmp_38 = or i1 %notrhs, %notlhs                ; [#uses=1 type=i1]
  %tmp_39 = fcmp oge float %a_load_8, 0.000000e+00, !dbg !107 ; [#uses=1 type=i1] [debug line = 11:3@61:6]
  ...
  %w_3 = select i1 %tmp_40, float %a_load_8, float %f_1, !dbg !111 ; [#uses=3 type=float] [debug line = 63:9]
  ...
  %tmp_61 = trunc i32 %w_3_to_int to i23          ; [#uses=1 type=i23]
  ...
  %tmp_62 = trunc i32 %wmax_to_int to i23         ; [#uses=1 type=i23]
  %notlhs3 = icmp ne i8 %tmp_41, -1               ; [#uses=1 type=i1]
  %notrhs3 = icmp eq i23 %tmp_61, 0               ; [#uses=1 type=i1]
  %tmp_45 = or i1 %notrhs3, %notlhs3              ; [#uses=1 type=i1]
  %notlhs4 = icmp ne i8 %tmp_43, -1               ; [#uses=1 type=i1]
  %notrhs4 = icmp eq i23 %tmp_62, 0               ; [#uses=1 type=i1]
  ...
  %i_6 = add nsw i32 1, %r_1, !dbg !117           ; [#uses=1 type=i32] [debug line = 59:25]
  call void @llvm.dbg.value(metadata !{i32 %i_6}, i64 0, metadata !76), !dbg !117 ; [debug line = 59:25] [debug variable = i]
  store i32 %r_2, i32* %r, !dbg !97               ; [debug line = 62:7]
  br label %.preheader12, !dbg !117               ; [debug line = 59:25]
...
_ifconv1:                                         ; preds = %.preheader12
  ...
  %tmp_51 = trunc i32 %r_load to i4               ; [#uses=1 type=i4]
  %tmp_63_cast = call i6 @_ssdm_op_BitConcatenate.i6.i4.i2(i4 %tmp_51, i2 0), !dbg !118 ; [#uses=2 type=i6] [debug line = 68:5]
  %tmp_55 = add i6 %tmp_63_cast, %tmp_3_cast, !dbg !118 ; [#uses=1 type=i6] [debug line = 68:5]
  %tmp_64_cast = sext i6 %tmp_55 to i64, !dbg !118 ; [#uses=1 type=i64] [debug line = 68:5]
  %a_addr = getelementptr [16 x float]* %a, i64 0, i64 %tmp_64_cast, !dbg !118 ; [#uses=1 type=float*] [debug line = 68:5]
  ...
  %tmp_56 = trunc i32 %pivot_to_int to i23        ; [#uses=1 type=i23]
  %notlhs1 = icmp ne i8 %tmp_9, -1                ; [#uses=1 type=i1]
  %notrhs1 = icmp eq i23 %tmp_56, 0               ; [#uses=1 type=i1]
  ...
  %tmp_57 = trunc i64 %tmp_5_to_int to i52        ; [#uses=1 type=i52]
  %notlhs2 = icmp ne i11 %tmp_31, -1              ; [#uses=1 type=i1]
  %notrhs2 = icmp eq i52 %tmp_57, 0               ; [#uses=1 type=i1]
...
; <label>:4                                       ; preds = %3
  %work_addr_3 = getelementptr [500 x i3]* %work, i64 0, i64 %tmp_3, !dbg !129 ; [#uses=2 type=i3*] [debug line = 77:7]
  %work_load_2 = load i3* %work_addr_3, align 1   ; [#uses=1 type=i3]
  %work_addr_4 = getelementptr [500 x i3]* %work, i64 0, i64 %tmp_4, !dbg !130 ; [#uses=2 type=i3*] [debug line = 78:7]
  %work_load_3 = load i3* %work_addr_4, align 1   ; [#uses=1 type=i3]
  store i3 %work_load_3, i3* %work_addr_3, align 1, !dbg !130 ; [debug line = 78:7]
  store i3 %work_load_2, i3* %work_addr_4, align 1, !dbg !131 ; [debug line = 79:7]
  br label %5, !dbg !132                          ; [debug line = 80:13]

; <label>:5                                       ; preds = %6, %4
  %j = phi i3 [ 0, %4 ], [ %j_1, %6 ]             ; [#uses=3 type=i3]
  %exitcond5 = icmp eq i3 %j, -4, !dbg !132       ; [#uses=1 type=i1] [debug line = 80:13]
  %j_1 = add i3 %j, 1, !dbg !133                  ; [#uses=1 type=i3] [debug line = 80:27]
...
; <label>:6                                       ; preds = %5
  ...
  %tmp_23 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @p_str6) nounwind, !dbg !134 ; [#uses=1 type=i32] [debug line = 80:34]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str) nounwind, !dbg !135 ; [debug line = 81:1]
  %tmp_11_cast = zext i3 %j to i6, !dbg !85       ; [#uses=2 type=i6] [debug line = 82:2]
  %tmp_67 = add i6 %tmp_16_cast, %tmp_11_cast, !dbg !85 ; [#uses=1 type=i6] [debug line = 82:2]
  %tmp_72_cast = zext i6 %tmp_67 to i64, !dbg !85 ; [#uses=1 type=i64] [debug line = 82:2]
  %a_addr_4 = getelementptr [16 x float]* %a, i64 0, i64 %tmp_72_cast, !dbg !85 ; [#uses=2 type=float*] [debug line = 82:2]
  %tmp_68 = add i6 %tmp_63_cast, %tmp_11_cast, !dbg !136 ; [#uses=1 type=i6] [debug line = 83:9]
  %tmp_73_cast = sext i6 %tmp_68 to i64, !dbg !136 ; [#uses=1 type=i64] [debug line = 83:9]
  %a_addr_5 = getelementptr [16 x float]* %a, i64 0, i64 %tmp_73_cast, !dbg !136 ; [#uses=2 type=float*] [debug line = 83:9]
  ...
  call void @llvm.dbg.value(metadata !{i3 %j_1}, i64 0, metadata !139), !dbg !133 ; [debug line = 80:27] [debug variable = j]
  br label %5, !dbg !133                          ; [debug line = 80:27]
...
; <label>:7                                       ; preds = %8, %.loopexit11
  %i_2 = phi i3 [ 0, %.loopexit11 ], [ %i_8, %8 ] ; [#uses=3 type=i3]
  %exitcond4 = icmp eq i3 %i_2, -4, !dbg !140     ; [#uses=1 type=i1] [debug line = 88:11]
  %i_8 = add i3 %i_2, 1, !dbg !142                ; [#uses=1 type=i3] [debug line = 88:25]
  br i1 %exitcond4, label %.preheader10.preheader, label %8, !dbg !140 ; [debug line = 88:11]

.preheader10.preheader:                           ; preds = %7
  %tmp_26 = icmp eq i3 %i_5, 0, !dbg !143         ; [#uses=1 type=i1] [debug line = 99:13]
  %tmp_20_1 = icmp eq i3 %i_5, 1, !dbg !143       ; [#uses=1 type=i1] [debug line = 99:13]
  %tmp_20_2 = icmp eq i3 %i_5, 2, !dbg !143       ; [#uses=1 type=i1] [debug line = 99:13]
  %tmp_20_3 = icmp eq i3 %i_5, 3, !dbg !143       ; [#uses=1 type=i1] [debug line = 99:13]
...
; <label>:8                                       ; preds = %7
  ...
  %tmp_24 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @p_str7) nounwind, !dbg !145 ; [#uses=1 type=i32] [debug line = 88:32]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str) nounwind, !dbg !147 ; [debug line = 89:1]
  %tmp_12_cast = zext i3 %i_2 to i6, !dbg !148    ; [#uses=1 type=i6] [debug line = 90:2]
  %tmp_69 = add i6 %tmp_16_cast, %tmp_12_cast, !dbg !148 ; [#uses=1 type=i6] [debug line = 90:2]
  %tmp_74_cast = zext i6 %tmp_69 to i64, !dbg !148 ; [#uses=1 type=i64] [debug line = 90:2]
  %a_addr_6 = getelementptr [16 x float]* %a, i64 0, i64 %tmp_74_cast, !dbg !148 ; [#uses=2 type=float*] [debug line = 90:2]
  ...
  call void @llvm.dbg.value(metadata !{i3 %i_8}, i64 0, metadata !76), !dbg !142 ; [debug line = 88:25] [debug variable = i]
  br label %7, !dbg !142                          ; [debug line = 88:25]

.preheader10:                                     ; preds = %._crit_edge, %.preheader10.preheader
  %i_3 = phi i3 [ %i_9, %._crit_edge ], [ 0, %.preheader10.preheader ] ; [#uses=4 type=i3]
  %exitcond3 = icmp eq i3 %i_3, -4, !dbg !144     ; [#uses=1 type=i1] [debug line = 93:11]
  %i_9 = add i3 %i_3, 1, !dbg !150                ; [#uses=1 type=i3] [debug line = 93:25]
  br i1 %exitcond3, label %15, label %9, !dbg !144 ; [debug line = 93:11]

; <label>:9                                       ; preds = %.preheader10
  %empty_15 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 4, i64 4, i64 4) nounwind ; [#uses=0 type=i32]
  %tmp_25 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @p_str8) nounwind, !dbg !151 ; [#uses=1 type=i32] [debug line = 93:32]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str) nounwind, !dbg !152 ; [debug line = 94:1]
  %tmp_15 = icmp eq i3 %i_3, %i_5, !dbg !153      ; [#uses=1 type=i1] [debug line = 95:2]
  br i1 %tmp_15, label %._crit_edge, label %10, !dbg !153 ; [debug line = 95:2]

; <label>:10                                      ; preds = %9
  %tmp_70 = call i5 @_ssdm_op_BitConcatenate.i5.i3.i2(i3 %i_3, i2 0) ; [#uses=5 type=i5]
  %tmp_71 = zext i5 %tmp_70 to i64, !dbg !154     ; [#uses=1 type=i64] [debug line = 96:9]
  %tmp_76_cast = zext i5 %tmp_70 to i6, !dbg !154 ; [#uses=1 type=i6] [debug line = 96:9]
  %tmp_72 = add i6 %tmp_76_cast, %tmp_3_cast, !dbg !154 ; [#uses=1 type=i6] [debug line = 96:9]
  %tmp_77_cast = zext i6 %tmp_72 to i64, !dbg !154 ; [#uses=1 type=i64] [debug line = 96:9]
  %a_addr_8 = getelementptr [16 x float]* %a, i64 0, i64 %tmp_77_cast, !dbg !154 ; [#uses=2 type=float*] [debug line = 96:9]
  %a_addr_10 = getelementptr [16 x float]* %a, i64 0, i64 %tmp_71, !dbg !89 ; [#uses=2 type=float*] [debug line = 99:27]
  %tmp_73 = or i5 %tmp_70, 1                      ; [#uses=1 type=i5]
  %tmp_74 = call i64 @_ssdm_op_BitConcatenate.i64.i59.i5(i59 0, i5 %tmp_73), !dbg !89 ; [#uses=1 type=i64] [debug line = 99:27]
  %a_addr_12 = getelementptr [16 x float]* %a, i64 0, i64 %tmp_74, !dbg !89 ; [#uses=2 type=float*] [debug line = 99:27]
  %tmp_75 = or i5 %tmp_70, 2                      ; [#uses=1 type=i5]
  %tmp_76 = call i64 @_ssdm_op_BitConcatenate.i64.i59.i5(i59 0, i5 %tmp_75), !dbg !89 ; [#uses=1 type=i64] [debug line = 99:27]
  %a_addr_14 = getelementptr [16 x float]* %a, i64 0, i64 %tmp_76, !dbg !89 ; [#uses=2 type=float*] [debug line = 99:27]
  %tmp_77 = or i5 %tmp_70, 3                      ; [#uses=1 type=i5]
  %tmp_78 = call i64 @_ssdm_op_BitConcatenate.i64.i59.i5(i59 0, i5 %tmp_77), !dbg !89 ; [#uses=1 type=i64] [debug line = 99:27]
  %a_addr_16 = getelementptr [16 x float]* %a, i64 0, i64 %tmp_78, !dbg !89 ; [#uses=2 type=float*] [debug line = 99:27]
  %w_2 = load float* %a_addr_8, align 4, !dbg !154 ; [#uses=6 type=float] [debug line = 96:9]
  ...
  %tmp_79 = trunc i32 %w_2_to_int to i23          ; [#uses=1 type=i23]
  %notlhs5 = icmp ne i8 %tmp_50, -1               ; [#uses=1 type=i1]
  %notrhs5 = icmp eq i23 %tmp_79, 0               ; [#uses=1 type=i1]
...
; <label>:11                                      ; preds = %.preheader9.0
  %a_load_10 = load float* %a_addr_9, align 4, !dbg !89 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp_27 = fmul float %w_2, %a_load_10, !dbg !89 ; [#uses=1 type=float] [debug line = 99:27]
  %a_load_11 = load float* %a_addr_10, align 4, !dbg !89 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp_28 = fsub float %a_load_11, %tmp_27, !dbg !89 ; [#uses=1 type=float] [debug line = 99:27]
...
; <label>:12                                      ; preds = %.preheader9.1
  %a_load_12 = load float* %a_addr_11, align 4, !dbg !89 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp_22_1 = fmul float %w_2, %a_load_12, !dbg !89 ; [#uses=1 type=float] [debug line = 99:27]
  %a_load_13 = load float* %a_addr_12, align 4, !dbg !89 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp_23_1 = fsub float %a_load_13, %tmp_22_1, !dbg !89 ; [#uses=1 type=float] [debug line = 99:27]
...
; <label>:13                                      ; preds = %.preheader9.2
  %a_load_14 = load float* %a_addr_13, align 4, !dbg !89 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp_22_2 = fmul float %w_2, %a_load_14, !dbg !89 ; [#uses=1 type=float] [debug line = 99:27]
  %a_load_15 = load float* %a_addr_14, align 4, !dbg !89 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp_23_2 = fsub float %a_load_15, %tmp_22_2, !dbg !89 ; [#uses=1 type=float] [debug line = 99:27]
...
; <label>:14                                      ; preds = %.preheader9.3
  %a_load_16 = load float* %a_addr_15, align 4, !dbg !89 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp_22_3 = fmul float %w_2, %a_load_16, !dbg !89 ; [#uses=1 type=float] [debug line = 99:27]
  %a_load_17 = load float* %a_addr_16, align 4, !dbg !89 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp_23_3 = fsub float %a_load_17, %tmp_22_3, !dbg !89 ; [#uses=1 type=float] [debug line = 99:27]
...
._crit_edge:                                      ; preds = %._crit_edge18, %9
  ...
  call void @llvm.dbg.value(metadata !{i3 %i_9}, i64 0, metadata !76), !dbg !150 ; [debug line = 93:25] [debug variable = i]
  br label %.preheader10, !dbg !150               ; [debug line = 93:25]
...
; <label>:15                                      ; preds = %.preheader10
  ...
  call void @llvm.dbg.value(metadata !{i3 %k}, i64 0, metadata !160), !dbg !77 ; [debug line = 56:23] [debug variable = k]
  br label %.preheader13, !dbg !77                ; [debug line = 56:23]
...
.preheader8:                                      ; preds = %.preheader8.loopexit, %.preheader8.preheader
  ...
  %exitcond1 = icmp eq i3 %i_4, -4, !dbg !78      ; [#uses=1 type=i1] [debug line = 109:9]
  %i_7 = add i3 %i_4, 1, !dbg !161                ; [#uses=1 type=i3] [debug line = 129:5]
  call void @llvm.dbg.value(metadata !{i3 %i_7}, i64 0, metadata !76), !dbg !161 ; [debug line = 129:5] [debug variable = i]
...
.preheader.preheader:                             ; preds = %.preheader8
  ...
  %tmp_s = zext i3 %i_4 to i64, !dbg !163         ; [#uses=1 type=i64] [debug line = 114:2]
  %tmp_cast = zext i3 %i_4 to i6, !dbg !163       ; [#uses=1 type=i6] [debug line = 114:2]
  %work_addr_1 = getelementptr [500 x i3]* %work, i64 0, i64 %tmp_s, !dbg !163 ; [#uses=2 type=i3*] [debug line = 114:2]
...
.preheader:                                       ; preds = %16, %.preheader.preheader
  ...
  %tmp_8 = icmp eq i3 %work_load, %i_4, !dbg !166 ; [#uses=1 type=i1] [debug line = 116:7]
  br i1 %tmp_8, label %.preheader8.loopexit, label %16, !dbg !166 ; [debug line = 116:7]
...
; <label>:16                                      ; preds = %.preheader
  ...
  %tmp_10 = zext i3 %work_load to i64, !dbg !168  ; [#uses=1 type=i64] [debug line = 118:7]
  %tmp_10_cast = zext i3 %work_load to i6         ; [#uses=1 type=i6]
  %tmp_63 = call i5 @_ssdm_op_BitConcatenate.i5.i3.i2(i3 %work_load, i2 0) ; [#uses=1 type=i5]
  %tmp_64 = zext i5 %tmp_63 to i6                 ; [#uses=2 type=i6]
  %tmp_65 = add i6 %tmp_64, %tmp_cast, !dbg !169  ; [#uses=1 type=i6] [debug line = 123:9]
  %tmp_70_cast = sext i6 %tmp_65 to i64, !dbg !169 ; [#uses=1 type=i64] [debug line = 123:9]
  %a_addr_2 = getelementptr [16 x float]* %a, i64 0, i64 %tmp_70_cast, !dbg !169 ; [#uses=8 type=float*] [debug line = 123:9]
  %tmp_66 = add i6 %tmp_64, %tmp_10_cast, !dbg !172 ; [#uses=1 type=i6] [debug line = 124:9]
  %tmp_71_cast = sext i6 %tmp_66 to i64, !dbg !172 ; [#uses=1 type=i64] [debug line = 124:9]
  %a_addr_3 = getelementptr [16 x float]* %a, i64 0, i64 %tmp_71_cast, !dbg !172 ; [#uses=5 type=float*] [debug line = 124:9]
  %work_addr_2 = getelementptr [500 x i3]* %work, i64 0, i64 %tmp_10, !dbg !168 ; [#uses=2 type=i3*] [debug line = 118:7]
  %work_load_1 = load i3* %work_addr_2, align 1   ; [#uses=1 type=i3]
  store i3 %work_load, i3* %work_addr_2, align 1, !dbg !173 ; [debug line = 119:7]
  store i3 %work_load_1, i3* %work_addr_1, align 1, !dbg !174 ; [debug line = 120:7]
  ...
  %a_load_7 = load float* %a_addr_2, align 4, !dbg !169 ; [#uses=1 type=float] [debug line = 123:9]
...
entry:
  ...
  %empty_21 = shl i3 1, %empty                    ; [#uses=1 type=i3]
  %empty_22 = and i3 %0, %empty_21                ; [#uses=1 type=i3]
  %empty_23 = icmp ne i3 %empty_22, 0             ; [#uses=1 type=i1]
  ret i1 %empty_23
}
...
entry:
  ...
  %empty_24 = zext i5 %1 to i64                   ; [#uses=1 type=i64]
  %empty_25 = shl i64 %empty, 5                   ; [#uses=1 type=i64]
...
entry:
  ...
  %empty_27 = zext i2 %1 to i6                    ; [#uses=1 type=i6]
  %empty_28 = shl i6 %empty, 2                    ; [#uses=1 type=i6]
...
entry:
  ...
  %empty_30 = zext i2 %1 to i5                    ; [#uses=1 type=i5]
  %empty_31 = shl i5 %empty, 2                    ; [#uses=1 type=i5]
  %empty_32 = or i5 %empty_31, %empty_30          ; [#uses=1 type=i5]
  ret i5 %empty_32
}
...
!48 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 128, i64 32, i32 0, i32 0, metadata !49, metadata !51, i32 0, i32 0} ; [ DW_TAG_array_type ]
...
!55 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 512, i64 32, i32 0, i32 0, metadata !49, metadata !56, i32 0, i32 0} ; [ DW_TAG_array_type ]
...
!67 = metadata !{i32 50, i32 23, metadata !66, null}
...
!71 = metadata !{i32 50, i32 30, metadata !72, null}
!72 = metadata !{i32 786443, metadata !66, i32 50, i32 29, metadata !43, i32 2} ; [ DW_TAG_lexical_block ]
...
!77 = metadata !{i32 56, i32 23, metadata !70, null}
...
!82 = metadata !{i32 786443, metadata !70, i32 56, i32 29, metadata !43, i32 4} ; [ DW_TAG_lexical_block ]
!83 = metadata !{i32 61, i32 6, metadata !84, null}
!84 = metadata !{i32 786443, metadata !81, i32 59, i32 31, metadata !43, i32 6} ; [ DW_TAG_lexical_block ]
!85 = metadata !{i32 82, i32 2, metadata !86, null}
!86 = metadata !{i32 786443, metadata !87, i32 80, i32 33, metadata !43, i32 11} ; [ DW_TAG_lexical_block ]
...
!90 = metadata !{i32 786443, metadata !91, i32 98, i32 37, metadata !43, i32 19} ; [ DW_TAG_lexical_block ]
...
!94 = metadata !{i32 786443, metadata !95, i32 93, i32 31, metadata !43, i32 15} ; [ DW_TAG_lexical_block ]
...
!98 = metadata !{i32 59, i32 32, metadata !84, null}
...
!117 = metadata !{i32 59, i32 25, metadata !81, null}
...
!133 = metadata !{i32 80, i32 27, metadata !87, null}
!134 = metadata !{i32 80, i32 34, metadata !86, null}
...
!142 = metadata !{i32 88, i32 25, metadata !141, null}
!143 = metadata !{i32 99, i32 13, metadata !90, null}
!144 = metadata !{i32 93, i32 11, metadata !95, null}
!145 = metadata !{i32 88, i32 32, metadata !146, null}
!146 = metadata !{i32 786443, metadata !141, i32 88, i32 31, metadata !43, i32 13} ; [ DW_TAG_lexical_block ]
...
!150 = metadata !{i32 93, i32 25, metadata !95, null}
!151 = metadata !{i32 93, i32 32, metadata !94, null}
...
!162 = metadata !{i32 786443, metadata !79, i32 109, i32 25, metadata !43, i32 21} ; [ DW_TAG_lexical_block ]
...
!170 = metadata !{i32 786443, metadata !171, i32 122, i32 33, metadata !43, i32 24} ; [ DW_TAG_lexical_block ]
