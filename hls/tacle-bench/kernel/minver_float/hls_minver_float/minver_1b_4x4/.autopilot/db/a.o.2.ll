...
; [#uses=0]
define i32 @minver_hwa([4 x [4 x float]]* %a) nounwind uwtable {
  call void (...)* @_ssdm_op_SpecBitsMap([4 x [4 x float]]* %a) nounwind, !map !49
  ...
  call void @llvm.dbg.value(metadata !{[4 x [4 x float]]* %a}, i64 0, metadata !59), !dbg !68 ; [debug line = 35:25] [debug variable = a]
  call void (...)* @_ssdm_op_SpecMemCore([4 x [4 x float]]* %a, [1 x i8]* @.str, [12 x i8]* @.str1, [1 x i8]* @.str, i32 -1, [1 x i8]* @.str, [1 x i8]* @.str, [1 x i8]* @.str, [1 x i8]* @.str, [1 x i8]* @.str) nounwind
  call void (...)* @_ssdm_op_SpecInterface([4 x [4 x float]]* %a, [5 x i8]* @.str2, i32 0, i32 0, [1 x i8]* @.str, i32 0, i32 0, [1 x i8]* @.str, [1 x i8]* @.str, [1 x i8]* @.str, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @.str, [1 x i8]* @.str) nounwind
  ...
  call void @llvm.dbg.declare(metadata !{[500 x i4]* %work}, metadata !71), !dbg !75 ; [debug line = 41:6] [debug variable = work]
...
; <label>:3                                       ; preds = %1
  ...
  %work.addr = getelementptr [500 x i4]* %work, i64 0, i64 %tmp, !dbg !85 ; [#uses=1 type=i4*] [debug line = 52:2]
  %i.cast7.cast = zext i3 %i to i4, !dbg !85      ; [#uses=1 type=i4] [debug line = 52:2]
  store i4 %i.cast7.cast, i4* %work.addr, align 1, !dbg !85 ; [debug line = 52:2]
  %4 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str4, i32 %tmp.6) nounwind, !dbg !86 ; [#uses=0 type=i32] [debug line = 53:3]
  %i.1 = add i3 %i, 1, !dbg !87                   ; [#uses=1 type=i3] [debug line = 50:23]
  call void @llvm.dbg.value(metadata !{i3 %i.1}, i64 0, metadata !88), !dbg !87 ; [debug line = 50:23] [debug variable = i]
...
.preheader13:                                     ; preds = %26, %.preheader13.preheader
  ...
  %i.5 = phi i3 [ %k, %26 ], [ 0, %.preheader13.preheader ] ; [#uses=9 type=i3]
  %i.5.cast6 = zext i3 %i.5 to i32, !dbg !78      ; [#uses=2 type=i32] [debug line = 59:11]
  call void @llvm.dbg.value(metadata !{i3 %i.5}, i64 0, metadata !88), !dbg !78 ; [debug line = 59:11] [debug variable = i]
  %tmp.2 = icmp sgt i3 %i.5, -1, !dbg !89         ; [#uses=1 type=i1] [debug line = 56:9]
...
.preheader12.preheader:                           ; preds = %.preheader13
  %tmp.3 = zext i3 %i.5 to i64, !dbg !92          ; [#uses=12 type=i64] [debug line = 61:6]
...
.preheader12:                                     ; preds = %_ifconv, %.preheader12.preheader
  ...
  %exitcond6 = icmp eq i32 %r.3, 4, !dbg !78      ; [#uses=1 type=i1] [debug line = 59:11]
...
_ifconv:                                          ; preds = %.preheader12
  ...
  %a.addr.1 = getelementptr [4 x [4 x float]]* %a, i64 0, i64 %tmp.7, i64 %tmp.3, !dbg !92 ; [#uses=1 type=float*] [debug line = 61:6]
...
_ifconv1:                                         ; preds = %.preheader12
  ...
  %a.addr = getelementptr [4 x [4 x float]]* %a, i64 0, i64 %tmp.4, i64 %tmp.3, !dbg !116 ; [#uses=1 type=float*] [debug line = 68:5]
...
; <label>:9                                       ; preds = %8
  %work.addr.2 = getelementptr [500 x i4]* %work, i64 0, i64 %tmp.3, !dbg !128 ; [#uses=2 type=i4*] [debug line = 77:7]
  %work.load.1 = load i4* %work.addr.2, align 1   ; [#uses=1 type=i4]
  %work.addr.3 = getelementptr [500 x i4]* %work, i64 0, i64 %tmp.4, !dbg !130 ; [#uses=2 type=i4*] [debug line = 78:7]
  %work.load.2 = load i4* %work.addr.3, align 1   ; [#uses=1 type=i4]
  store i4 %work.load.2, i4* %work.addr.2, align 1, !dbg !130 ; [debug line = 78:7]
  store i4 %work.load.1, i4* %work.addr.3, align 1, !dbg !131 ; [debug line = 79:7]
  br label %10, !dbg !132                         ; [debug line = 80:13]

; <label>:10                                      ; preds = %12, %9
  %j = phi i3 [ 0, %9 ], [ %j.1, %12 ]            ; [#uses=3 type=i3]
...
; <label>:12                                      ; preds = %10
  ...
  %tmp.11 = zext i3 %j to i64, !dbg !137          ; [#uses=2 type=i64] [debug line = 82:2]
  %a.addr.4 = getelementptr [4 x [4 x float]]* %a, i64 0, i64 %tmp.3, i64 %tmp.11, !dbg !137 ; [#uses=2 type=float*] [debug line = 82:2]
  ...
  %a.addr.5 = getelementptr [4 x [4 x float]]* %a, i64 0, i64 %tmp.4, i64 %tmp.11, !dbg !138 ; [#uses=2 type=float*] [debug line = 83:9]
  ...
  %j.1 = add i3 %j, 1, !dbg !141                  ; [#uses=1 type=i3] [debug line = 80:27]
  call void @llvm.dbg.value(metadata !{i3 %j.1}, i64 0, metadata !142), !dbg !141 ; [debug line = 80:27] [debug variable = j]
...
; <label>:14                                      ; preds = %16, %.loopexit11
  %i.2 = phi i3 [ 0, %.loopexit11 ], [ %i.8, %16 ] ; [#uses=3 type=i3]
  %exitcond4 = icmp eq i3 %i.2, -4, !dbg !143     ; [#uses=1 type=i1] [debug line = 88:11]
  %15 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 4, i64 4, i64 4) nounwind ; [#uses=0 type=i32]
  br i1 %exitcond4, label %.preheader10.preheader, label %16, !dbg !143 ; [debug line = 88:11]

.preheader10.preheader:                           ; preds = %14
  %tmp.26 = icmp eq i3 %i.5, 0, !dbg !145         ; [#uses=1 type=i1] [debug line = 99:13]
  %tmp.20.1 = icmp eq i3 %i.5, 1, !dbg !145       ; [#uses=1 type=i1] [debug line = 99:13]
  %tmp.20.2 = icmp eq i3 %i.5, 2, !dbg !145       ; [#uses=1 type=i1] [debug line = 99:13]
  %tmp.20.3 = icmp eq i3 %i.5, 3, !dbg !145       ; [#uses=1 type=i1] [debug line = 99:13]
  %a.addr.15 = getelementptr [4 x [4 x float]]* %a, i64 0, i64 %tmp.3, i64 3, !dbg !152 ; [#uses=1 type=float*] [debug line = 99:27]
  %a.addr.13 = getelementptr [4 x [4 x float]]* %a, i64 0, i64 %tmp.3, i64 2, !dbg !152 ; [#uses=1 type=float*] [debug line = 99:27]
  %a.addr.11 = getelementptr [4 x [4 x float]]* %a, i64 0, i64 %tmp.3, i64 1, !dbg !152 ; [#uses=1 type=float*] [debug line = 99:27]
  %a.addr.9 = getelementptr [4 x [4 x float]]* %a, i64 0, i64 %tmp.3, i64 0, !dbg !152 ; [#uses=1 type=float*] [debug line = 99:27]
...
; <label>:16                                      ; preds = %14
  ...
  %tmp.12 = zext i3 %i.2 to i64, !dbg !157        ; [#uses=1 type=i64] [debug line = 90:2]
  %a.addr.6 = getelementptr [4 x [4 x float]]* %a, i64 0, i64 %tmp.3, i64 %tmp.12, !dbg !157 ; [#uses=2 type=float*] [debug line = 90:2]
  ...
  %i.8 = add i3 %i.2, 1, !dbg !159                ; [#uses=1 type=i3] [debug line = 88:25]
  call void @llvm.dbg.value(metadata !{i3 %i.8}, i64 0, metadata !88), !dbg !159 ; [debug line = 88:25] [debug variable = i]
...
.preheader10:                                     ; preds = %._crit_edge, %.preheader10.preheader
  ...
  %exitcond3 = icmp eq i3 %i.3, -4, !dbg !153     ; [#uses=1 type=i1] [debug line = 93:11]
  %18 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 4, i64 4, i64 4) nounwind ; [#uses=0 type=i32]
  br i1 %exitcond3, label %26, label %19, !dbg !153 ; [debug line = 93:11]
...
; <label>:19                                      ; preds = %.preheader10
  ...
  %tmp.15 = icmp eq i3 %i.3, %i.5, !dbg !162      ; [#uses=1 type=i1] [debug line = 95:2]
  br i1 %tmp.15, label %._crit_edge, label %20, !dbg !162 ; [debug line = 95:2]

; <label>:20                                      ; preds = %19
  %tmp.16 = zext i3 %i.3 to i64, !dbg !163        ; [#uses=5 type=i64] [debug line = 96:9]
  %a.addr.8 = getelementptr [4 x [4 x float]]* %a, i64 0, i64 %tmp.16, i64 %tmp.3, !dbg !163 ; [#uses=2 type=float*] [debug line = 96:9]
  %w.2 = load float* %a.addr.8, align 4, !dbg !163 ; [#uses=7 type=float] [debug line = 96:9]
...
; <label>:21                                      ; preds = %.preheader9.0
  %a.load.10 = load float* %a.addr.9, align 4, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp.27 = fmul float %w.2, %a.load.10, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
  %a.addr.10 = getelementptr [4 x [4 x float]]* %a, i64 0, i64 %tmp.16, i64 0, !dbg !152 ; [#uses=2 type=float*] [debug line = 99:27]
  %a.load.11 = load float* %a.addr.10, align 4, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp.28 = fsub float %a.load.11, %tmp.27, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
...
; <label>:22                                      ; preds = %.preheader9.1
  %a.load.12 = load float* %a.addr.11, align 4, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp.22.1 = fmul float %w.2, %a.load.12, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
  %a.addr.12 = getelementptr [4 x [4 x float]]* %a, i64 0, i64 %tmp.16, i64 1, !dbg !152 ; [#uses=2 type=float*] [debug line = 99:27]
  %a.load.13 = load float* %a.addr.12, align 4, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp.23.1 = fsub float %a.load.13, %tmp.22.1, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
...
; <label>:23                                      ; preds = %.preheader9.2
  %a.load.14 = load float* %a.addr.13, align 4, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp.22.2 = fmul float %w.2, %a.load.14, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
  %a.addr.14 = getelementptr [4 x [4 x float]]* %a, i64 0, i64 %tmp.16, i64 2, !dbg !152 ; [#uses=2 type=float*] [debug line = 99:27]
  %a.load.15 = load float* %a.addr.14, align 4, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp.23.2 = fsub float %a.load.15, %tmp.22.2, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
...
; <label>:24                                      ; preds = %.preheader9.3
  %a.load.16 = load float* %a.addr.15, align 4, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp.22.3 = fmul float %w.2, %a.load.16, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
  %a.addr.16 = getelementptr [4 x [4 x float]]* %a, i64 0, i64 %tmp.16, i64 3, !dbg !152 ; [#uses=2 type=float*] [debug line = 99:27]
  %a.load.17 = load float* %a.addr.16, align 4, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp.23.3 = fsub float %a.load.17, %tmp.22.3, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
...
._crit_edge18:                                    ; preds = %.preheader9.4, %20
  br label %._crit_edge, !dbg !167                ; [debug line = 103:7]

._crit_edge:                                      ; preds = %._crit_edge18, %19
  %25 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str8, i32 %tmp.25) nounwind, !dbg !168 ; [#uses=0 type=i32] [debug line = 104:5]
  %i.9 = add i3 %i.3, 1, !dbg !169                ; [#uses=1 type=i3] [debug line = 93:25]
  call void @llvm.dbg.value(metadata !{i3 %i.9}, i64 0, metadata !88), !dbg !169 ; [debug line = 93:25] [debug variable = i]
...
; <label>:26                                      ; preds = %.preheader10
  ...
  %a.addr.7 = getelementptr [4 x [4 x float]]* %a, i64 0, i64 %tmp.3, i64 %tmp.3, !dbg !117 ; [#uses=1 type=float*] [debug line = 105:5]
  store float %tmp.14, float* %a.addr.7, align 4, !dbg !117 ; [debug line = 105:5]
  %k = add i3 %i.5, 1, !dbg !170                  ; [#uses=1 type=i3] [debug line = 56:23]
  call void @llvm.dbg.value(metadata !{i3 %k}, i64 0, metadata !171), !dbg !170 ; [debug line = 56:23] [debug variable = k]
  br label %.preheader13, !dbg !170               ; [debug line = 56:23]

.preheader8:                                      ; preds = %30, %.preheader8.preheader
  %i.4 = phi i3 [ %i.7, %30 ], [ 0, %.preheader8.preheader ] ; [#uses=4 type=i3]
  %i.4.cast2.cast = zext i3 %i.4 to i4, !dbg !90  ; [#uses=1 type=i4] [debug line = 109:9]
  %exitcond1 = icmp eq i3 %i.4, -4, !dbg !90      ; [#uses=1 type=i1] [debug line = 109:9]
  %27 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 4, i64 4, i64 4) nounwind ; [#uses=0 type=i32]
...
.preheader.preheader:                             ; preds = %.preheader8
  %tmp. = zext i3 %i.4 to i64, !dbg !172          ; [#uses=2 type=i64] [debug line = 114:2]
  %work.addr.1 = getelementptr [500 x i4]* %work, i64 0, i64 %tmp., !dbg !172 ; [#uses=2 type=i4*] [debug line = 114:2]
...
.preheader:                                       ; preds = %28, %.preheader.preheader
  ...
  %work.load = load i4* %work.addr.1, align 1     ; [#uses=3 type=i4]
  %tmp.8 = icmp eq i4 %work.load, %i.4.cast2.cast, !dbg !177 ; [#uses=1 type=i1] [debug line = 116:7]
  br i1 %tmp.8, label %30, label %28, !dbg !177   ; [debug line = 116:7]

; <label>:28                                      ; preds = %.preheader
  %tmp.10 = sext i4 %work.load to i64, !dbg !178  ; [#uses=4 type=i64] [debug line = 118:7]
  %work.addr.4 = getelementptr [500 x i4]* %work, i64 0, i64 %tmp.10, !dbg !178 ; [#uses=2 type=i4*] [debug line = 118:7]
  %work.load.3 = load i4* %work.addr.4, align 1   ; [#uses=1 type=i4]
  store i4 %work.load, i4* %work.addr.4, align 1, !dbg !179 ; [debug line = 119:7]
  store i4 %work.load.3, i4* %work.addr.1, align 1, !dbg !180 ; [debug line = 120:7]
  %a.addr.2 = getelementptr [4 x [4 x float]]* %a, i64 0, i64 %tmp.10, i64 %tmp., !dbg !181 ; [#uses=8 type=float*] [debug line = 123:9]
  %a.addr.3 = getelementptr [4 x [4 x float]]* %a, i64 0, i64 %tmp.10, i64 %tmp.10, !dbg !184 ; [#uses=5 type=float*] [debug line = 124:9]
  ...
  %a.load.7 = load float* %a.addr.2, align 4, !dbg !181 ; [#uses=1 type=float] [debug line = 123:9]
  ...
  %29 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str9, i32 %tmp.22) nounwind, !dbg !186 ; [#uses=0 type=i32] [debug line = 127:5]
  br label %.preheader, !dbg !186                 ; [debug line = 127:5]

; <label>:30                                      ; preds = %.preheader
  %i.7 = add i3 %i.4, 1, !dbg !187                ; [#uses=1 type=i3] [debug line = 129:5]
  call void @llvm.dbg.value(metadata !{i3 %i.7}, i64 0, metadata !88), !dbg !187 ; [debug line = 129:5] [debug variable = i]
...
!64 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 128, i64 32, i32 0, i32 0, metadata !36, metadata !65, i32 0, i32 0} ; [ DW_TAG_array_type ]
