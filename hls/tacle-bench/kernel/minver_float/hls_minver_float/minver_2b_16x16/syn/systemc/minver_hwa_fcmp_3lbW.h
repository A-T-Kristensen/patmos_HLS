...
#ifndef __minver_hwa_fcmp_3lbW__HH__
#define __minver_hwa_fcmp_3lbW__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(minver_hwa_fcmp_3lbW) {
    ...
    SC_CTOR(minver_hwa_fcmp_3lbW):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
