; ModuleID = '/home/patmos/github/bachelor_project_HLS/hls/tacle-bench/kernel/minver_float/hls_minver_float/minver_1b_16x16/.autopilot/db/a.g.bc'
...
define i32 @minver_hwa([16 x float]* %a) nounwind uwtable {
  ...
  %5 = load [16 x float]** %2, align 8, !dbg !381 ; [#uses=1 type=[16 x float]*] [debug line = 38:1]
  ...
  br label %6, !dbg !412                          ; [debug line = 50:9]

; <label>:6                                       ; preds = %14, %0
  %7 = load i32* %i, align 4, !dbg !412           ; [#uses=1 type=i32] [debug line = 50:9]
  %8 = icmp slt i32 %7, 16, !dbg !412             ; [#uses=1 type=i1] [debug line = 50:9]
  br i1 %8, label %9, label %17, !dbg !412        ; [debug line = 50:9]

; <label>:9                                       ; preds = %6
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str4, i32 0, i32 0)) nounwind, !dbg !414 ; [debug line = 50:31]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str, i32 0, i32 0)) nounwind, !dbg !416 ; [debug line = 51:1]
  %10 = load i32* %i, align 4, !dbg !417          ; [#uses=1 type=i32] [debug line = 52:2]
  %11 = load i32* %i, align 4, !dbg !417          ; [#uses=1 type=i32] [debug line = 52:2]
  %12 = sext i32 %11 to i64, !dbg !417            ; [#uses=1 type=i64] [debug line = 52:2]
  %13 = getelementptr inbounds [500 x i32]* %work, i32 0, i64 %12, !dbg !417 ; [#uses=1 type=i32*] [debug line = 52:2]
  store i32 %10, i32* %13, align 4, !dbg !417     ; [debug line = 52:2]
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str4, i32 0, i32 0)) nounwind, !dbg !418 ; [debug line = 53:3]
  br label %14, !dbg !418                         ; [debug line = 53:3]

; <label>:14                                      ; preds = %9
  %15 = load i32* %i, align 4, !dbg !419          ; [#uses=1 type=i32] [debug line = 50:24]
  %16 = add nsw i32 %15, 1, !dbg !419             ; [#uses=1 type=i32] [debug line = 50:24]
  store i32 %16, i32* %i, align 4, !dbg !419      ; [debug line = 50:24]
  br label %6, !dbg !419                          ; [debug line = 50:24]

; <label>:17                                      ; preds = %6
  store i32 0, i32* %k, align 4, !dbg !420        ; [debug line = 56:9]
  br label %18, !dbg !420                         ; [debug line = 56:9]

; <label>:18                                      ; preds = %225, %17
  %19 = load i32* %k, align 4, !dbg !420          ; [#uses=1 type=i32] [debug line = 56:9]
  %20 = icmp slt i32 %19, 16, !dbg !420           ; [#uses=1 type=i1] [debug line = 56:9]
  br i1 %20, label %21, label %228, !dbg !420     ; [debug line = 56:9]

; <label>:21                                      ; preds = %18
  store float 0.000000e+00, float* %wmax, align 4, !dbg !422 ; [debug line = 58:5]
  %22 = load i32* %k, align 4, !dbg !424          ; [#uses=1 type=i32] [debug line = 59:11]
  store i32 %22, i32* %i, align 4, !dbg !424      ; [debug line = 59:11]
  br label %23, !dbg !424                         ; [debug line = 59:11]

; <label>:23                                      ; preds = %43, %21
  %24 = load i32* %i, align 4, !dbg !424          ; [#uses=1 type=i32] [debug line = 59:11]
  %25 = icmp slt i32 %24, 16, !dbg !424           ; [#uses=1 type=i1] [debug line = 59:11]
  br i1 %25, label %26, label %46, !dbg !424      ; [debug line = 59:11]

; <label>:26                                      ; preds = %23
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str5, i32 0, i32 0)) nounwind, !dbg !426 ; [debug line = 59:33]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str, i32 0, i32 0)) nounwind, !dbg !428 ; [debug line = 60:1]
  %27 = load i32* %k, align 4, !dbg !429          ; [#uses=1 type=i32] [debug line = 61:6]
  %28 = sext i32 %27 to i64, !dbg !429            ; [#uses=1 type=i64] [debug line = 61:6]
  %29 = load i32* %i, align 4, !dbg !429          ; [#uses=1 type=i32] [debug line = 61:6]
  %30 = sext i32 %29 to i64, !dbg !429            ; [#uses=1 type=i64] [debug line = 61:6]
  %31 = load [16 x float]** %2, align 8, !dbg !429 ; [#uses=1 type=[16 x float]*] [debug line = 61:6]
  %32 = getelementptr inbounds [16 x float]* %31, i64 %30, !dbg !429 ; [#uses=1 type=[16 x float]*] [debug line = 61:6]
  %33 = getelementptr inbounds [16 x float]* %32, i32 0, i64 %28, !dbg !429 ; [#uses=1 type=float*] [debug line = 61:6]
  %34 = load float* %33, align 4, !dbg !429       ; [#uses=1 type=float] [debug line = 61:6]
  %35 = call float @minver_fabs(float %34), !dbg !429 ; [#uses=1 type=float] [debug line = 61:6]
  store float %35, float* %w, align 4, !dbg !429  ; [debug line = 61:6]
  %36 = load float* %w, align 4, !dbg !430        ; [#uses=1 type=float] [debug line = 62:7]
  %37 = load float* %wmax, align 4, !dbg !430     ; [#uses=1 type=float] [debug line = 62:7]
  %38 = fcmp ogt float %36, %37, !dbg !430        ; [#uses=1 type=i1] [debug line = 62:7]
  br i1 %38, label %39, label %42, !dbg !430      ; [debug line = 62:7]

; <label>:39                                      ; preds = %26
  %40 = load float* %w, align 4, !dbg !431        ; [#uses=1 type=float] [debug line = 63:9]
  store float %40, float* %wmax, align 4, !dbg !431 ; [debug line = 63:9]
  %41 = load i32* %i, align 4, !dbg !433          ; [#uses=1 type=i32] [debug line = 64:9]
  store i32 %41, i32* %r, align 4, !dbg !433      ; [debug line = 64:9]
  br label %42, !dbg !434                         ; [debug line = 65:7]

; <label>:42                                      ; preds = %39, %26
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str5, i32 0, i32 0)) nounwind, !dbg !435 ; [debug line = 66:5]
  br label %43, !dbg !435                         ; [debug line = 66:5]

; <label>:43                                      ; preds = %42
  %44 = load i32* %i, align 4, !dbg !436          ; [#uses=1 type=i32] [debug line = 59:26]
  %45 = add nsw i32 %44, 1, !dbg !436             ; [#uses=1 type=i32] [debug line = 59:26]
  store i32 %45, i32* %i, align 4, !dbg !436      ; [debug line = 59:26]
  br label %23, !dbg !436                         ; [debug line = 59:26]

; <label>:46                                      ; preds = %23
  %47 = load i32* %k, align 4, !dbg !437          ; [#uses=1 type=i32] [debug line = 68:5]
  %48 = sext i32 %47 to i64, !dbg !437            ; [#uses=1 type=i64] [debug line = 68:5]
  %49 = load i32* %r, align 4, !dbg !437          ; [#uses=1 type=i32] [debug line = 68:5]
  %50 = sext i32 %49 to i64, !dbg !437            ; [#uses=1 type=i64] [debug line = 68:5]
  %51 = load [16 x float]** %2, align 8, !dbg !437 ; [#uses=1 type=[16 x float]*] [debug line = 68:5]
  %52 = getelementptr inbounds [16 x float]* %51, i64 %50, !dbg !437 ; [#uses=1 type=[16 x float]*] [debug line = 68:5]
  %53 = getelementptr inbounds [16 x float]* %52, i32 0, i64 %48, !dbg !437 ; [#uses=1 type=float*] [debug line = 68:5]
  %54 = load float* %53, align 4, !dbg !437       ; [#uses=1 type=float] [debug line = 68:5]
  store float %54, float* %pivot, align 4, !dbg !437 ; [debug line = 68:5]
  %55 = load float* %pivot, align 4, !dbg !438    ; [#uses=1 type=float] [debug line = 69:11]
  %56 = call float @minver_fabs(float %55), !dbg !438 ; [#uses=1 type=float] [debug line = 69:11]
  store float %56, float* %api, align 4, !dbg !438 ; [debug line = 69:11]
  %57 = load float* %api, align 4, !dbg !439      ; [#uses=1 type=float] [debug line = 70:5]
  %58 = fpext float %57 to double, !dbg !439      ; [#uses=1 type=double] [debug line = 70:5]
  %59 = fcmp ole double %58, 1.000000e-06, !dbg !439 ; [#uses=1 type=i1] [debug line = 70:5]
  br i1 %59, label %60, label %62, !dbg !439      ; [debug line = 70:5]

; <label>:60                                      ; preds = %46
  %61 = load float* %w1, align 4, !dbg !440       ; [#uses=1 type=float] [debug line = 71:7]
  store float %61, float* %minver_det, align 4, !dbg !440 ; [debug line = 71:7]
  store i32 1, i32* %1, !dbg !442                 ; [debug line = 72:7]
  br label %302, !dbg !442                        ; [debug line = 72:7]

; <label>:62                                      ; preds = %46
  %63 = load float* %pivot, align 4, !dbg !443    ; [#uses=1 type=float] [debug line = 74:5]
  %64 = load float* %w1, align 4, !dbg !443       ; [#uses=1 type=float] [debug line = 74:5]
  %65 = fmul float %64, %63, !dbg !443            ; [#uses=1 type=float] [debug line = 74:5]
  store float %65, float* %w1, align 4, !dbg !443 ; [debug line = 74:5]
  %66 = load i32* %r, align 4, !dbg !444          ; [#uses=1 type=i32] [debug line = 75:5]
  %67 = load i32* %k, align 4, !dbg !444          ; [#uses=1 type=i32] [debug line = 75:5]
  %68 = icmp ne i32 %66, %67, !dbg !444           ; [#uses=1 type=i1] [debug line = 75:5]
  br i1 %68, label %69, label %126, !dbg !444     ; [debug line = 75:5]

; <label>:69                                      ; preds = %62
  %70 = load float* %w, align 4, !dbg !445        ; [#uses=1 type=float] [debug line = 76:7]
  %71 = fsub float -0.000000e+00, %70, !dbg !445  ; [#uses=1 type=float] [debug line = 76:7]
  store float %71, float* %w1, align 4, !dbg !445 ; [debug line = 76:7]
  %72 = load i32* %k, align 4, !dbg !447          ; [#uses=1 type=i32] [debug line = 77:7]
  %73 = sext i32 %72 to i64, !dbg !447            ; [#uses=1 type=i64] [debug line = 77:7]
  %74 = getelementptr inbounds [500 x i32]* %work, i32 0, i64 %73, !dbg !447 ; [#uses=1 type=i32*] [debug line = 77:7]
  %75 = load i32* %74, align 4, !dbg !447         ; [#uses=1 type=i32] [debug line = 77:7]
  store i32 %75, i32* %iw, align 4, !dbg !447     ; [debug line = 77:7]
  %76 = load i32* %r, align 4, !dbg !448          ; [#uses=1 type=i32] [debug line = 78:7]
  %77 = sext i32 %76 to i64, !dbg !448            ; [#uses=1 type=i64] [debug line = 78:7]
  %78 = getelementptr inbounds [500 x i32]* %work, i32 0, i64 %77, !dbg !448 ; [#uses=1 type=i32*] [debug line = 78:7]
  %79 = load i32* %78, align 4, !dbg !448         ; [#uses=1 type=i32] [debug line = 78:7]
  %80 = load i32* %k, align 4, !dbg !448          ; [#uses=1 type=i32] [debug line = 78:7]
  %81 = sext i32 %80 to i64, !dbg !448            ; [#uses=1 type=i64] [debug line = 78:7]
  %82 = getelementptr inbounds [500 x i32]* %work, i32 0, i64 %81, !dbg !448 ; [#uses=1 type=i32*] [debug line = 78:7]
  store i32 %79, i32* %82, align 4, !dbg !448     ; [debug line = 78:7]
  %83 = load i32* %iw, align 4, !dbg !449         ; [#uses=1 type=i32] [debug line = 79:7]
  %84 = load i32* %r, align 4, !dbg !449          ; [#uses=1 type=i32] [debug line = 79:7]
  %85 = sext i32 %84 to i64, !dbg !449            ; [#uses=1 type=i64] [debug line = 79:7]
  %86 = getelementptr inbounds [500 x i32]* %work, i32 0, i64 %85, !dbg !449 ; [#uses=1 type=i32*] [debug line = 79:7]
  store i32 %83, i32* %86, align 4, !dbg !449     ; [debug line = 79:7]
  store i32 0, i32* %j, align 4, !dbg !450        ; [debug line = 80:13]
  br label %87, !dbg !450                         ; [debug line = 80:13]

; <label>:87                                      ; preds = %122, %69
  %88 = load i32* %j, align 4, !dbg !450          ; [#uses=1 type=i32] [debug line = 80:13]
  %89 = icmp slt i32 %88, 16, !dbg !450           ; [#uses=1 type=i1] [debug line = 80:13]
  br i1 %89, label %90, label %125, !dbg !450     ; [debug line = 80:13]

; <label>:90                                      ; preds = %87
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str6, i32 0, i32 0)) nounwind, !dbg !452 ; [debug line = 80:35]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str, i32 0, i32 0)) nounwind, !dbg !454 ; [debug line = 81:1]
  %91 = load i32* %j, align 4, !dbg !455          ; [#uses=1 type=i32] [debug line = 82:2]
  %92 = sext i32 %91 to i64, !dbg !455            ; [#uses=1 type=i64] [debug line = 82:2]
  %93 = load i32* %k, align 4, !dbg !455          ; [#uses=1 type=i32] [debug line = 82:2]
  %94 = sext i32 %93 to i64, !dbg !455            ; [#uses=1 type=i64] [debug line = 82:2]
  %95 = load [16 x float]** %2, align 8, !dbg !455 ; [#uses=1 type=[16 x float]*] [debug line = 82:2]
  %96 = getelementptr inbounds [16 x float]* %95, i64 %94, !dbg !455 ; [#uses=1 type=[16 x float]*] [debug line = 82:2]
  %97 = getelementptr inbounds [16 x float]* %96, i32 0, i64 %92, !dbg !455 ; [#uses=1 type=float*] [debug line = 82:2]
  %98 = load float* %97, align 4, !dbg !455       ; [#uses=1 type=float] [debug line = 82:2]
  store float %98, float* %w, align 4, !dbg !455  ; [debug line = 82:2]
  %99 = load i32* %j, align 4, !dbg !456          ; [#uses=1 type=i32] [debug line = 83:9]
  %100 = sext i32 %99 to i64, !dbg !456           ; [#uses=1 type=i64] [debug line = 83:9]
  %101 = load i32* %r, align 4, !dbg !456         ; [#uses=1 type=i32] [debug line = 83:9]
  %102 = sext i32 %101 to i64, !dbg !456          ; [#uses=1 type=i64] [debug line = 83:9]
  %103 = load [16 x float]** %2, align 8, !dbg !456 ; [#uses=1 type=[16 x float]*] [debug line = 83:9]
  %104 = getelementptr inbounds [16 x float]* %103, i64 %102, !dbg !456 ; [#uses=1 type=[16 x float]*] [debug line = 83:9]
  %105 = getelementptr inbounds [16 x float]* %104, i32 0, i64 %100, !dbg !456 ; [#uses=1 type=float*] [debug line = 83:9]
  %106 = load float* %105, align 4, !dbg !456     ; [#uses=1 type=float] [debug line = 83:9]
  %107 = load i32* %j, align 4, !dbg !456         ; [#uses=1 type=i32] [debug line = 83:9]
  %108 = sext i32 %107 to i64, !dbg !456          ; [#uses=1 type=i64] [debug line = 83:9]
  %109 = load i32* %k, align 4, !dbg !456         ; [#uses=1 type=i32] [debug line = 83:9]
  %110 = sext i32 %109 to i64, !dbg !456          ; [#uses=1 type=i64] [debug line = 83:9]
  %111 = load [16 x float]** %2, align 8, !dbg !456 ; [#uses=1 type=[16 x float]*] [debug line = 83:9]
  %112 = getelementptr inbounds [16 x float]* %111, i64 %110, !dbg !456 ; [#uses=1 type=[16 x float]*] [debug line = 83:9]
  %113 = getelementptr inbounds [16 x float]* %112, i32 0, i64 %108, !dbg !456 ; [#uses=1 type=float*] [debug line = 83:9]
  store float %106, float* %113, align 4, !dbg !456 ; [debug line = 83:9]
  %114 = load float* %w, align 4, !dbg !457       ; [#uses=1 type=float] [debug line = 84:9]
  %115 = load i32* %j, align 4, !dbg !457         ; [#uses=1 type=i32] [debug line = 84:9]
  %116 = sext i32 %115 to i64, !dbg !457          ; [#uses=1 type=i64] [debug line = 84:9]
  %117 = load i32* %r, align 4, !dbg !457         ; [#uses=1 type=i32] [debug line = 84:9]
  %118 = sext i32 %117 to i64, !dbg !457          ; [#uses=1 type=i64] [debug line = 84:9]
  %119 = load [16 x float]** %2, align 8, !dbg !457 ; [#uses=1 type=[16 x float]*] [debug line = 84:9]
  %120 = getelementptr inbounds [16 x float]* %119, i64 %118, !dbg !457 ; [#uses=1 type=[16 x float]*] [debug line = 84:9]
  %121 = getelementptr inbounds [16 x float]* %120, i32 0, i64 %116, !dbg !457 ; [#uses=1 type=float*] [debug line = 84:9]
  store float %114, float* %121, align 4, !dbg !457 ; [debug line = 84:9]
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str6, i32 0, i32 0)) nounwind, !dbg !458 ; [debug line = 85:7]
  br label %122, !dbg !458                        ; [debug line = 85:7]

; <label>:122                                     ; preds = %90
  %123 = load i32* %j, align 4, !dbg !459         ; [#uses=1 type=i32] [debug line = 80:28]
  %124 = add nsw i32 %123, 1, !dbg !459           ; [#uses=1 type=i32] [debug line = 80:28]
  store i32 %124, i32* %j, align 4, !dbg !459     ; [debug line = 80:28]
  br label %87, !dbg !459                         ; [debug line = 80:28]

; <label>:125                                     ; preds = %87
  br label %126, !dbg !460                        ; [debug line = 86:5]

; <label>:126                                     ; preds = %125, %62
  store i32 0, i32* %i, align 4, !dbg !461        ; [debug line = 88:11]
  br label %127, !dbg !461                        ; [debug line = 88:11]

; <label>:127                                     ; preds = %141, %126
  %128 = load i32* %i, align 4, !dbg !461         ; [#uses=1 type=i32] [debug line = 88:11]
  %129 = icmp slt i32 %128, 16, !dbg !461         ; [#uses=1 type=i1] [debug line = 88:11]
  br i1 %129, label %130, label %144, !dbg !461   ; [debug line = 88:11]

; <label>:130                                     ; preds = %127
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str7, i32 0, i32 0)) nounwind, !dbg !463 ; [debug line = 88:33]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str, i32 0, i32 0)) nounwind, !dbg !465 ; [debug line = 89:1]
  %131 = load float* %pivot, align 4, !dbg !466   ; [#uses=1 type=float] [debug line = 90:2]
  %132 = load i32* %i, align 4, !dbg !466         ; [#uses=1 type=i32] [debug line = 90:2]
  %133 = sext i32 %132 to i64, !dbg !466          ; [#uses=1 type=i64] [debug line = 90:2]
  %134 = load i32* %k, align 4, !dbg !466         ; [#uses=1 type=i32] [debug line = 90:2]
  %135 = sext i32 %134 to i64, !dbg !466          ; [#uses=1 type=i64] [debug line = 90:2]
  %136 = load [16 x float]** %2, align 8, !dbg !466 ; [#uses=1 type=[16 x float]*] [debug line = 90:2]
  %137 = getelementptr inbounds [16 x float]* %136, i64 %135, !dbg !466 ; [#uses=1 type=[16 x float]*] [debug line = 90:2]
  %138 = getelementptr inbounds [16 x float]* %137, i32 0, i64 %133, !dbg !466 ; [#uses=2 type=float*] [debug line = 90:2]
  %139 = load float* %138, align 4, !dbg !466     ; [#uses=1 type=float] [debug line = 90:2]
  %140 = fdiv float %139, %131, !dbg !466         ; [#uses=1 type=float] [debug line = 90:2]
  store float %140, float* %138, align 4, !dbg !466 ; [debug line = 90:2]
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str7, i32 0, i32 0)) nounwind, !dbg !467 ; [debug line = 91:5]
  br label %141, !dbg !467                        ; [debug line = 91:5]

; <label>:141                                     ; preds = %130
  %142 = load i32* %i, align 4, !dbg !468         ; [#uses=1 type=i32] [debug line = 88:26]
  %143 = add nsw i32 %142, 1, !dbg !468           ; [#uses=1 type=i32] [debug line = 88:26]
  store i32 %143, i32* %i, align 4, !dbg !468     ; [debug line = 88:26]
  br label %127, !dbg !468                        ; [debug line = 88:26]

; <label>:144                                     ; preds = %127
  store i32 0, i32* %i, align 4, !dbg !469        ; [debug line = 93:11]
  br label %145, !dbg !469                        ; [debug line = 93:11]

; <label>:145                                     ; preds = %210, %144
  %146 = load i32* %i, align 4, !dbg !469         ; [#uses=1 type=i32] [debug line = 93:11]
  %147 = icmp slt i32 %146, 16, !dbg !469         ; [#uses=1 type=i1] [debug line = 93:11]
  br i1 %147, label %148, label %213, !dbg !469   ; [debug line = 93:11]

; <label>:148                                     ; preds = %145
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str8, i32 0, i32 0)) nounwind, !dbg !471 ; [debug line = 93:33]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str, i32 0, i32 0)) nounwind, !dbg !473 ; [debug line = 94:1]
  %149 = load i32* %i, align 4, !dbg !474         ; [#uses=1 type=i32] [debug line = 95:2]
  %150 = load i32* %k, align 4, !dbg !474         ; [#uses=1 type=i32] [debug line = 95:2]
  %151 = icmp ne i32 %149, %150, !dbg !474        ; [#uses=1 type=i1] [debug line = 95:2]
  br i1 %151, label %152, label %209, !dbg !474   ; [debug line = 95:2]

; <label>:152                                     ; preds = %148
  %153 = load i32* %k, align 4, !dbg !475         ; [#uses=1 type=i32] [debug line = 96:9]
  %154 = sext i32 %153 to i64, !dbg !475          ; [#uses=1 type=i64] [debug line = 96:9]
  %155 = load i32* %i, align 4, !dbg !475         ; [#uses=1 type=i32] [debug line = 96:9]
  %156 = sext i32 %155 to i64, !dbg !475          ; [#uses=1 type=i64] [debug line = 96:9]
  %157 = load [16 x float]** %2, align 8, !dbg !475 ; [#uses=1 type=[16 x float]*] [debug line = 96:9]
  %158 = getelementptr inbounds [16 x float]* %157, i64 %156, !dbg !475 ; [#uses=1 type=[16 x float]*] [debug line = 96:9]
  %159 = getelementptr inbounds [16 x float]* %158, i32 0, i64 %154, !dbg !475 ; [#uses=1 type=float*] [debug line = 96:9]
  %160 = load float* %159, align 4, !dbg !475     ; [#uses=1 type=float] [debug line = 96:9]
  store float %160, float* %w, align 4, !dbg !475 ; [debug line = 96:9]
  %161 = load float* %w, align 4, !dbg !477       ; [#uses=1 type=float] [debug line = 97:9]
  %162 = fpext float %161 to double, !dbg !477    ; [#uses=1 type=double] [debug line = 97:9]
  %163 = fcmp une double %162, 0.000000e+00, !dbg !477 ; [#uses=1 type=i1] [debug line = 97:9]
  br i1 %163, label %164, label %208, !dbg !477   ; [debug line = 97:9]

; <label>:164                                     ; preds = %152
  store i32 0, i32* %j, align 4, !dbg !478        ; [debug line = 98:17]
  br label %165, !dbg !478                        ; [debug line = 98:17]

; <label>:165                                     ; preds = %193, %164
  %166 = load i32* %j, align 4, !dbg !478         ; [#uses=1 type=i32] [debug line = 98:17]
  %167 = icmp slt i32 %166, 16, !dbg !478         ; [#uses=1 type=i1] [debug line = 98:17]
  br i1 %167, label %168, label %196, !dbg !478   ; [debug line = 98:17]

; <label>:168                                     ; preds = %165
  %169 = load i32* %j, align 4, !dbg !481         ; [#uses=1 type=i32] [debug line = 99:13]
  %170 = load i32* %k, align 4, !dbg !481         ; [#uses=1 type=i32] [debug line = 99:13]
  %171 = icmp ne i32 %169, %170, !dbg !481        ; [#uses=1 type=i1] [debug line = 99:13]
  br i1 %171, label %172, label %192, !dbg !481   ; [debug line = 99:13]

; <label>:172                                     ; preds = %168
  %173 = load float* %w, align 4, !dbg !483       ; [#uses=1 type=float] [debug line = 99:27]
  %174 = load i32* %j, align 4, !dbg !483         ; [#uses=1 type=i32] [debug line = 99:27]
  %175 = sext i32 %174 to i64, !dbg !483          ; [#uses=1 type=i64] [debug line = 99:27]
  %176 = load i32* %k, align 4, !dbg !483         ; [#uses=1 type=i32] [debug line = 99:27]
  %177 = sext i32 %176 to i64, !dbg !483          ; [#uses=1 type=i64] [debug line = 99:27]
  %178 = load [16 x float]** %2, align 8, !dbg !483 ; [#uses=1 type=[16 x float]*] [debug line = 99:27]
  %179 = getelementptr inbounds [16 x float]* %178, i64 %177, !dbg !483 ; [#uses=1 type=[16 x float]*] [debug line = 99:27]
  %180 = getelementptr inbounds [16 x float]* %179, i32 0, i64 %175, !dbg !483 ; [#uses=1 type=float*] [debug line = 99:27]
  %181 = load float* %180, align 4, !dbg !483     ; [#uses=1 type=float] [debug line = 99:27]
  %182 = fmul float %173, %181, !dbg !483         ; [#uses=1 type=float] [debug line = 99:27]
  %183 = load i32* %j, align 4, !dbg !483         ; [#uses=1 type=i32] [debug line = 99:27]
  %184 = sext i32 %183 to i64, !dbg !483          ; [#uses=1 type=i64] [debug line = 99:27]
  %185 = load i32* %i, align 4, !dbg !483         ; [#uses=1 type=i32] [debug line = 99:27]
  %186 = sext i32 %185 to i64, !dbg !483          ; [#uses=1 type=i64] [debug line = 99:27]
  %187 = load [16 x float]** %2, align 8, !dbg !483 ; [#uses=1 type=[16 x float]*] [debug line = 99:27]
  %188 = getelementptr inbounds [16 x float]* %187, i64 %186, !dbg !483 ; [#uses=1 type=[16 x float]*] [debug line = 99:27]
  %189 = getelementptr inbounds [16 x float]* %188, i32 0, i64 %184, !dbg !483 ; [#uses=2 type=float*] [debug line = 99:27]
  %190 = load float* %189, align 4, !dbg !483     ; [#uses=1 type=float] [debug line = 99:27]
  %191 = fsub float %190, %182, !dbg !483         ; [#uses=1 type=float] [debug line = 99:27]
  store float %191, float* %189, align 4, !dbg !483 ; [debug line = 99:27]
  br label %192, !dbg !483                        ; [debug line = 99:27]

; <label>:192                                     ; preds = %172, %168
  br label %193, !dbg !484                        ; [debug line = 100:11]

; <label>:193                                     ; preds = %192
  %194 = load i32* %j, align 4, !dbg !485         ; [#uses=1 type=i32] [debug line = 98:32]
  %195 = add nsw i32 %194, 1, !dbg !485           ; [#uses=1 type=i32] [debug line = 98:32]
  store i32 %195, i32* %j, align 4, !dbg !485     ; [debug line = 98:32]
  br label %165, !dbg !485                        ; [debug line = 98:32]

; <label>:196                                     ; preds = %165
  %197 = load float* %w, align 4, !dbg !486       ; [#uses=1 type=float] [debug line = 101:11]
  %198 = fsub float -0.000000e+00, %197, !dbg !486 ; [#uses=1 type=float] [debug line = 101:11]
  %199 = load float* %pivot, align 4, !dbg !486   ; [#uses=1 type=float] [debug line = 101:11]
  %200 = fdiv float %198, %199, !dbg !486         ; [#uses=1 type=float] [debug line = 101:11]
  %201 = load i32* %k, align 4, !dbg !486         ; [#uses=1 type=i32] [debug line = 101:11]
  %202 = sext i32 %201 to i64, !dbg !486          ; [#uses=1 type=i64] [debug line = 101:11]
  %203 = load i32* %i, align 4, !dbg !486         ; [#uses=1 type=i32] [debug line = 101:11]
  %204 = sext i32 %203 to i64, !dbg !486          ; [#uses=1 type=i64] [debug line = 101:11]
  %205 = load [16 x float]** %2, align 8, !dbg !486 ; [#uses=1 type=[16 x float]*] [debug line = 101:11]
  %206 = getelementptr inbounds [16 x float]* %205, i64 %204, !dbg !486 ; [#uses=1 type=[16 x float]*] [debug line = 101:11]
  %207 = getelementptr inbounds [16 x float]* %206, i32 0, i64 %202, !dbg !486 ; [#uses=1 type=float*] [debug line = 101:11]
  store float %200, float* %207, align 4, !dbg !486 ; [debug line = 101:11]
  br label %208, !dbg !487                        ; [debug line = 102:9]

; <label>:208                                     ; preds = %196, %152
  br label %209, !dbg !488                        ; [debug line = 103:7]

; <label>:209                                     ; preds = %208, %148
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str8, i32 0, i32 0)) nounwind, !dbg !489 ; [debug line = 104:5]
  br label %210, !dbg !489                        ; [debug line = 104:5]

; <label>:210                                     ; preds = %209
  %211 = load i32* %i, align 4, !dbg !490         ; [#uses=1 type=i32] [debug line = 93:26]
  %212 = add nsw i32 %211, 1, !dbg !490           ; [#uses=1 type=i32] [debug line = 93:26]
  store i32 %212, i32* %i, align 4, !dbg !490     ; [debug line = 93:26]
  br label %145, !dbg !490                        ; [debug line = 93:26]

; <label>:213                                     ; preds = %145
  %214 = load float* %pivot, align 4, !dbg !491   ; [#uses=1 type=float] [debug line = 105:5]
  %215 = fpext float %214 to double, !dbg !491    ; [#uses=1 type=double] [debug line = 105:5]
  %216 = fdiv double 1.000000e+00, %215, !dbg !491 ; [#uses=1 type=double] [debug line = 105:5]
  %217 = fptrunc double %216 to float, !dbg !491  ; [#uses=1 type=float] [debug line = 105:5]
  %218 = load i32* %k, align 4, !dbg !491         ; [#uses=1 type=i32] [debug line = 105:5]
  %219 = sext i32 %218 to i64, !dbg !491          ; [#uses=1 type=i64] [debug line = 105:5]
  %220 = load i32* %k, align 4, !dbg !491         ; [#uses=1 type=i32] [debug line = 105:5]
  %221 = sext i32 %220 to i64, !dbg !491          ; [#uses=1 type=i64] [debug line = 105:5]
  %222 = load [16 x float]** %2, align 8, !dbg !491 ; [#uses=1 type=[16 x float]*] [debug line = 105:5]
  %223 = getelementptr inbounds [16 x float]* %222, i64 %221, !dbg !491 ; [#uses=1 type=[16 x float]*] [debug line = 105:5]
  %224 = getelementptr inbounds [16 x float]* %223, i32 0, i64 %219, !dbg !491 ; [#uses=1 type=float*] [debug line = 105:5]
  store float %217, float* %224, align 4, !dbg !491 ; [debug line = 105:5]
  br label %225, !dbg !492                        ; [debug line = 107:3]

; <label>:225                                     ; preds = %213
  %226 = load i32* %k, align 4, !dbg !493         ; [#uses=1 type=i32] [debug line = 56:24]
  %227 = add nsw i32 %226, 1, !dbg !493           ; [#uses=1 type=i32] [debug line = 56:24]
  store i32 %227, i32* %k, align 4, !dbg !493     ; [debug line = 56:24]
  br label %18, !dbg !493                         ; [debug line = 56:24]

; <label>:228                                     ; preds = %18
  store i32 0, i32* %i, align 4, !dbg !494        ; [debug line = 109:9]
  br label %229, !dbg !494                        ; [debug line = 109:9]

; <label>:229                                     ; preds = %297, %228
  %230 = load i32* %i, align 4, !dbg !494         ; [#uses=1 type=i32] [debug line = 109:9]
  %231 = icmp slt i32 %230, 16, !dbg !494         ; [#uses=1 type=i1] [debug line = 109:9]
  br i1 %231, label %232, label %300, !dbg !494   ; [debug line = 109:9]

; <label>:232                                     ; preds = %229
  br label %233, !dbg !496                        ; [debug line = 111:5]

; <label>:233                                     ; preds = %296, %232
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str9, i32 0, i32 0)) nounwind, !dbg !498 ; [debug line = 111:18]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str, i32 0, i32 0)) nounwind, !dbg !500 ; [debug line = 112:1]
  %234 = load i32* %i, align 4, !dbg !501         ; [#uses=1 type=i32] [debug line = 114:2]
  %235 = sext i32 %234 to i64, !dbg !501          ; [#uses=1 type=i64] [debug line = 114:2]
  %236 = getelementptr inbounds [500 x i32]* %work, i32 0, i64 %235, !dbg !501 ; [#uses=1 type=i32*] [debug line = 114:2]
  %237 = load i32* %236, align 4, !dbg !501       ; [#uses=1 type=i32] [debug line = 114:2]
  store i32 %237, i32* %k, align 4, !dbg !501     ; [debug line = 114:2]
  %238 = load i32* %k, align 4, !dbg !502         ; [#uses=1 type=i32] [debug line = 116:7]
  %239 = load i32* %i, align 4, !dbg !502         ; [#uses=1 type=i32] [debug line = 116:7]
  %240 = icmp eq i32 %238, %239, !dbg !502        ; [#uses=1 type=i1] [debug line = 116:7]
  br i1 %240, label %241, label %242, !dbg !502   ; [debug line = 116:7]

; <label>:241                                     ; preds = %233
  br label %297, !dbg !503                        ; [debug line = 116:21]

; <label>:242                                     ; preds = %233
  %243 = load i32* %k, align 4, !dbg !504         ; [#uses=1 type=i32] [debug line = 118:7]
  %244 = sext i32 %243 to i64, !dbg !504          ; [#uses=1 type=i64] [debug line = 118:7]
  %245 = getelementptr inbounds [500 x i32]* %work, i32 0, i64 %244, !dbg !504 ; [#uses=1 type=i32*] [debug line = 118:7]
  %246 = load i32* %245, align 4, !dbg !504       ; [#uses=1 type=i32] [debug line = 118:7]
  store i32 %246, i32* %iw, align 4, !dbg !504    ; [debug line = 118:7]
  %247 = load i32* %i, align 4, !dbg !505         ; [#uses=1 type=i32] [debug line = 119:7]
  %248 = sext i32 %247 to i64, !dbg !505          ; [#uses=1 type=i64] [debug line = 119:7]
  %249 = getelementptr inbounds [500 x i32]* %work, i32 0, i64 %248, !dbg !505 ; [#uses=1 type=i32*] [debug line = 119:7]
  %250 = load i32* %249, align 4, !dbg !505       ; [#uses=1 type=i32] [debug line = 119:7]
  %251 = load i32* %k, align 4, !dbg !505         ; [#uses=1 type=i32] [debug line = 119:7]
  %252 = sext i32 %251 to i64, !dbg !505          ; [#uses=1 type=i64] [debug line = 119:7]
  %253 = getelementptr inbounds [500 x i32]* %work, i32 0, i64 %252, !dbg !505 ; [#uses=1 type=i32*] [debug line = 119:7]
  store i32 %250, i32* %253, align 4, !dbg !505   ; [debug line = 119:7]
  %254 = load i32* %iw, align 4, !dbg !506        ; [#uses=1 type=i32] [debug line = 120:7]
  %255 = load i32* %i, align 4, !dbg !506         ; [#uses=1 type=i32] [debug line = 120:7]
  %256 = sext i32 %255 to i64, !dbg !506          ; [#uses=1 type=i64] [debug line = 120:7]
  %257 = getelementptr inbounds [500 x i32]* %work, i32 0, i64 %256, !dbg !506 ; [#uses=1 type=i32*] [debug line = 120:7]
  store i32 %254, i32* %257, align 4, !dbg !506   ; [debug line = 120:7]
  store i32 0, i32* %j, align 4, !dbg !507        ; [debug line = 122:13]
  br label %258, !dbg !507                        ; [debug line = 122:13]

; <label>:258                                     ; preds = %293, %242
  %259 = load i32* %j, align 4, !dbg !507         ; [#uses=1 type=i32] [debug line = 122:13]
  %260 = icmp slt i32 %259, 16, !dbg !507         ; [#uses=1 type=i1] [debug line = 122:13]
  br i1 %260, label %261, label %296, !dbg !507   ; [debug line = 122:13]

; <label>:261                                     ; preds = %258
  %262 = load i32* %i, align 4, !dbg !509         ; [#uses=1 type=i32] [debug line = 123:9]
  %263 = sext i32 %262 to i64, !dbg !509          ; [#uses=1 type=i64] [debug line = 123:9]
  %264 = load i32* %k, align 4, !dbg !509         ; [#uses=1 type=i32] [debug line = 123:9]
  %265 = sext i32 %264 to i64, !dbg !509          ; [#uses=1 type=i64] [debug line = 123:9]
  %266 = load [16 x float]** %2, align 8, !dbg !509 ; [#uses=1 type=[16 x float]*] [debug line = 123:9]
  %267 = getelementptr inbounds [16 x float]* %266, i64 %265, !dbg !509 ; [#uses=1 type=[16 x float]*] [debug line = 123:9]
  %268 = getelementptr inbounds [16 x float]* %267, i32 0, i64 %263, !dbg !509 ; [#uses=1 type=float*] [debug line = 123:9]
  %269 = load float* %268, align 4, !dbg !509     ; [#uses=1 type=float] [debug line = 123:9]
  store float %269, float* %w, align 4, !dbg !509 ; [debug line = 123:9]
  %270 = load i32* %k, align 4, !dbg !511         ; [#uses=1 type=i32] [debug line = 124:9]
  %271 = sext i32 %270 to i64, !dbg !511          ; [#uses=1 type=i64] [debug line = 124:9]
  %272 = load i32* %k, align 4, !dbg !511         ; [#uses=1 type=i32] [debug line = 124:9]
  %273 = sext i32 %272 to i64, !dbg !511          ; [#uses=1 type=i64] [debug line = 124:9]
  %274 = load [16 x float]** %2, align 8, !dbg !511 ; [#uses=1 type=[16 x float]*] [debug line = 124:9]
  %275 = getelementptr inbounds [16 x float]* %274, i64 %273, !dbg !511 ; [#uses=1 type=[16 x float]*] [debug line = 124:9]
  %276 = getelementptr inbounds [16 x float]* %275, i32 0, i64 %271, !dbg !511 ; [#uses=1 type=float*] [debug line = 124:9]
  %277 = load float* %276, align 4, !dbg !511     ; [#uses=1 type=float] [debug line = 124:9]
  %278 = load i32* %i, align 4, !dbg !511         ; [#uses=1 type=i32] [debug line = 124:9]
  %279 = sext i32 %278 to i64, !dbg !511          ; [#uses=1 type=i64] [debug line = 124:9]
  %280 = load i32* %k, align 4, !dbg !511         ; [#uses=1 type=i32] [debug line = 124:9]
  %281 = sext i32 %280 to i64, !dbg !511          ; [#uses=1 type=i64] [debug line = 124:9]
  %282 = load [16 x float]** %2, align 8, !dbg !511 ; [#uses=1 type=[16 x float]*] [debug line = 124:9]
  %283 = getelementptr inbounds [16 x float]* %282, i64 %281, !dbg !511 ; [#uses=1 type=[16 x float]*] [debug line = 124:9]
  %284 = getelementptr inbounds [16 x float]* %283, i32 0, i64 %279, !dbg !511 ; [#uses=1 type=float*] [debug line = 124:9]
  store float %277, float* %284, align 4, !dbg !511 ; [debug line = 124:9]
  %285 = load float* %w, align 4, !dbg !512       ; [#uses=1 type=float] [debug line = 125:9]
  %286 = load i32* %k, align 4, !dbg !512         ; [#uses=1 type=i32] [debug line = 125:9]
  %287 = sext i32 %286 to i64, !dbg !512          ; [#uses=1 type=i64] [debug line = 125:9]
  %288 = load i32* %k, align 4, !dbg !512         ; [#uses=1 type=i32] [debug line = 125:9]
  %289 = sext i32 %288 to i64, !dbg !512          ; [#uses=1 type=i64] [debug line = 125:9]
  %290 = load [16 x float]** %2, align 8, !dbg !512 ; [#uses=1 type=[16 x float]*] [debug line = 125:9]
  %291 = getelementptr inbounds [16 x float]* %290, i64 %289, !dbg !512 ; [#uses=1 type=[16 x float]*] [debug line = 125:9]
  %292 = getelementptr inbounds [16 x float]* %291, i32 0, i64 %287, !dbg !512 ; [#uses=1 type=float*] [debug line = 125:9]
  store float %285, float* %292, align 4, !dbg !512 ; [debug line = 125:9]
  br label %293, !dbg !513                        ; [debug line = 126:7]

; <label>:293                                     ; preds = %261
  %294 = load i32* %j, align 4, !dbg !514         ; [#uses=1 type=i32] [debug line = 122:28]
  %295 = add nsw i32 %294, 1, !dbg !514           ; [#uses=1 type=i32] [debug line = 122:28]
  store i32 %295, i32* %j, align 4, !dbg !514     ; [debug line = 122:28]
  br label %258, !dbg !514                        ; [debug line = 122:28]

; <label>:296                                     ; preds = %258
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str9, i32 0, i32 0)) nounwind, !dbg !515 ; [debug line = 127:5]
  br label %233, !dbg !515                        ; [debug line = 127:5]

; <label>:297                                     ; preds = %241
  %298 = load i32* %i, align 4, !dbg !516         ; [#uses=1 type=i32] [debug line = 129:5]
  %299 = add nsw i32 %298, 1, !dbg !516           ; [#uses=1 type=i32] [debug line = 129:5]
  store i32 %299, i32* %i, align 4, !dbg !516     ; [debug line = 129:5]
  br label %229, !dbg !517                        ; [debug line = 130:3]

; <label>:300                                     ; preds = %229
  %301 = load float* %w1, align 4, !dbg !518      ; [#uses=1 type=float] [debug line = 132:3]
  store float %301, float* %minver_det, align 4, !dbg !518 ; [debug line = 132:3]
  br label %302, !dbg !519                        ; [debug line = 133:1]

; <label>:302                                     ; preds = %300, %60
  %303 = load i32* %1, !dbg !519                  ; [#uses=1 type=i32] [debug line = 133:1]
  ret i32 %303, !dbg !519                         ; [debug line = 133:1]
}
