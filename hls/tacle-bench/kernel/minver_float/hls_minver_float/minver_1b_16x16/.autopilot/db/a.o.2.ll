...
define i32 @minver_hwa([16 x [16 x float]]* %a) nounwind uwtable {
  ...
  call void @llvm.dbg.value(metadata !{[16 x [16 x float]]* %a}, i64 0, metadata !59), !dbg !68 ; [debug line = 35:25] [debug variable = a]
...
; <label>:1                                       ; preds = %3, %0
  ...
  %exitcond7 = icmp eq i5 %i, -16, !dbg !76       ; [#uses=1 type=i1] [debug line = 50:9]
...
; <label>:3                                       ; preds = %1
  ...
  %tmp = zext i5 %i to i64, !dbg !85              ; [#uses=1 type=i64] [debug line = 52:2]
  %work.addr = getelementptr [500 x i6]* %work, i64 0, i64 %tmp, !dbg !85 ; [#uses=1 type=i6*] [debug line = 52:2]
  %i.cast7.cast = zext i5 %i to i6, !dbg !85      ; [#uses=1 type=i6] [debug line = 52:2]
  store i6 %i.cast7.cast, i6* %work.addr, align 1, !dbg !85 ; [debug line = 52:2]
  %4 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str4, i32 %tmp.6) nounwind, !dbg !86 ; [#uses=0 type=i32] [debug line = 53:3]
  %i.1 = add i5 %i, 1, !dbg !87                   ; [#uses=1 type=i5] [debug line = 50:24]
  call void @llvm.dbg.value(metadata !{i5 %i.1}, i64 0, metadata !88), !dbg !87 ; [debug line = 50:24] [debug variable = i]
...
.preheader13:                                     ; preds = %38, %.preheader13.preheader
  ...
  %i.5.cast6 = zext i5 %i.5 to i32, !dbg !78      ; [#uses=2 type=i32] [debug line = 59:11]
  call void @llvm.dbg.value(metadata !{i5 %i.5}, i64 0, metadata !88), !dbg !78 ; [debug line = 59:11] [debug variable = i]
  %tmp.2 = icmp sgt i5 %i.5, -1, !dbg !89         ; [#uses=1 type=i1] [debug line = 56:9]
...
.preheader12.preheader:                           ; preds = %.preheader13
  %tmp.3 = zext i5 %i.5 to i64, !dbg !92          ; [#uses=24 type=i64] [debug line = 61:6]
...
.preheader12:                                     ; preds = %_ifconv, %.preheader12.preheader
  ...
  %exitcond6 = icmp eq i32 %r.3, 16, !dbg !78     ; [#uses=1 type=i1] [debug line = 59:11]
...
_ifconv:                                          ; preds = %.preheader12
  ...
  %a.addr.1 = getelementptr [16 x [16 x float]]* %a, i64 0, i64 %tmp.7, i64 %tmp.3, !dbg !92 ; [#uses=1 type=float*] [debug line = 61:6]
...
_ifconv1:                                         ; preds = %.preheader12
  ...
  %a.addr = getelementptr [16 x [16 x float]]* %a, i64 0, i64 %tmp.4, i64 %tmp.3, !dbg !116 ; [#uses=1 type=float*] [debug line = 68:5]
...
; <label>:9                                       ; preds = %8
  %work.addr.2 = getelementptr [500 x i6]* %work, i64 0, i64 %tmp.3, !dbg !128 ; [#uses=2 type=i6*] [debug line = 77:7]
  %work.load.1 = load i6* %work.addr.2, align 1   ; [#uses=1 type=i6]
  %work.addr.3 = getelementptr [500 x i6]* %work, i64 0, i64 %tmp.4, !dbg !130 ; [#uses=2 type=i6*] [debug line = 78:7]
  %work.load.2 = load i6* %work.addr.3, align 1   ; [#uses=1 type=i6]
  store i6 %work.load.2, i6* %work.addr.2, align 1, !dbg !130 ; [debug line = 78:7]
  store i6 %work.load.1, i6* %work.addr.3, align 1, !dbg !131 ; [debug line = 79:7]
  br label %10, !dbg !132                         ; [debug line = 80:13]

; <label>:10                                      ; preds = %12, %9
  %j = phi i5 [ 0, %9 ], [ %j.1, %12 ]            ; [#uses=3 type=i5]
  %exitcond5 = icmp eq i5 %j, -16, !dbg !132      ; [#uses=1 type=i1] [debug line = 80:13]
...
; <label>:12                                      ; preds = %10
  ...
  %tmp.11 = zext i5 %j to i64, !dbg !137          ; [#uses=2 type=i64] [debug line = 82:2]
  %a.addr.4 = getelementptr [16 x [16 x float]]* %a, i64 0, i64 %tmp.3, i64 %tmp.11, !dbg !137 ; [#uses=2 type=float*] [debug line = 82:2]
  ...
  %a.addr.5 = getelementptr [16 x [16 x float]]* %a, i64 0, i64 %tmp.4, i64 %tmp.11, !dbg !138 ; [#uses=2 type=float*] [debug line = 83:9]
  ...
  %j.1 = add i5 %j, 1, !dbg !141                  ; [#uses=1 type=i5] [debug line = 80:28]
  call void @llvm.dbg.value(metadata !{i5 %j.1}, i64 0, metadata !142), !dbg !141 ; [debug line = 80:28] [debug variable = j]
...
; <label>:14                                      ; preds = %16, %.loopexit11
  ...
  %exitcond4 = icmp eq i5 %i.2, -16, !dbg !143    ; [#uses=1 type=i1] [debug line = 88:11]
...
.preheader10.preheader:                           ; preds = %14
  %tmp.26 = icmp eq i5 %i.5, 0, !dbg !145         ; [#uses=1 type=i1] [debug line = 99:13]
  %tmp.20.1 = icmp eq i5 %i.5, 1, !dbg !145       ; [#uses=1 type=i1] [debug line = 99:13]
  %tmp.20.2 = icmp eq i5 %i.5, 2, !dbg !145       ; [#uses=1 type=i1] [debug line = 99:13]
  %tmp.20.3 = icmp eq i5 %i.5, 3, !dbg !145       ; [#uses=1 type=i1] [debug line = 99:13]
  %tmp.20.4 = icmp eq i5 %i.5, 4, !dbg !145       ; [#uses=1 type=i1] [debug line = 99:13]
  %tmp.20.5 = icmp eq i5 %i.5, 5, !dbg !145       ; [#uses=1 type=i1] [debug line = 99:13]
  %tmp.20.6 = icmp eq i5 %i.5, 6, !dbg !145       ; [#uses=1 type=i1] [debug line = 99:13]
  %tmp.20.7 = icmp eq i5 %i.5, 7, !dbg !145       ; [#uses=1 type=i1] [debug line = 99:13]
  %tmp.20.8 = icmp eq i5 %i.5, 8, !dbg !145       ; [#uses=1 type=i1] [debug line = 99:13]
  %tmp.20.9 = icmp eq i5 %i.5, 9, !dbg !145       ; [#uses=1 type=i1] [debug line = 99:13]
  %tmp.20. = icmp eq i5 %i.5, 10, !dbg !145       ; [#uses=1 type=i1] [debug line = 99:13]
  %tmp.20.10 = icmp eq i5 %i.5, 11, !dbg !145     ; [#uses=1 type=i1] [debug line = 99:13]
  %tmp.20.11 = icmp eq i5 %i.5, 12, !dbg !145     ; [#uses=1 type=i1] [debug line = 99:13]
  %tmp.20.12 = icmp eq i5 %i.5, 13, !dbg !145     ; [#uses=1 type=i1] [debug line = 99:13]
  %tmp.20.13 = icmp eq i5 %i.5, 14, !dbg !145     ; [#uses=1 type=i1] [debug line = 99:13]
  %tmp.20.14 = icmp eq i5 %i.5, 15, !dbg !145     ; [#uses=1 type=i1] [debug line = 99:13]
  %a.addr.39 = getelementptr [16 x [16 x float]]* %a, i64 0, i64 %tmp.3, i64 15, !dbg !152 ; [#uses=1 type=float*] [debug line = 99:27]
  %a.addr.37 = getelementptr [16 x [16 x float]]* %a, i64 0, i64 %tmp.3, i64 14, !dbg !152 ; [#uses=1 type=float*] [debug line = 99:27]
  %a.addr.35 = getelementptr [16 x [16 x float]]* %a, i64 0, i64 %tmp.3, i64 13, !dbg !152 ; [#uses=1 type=float*] [debug line = 99:27]
  %a.addr.33 = getelementptr [16 x [16 x float]]* %a, i64 0, i64 %tmp.3, i64 12, !dbg !152 ; [#uses=1 type=float*] [debug line = 99:27]
  %a.addr.31 = getelementptr [16 x [16 x float]]* %a, i64 0, i64 %tmp.3, i64 11, !dbg !152 ; [#uses=1 type=float*] [debug line = 99:27]
  %a.addr.29 = getelementptr [16 x [16 x float]]* %a, i64 0, i64 %tmp.3, i64 10, !dbg !152 ; [#uses=1 type=float*] [debug line = 99:27]
  %a.addr.27 = getelementptr [16 x [16 x float]]* %a, i64 0, i64 %tmp.3, i64 9, !dbg !152 ; [#uses=1 type=float*] [debug line = 99:27]
  %a.addr.25 = getelementptr [16 x [16 x float]]* %a, i64 0, i64 %tmp.3, i64 8, !dbg !152 ; [#uses=1 type=float*] [debug line = 99:27]
  %a.addr.23 = getelementptr [16 x [16 x float]]* %a, i64 0, i64 %tmp.3, i64 7, !dbg !152 ; [#uses=1 type=float*] [debug line = 99:27]
  %a.addr.21 = getelementptr [16 x [16 x float]]* %a, i64 0, i64 %tmp.3, i64 6, !dbg !152 ; [#uses=1 type=float*] [debug line = 99:27]
  %a.addr.19 = getelementptr [16 x [16 x float]]* %a, i64 0, i64 %tmp.3, i64 5, !dbg !152 ; [#uses=1 type=float*] [debug line = 99:27]
  %a.addr.17 = getelementptr [16 x [16 x float]]* %a, i64 0, i64 %tmp.3, i64 4, !dbg !152 ; [#uses=1 type=float*] [debug line = 99:27]
  %a.addr.15 = getelementptr [16 x [16 x float]]* %a, i64 0, i64 %tmp.3, i64 3, !dbg !152 ; [#uses=1 type=float*] [debug line = 99:27]
  %a.addr.13 = getelementptr [16 x [16 x float]]* %a, i64 0, i64 %tmp.3, i64 2, !dbg !152 ; [#uses=1 type=float*] [debug line = 99:27]
  %a.addr.11 = getelementptr [16 x [16 x float]]* %a, i64 0, i64 %tmp.3, i64 1, !dbg !152 ; [#uses=1 type=float*] [debug line = 99:27]
  %a.addr.9 = getelementptr [16 x [16 x float]]* %a, i64 0, i64 %tmp.3, i64 0, !dbg !152 ; [#uses=1 type=float*] [debug line = 99:27]
...
; <label>:16                                      ; preds = %14
  ...
  %tmp.12 = zext i5 %i.2 to i64, !dbg !157        ; [#uses=1 type=i64] [debug line = 90:2]
  %a.addr.6 = getelementptr [16 x [16 x float]]* %a, i64 0, i64 %tmp.3, i64 %tmp.12, !dbg !157 ; [#uses=2 type=float*] [debug line = 90:2]
  ...
  %i.8 = add i5 %i.2, 1, !dbg !159                ; [#uses=1 type=i5] [debug line = 88:26]
  call void @llvm.dbg.value(metadata !{i5 %i.8}, i64 0, metadata !88), !dbg !159 ; [debug line = 88:26] [debug variable = i]
...
.preheader10:                                     ; preds = %._crit_edge, %.preheader10.preheader
  ...
  %exitcond3 = icmp eq i5 %i.3, -16, !dbg !153    ; [#uses=1 type=i1] [debug line = 93:11]
  %18 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 16, i64 16, i64 16) nounwind ; [#uses=0 type=i32]
  br i1 %exitcond3, label %38, label %19, !dbg !153 ; [debug line = 93:11]
...
; <label>:19                                      ; preds = %.preheader10
  ...
  %tmp.15 = icmp eq i5 %i.3, %i.5, !dbg !162      ; [#uses=1 type=i1] [debug line = 95:2]
  br i1 %tmp.15, label %._crit_edge, label %20, !dbg !162 ; [debug line = 95:2]

; <label>:20                                      ; preds = %19
  %tmp.16 = zext i5 %i.3 to i64, !dbg !163        ; [#uses=17 type=i64] [debug line = 96:9]
  %a.addr.8 = getelementptr [16 x [16 x float]]* %a, i64 0, i64 %tmp.16, i64 %tmp.3, !dbg !163 ; [#uses=2 type=float*] [debug line = 96:9]
  %w.2 = load float* %a.addr.8, align 4, !dbg !163 ; [#uses=19 type=float] [debug line = 96:9]
...
; <label>:21                                      ; preds = %.preheader9.0
  %a.load.22 = load float* %a.addr.9, align 4, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp.27 = fmul float %w.2, %a.load.22, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
  %a.addr.10 = getelementptr [16 x [16 x float]]* %a, i64 0, i64 %tmp.16, i64 0, !dbg !152 ; [#uses=2 type=float*] [debug line = 99:27]
  %a.load.23 = load float* %a.addr.10, align 4, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp.28 = fsub float %a.load.23, %tmp.27, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
...
; <label>:22                                      ; preds = %.preheader9.1
  %a.load.24 = load float* %a.addr.11, align 4, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp.22.1 = fmul float %w.2, %a.load.24, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
  %a.addr.12 = getelementptr [16 x [16 x float]]* %a, i64 0, i64 %tmp.16, i64 1, !dbg !152 ; [#uses=2 type=float*] [debug line = 99:27]
  %a.load.25 = load float* %a.addr.12, align 4, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp.23.1 = fsub float %a.load.25, %tmp.22.1, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
...
; <label>:23                                      ; preds = %.preheader9.2
  %a.load.26 = load float* %a.addr.13, align 4, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp.22.2 = fmul float %w.2, %a.load.26, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
  %a.addr.14 = getelementptr [16 x [16 x float]]* %a, i64 0, i64 %tmp.16, i64 2, !dbg !152 ; [#uses=2 type=float*] [debug line = 99:27]
  %a.load.27 = load float* %a.addr.14, align 4, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp.23.2 = fsub float %a.load.27, %tmp.22.2, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
...
; <label>:24                                      ; preds = %.preheader9.3
  %a.load.28 = load float* %a.addr.15, align 4, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp.22.3 = fmul float %w.2, %a.load.28, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
  %a.addr.16 = getelementptr [16 x [16 x float]]* %a, i64 0, i64 %tmp.16, i64 3, !dbg !152 ; [#uses=2 type=float*] [debug line = 99:27]
  %a.load.29 = load float* %a.addr.16, align 4, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp.23.3 = fsub float %a.load.29, %tmp.22.3, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
...
; <label>:25                                      ; preds = %.preheader9.4
  %a.load.30 = load float* %a.addr.17, align 4, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp.22.4 = fmul float %w.2, %a.load.30, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
  %a.addr.18 = getelementptr [16 x [16 x float]]* %a, i64 0, i64 %tmp.16, i64 4, !dbg !152 ; [#uses=2 type=float*] [debug line = 99:27]
  %a.load.31 = load float* %a.addr.18, align 4, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp.23.4 = fsub float %a.load.31, %tmp.22.4, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
...
; <label>:26                                      ; preds = %.preheader9.5
  %a.load.32 = load float* %a.addr.19, align 4, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp.22.5 = fmul float %w.2, %a.load.32, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
  %a.addr.20 = getelementptr [16 x [16 x float]]* %a, i64 0, i64 %tmp.16, i64 5, !dbg !152 ; [#uses=2 type=float*] [debug line = 99:27]
  %a.load.33 = load float* %a.addr.20, align 4, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp.23.5 = fsub float %a.load.33, %tmp.22.5, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
...
; <label>:27                                      ; preds = %.preheader9.6
  %a.load.34 = load float* %a.addr.21, align 4, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp.22.6 = fmul float %w.2, %a.load.34, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
  %a.addr.22 = getelementptr [16 x [16 x float]]* %a, i64 0, i64 %tmp.16, i64 6, !dbg !152 ; [#uses=2 type=float*] [debug line = 99:27]
  %a.load.35 = load float* %a.addr.22, align 4, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp.23.6 = fsub float %a.load.35, %tmp.22.6, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
...
; <label>:28                                      ; preds = %.preheader9.7
  %a.load.36 = load float* %a.addr.23, align 4, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp.22.7 = fmul float %w.2, %a.load.36, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
  %a.addr.24 = getelementptr [16 x [16 x float]]* %a, i64 0, i64 %tmp.16, i64 7, !dbg !152 ; [#uses=2 type=float*] [debug line = 99:27]
  %a.load.37 = load float* %a.addr.24, align 4, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp.23.7 = fsub float %a.load.37, %tmp.22.7, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
...
; <label>:29                                      ; preds = %.preheader9.8
  %a.load.38 = load float* %a.addr.25, align 4, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp.22.8 = fmul float %w.2, %a.load.38, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
  %a.addr.26 = getelementptr [16 x [16 x float]]* %a, i64 0, i64 %tmp.16, i64 8, !dbg !152 ; [#uses=2 type=float*] [debug line = 99:27]
  %a.load.39 = load float* %a.addr.26, align 4, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp.23.8 = fsub float %a.load.39, %tmp.22.8, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
...
; <label>:30                                      ; preds = %.preheader9.9
  %a.load.40 = load float* %a.addr.27, align 4, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp.22.9 = fmul float %w.2, %a.load.40, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
  %a.addr.28 = getelementptr [16 x [16 x float]]* %a, i64 0, i64 %tmp.16, i64 9, !dbg !152 ; [#uses=2 type=float*] [debug line = 99:27]
  %a.load.41 = load float* %a.addr.28, align 4, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp.23.9 = fsub float %a.load.41, %tmp.22.9, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
...
; <label>:31                                      ; preds = %.preheader9.10
  %a.load.42 = load float* %a.addr.29, align 4, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp.22. = fmul float %w.2, %a.load.42, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
  %a.addr.30 = getelementptr [16 x [16 x float]]* %a, i64 0, i64 %tmp.16, i64 10, !dbg !152 ; [#uses=2 type=float*] [debug line = 99:27]
  %a.load.43 = load float* %a.addr.30, align 4, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp.23. = fsub float %a.load.43, %tmp.22., !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
...
; <label>:32                                      ; preds = %.preheader9.11
  %a.load.44 = load float* %a.addr.31, align 4, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp.22.10 = fmul float %w.2, %a.load.44, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
  %a.addr.32 = getelementptr [16 x [16 x float]]* %a, i64 0, i64 %tmp.16, i64 11, !dbg !152 ; [#uses=2 type=float*] [debug line = 99:27]
  %a.load.45 = load float* %a.addr.32, align 4, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp.23.10 = fsub float %a.load.45, %tmp.22.10, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
...
; <label>:33                                      ; preds = %.preheader9.12
  %a.load.46 = load float* %a.addr.33, align 4, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp.22.11 = fmul float %w.2, %a.load.46, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
  %a.addr.34 = getelementptr [16 x [16 x float]]* %a, i64 0, i64 %tmp.16, i64 12, !dbg !152 ; [#uses=2 type=float*] [debug line = 99:27]
  %a.load.47 = load float* %a.addr.34, align 4, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp.23.11 = fsub float %a.load.47, %tmp.22.11, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
...
; <label>:34                                      ; preds = %.preheader9.13
  %a.load.48 = load float* %a.addr.35, align 4, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp.22.12 = fmul float %w.2, %a.load.48, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
  %a.addr.36 = getelementptr [16 x [16 x float]]* %a, i64 0, i64 %tmp.16, i64 13, !dbg !152 ; [#uses=2 type=float*] [debug line = 99:27]
  %a.load.49 = load float* %a.addr.36, align 4, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp.23.12 = fsub float %a.load.49, %tmp.22.12, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
...
; <label>:35                                      ; preds = %.preheader9.14
  %a.load.50 = load float* %a.addr.37, align 4, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp.22.13 = fmul float %w.2, %a.load.50, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
  %a.addr.38 = getelementptr [16 x [16 x float]]* %a, i64 0, i64 %tmp.16, i64 14, !dbg !152 ; [#uses=2 type=float*] [debug line = 99:27]
  %a.load.51 = load float* %a.addr.38, align 4, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp.23.13 = fsub float %a.load.51, %tmp.22.13, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
...
; <label>:36                                      ; preds = %.preheader9.15
  %a.load.52 = load float* %a.addr.39, align 4, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp.22.14 = fmul float %w.2, %a.load.52, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
  %a.addr.40 = getelementptr [16 x [16 x float]]* %a, i64 0, i64 %tmp.16, i64 15, !dbg !152 ; [#uses=2 type=float*] [debug line = 99:27]
  %a.load.53 = load float* %a.addr.40, align 4, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
  %tmp.23.14 = fsub float %a.load.53, %tmp.22.14, !dbg !152 ; [#uses=1 type=float] [debug line = 99:27]
...
._crit_edge:                                      ; preds = %._crit_edge18, %19
  %37 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str8, i32 %tmp.25) nounwind, !dbg !168 ; [#uses=0 type=i32] [debug line = 104:5]
  %i.9 = add i5 %i.3, 1, !dbg !169                ; [#uses=1 type=i5] [debug line = 93:26]
  call void @llvm.dbg.value(metadata !{i5 %i.9}, i64 0, metadata !88), !dbg !169 ; [debug line = 93:26] [debug variable = i]
...
; <label>:38                                      ; preds = %.preheader10
  ...
  %a.addr.7 = getelementptr [16 x [16 x float]]* %a, i64 0, i64 %tmp.3, i64 %tmp.3, !dbg !117 ; [#uses=1 type=float*] [debug line = 105:5]
  store float %tmp.14, float* %a.addr.7, align 4, !dbg !117 ; [debug line = 105:5]
  %k = add i5 %i.5, 1, !dbg !170                  ; [#uses=1 type=i5] [debug line = 56:24]
  call void @llvm.dbg.value(metadata !{i5 %k}, i64 0, metadata !171), !dbg !170 ; [debug line = 56:24] [debug variable = k]
...
.preheader8:                                      ; preds = %42, %.preheader8.preheader
  ...
  %i.4.cast2.cast = zext i5 %i.4 to i6, !dbg !90  ; [#uses=1 type=i6] [debug line = 109:9]
  %exitcond1 = icmp eq i5 %i.4, -16, !dbg !90     ; [#uses=1 type=i1] [debug line = 109:9]
...
.preheader.preheader:                             ; preds = %.preheader8
  %tmp. = zext i5 %i.4 to i64, !dbg !172          ; [#uses=2 type=i64] [debug line = 114:2]
  %work.addr.1 = getelementptr [500 x i6]* %work, i64 0, i64 %tmp., !dbg !172 ; [#uses=2 type=i6*] [debug line = 114:2]
...
.preheader:                                       ; preds = %40, %.preheader.preheader
  ...
  %tmp.8 = icmp eq i6 %work.load, %i.4.cast2.cast, !dbg !177 ; [#uses=1 type=i1] [debug line = 116:7]
  br i1 %tmp.8, label %42, label %40, !dbg !177   ; [debug line = 116:7]

; <label>:40                                      ; preds = %.preheader
  %tmp.10 = sext i6 %work.load to i64, !dbg !178  ; [#uses=4 type=i64] [debug line = 118:7]
  %work.addr.4 = getelementptr [500 x i6]* %work, i64 0, i64 %tmp.10, !dbg !178 ; [#uses=2 type=i6*] [debug line = 118:7]
  %work.load.3 = load i6* %work.addr.4, align 1   ; [#uses=1 type=i6]
  store i6 %work.load, i6* %work.addr.4, align 1, !dbg !179 ; [debug line = 119:7]
  store i6 %work.load.3, i6* %work.addr.1, align 1, !dbg !180 ; [debug line = 120:7]
  %a.addr.2 = getelementptr [16 x [16 x float]]* %a, i64 0, i64 %tmp.10, i64 %tmp., !dbg !181 ; [#uses=32 type=float*] [debug line = 123:9]
  %a.addr.3 = getelementptr [16 x [16 x float]]* %a, i64 0, i64 %tmp.10, i64 %tmp.10, !dbg !184 ; [#uses=17 type=float*] [debug line = 124:9]
  ...
  %a.load.19 = load float* %a.addr.2, align 4, !dbg !181 ; [#uses=1 type=float] [debug line = 123:9]
  ...
  %41 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @.str9, i32 %tmp.22) nounwind, !dbg !186 ; [#uses=0 type=i32] [debug line = 127:5]
  br label %.preheader, !dbg !186                 ; [debug line = 127:5]

; <label>:42                                      ; preds = %.preheader
  %i.7 = add i5 %i.4, 1, !dbg !187                ; [#uses=1 type=i5] [debug line = 129:5]
  call void @llvm.dbg.value(metadata !{i5 %i.7}, i64 0, metadata !88), !dbg !187 ; [debug line = 129:5] [debug variable = i]
...
!64 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 512, i64 32, i32 0, i32 0, metadata !36, metadata !65, i32 0, i32 0} ; [ DW_TAG_array_type ]
