...
define i32 @minver_hwa([16 x float]* %a) nounwind uwtable {
  ...
  call void @llvm.dbg.value(metadata !{[16 x float]* %a}, i64 0, metadata !80), !dbg !81 ; [debug line = 35:25] [debug variable = a]
  call void (...)* @_ssdm_SpecArrayDimSize([16 x float]* %a, i32 16) nounwind, !dbg !82 ; [debug line = 36:2]
  call void (...)* @_ssdm_op_SpecResource([16 x float]* %a, i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([12 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0), i32 -1, i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !84 ; [debug line = 37:1]
...
; <label>:1                                       ; preds = %2, %0
  ...
  %exitcond7 = icmp eq i32 %i, 16, !dbg !92       ; [#uses=1 type=i1] [debug line = 50:9]
...
; <label>:2                                       ; preds = %1
  %rbegin1 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str4, i64 0, i64 0)) nounwind, !dbg !98 ; [#uses=1 type=i32] [debug line = 50:31]
  ...
  %rend30 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str4, i64 0, i64 0), i32 %rbegin1) nounwind, !dbg !102 ; [#uses=0 type=i32] [debug line = 53:3]
  %i.5 = add nsw i32 %i, 1, !dbg !103             ; [#uses=1 type=i32] [debug line = 50:24]
  call void @llvm.dbg.value(metadata !{i32 %i.5}, i64 0, metadata !104), !dbg !103 ; [debug line = 50:24] [debug variable = i]
  br label %1, !dbg !103                          ; [debug line = 50:24]
...
.preheader13:                                     ; preds = %16, %.preheader13.preheader
  ...
  %tmp.2 = icmp slt i32 %i.6, 16, !dbg !105       ; [#uses=1 type=i1] [debug line = 56:9]
...
.preheader12:                                     ; preds = %3, %.preheader12.preheader
  ...
  %exitcond6 = icmp eq i32 %r.3, 16, !dbg !94     ; [#uses=1 type=i1] [debug line = 59:11]
  br i1 %exitcond6, label %4, label %3, !dbg !94  ; [debug line = 59:11]

; <label>:3                                       ; preds = %.preheader12
  %rbegin2 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str5, i64 0, i64 0)) nounwind, !dbg !110 ; [#uses=1 type=i32] [debug line = 59:33]
  ...
  %a.addr.1 = getelementptr inbounds [16 x float]* %a, i64 %tmp.7, i64 %tmp.3, !dbg !108 ; [#uses=1 type=float*] [debug line = 61:6]
  ...
  %rend26 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str5, i64 0, i64 0), i32 %rbegin2) nounwind, !dbg !119 ; [#uses=0 type=i32] [debug line = 66:5]
...
; <label>:4                                       ; preds = %.preheader12
  ...
  %a.addr = getelementptr inbounds [16 x float]* %a, i64 %tmp.4, i64 %tmp.3, !dbg !121 ; [#uses=1 type=float*] [debug line = 68:5]
...
; <label>:7                                       ; preds = %8, %6
  ...
  %exitcond5 = icmp eq i32 %j, 16, !dbg !133      ; [#uses=1 type=i1] [debug line = 80:13]
  br i1 %exitcond5, label %.loopexit11.loopexit, label %8, !dbg !133 ; [debug line = 80:13]

; <label>:8                                       ; preds = %7
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str6, i64 0, i64 0)) nounwind, !dbg !135 ; [#uses=1 type=i32] [debug line = 80:35]
  ...
  %a.addr.4 = getelementptr inbounds [16 x float]* %a, i64 %tmp.3, i64 %tmp.16, !dbg !138 ; [#uses=2 type=float*] [debug line = 82:2]
  ...
  %a.addr.5 = getelementptr inbounds [16 x float]* %a, i64 %tmp.4, i64 %tmp.16, !dbg !139 ; [#uses=2 type=float*] [debug line = 83:9]
  ...
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str6, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !141 ; [#uses=0 type=i32] [debug line = 85:7]
...
; <label>:9                                       ; preds = %10, %.loopexit11
  ...
  %exitcond4 = icmp eq i32 %i.2, 16, !dbg !144    ; [#uses=1 type=i1] [debug line = 88:11]
...
; <label>:10                                      ; preds = %9
  %rbegin4 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str7, i64 0, i64 0)) nounwind, !dbg !148 ; [#uses=1 type=i32] [debug line = 88:33]
  ...
  %a.addr.6 = getelementptr inbounds [16 x float]* %a, i64 %tmp.3, i64 %tmp.19, !dbg !151 ; [#uses=2 type=float*] [debug line = 90:2]
  ...
  %rend28 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str7, i64 0, i64 0), i32 %rbegin4) nounwind, !dbg !152 ; [#uses=0 type=i32] [debug line = 91:5]
...
.preheader10:                                     ; preds = %._crit_edge, %.preheader10.preheader
  ...
  %exitcond3 = icmp eq i32 %i.3, 16, !dbg !146    ; [#uses=1 type=i1] [debug line = 93:11]
  br i1 %exitcond3, label %16, label %11, !dbg !146 ; [debug line = 93:11]

; <label>:11                                      ; preds = %.preheader10
  %rbegin5 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str8, i64 0, i64 0)) nounwind, !dbg !154 ; [#uses=1 type=i32] [debug line = 93:33]
...
; <label>:12                                      ; preds = %11
  ...
  %a.addr.8 = getelementptr inbounds [16 x float]* %a, i64 %tmp.25, i64 %tmp.3, !dbg !158 ; [#uses=2 type=float*] [debug line = 96:9]
...
.preheader9:                                      ; preds = %._crit_edge19, %.preheader9.preheader
  ...
  %exitcond2 = icmp eq i32 %j.1, 16, !dbg !161    ; [#uses=1 type=i1] [debug line = 98:17]
...
; <label>:14                                      ; preds = %13
  ...
  %a.addr.9 = getelementptr inbounds [16 x float]* %a, i64 %tmp.3, i64 %tmp.30, !dbg !166 ; [#uses=1 type=float*] [debug line = 99:27]
  ...
  %a.addr.10 = getelementptr inbounds [16 x float]* %a, i64 %tmp.25, i64 %tmp.30, !dbg !166 ; [#uses=2 type=float*] [debug line = 99:27]
...
._crit_edge19:                                    ; preds = %14, %13
  %j.5 = add nsw i32 %j.1, 1, !dbg !167           ; [#uses=1 type=i32] [debug line = 98:32]
  call void @llvm.dbg.value(metadata !{i32 %j.5}, i64 0, metadata !143), !dbg !167 ; [debug line = 98:32] [debug variable = j]
  br label %.preheader9, !dbg !167                ; [debug line = 98:32]
...
._crit_edge:                                      ; preds = %._crit_edge18, %11
  %rend22 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str8, i64 0, i64 0), i32 %rbegin5) nounwind, !dbg !171 ; [#uses=0 type=i32] [debug line = 104:5]
  %i.10 = add nsw i32 %i.3, 1, !dbg !172          ; [#uses=1 type=i32] [debug line = 93:26]
  call void @llvm.dbg.value(metadata !{i32 %i.10}, i64 0, metadata !104), !dbg !172 ; [debug line = 93:26] [debug variable = i]
  br label %.preheader10, !dbg !172               ; [debug line = 93:26]

; <label>:16                                      ; preds = %.preheader10
  %tmp.22 = fdiv float 1.000000e+00, %pivot, !dbg !122 ; [#uses=1 type=float] [debug line = 105:5]
  %a.addr.7 = getelementptr inbounds [16 x float]* %a, i64 %tmp.3, i64 %tmp.3, !dbg !122 ; [#uses=1 type=float*] [debug line = 105:5]
  store float %tmp.22, float* %a.addr.7, align 4, !dbg !122 ; [debug line = 105:5]
  %k.1 = add nsw i32 %i.6, 1, !dbg !173           ; [#uses=1 type=i32] [debug line = 56:24]
  call void @llvm.dbg.value(metadata !{i32 %k.1}, i64 0, metadata !174), !dbg !173 ; [debug line = 56:24] [debug variable = k]
  br label %.preheader13, !dbg !173               ; [debug line = 56:24]

.preheader8:                                      ; preds = %21, %.preheader8.preheader
  %i.4 = phi i32 [ %i.8, %21 ], [ 0, %.preheader8.preheader ] ; [#uses=4 type=i32]
  %exitcond1 = icmp eq i32 %i.4, 16, !dbg !106    ; [#uses=1 type=i1] [debug line = 109:9]
...
; <label>:17                                      ; preds = %.preheader
  ...
  %a.addr.2 = getelementptr inbounds [16 x float]* %a, i64 %tmp.15, i64 %tmp.11, !dbg !184 ; [#uses=2 type=float*] [debug line = 123:9]
  %a.addr.3 = getelementptr inbounds [16 x float]* %a, i64 %tmp.15, i64 %tmp.15, !dbg !187 ; [#uses=2 type=float*] [debug line = 124:9]
  br label %18, !dbg !188                         ; [debug line = 122:13]

; <label>:18                                      ; preds = %19, %17
  %j.2 = phi i32 [ 0, %17 ], [ %j.4, %19 ]        ; [#uses=2 type=i32]
  %exitcond = icmp eq i32 %j.2, 16, !dbg !188     ; [#uses=1 type=i1] [debug line = 122:13]
...
; <label>:19                                      ; preds = %18
  ...
  %j.4 = add nsw i32 %j.2, 1, !dbg !190           ; [#uses=1 type=i32] [debug line = 122:28]
  call void @llvm.dbg.value(metadata !{i32 %j.4}, i64 0, metadata !143), !dbg !190 ; [debug line = 122:28] [debug variable = j]
  br label %18, !dbg !190                         ; [debug line = 122:28]

; <label>:20                                      ; preds = %18
  %rend24 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str9, i64 0, i64 0), i32 %rbegin3) nounwind, !dbg !191 ; [#uses=0 type=i32] [debug line = 127:5]
...
!29 = metadata !{i32 786484, i32 0, null, metadata !"sys_nerr", metadata !"sys_nerr", metadata !"", metadata !30, i32 26, metadata !9, i32 0, i32 1, null} ; [ DW_TAG_variable ]
...
!39 = metadata !{i32 786478, i32 0, metadata !35, metadata !"minver_mmul", metadata !"minver_mmul", metadata !"", metadata !35, i32 18, metadata !40, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, null, metadata !16, i32 20} ; [ DW_TAG_subprogram ]
...
!44 = metadata !{i32 786478, i32 0, metadata !35, metadata !"set_minver", metadata !"set_minver", metadata !"", metadata !35, i32 43, metadata !45, i1 false, i1 true, i32 0, i32 0, null, i32 0, i1 false, null, null, null, metadata !16, i32 43} ; [ DW_TAG_subprogram ]
...
!62 = metadata !{null, metadata !63, metadata !64, metadata !65, metadata !66, metadata !67, metadata !57}
...
!68 = metadata !{null, metadata !69, metadata !70, metadata !71, metadata !72, metadata !73, metadata !57}
...
!80 = metadata !{i32 786689, metadata !5, metadata !"a", metadata !6, i32 16777251, metadata !10, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!81 = metadata !{i32 35, i32 25, metadata !5, null}
!82 = metadata !{i32 36, i32 2, metadata !83, null}
!83 = metadata !{i32 786443, metadata !5, i32 36, i32 1, metadata !6, i32 0} ; [ DW_TAG_lexical_block ]
...
!87 = metadata !{i32 786688, metadata !83, metadata !"work", metadata !6, i32 41, metadata !88, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!88 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 16000, i64 32, i32 0, i32 0, metadata !9, metadata !89, i32 0, i32 0} ; [ DW_TAG_array_type ]
...
!93 = metadata !{i32 786443, metadata !83, i32 50, i32 3, metadata !6, i32 1} ; [ DW_TAG_lexical_block ]
!94 = metadata !{i32 59, i32 11, metadata !95, null}
!95 = metadata !{i32 786443, metadata !96, i32 59, i32 5, metadata !6, i32 5} ; [ DW_TAG_lexical_block ]
!96 = metadata !{i32 786443, metadata !97, i32 56, i32 30, metadata !6, i32 4} ; [ DW_TAG_lexical_block ]
!97 = metadata !{i32 786443, metadata !83, i32 56, i32 3, metadata !6, i32 3} ; [ DW_TAG_lexical_block ]
!98 = metadata !{i32 50, i32 31, metadata !99, null}
!99 = metadata !{i32 786443, metadata !93, i32 50, i32 30, metadata !6, i32 2} ; [ DW_TAG_lexical_block ]
...
!103 = metadata !{i32 50, i32 24, metadata !93, null}
!104 = metadata !{i32 786688, metadata !83, metadata !"i", metadata !6, i32 41, metadata !9, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!105 = metadata !{i32 56, i32 9, metadata !97, null}
!106 = metadata !{i32 109, i32 9, metadata !107, null}
!107 = metadata !{i32 786443, metadata !83, i32 109, i32 3, metadata !6, i32 20} ; [ DW_TAG_lexical_block ]
!108 = metadata !{i32 61, i32 6, metadata !109, null}
!109 = metadata !{i32 786443, metadata !95, i32 59, i32 32, metadata !6, i32 6} ; [ DW_TAG_lexical_block ]
!110 = metadata !{i32 59, i32 33, metadata !109, null}
!111 = metadata !{i32 60, i32 1, metadata !109, null}
!112 = metadata !{i32 786688, metadata !83, metadata !"w", metadata !6, i32 43, metadata !12, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!113 = metadata !{i32 62, i32 7, metadata !109, null}
!114 = metadata !{i32 786688, metadata !83, metadata !"wmax", metadata !6, i32 43, metadata !12, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!115 = metadata !{i32 63, i32 9, metadata !116, null}
!116 = metadata !{i32 786443, metadata !109, i32 62, i32 23, metadata !6, i32 7} ; [ DW_TAG_lexical_block ]
!117 = metadata !{i32 786688, metadata !83, metadata !"r", metadata !6, i32 42, metadata !9, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!118 = metadata !{i32 64, i32 9, metadata !116, null}
!119 = metadata !{i32 66, i32 5, metadata !109, null}
!120 = metadata !{i32 59, i32 26, metadata !95, null}
!121 = metadata !{i32 68, i32 5, metadata !96, null}
!122 = metadata !{i32 105, i32 5, metadata !96, null}
!123 = metadata !{i32 786688, metadata !83, metadata !"pivot", metadata !6, i32 43, metadata !12, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!124 = metadata !{i32 69, i32 11, metadata !96, null}
!125 = metadata !{i32 786688, metadata !83, metadata !"api", metadata !6, i32 43, metadata !12, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
...
!129 = metadata !{i32 786443, metadata !96, i32 75, i32 19, metadata !6, i32 9} ; [ DW_TAG_lexical_block ]
!130 = metadata !{i32 786688, metadata !83, metadata !"iw", metadata !6, i32 41, metadata !9, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
...
!134 = metadata !{i32 786443, metadata !129, i32 80, i32 7, metadata !6, i32 10} ; [ DW_TAG_lexical_block ]
!135 = metadata !{i32 80, i32 35, metadata !136, null}
!136 = metadata !{i32 786443, metadata !134, i32 80, i32 34, metadata !6, i32 11} ; [ DW_TAG_lexical_block ]
...
!143 = metadata !{i32 786688, metadata !83, metadata !"j", metadata !6, i32 41, metadata !9, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!144 = metadata !{i32 88, i32 11, metadata !145, null}
!145 = metadata !{i32 786443, metadata !96, i32 88, i32 5, metadata !6, i32 12} ; [ DW_TAG_lexical_block ]
!146 = metadata !{i32 93, i32 11, metadata !147, null}
!147 = metadata !{i32 786443, metadata !96, i32 93, i32 5, metadata !6, i32 14} ; [ DW_TAG_lexical_block ]
!148 = metadata !{i32 88, i32 33, metadata !149, null}
!149 = metadata !{i32 786443, metadata !145, i32 88, i32 32, metadata !6, i32 13} ; [ DW_TAG_lexical_block ]
...
!153 = metadata !{i32 88, i32 26, metadata !145, null}
!154 = metadata !{i32 93, i32 33, metadata !155, null}
!155 = metadata !{i32 786443, metadata !147, i32 93, i32 32, metadata !6, i32 15} ; [ DW_TAG_lexical_block ]
...
!159 = metadata !{i32 786443, metadata !155, i32 95, i32 16, metadata !6, i32 16} ; [ DW_TAG_lexical_block ]
!160 = metadata !{i32 97, i32 9, metadata !159, null}
!161 = metadata !{i32 98, i32 17, metadata !162, null}
!162 = metadata !{i32 786443, metadata !163, i32 98, i32 11, metadata !6, i32 18} ; [ DW_TAG_lexical_block ]
!163 = metadata !{i32 786443, metadata !159, i32 97, i32 25, metadata !6, i32 17} ; [ DW_TAG_lexical_block ]
!164 = metadata !{i32 99, i32 13, metadata !165, null}
!165 = metadata !{i32 786443, metadata !162, i32 98, i32 38, metadata !6, i32 19} ; [ DW_TAG_lexical_block ]
!166 = metadata !{i32 99, i32 27, metadata !165, null}
!167 = metadata !{i32 98, i32 32, metadata !162, null}
...
!172 = metadata !{i32 93, i32 26, metadata !147, null}
!173 = metadata !{i32 56, i32 24, metadata !97, null}
!174 = metadata !{i32 786688, metadata !83, metadata !"k", metadata !6, i32 41, metadata !9, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!175 = metadata !{i32 114, i32 2, metadata !176, null}
!176 = metadata !{i32 786443, metadata !177, i32 111, i32 17, metadata !6, i32 22} ; [ DW_TAG_lexical_block ]
!177 = metadata !{i32 786443, metadata !107, i32 109, i32 26, metadata !6, i32 21} ; [ DW_TAG_lexical_block ]
...
!185 = metadata !{i32 786443, metadata !186, i32 122, i32 34, metadata !6, i32 24} ; [ DW_TAG_lexical_block ]
!186 = metadata !{i32 786443, metadata !176, i32 122, i32 7, metadata !6, i32 23} ; [ DW_TAG_lexical_block ]
...
!190 = metadata !{i32 122, i32 28, metadata !186, null}
...
!195 = metadata !{i32 786689, metadata !34, metadata !"n", metadata !35, i32 16777224, metadata !38, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!196 = metadata !{i32 8, i32 31, metadata !34, null}
!197 = metadata !{i32 11, i32 3, metadata !198, null}
!198 = metadata !{i32 786443, metadata !34, i32 8, i32 34, metadata !35, i32 0} ; [ DW_TAG_lexical_block ]
!199 = metadata !{i32 14, i32 5, metadata !198, null}
!200 = metadata !{i32 786688, metadata !198, metadata !"f", metadata !35, i32 9, metadata !38, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
