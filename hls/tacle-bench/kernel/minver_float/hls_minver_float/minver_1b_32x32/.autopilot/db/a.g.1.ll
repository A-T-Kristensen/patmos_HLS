; ModuleID = '/home/patmos/github/bachelor_project_HLS/hls/tacle-bench/kernel/minver_float/hls_minver_float/minver_1b_32x32/.autopilot/db/a.g.1.bc'
...
define i32 @minver_hwa([32 x float]* %a) nounwind uwtable {
  ...
  call void (...)* @_ssdm_op_SpecResource([32 x float]* %a, i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([12 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0), i32 -1, i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !72 ; [debug line = 37:1]
...
; <label>:2                                       ; preds = %1
  ...
  %rend30 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str4, i64 0, i64 0), i32 %rbegin1) nounwind, !dbg !90 ; [#uses=0 type=i32] [debug line = 53:3]
...
; <label>:3                                       ; preds = %.preheader12
  ...
  %rend24 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str5, i64 0, i64 0), i32 %rbegin2) nounwind, !dbg !107 ; [#uses=0 type=i32] [debug line = 66:5]
...
; <label>:8                                       ; preds = %7
  ...
  %rend26 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str6, i64 0, i64 0), i32 %rbegin4) nounwind, !dbg !129 ; [#uses=0 type=i32] [debug line = 85:7]
...
._crit_edge:                                      ; preds = %._crit_edge18, %11
  %rend28 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str8, i64 0, i64 0), i32 %rbegin5) nounwind, !dbg !159 ; [#uses=0 type=i32] [debug line = 104:5]
...
; <label>:20                                      ; preds = %18
  %rend22 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str9, i64 0, i64 0), i32 %rbegin3) nounwind, !dbg !179 ; [#uses=0 type=i32] [debug line = 127:5]
