...
#ifndef __minver_hwa_fcmp_3fYi__HH__
#define __minver_hwa_fcmp_3fYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(minver_hwa_fcmp_3fYi) {
    ...
    SC_CTOR(minver_hwa_fcmp_3fYi):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
