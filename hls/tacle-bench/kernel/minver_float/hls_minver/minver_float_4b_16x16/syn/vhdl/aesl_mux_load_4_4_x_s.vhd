...
architecture behav of aesl_mux_load_4_4_x_s is 
    ...
    signal sel_tmp_fu_138_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal sel_tmp_reg_197 : STD_LOGIC_VECTOR (0 downto 0);
    signal sel_tmp2_fu_144_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal sel_tmp2_reg_202 : STD_LOGIC_VECTOR (0 downto 0);
    signal sel_tmp4_fu_150_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal sel_tmp4_reg_207 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_75_fu_128_p2 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal tmp_fu_116_p3 : STD_LOGIC_VECTOR (5 downto 0);
    signal tmp_s_fu_124_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal p_cast2_fu_112_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal sel_tmp1_fu_156_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal sel_tmp3_fu_163_p3 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_CS_fsm_pp0_stage0 = ap_const_lv1_1) and not(((ap_const_logic_1 = ap_enable_reg_pp0_iter0) and (ap_start = ap_const_logic_0))) and (ap_const_logic_1 = ap_ce))) then
                sel_tmp2_reg_202 <= sel_tmp2_fu_144_p2;
                sel_tmp4_reg_207 <= sel_tmp4_fu_150_p2;
                sel_tmp_reg_197 <= sel_tmp_fu_138_p2;
            end if;
        end if;
    end process;
    ...
    ap_return <= 
        empty_11_Dout_A when (sel_tmp4_reg_207(0) = '1') else 
        sel_tmp3_fu_163_p3;
    ...
    empty_10_Addr_A_orig <= tmp_75_fu_128_p2(32 - 1 downto 0);
    ...
    empty_11_Addr_A_orig <= tmp_75_fu_128_p2(32 - 1 downto 0);
    ...
    empty_12_Addr_A_orig <= tmp_75_fu_128_p2(32 - 1 downto 0);
    ...
    empty_9_Addr_A_orig <= tmp_75_fu_128_p2(32 - 1 downto 0);
    ...
    empty_9_WEN_A <= ap_const_lv4_0;
        p_cast2_fu_112_p1 <= std_logic_vector(resize(signed(empty),64));

    sel_tmp1_fu_156_p3 <= 
        empty_9_Dout_A when (sel_tmp_reg_197(0) = '1') else 
        empty_12_Dout_A;
    sel_tmp2_fu_144_p2 <= "1" when (empty_13 = ap_const_lv30_1) else "0";
    sel_tmp3_fu_163_p3 <= 
        empty_10_Dout_A when (sel_tmp2_reg_202(0) = '1') else 
        sel_tmp1_fu_156_p3;
    sel_tmp4_fu_150_p2 <= "1" when (empty_13 = ap_const_lv30_2) else "0";
    sel_tmp_fu_138_p2 <= "1" when (empty_13 = ap_const_lv30_0) else "0";
    tmp_75_fu_128_p2 <= std_logic_vector(unsigned(tmp_s_fu_124_p1) + unsigned(p_cast2_fu_112_p1));
    tmp_fu_116_p3 <= (empty_14 & ap_const_lv4_0);
    tmp_s_fu_124_p1 <= std_logic_vector(resize(unsigned(tmp_fu_116_p3),64));
end behav;
