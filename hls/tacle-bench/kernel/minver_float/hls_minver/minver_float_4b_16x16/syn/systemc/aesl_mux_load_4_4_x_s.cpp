...
const sc_lv<30> aesl_mux_load_4_4_x_s::ap_const_lv30_0 = "000000000000000000000000000000";
const sc_lv<30> aesl_mux_load_4_4_x_s::ap_const_lv30_1 = "1";
const sc_lv<30> aesl_mux_load_4_4_x_s::ap_const_lv30_2 = "10";
...
aesl_mux_load_4_4_x_s::aesl_mux_load_4_4_x_s(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( sel_tmp4_reg_207 );
    sensitive << ( sel_tmp3_fu_163_p3 );
    ...
    SC_METHOD(thread_p_cast2_fu_112_p1);
    sensitive << ( empty );

    SC_METHOD(thread_sel_tmp1_fu_156_p3);
    sensitive << ( empty_9_Dout_A );
    sensitive << ( empty_12_Dout_A );
    sensitive << ( sel_tmp_reg_197 );
    ...
    SC_METHOD(thread_sel_tmp3_fu_163_p3);
    sensitive << ( empty_10_Dout_A );
    sensitive << ( sel_tmp2_reg_202 );
    sensitive << ( sel_tmp1_fu_156_p3 );

    SC_METHOD(thread_sel_tmp4_fu_150_p2);
    sensitive << ( ap_start );
    sensitive << ( ap_CS_fsm_pp0_stage0 );
    sensitive << ( ap_enable_reg_pp0_iter0 );
    sensitive << ( ap_ce );
    ...
    SC_METHOD(thread_sel_tmp_fu_138_p2);
    sensitive << ( ap_start );
    sensitive << ( ap_CS_fsm_pp0_stage0 );
    sensitive << ( ap_enable_reg_pp0_iter0 );
    sensitive << ( ap_ce );
    ...
    SC_METHOD(thread_tmp_75_fu_128_p2);
    sensitive << ( tmp_s_fu_124_p1 );
    sensitive << ( p_cast2_fu_112_p1 );

    SC_METHOD(thread_tmp_fu_116_p3);
    sensitive << ( empty_14 );

    SC_METHOD(thread_tmp_s_fu_124_p1);
    ...
    sc_trace(mVcdFile, sel_tmp_fu_138_p2, "sel_tmp_fu_138_p2");
    sc_trace(mVcdFile, sel_tmp_reg_197, "sel_tmp_reg_197");
    sc_trace(mVcdFile, sel_tmp2_fu_144_p2, "sel_tmp2_fu_144_p2");
    sc_trace(mVcdFile, sel_tmp2_reg_202, "sel_tmp2_reg_202");
    sc_trace(mVcdFile, sel_tmp4_fu_150_p2, "sel_tmp4_fu_150_p2");
    sc_trace(mVcdFile, sel_tmp4_reg_207, "sel_tmp4_reg_207");
    sc_trace(mVcdFile, tmp_75_fu_128_p2, "tmp_75_fu_128_p2");
    ...
    sc_trace(mVcdFile, tmp_s_fu_124_p1, "tmp_s_fu_124_p1");
    sc_trace(mVcdFile, p_cast2_fu_112_p1, "p_cast2_fu_112_p1");
    sc_trace(mVcdFile, sel_tmp1_fu_156_p3, "sel_tmp1_fu_156_p3");
    sc_trace(mVcdFile, sel_tmp3_fu_163_p3, "sel_tmp3_fu_163_p3");
...
void aesl_mux_load_4_4_x_s::thread_ap_clk_no_reset_() {
  ...
  esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_0)) || !esl_seteq<1,1,1>(ap_const_logic_1, ap_ce.read())))) {
    ...
    if ((esl_seteq<1,1,1>(ap_CS_fsm_pp0_stage0.read(), ap_const_lv1_1) && !(esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_0)) && esl_seteq<1,1,1>(ap_const_logic_1, ap_ce.read()))) {
        sel_tmp2_reg_202 = sel_tmp2_fu_144_p2.read();
        sel_tmp4_reg_207 = sel_tmp4_fu_150_p2.read();
        sel_tmp_reg_197 = sel_tmp_fu_138_p2.read();
    }
}
...
void aesl_mux_load_4_4_x_s::thread_ap_return() {
    ap_return = (!sel_tmp4_reg_207.read()[0].is_01())? sc_lv<32>(): ((sel_tmp4_reg_207.read()[0].to_bool())? empty_11_Dout_A.read(): sel_tmp3_fu_163_p3.read());
}
...
void aesl_mux_load_4_4_x_s::thread_empty_10_Addr_A_orig() {
    empty_10_Addr_A_orig =  (sc_lv<32>) (tmp_75_fu_128_p2.read());
}
...
void aesl_mux_load_4_4_x_s::thread_empty_11_Addr_A() {
    empty_11_Addr_A = (!ap_const_lv32_2.is_01())? sc_lv<32>(): empty_11_Addr_A_orig.read() << (unsigned short)ap_const_lv32_2.to_uint();
}

void aesl_mux_load_4_4_x_s::thread_empty_11_Addr_A_orig() {
    empty_11_Addr_A_orig =  (sc_lv<32>) (tmp_75_fu_128_p2.read());
}

void aesl_mux_load_4_4_x_s::thread_empty_11_Din_A() {
    empty_11_Din_A = ap_const_lv32_0;
}

void aesl_mux_load_4_4_x_s::thread_empty_11_EN_A() {
    if ((esl_seteq<1,1,1>(ap_CS_fsm_pp0_stage0.read(), ap_const_lv1_1) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && 
         !(esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_0)) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_ce.read()))) {
...
void aesl_mux_load_4_4_x_s::thread_empty_11_WEN_A() {
    empty_11_WEN_A = ap_const_lv4_0;
}

void aesl_mux_load_4_4_x_s::thread_empty_12_Addr_A() {
    empty_12_Addr_A = (!ap_const_lv32_2.is_01())? sc_lv<32>(): empty_12_Addr_A_orig.read() << (unsigned short)ap_const_lv32_2.to_uint();
}

void aesl_mux_load_4_4_x_s::thread_empty_12_Addr_A_orig() {
    empty_12_Addr_A_orig =  (sc_lv<32>) (tmp_75_fu_128_p2.read());
}

void aesl_mux_load_4_4_x_s::thread_empty_12_Din_A() {
    empty_12_Din_A = ap_const_lv32_0;
}

void aesl_mux_load_4_4_x_s::thread_empty_12_EN_A() {
    if ((esl_seteq<1,1,1>(ap_CS_fsm_pp0_stage0.read(), ap_const_lv1_1) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && 
         !(esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_0)) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_ce.read()))) {
...
void aesl_mux_load_4_4_x_s::thread_empty_12_WEN_A() {
...
void aesl_mux_load_4_4_x_s::thread_empty_9_Addr_A_orig() {
    empty_9_Addr_A_orig =  (sc_lv<32>) (tmp_75_fu_128_p2.read());
}
...
void aesl_mux_load_4_4_x_s::thread_p_cast2_fu_112_p1() {
    p_cast2_fu_112_p1 = esl_sext<64,7>(empty.read());
}

void aesl_mux_load_4_4_x_s::thread_sel_tmp1_fu_156_p3() {
    sel_tmp1_fu_156_p3 = (!sel_tmp_reg_197.read()[0].is_01())? sc_lv<32>(): ((sel_tmp_reg_197.read()[0].to_bool())? empty_9_Dout_A.read(): empty_12_Dout_A.read());
}

void aesl_mux_load_4_4_x_s::thread_sel_tmp2_fu_144_p2() {
    sel_tmp2_fu_144_p2 = (!empty_13.read().is_01() || !ap_const_lv30_1.is_01())? sc_lv<1>(): sc_lv<1>(empty_13.read() == ap_const_lv30_1);
}

void aesl_mux_load_4_4_x_s::thread_sel_tmp3_fu_163_p3() {
    sel_tmp3_fu_163_p3 = (!sel_tmp2_reg_202.read()[0].is_01())? sc_lv<32>(): ((sel_tmp2_reg_202.read()[0].to_bool())? empty_10_Dout_A.read(): sel_tmp1_fu_156_p3.read());
}

void aesl_mux_load_4_4_x_s::thread_sel_tmp4_fu_150_p2() {
    sel_tmp4_fu_150_p2 = (!empty_13.read().is_01() || !ap_const_lv30_2.is_01())? sc_lv<1>(): sc_lv<1>(empty_13.read() == ap_const_lv30_2);
}

void aesl_mux_load_4_4_x_s::thread_sel_tmp_fu_138_p2() {
    sel_tmp_fu_138_p2 = (!empty_13.read().is_01() || !ap_const_lv30_0.is_01())? sc_lv<1>(): sc_lv<1>(empty_13.read() == ap_const_lv30_0);
}

void aesl_mux_load_4_4_x_s::thread_tmp_75_fu_128_p2() {
    tmp_75_fu_128_p2 = (!tmp_s_fu_124_p1.read().is_01() || !p_cast2_fu_112_p1.read().is_01())? sc_lv<64>(): (sc_biguint<64>(tmp_s_fu_124_p1.read()) + sc_bigint<64>(p_cast2_fu_112_p1.read()));
}

void aesl_mux_load_4_4_x_s::thread_tmp_fu_116_p3() {
    tmp_fu_116_p3 = esl_concat<2,4>(empty_14.read(), ap_const_lv4_0);
}

void aesl_mux_load_4_4_x_s::thread_tmp_s_fu_124_p1() {
    tmp_s_fu_124_p1 = esl_zext<64,6>(tmp_fu_116_p3.read());
}
