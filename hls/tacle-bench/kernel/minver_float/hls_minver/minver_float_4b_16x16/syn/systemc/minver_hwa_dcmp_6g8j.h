...
#ifndef __minver_hwa_dcmp_6g8j__HH__
#define __minver_hwa_dcmp_6g8j__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(minver_hwa_dcmp_6g8j) {
    ...
    SC_CTOR(minver_hwa_dcmp_6g8j):  ACMP_dcmp_comb_U ("ACMP_dcmp_comb_U") {
