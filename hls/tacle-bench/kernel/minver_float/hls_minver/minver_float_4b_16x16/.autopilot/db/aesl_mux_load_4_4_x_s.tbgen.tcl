...
set C_modelArgList {
	...
	{ empty_13 int 30 regular  }
	{ empty_14 int 2 regular  }
	{ empty int 7 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "empty_9", "interface" : "bram", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "empty_13", "interface" : "wire", "bitwidth" : 30, "direction" : "READONLY"} , 
 	{ "Name" : "empty_14", "interface" : "wire", "bitwidth" : 2, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ empty_13 sc_in sc_lv 30 signal 4 } 
	{ empty_14 sc_in sc_lv 2 signal 5 } 
	{ empty sc_in sc_lv 7 signal 6 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "empty_13", "direction": "in", "datatype": "sc_lv", "bitwidth":30, "type": "signal", "bundle":{"name": "empty_13", "role": "default" }} , 
 	{ "name": "empty_14", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "empty_14", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	empty_13 { ap_none {  { empty_13 in_data 0 30 } } }
	empty_14 { ap_none {  { empty_14 in_data 0 2 } } }
