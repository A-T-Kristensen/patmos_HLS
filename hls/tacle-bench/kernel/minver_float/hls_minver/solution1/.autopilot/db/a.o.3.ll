; ModuleID = '/home/andreas/github/bachelor_project_HLS/hls/tacle-bench/kernel/minver_float/hls_minver/solution1/.autopilot/db/a.o.3.bc'
...
define i32 @minver_hwa([9 x float]* %a) nounwind uwtable {
  ...
  call void @llvm.dbg.value(metadata !{[9 x float]* %a}, i64 0, metadata !29), !dbg !45 ; [debug line = 35:25] [debug variable = a]
...
.preheader13.preheader:                           ; preds = %.preheader14
  ...
  %empty_7 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 1, i64 3, i64 2) nounwind ; [#uses=0 type=i32]
  ...
  %p_shl = zext i4 %tmp_7 to i64, !dbg !69        ; [#uses=1 type=i64] [debug line = 80:2]
  %p_shl_cast = zext i4 %tmp_7 to i5, !dbg !69    ; [#uses=1 type=i5] [debug line = 80:2]
  %tmp_9 = sub i5 %p_shl_cast, %tmp_3_cast, !dbg !69 ; [#uses=3 type=i5] [debug line = 80:2]
  %a_addr_7 = getelementptr [9 x float]* %a, i64 0, i64 %p_shl, !dbg !73 ; [#uses=1 type=float*] [debug line = 102:5]
...
_ifconv:                                          ; preds = %.preheader13
  ...
  %empty_8 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 1, i64 3, i64 0) nounwind ; [#uses=0 type=i32]
  %tmp_24 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @p_str3) nounwind, !dbg !75 ; [#uses=1 type=i32] [debug line = 57:32]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str1) nounwind, !dbg !76 ; [debug line = 58:1]
  %tmp_41 = trunc i32 %r_1 to i5                  ; [#uses=1 type=i5]
  %tmp_43 = trunc i32 %r_1 to i3                  ; [#uses=1 type=i3]
  %p_shl2_cast = call i5 @_ssdm_op_BitConcatenate.i5.i3.i2(i3 %tmp_43, i2 0), !dbg !67 ; [#uses=1 type=i5] [debug line = 59:6]
  %tmp_50 = sub i5 %p_shl2_cast, %tmp_41, !dbg !67 ; [#uses=1 type=i5] [debug line = 59:6]
  %tmp_54 = add i5 %tmp_3_cast, %tmp_50, !dbg !67 ; [#uses=1 type=i5] [debug line = 59:6]
  %tmp_61_cast = sext i5 %tmp_54 to i64, !dbg !67 ; [#uses=1 type=i64] [debug line = 59:6]
  %a_addr_1 = getelementptr [9 x float]* %a, i64 0, i64 %tmp_61_cast, !dbg !67 ; [#uses=1 type=float*] [debug line = 59:6]
  %a_load_3 = load float* %a_addr_1, align 4, !dbg !67 ; [#uses=3 type=float] [debug line = 59:6]
  call void @llvm.dbg.value(metadata !{float %a_load_3}, i64 0, metadata !77), !dbg !83 ; [debug line = 8:31@59:6] [debug variable = n]
  %n_assign_1_to_int = bitcast float %a_load_3 to i32 ; [#uses=3 type=i32]
  %tmp_35 = call i8 @_ssdm_op_PartSelect.i8.i32.i32.i32(i32 %n_assign_1_to_int, i32 23, i32 30) ; [#uses=1 type=i8]
  %tmp_55 = trunc i32 %n_assign_1_to_int to i23   ; [#uses=1 type=i23]
  %notlhs = icmp ne i8 %tmp_35, -1                ; [#uses=1 type=i1]
  %notrhs = icmp eq i23 %tmp_55, 0                ; [#uses=1 type=i1]
  %tmp_37 = or i1 %notrhs, %notlhs                ; [#uses=1 type=i1]
  %tmp_38 = fcmp oge float %a_load_3, 0.000000e+00, !dbg !84 ; [#uses=1 type=i1] [debug line = 11:3@59:6]
  %tmp_39 = and i1 %tmp_37, %tmp_38, !dbg !84     ; [#uses=1 type=i1] [debug line = 11:3@59:6]
  %f_neg_i = xor i32 %n_assign_1_to_int, -2147483648, !dbg !86 ; [#uses=1 type=i32] [debug line = 14:5@59:6]
  %f_1 = bitcast i32 %f_neg_i to float, !dbg !86  ; [#uses=1 type=float] [debug line = 14:5@59:6]
  call void @llvm.dbg.value(metadata !{float %f_1}, i64 0, metadata !87), !dbg !86 ; [debug line = 14:5@59:6] [debug variable = f]
  %w_4 = select i1 %tmp_39, float %a_load_3, float %f_1, !dbg !88 ; [#uses=3 type=float] [debug line = 61:9]
  call void @llvm.dbg.value(metadata !{float %w_4}, i64 0, metadata !90), !dbg !67 ; [debug line = 59:6] [debug variable = w]
  %w_4_to_int = bitcast float %w_4 to i32         ; [#uses=2 type=i32]
  %tmp_40 = call i8 @_ssdm_op_PartSelect.i8.i32.i32.i32(i32 %w_4_to_int, i32 23, i32 30) ; [#uses=1 type=i8]
  %tmp_56 = trunc i32 %w_4_to_int to i23          ; [#uses=1 type=i23]
  %wmax_to_int = bitcast float %wmax to i32       ; [#uses=2 type=i32]
  %tmp_42 = call i8 @_ssdm_op_PartSelect.i8.i32.i32.i32(i32 %wmax_to_int, i32 23, i32 30) ; [#uses=1 type=i8]
  %tmp_57 = trunc i32 %wmax_to_int to i23         ; [#uses=1 type=i23]
  %notlhs3 = icmp ne i8 %tmp_40, -1               ; [#uses=1 type=i1]
  %notrhs3 = icmp eq i23 %tmp_56, 0               ; [#uses=1 type=i1]
  %tmp_44 = or i1 %notrhs3, %notlhs3              ; [#uses=1 type=i1]
  %notlhs4 = icmp ne i8 %tmp_42, -1               ; [#uses=1 type=i1]
  %notrhs4 = icmp eq i23 %tmp_57, 0               ; [#uses=1 type=i1]
  %tmp_45 = or i1 %notrhs4, %notlhs4              ; [#uses=1 type=i1]
  %tmp_46 = and i1 %tmp_44, %tmp_45               ; [#uses=1 type=i1]
  %tmp_47 = fcmp ogt float %w_4, %wmax, !dbg !74  ; [#uses=1 type=i1] [debug line = 60:7]
  %tmp_48 = and i1 %tmp_46, %tmp_47, !dbg !74     ; [#uses=2 type=i1] [debug line = 60:7]
  call void @llvm.dbg.value(metadata !{float %w_4}, i64 0, metadata !91), !dbg !88 ; [debug line = 61:9] [debug variable = wmax]
  call void @llvm.dbg.value(metadata !{i32 %r_1}, i64 0, metadata !56), !dbg !92 ; [debug line = 62:9] [debug variable = r]
  %wmax_1 = select i1 %tmp_48, float %w_4, float %wmax, !dbg !74 ; [#uses=1 type=float] [debug line = 60:7]
  call void @llvm.dbg.value(metadata !{float %wmax_1}, i64 0, metadata !91), !dbg !74 ; [debug line = 60:7] [debug variable = wmax]
  %r_2 = select i1 %tmp_48, i32 %r_1, i32 %r_load_1, !dbg !74 ; [#uses=1 type=i32] [debug line = 60:7]
  call void @llvm.dbg.value(metadata !{i32 %r_2}, i64 0, metadata !56), !dbg !74 ; [debug line = 60:7] [debug variable = r]
  %empty_9 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str3, i32 %tmp_24) nounwind, !dbg !93 ; [#uses=0 type=i32] [debug line = 64:5]
...
_ifconv1:                                         ; preds = %.preheader13
  ...
  %tmp_11 = trunc i32 %r_load to i5               ; [#uses=1 type=i5]
  %tmp_12 = trunc i32 %r_load to i3               ; [#uses=1 type=i3]
  %p_shl3_cast = call i5 @_ssdm_op_BitConcatenate.i5.i3.i2(i3 %tmp_12, i2 0), !dbg !95 ; [#uses=1 type=i5] [debug line = 66:5]
  %tmp_16 = sub i5 %p_shl3_cast, %tmp_11, !dbg !95 ; [#uses=2 type=i5] [debug line = 66:5]
  %tmp_21 = add i5 %tmp_3_cast, %tmp_16, !dbg !95 ; [#uses=1 type=i5] [debug line = 66:5]
  %tmp_58_cast = sext i5 %tmp_21 to i64, !dbg !95 ; [#uses=1 type=i64] [debug line = 66:5]
  %a_addr = getelementptr [9 x float]* %a, i64 0, i64 %tmp_58_cast, !dbg !95 ; [#uses=1 type=float*] [debug line = 66:5]
  %pivot = load float* %a_addr, align 4, !dbg !73 ; [#uses=6 type=float] [debug line = 102:5]
  call void @llvm.dbg.value(metadata !{float %pivot}, i64 0, metadata !96), !dbg !95 ; [debug line = 66:5] [debug variable = pivot]
  call void @llvm.dbg.value(metadata !{float %pivot}, i64 0, metadata !97), !dbg !99 ; [debug line = 8:31@67:11] [debug variable = n]
  ...
  %tmp_31 = trunc i32 %pivot_to_int to i23        ; [#uses=1 type=i23]
  %notlhs1 = icmp ne i8 %tmp_6, -1                ; [#uses=1 type=i1]
  %notrhs1 = icmp eq i23 %tmp_31, 0               ; [#uses=1 type=i1]
  %tmp_17 = or i1 %notrhs1, %notlhs1              ; [#uses=1 type=i1]
  %tmp_28 = fcmp oge float %pivot, 0.000000e+00, !dbg !100 ; [#uses=1 type=i1] [debug line = 11:3@67:11]
  %tmp_29 = and i1 %tmp_17, %tmp_28, !dbg !100    ; [#uses=1 type=i1] [debug line = 11:3@67:11]
  %f_neg_i1 = xor i32 %pivot_to_int, -2147483648, !dbg !101 ; [#uses=1 type=i32] [debug line = 14:5@67:11]
  %f = bitcast i32 %f_neg_i1 to float, !dbg !101  ; [#uses=1 type=float] [debug line = 14:5@67:11]
  call void @llvm.dbg.value(metadata !{float %f}, i64 0, metadata !102), !dbg !101 ; [debug line = 14:5@67:11] [debug variable = f]
  %api = select i1 %tmp_29, float %pivot, float %f, !dbg !98 ; [#uses=1 type=float] [debug line = 67:11]
  call void @llvm.dbg.value(metadata !{float %api}, i64 0, metadata !103), !dbg !98 ; [debug line = 67:11] [debug variable = api]
  %tmp_5 = fpext float %api to double, !dbg !104  ; [#uses=2 type=double] [debug line = 68:5]
  %tmp_5_to_int = bitcast double %tmp_5 to i64    ; [#uses=2 type=i64]
  %tmp_30 = call i11 @_ssdm_op_PartSelect.i11.i64.i32.i32(i64 %tmp_5_to_int, i32 52, i32 62) ; [#uses=1 type=i11]
  %tmp_36 = trunc i64 %tmp_5_to_int to i52        ; [#uses=1 type=i52]
  %notlhs2 = icmp ne i11 %tmp_30, -1              ; [#uses=1 type=i1]
  %notrhs2 = icmp eq i52 %tmp_36, 0               ; [#uses=1 type=i1]
  %tmp_32 = or i1 %notrhs2, %notlhs2              ; [#uses=1 type=i1]
  %tmp_33 = fcmp ole double %tmp_5, 1.000000e-06, !dbg !104 ; [#uses=1 type=i1] [debug line = 68:5]
  %tmp_34 = and i1 %tmp_32, %tmp_33, !dbg !104    ; [#uses=1 type=i1] [debug line = 68:5]
  br i1 %tmp_34, label %.loopexit9.loopexit22, label %3, !dbg !104 ; [debug line = 68:5]
...
; <label>:6                                       ; preds = %5
  ...
  %tmp_26 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @p_str4) nounwind, !dbg !111 ; [#uses=1 type=i32] [debug line = 78:34]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str1) nounwind, !dbg !112 ; [debug line = 79:1]
  %tmp_11_cast = zext i2 %j to i5, !dbg !69       ; [#uses=2 type=i5] [debug line = 80:2]
  %tmp_62 = add i5 %tmp_9, %tmp_11_cast, !dbg !69 ; [#uses=1 type=i5] [debug line = 80:2]
  %tmp_65_cast = sext i5 %tmp_62 to i64, !dbg !69 ; [#uses=1 type=i64] [debug line = 80:2]
  %a_addr_4 = getelementptr [9 x float]* %a, i64 0, i64 %tmp_65_cast, !dbg !69 ; [#uses=2 type=float*] [debug line = 80:2]
  %tmp_63 = add i5 %tmp_16, %tmp_11_cast, !dbg !113 ; [#uses=1 type=i5] [debug line = 81:9]
  %tmp_66_cast = sext i5 %tmp_63 to i64, !dbg !113 ; [#uses=1 type=i64] [debug line = 81:9]
  %a_addr_5 = getelementptr [9 x float]* %a, i64 0, i64 %tmp_66_cast, !dbg !113 ; [#uses=2 type=float*] [debug line = 81:9]
  %w = load float* %a_addr_4, align 4, !dbg !69   ; [#uses=1 type=float] [debug line = 80:2]
  call void @llvm.dbg.value(metadata !{float %w}, i64 0, metadata !90), !dbg !69 ; [debug line = 80:2] [debug variable = w]
  %a_load_2 = load float* %a_addr_5, align 4, !dbg !113 ; [#uses=1 type=float] [debug line = 81:9]
  store float %a_load_2, float* %a_addr_4, align 4, !dbg !113 ; [debug line = 81:9]
  store float %w, float* %a_addr_5, align 4, !dbg !114 ; [debug line = 82:9]
  %empty_11 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str4, i32 %tmp_26) nounwind, !dbg !115 ; [#uses=0 type=i32] [debug line = 83:7]
...
; <label>:8                                       ; preds = %7
  ...
  %tmp_27 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @p_str5) nounwind, !dbg !122 ; [#uses=1 type=i32] [debug line = 86:32]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str1) nounwind, !dbg !124 ; [debug line = 87:1]
  %tmp_12_cast = zext i2 %i_2 to i5, !dbg !125    ; [#uses=1 type=i5] [debug line = 88:2]
  %tmp_64 = add i5 %tmp_9, %tmp_12_cast, !dbg !125 ; [#uses=1 type=i5] [debug line = 88:2]
  %tmp_67_cast = sext i5 %tmp_64 to i64, !dbg !125 ; [#uses=1 type=i64] [debug line = 88:2]
  %a_addr_6 = getelementptr [9 x float]* %a, i64 0, i64 %tmp_67_cast, !dbg !125 ; [#uses=2 type=float*] [debug line = 88:2]
  %a_load_4 = load float* %a_addr_6, align 4, !dbg !125 ; [#uses=1 type=float] [debug line = 88:2]
  %tmp_13 = fdiv float %a_load_4, %pivot, !dbg !125 ; [#uses=1 type=float] [debug line = 88:2]
  store float %tmp_13, float* %a_addr_6, align 4, !dbg !125 ; [debug line = 88:2]
  %empty_13 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str5, i32 %tmp_27) nounwind, !dbg !126 ; [#uses=0 type=i32] [debug line = 89:5]
...
; <label>:9                                       ; preds = %.preheader11
  %tmp_15 = icmp eq i2 %i_3, %i_5, !dbg !128      ; [#uses=1 type=i1] [debug line = 92:7]
  br i1 %tmp_15, label %._crit_edge, label %10, !dbg !128 ; [debug line = 92:7]

; <label>:10                                      ; preds = %9
  %tmp_16_cast = zext i2 %i_3 to i5               ; [#uses=1 type=i5]
  %tmp_65 = call i4 @_ssdm_op_BitConcatenate.i4.i2.i2(i2 %i_3, i2 0) ; [#uses=1 type=i4]
  %p_shl4_cast = zext i4 %tmp_65 to i5, !dbg !130 ; [#uses=1 type=i5] [debug line = 93:9]
  %tmp_66 = sub i5 %p_shl4_cast, %tmp_16_cast, !dbg !130 ; [#uses=2 type=i5] [debug line = 93:9]
  %tmp_67 = add i5 %tmp_3_cast, %tmp_66, !dbg !130 ; [#uses=1 type=i5] [debug line = 93:9]
  %tmp_70_cast = sext i5 %tmp_67 to i64, !dbg !130 ; [#uses=1 type=i64] [debug line = 93:9]
  %a_addr_8 = getelementptr [9 x float]* %a, i64 0, i64 %tmp_70_cast, !dbg !130 ; [#uses=2 type=float*] [debug line = 93:9]
  %w_3 = load float* %a_addr_8, align 4, !dbg !130 ; [#uses=3 type=float] [debug line = 93:9]
  call void @llvm.dbg.value(metadata !{float %w_3}, i64 0, metadata !90), !dbg !130 ; [debug line = 93:9] [debug variable = w]
  %w_3_to_int = bitcast float %w_3 to i32         ; [#uses=3 type=i32]
  %tmp_49 = call i8 @_ssdm_op_PartSelect.i8.i32.i32.i32(i32 %w_3_to_int, i32 23, i32 30) ; [#uses=1 type=i8]
  %tmp_68 = trunc i32 %w_3_to_int to i23          ; [#uses=1 type=i23]
  %notlhs5 = icmp ne i8 %tmp_49, -1               ; [#uses=1 type=i1]
  %notrhs5 = icmp eq i23 %tmp_68, 0               ; [#uses=1 type=i1]
  %tmp_51 = or i1 %notrhs5, %notlhs5              ; [#uses=1 type=i1]
  %tmp_52 = fcmp oeq float %w_3, 0.000000e+00, !dbg !132 ; [#uses=1 type=i1] [debug line = 94:9]
  %tmp_53 = and i1 %tmp_51, %tmp_52, !dbg !132    ; [#uses=1 type=i1] [debug line = 94:9]
  br i1 %tmp_53, label %._crit_edge19, label %.preheader10.preheader, !dbg !132 ; [debug line = 94:9]
...
; <label>:11                                      ; preds = %.preheader10
  %tmp_20 = icmp eq i2 %j_1, %i_5, !dbg !137      ; [#uses=1 type=i1] [debug line = 96:13]
  br i1 %tmp_20, label %._crit_edge20, label %12, !dbg !137 ; [debug line = 96:13]

; <label>:12                                      ; preds = %11
  %tmp_21_cast = zext i2 %j_1 to i5, !dbg !139    ; [#uses=2 type=i5] [debug line = 96:27]
  %tmp_69 = add i5 %tmp_9, %tmp_21_cast, !dbg !139 ; [#uses=1 type=i5] [debug line = 96:27]
  %tmp_71_cast = sext i5 %tmp_69 to i64, !dbg !139 ; [#uses=1 type=i64] [debug line = 96:27]
  %a_addr_9 = getelementptr [9 x float]* %a, i64 0, i64 %tmp_71_cast, !dbg !139 ; [#uses=1 type=float*] [debug line = 96:27]
  %tmp_70 = add i5 %tmp_66, %tmp_21_cast, !dbg !139 ; [#uses=1 type=i5] [debug line = 96:27]
  %tmp_72_cast = sext i5 %tmp_70 to i64, !dbg !139 ; [#uses=1 type=i64] [debug line = 96:27]
  %a_addr_10 = getelementptr [9 x float]* %a, i64 0, i64 %tmp_72_cast, !dbg !139 ; [#uses=2 type=float*] [debug line = 96:27]
  %a_load_6 = load float* %a_addr_9, align 4, !dbg !139 ; [#uses=1 type=float] [debug line = 96:27]
  %tmp_22 = fmul float %w_3, %a_load_6, !dbg !139 ; [#uses=1 type=float] [debug line = 96:27]
  %a_load_7 = load float* %a_addr_10, align 4, !dbg !139 ; [#uses=1 type=float] [debug line = 96:27]
  %tmp_23 = fsub float %a_load_7, %tmp_22, !dbg !139 ; [#uses=1 type=float] [debug line = 96:27]
  store float %tmp_23, float* %a_addr_10, align 4, !dbg !139 ; [debug line = 96:27]
...
; <label>:13                                      ; preds = %.preheader10
  %tmp_18_neg = xor i32 %w_3_to_int, -2147483648, !dbg !140 ; [#uses=1 type=i32] [debug line = 98:11]
  %tmp_18 = bitcast i32 %tmp_18_neg to float, !dbg !140 ; [#uses=1 type=float] [debug line = 98:11]
  %tmp_19 = fdiv float %tmp_18, %pivot, !dbg !140 ; [#uses=1 type=float] [debug line = 98:11]
  store float %tmp_19, float* %a_addr_8, align 4, !dbg !140 ; [debug line = 98:11]
...
; <label>:14                                      ; preds = %.preheader11
  %tmp_14 = fdiv float 1.000000e+00, %pivot, !dbg !73 ; [#uses=1 type=float] [debug line = 102:5]
  store float %tmp_14, float* %a_addr_7, align 4, !dbg !73 ; [debug line = 102:5]
...
.preheader.preheader:                             ; preds = %.preheader8
  %empty_16 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 3, i64 3, i64 3) nounwind ; [#uses=0 type=i32]
...
.preheader:                                       ; preds = %.preheader.loopexit, %.preheader.preheader
  ...
  %tmp_8 = icmp eq i2 %work_load, %i_4, !dbg !148 ; [#uses=1 type=i1] [debug line = 112:7]
  br i1 %tmp_8, label %.preheader8.loopexit, label %15, !dbg !148 ; [debug line = 112:7]

; <label>:15                                      ; preds = %.preheader
  %tmp_10 = zext i2 %work_load to i64, !dbg !149  ; [#uses=1 type=i64] [debug line = 114:7]
  %tmp_10_cast = zext i2 %work_load to i5         ; [#uses=1 type=i5]
  %tmp_58 = call i4 @_ssdm_op_BitConcatenate.i4.i2.i2(i2 %work_load, i2 0) ; [#uses=2 type=i4]
  %tmp_59 = zext i4 %tmp_58 to i5                 ; [#uses=1 type=i5]
  %p_shl5 = zext i4 %tmp_58 to i64, !dbg !150     ; [#uses=1 type=i64] [debug line = 120:2]
  %tmp_60 = sub i5 %tmp_59, %tmp_10_cast, !dbg !150 ; [#uses=1 type=i5] [debug line = 120:2]
  %tmp_61 = add i5 %tmp_cast, %tmp_60, !dbg !150  ; [#uses=1 type=i5] [debug line = 120:2]
  %tmp_64_cast = sext i5 %tmp_61 to i64, !dbg !150 ; [#uses=1 type=i64] [debug line = 120:2]
  %a_addr_2 = getelementptr [9 x float]* %a, i64 0, i64 %tmp_64_cast, !dbg !150 ; [#uses=2 type=float*] [debug line = 120:2]
  %a_addr_3 = getelementptr [9 x float]* %a, i64 0, i64 %p_shl5, !dbg !153 ; [#uses=2 type=float*] [debug line = 121:9]
  %work_addr_2 = getelementptr [500 x i2]* %work, i64 0, i64 %tmp_10, !dbg !149 ; [#uses=2 type=i2*] [debug line = 114:7]
...
; <label>:17                                      ; preds = %16
  ...
  %tmp_25 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @p_str6) nounwind, !dbg !158 ; [#uses=1 type=i32] [debug line = 118:34]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str1) nounwind, !dbg !159 ; [debug line = 119:1]
  %w_2 = load float* %a_addr_2, align 4, !dbg !150 ; [#uses=1 type=float] [debug line = 120:2]
  call void @llvm.dbg.value(metadata !{float %w_2}, i64 0, metadata !90), !dbg !150 ; [debug line = 120:2] [debug variable = w]
  %a_load = load float* %a_addr_3, align 4, !dbg !153 ; [#uses=1 type=float] [debug line = 121:9]
  store float %a_load, float* %a_addr_2, align 4, !dbg !153 ; [debug line = 121:9]
  store float %w_2, float* %a_addr_3, align 4, !dbg !160 ; [debug line = 122:9]
  %empty_18 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str6, i32 %tmp_25) nounwind, !dbg !161 ; [#uses=0 type=i32] [debug line = 123:7]
...
!31 = metadata !{i32 786473, metadata !"minver.c", metadata !"/home/andreas/github/bachelor_project_HLS/hls/tacle-bench/kernel/minver_float", null} ; [ DW_TAG_file_type ]
...
!36 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 96, i64 32, i32 0, i32 0, metadata !37, metadata !39, i32 0, i32 0} ; [ DW_TAG_array_type ]
...
!43 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 288, i64 32, i32 0, i32 0, metadata !37, metadata !44, i32 0, i32 0} ; [ DW_TAG_array_type ]
...
!79 = metadata !{i32 786473, metadata !"minver_lib.c", metadata !"/home/andreas/github/bachelor_project_HLS/hls/tacle-bench/kernel/minver_float", null} ; [ DW_TAG_file_type ]
