...
// wrapc file define: "a"
#define AUTOTB_TVIN_a  "../tv/cdatafile/c.matmul_hw.autotvin_a.dat"
// wrapc file define: "b"
#define AUTOTB_TVIN_b  "../tv/cdatafile/c.matmul_hw.autotvin_b.dat"
// wrapc file define: "c"
#define AUTOTB_TVOUT_c  "../tv/cdatafile/c.matmul_hw.autotvout_c.dat"
#define AUTOTB_TVIN_c  "../tv/cdatafile/c.matmul_hw.autotvin_c.dat"

#define INTER_TCL  "../tv/cdatafile/ref.tcl"

// tvout file define: "c"
#define AUTOTB_TVOUT_PC_c  "../tv/rtldatafile/rtl.matmul_hw.autotvout_c.dat"
...
extern "C" void matmul_hw (
float a[2][2],
float b[2][2],
float c[2][2]);

extern "C" void AESL_WRAP_matmul_hw (
float a[2][2],
float b[2][2],
float c[2][2])
{
			...
			if (i > 0)
			{
				// RTL Name: c
				{
					...
					// {
						// celement: c(31, 0)
						// {
							sc_lv<32>* c_lv0_0_1_1_lv1_0_1_1 = new sc_lv<32>[4];
						// }
					// }
						...
						// celement: c(31, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 1; i_0 += 1)
							{
								...
								for (int i_1 = 0; i_1 <= 1; i_1 += 1)
								{
									...
									{
										c_lv0_0_1_1_lv1_0_1_1[hls_map_index++].range(31, 0) = sc_bv<32>(c_pc_buffer[hls_map_index].range(31, 0));
									}
								}
							}
						}
						...
						// celement: c(31, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 1; i_0 += 1)
							{
								...
								for (int i_1 = 0; i_1 <= 1; i_1 += 1)
								{
									...
									// output_type_conversion : (c_lv0_0_1_1_lv1_0_1_1[hls_map_index++]).to_uint64()
									if (&(c[0][0]) != NULL) // check the null address if the c port is array or others
									{
										*(int*)&c[i_0][i_1] = (c_lv0_0_1_1_lv1_0_1_1[hls_map_index++]).to_uint64();
									}
								}
							}
						}
	...
	else
	{
		...
		sc_bv<32>* a_tvin_wrapc_buffer = new sc_bv<32>[4];
		...
		sc_bv<32>* b_tvin_wrapc_buffer = new sc_bv<32>[4];
		...
		tcl_file.set_num(4, &tcl_file.b_depth);
