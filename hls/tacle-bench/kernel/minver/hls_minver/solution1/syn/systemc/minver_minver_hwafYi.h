...
#ifndef __minver_minver_hwafYi__HH__
#define __minver_minver_hwafYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(minver_minver_hwafYi) {
    ...
    SC_CTOR(minver_minver_hwafYi):  ACMP_dcmp_comb_U ("ACMP_dcmp_comb_U") {
