...
#ifndef __minver_hwa_dcmp_6eOg__HH__
#define __minver_hwa_dcmp_6eOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(minver_hwa_dcmp_6eOg) {
    ...
    SC_CTOR(minver_hwa_dcmp_6eOg):  ACMP_dcmp_comb_U ("ACMP_dcmp_comb_U") {
