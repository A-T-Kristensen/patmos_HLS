...
if {[file isfile minver_minver_hwa.autotvin.dat]} {
	file delete -force minver_minver_hwa.autotvin.dat
}

if {[file isfile minver_minver_hwa.autotvout.dat]} {
	file delete -force minver_minver_hwa.autotvout.dat
}
