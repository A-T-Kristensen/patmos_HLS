...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "minver_minver_hwa.autotvin.dat"
	set constFileTvOut       "minver_minver_hwa.autotvout.dat"
	set constFileHdlTvIn     "minver_minver_hwa.autohdltvin.dat"
	set constFileHdlTvOut    "minver_minver_hwa.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
