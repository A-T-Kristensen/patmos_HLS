...
$(ObjDir)/minver_test.c_pre.c.tb.o : minver_test.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) minver_test.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/minver_lib.c_pre.c.tb.o : minver_lib.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) minver_lib.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/minver.c_pre.c.tb.o : minver.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) minver.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
