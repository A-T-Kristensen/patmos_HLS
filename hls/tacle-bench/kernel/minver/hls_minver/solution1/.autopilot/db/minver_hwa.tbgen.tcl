...
set C_modelArgList {
	{ a double 64 regular {bram 9 { 2 2 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "a", "interface" : "bram", "bitwidth" : 64, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":63,"cElement": [{"cName": "a","cData": "double","bit_use": { "low": 0,"up": 63},"cArray": [{"low" : 0,"up" : 2,"step" : 1},{"low" : 0,"up" : 2,"step" : 1}]}]}]} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.minver_hwa_dsub_6bkb_U1", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.minver_hwa_dmul_6cud_U2", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.minver_hwa_ddiv_6dEe_U3", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.minver_hwa_dcmp_6eOg_U4", "Parent" : "0"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.minver_hwa_dcmp_6eOg_U5", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	a { bram {  { a_Addr_A mem_address 1 32 }  { a_EN_A mem_ce 1 1 }  { a_WEN_A mem_we 1 8 }  { a_Din_A mem_din 1 64 }  { a_Dout_A mem_dout 0 64 }  { a_Clk_A mem_clk 1 1 }  { a_Rst_A mem_rst 1 1 }  { a_Addr_B mem_address 1 32 }  { a_EN_B mem_ce 1 1 }  { a_WEN_B mem_we 1 8 }  { a_Din_B mem_din 1 64 }  { a_Dout_B mem_dout 0 64 }  { a_Clk_B mem_clk 1 1 }  { a_Rst_B mem_rst 1 1 } } }
}
