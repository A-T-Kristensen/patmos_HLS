...
define void @fir2dim_hwa(float* %fir2dim_input, float* %fir2dim_output) nounwind uwtable {
  ...
  call void @llvm.dbg.value(metadata !{float* %fir2dim_output}, i64 0, metadata !42), !dbg !43 ; [debug line = 110:3] [debug variable = poutput]
  br label %1, !dbg !44                           ; [debug line = 119:9]
...
; <label>:1                                       ; preds = %10, %0
  ...
  %exitcond1 = icmp eq i32 %k, 4, !dbg !44        ; [#uses=1 type=i1] [debug line = 119:9]
  br i1 %exitcond1, label %11, label %2, !dbg !44 ; [debug line = 119:9]

; <label>:2                                       ; preds = %1
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str4, i64 0, i64 0)) nounwind, !dbg !46 ; [#uses=1 type=i32] [debug line = 119:32]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !48 ; [debug line = 120:1]
  %tmp = mul nsw i32 %k, 6, !dbg !49              ; [#uses=1 type=i32] [debug line = 125:4]
  br label %3, !dbg !52                           ; [debug line = 122:8]
...
; <label>:3                                       ; preds = %9, %2
  ...
  %lftr.wideiv = trunc i64 %poutput.1.rec to i32, !dbg !52 ; [#uses=1 type=i32] [debug line = 122:8]
  %exitcond = icmp eq i32 %lftr.wideiv, 4, !dbg !52 ; [#uses=1 type=i1] [debug line = 122:8]
  br i1 %exitcond, label %10, label %4, !dbg !52  ; [debug line = 122:8]

; <label>:4                                       ; preds = %3
  call void @llvm.dbg.value(metadata !{float* %fir2dim_input}, i64 0, metadata !53), !dbg !54 ; [debug line = 124:4] [debug variable = pcoeff]
  %tmp.2 = add i32 %tmp, 25, !dbg !49             ; [#uses=1 type=i32] [debug line = 125:4]
  %tmp.3 = add i32 %tmp.2, %f, !dbg !49           ; [#uses=1 type=i32] [debug line = 125:4]
  %tmp.4 = sext i32 %tmp.3 to i64, !dbg !49       ; [#uses=3 type=i64] [debug line = 125:4]
  br label %5, !dbg !55                           ; [debug line = 131:10]

; <label>:5                                       ; preds = %6, %4
  %tmp.5 = phi float [ 0.000000e+00, %4 ], [ %tmp.7, %6 ] ; [#uses=3 type=float]
  %pcoeff.0.rec = phi i64 [ 0, %4 ], [ %.rec8, %6 ] ; [#uses=4 type=i64]
  store float %tmp.5, float* %fir2dim_output.addr.1, align 4, !dbg !57 ; [debug line = 132:3]
  ...
  %lftr.wideiv1 = trunc i64 %pcoeff.0.rec to i32, !dbg !55 ; [#uses=1 type=i32] [debug line = 131:10]
  %exitcond2 = icmp eq i32 %lftr.wideiv1, 3, !dbg !55 ; [#uses=1 type=i1] [debug line = 131:10]
  br i1 %exitcond2, label %.preheader21.preheader, label %6, !dbg !55 ; [debug line = 131:10]

.preheader21.preheader:                           ; preds = %5
  %.lcssa1 = phi float [ %tmp.5, %5 ]             ; [#uses=1 type=float]
  br label %.preheader21, !dbg !59                ; [debug line = 126:4]

; <label>:6                                       ; preds = %5
  %.rec8 = add i64 %pcoeff.0.rec, 1, !dbg !57     ; [#uses=1 type=i64] [debug line = 132:3]
  %fir2dim_input.load = load float* %fir2dim_input.addr.1, align 4, !dbg !57 ; [#uses=1 type=float] [debug line = 132:3]
  %fir2dim_input.load.1 = load float* %fir2dim_input.addr, align 4, !dbg !57 ; [#uses=1 type=float] [debug line = 132:3]
  %tmp.6 = fmul float %fir2dim_input.load, %fir2dim_input.load.1, !dbg !57 ; [#uses=1 type=float] [debug line = 132:3]
  %tmp.7 = fadd float %tmp.5, %tmp.6, !dbg !57    ; [#uses=1 type=float] [debug line = 132:3]
  br label %5, !dbg !60                           ; [debug line = 131:26]
...
.preheader21:                                     ; preds = %7, %.preheader21.preheader
  ...
  %.sum = add i64 %tmp.4, 6, !dbg !59             ; [#uses=1 type=i64] [debug line = 126:4]
  ...
  %lftr.wideiv2 = trunc i64 %pcoeff.1.rec to i32, !dbg !61 ; [#uses=1 type=i32] [debug line = 135:10]
  %exitcond3 = icmp eq i32 %lftr.wideiv2, 3, !dbg !61 ; [#uses=1 type=i1] [debug line = 135:10]
  br i1 %exitcond3, label %.preheader.preheader, label %7, !dbg !61 ; [debug line = 135:10]

.preheader.preheader:                             ; preds = %.preheader21
  %.lcssa = phi float [ %tmp.8, %.preheader21 ]   ; [#uses=1 type=float]
  br label %.preheader, !dbg !63                  ; [debug line = 127:4]

; <label>:7                                       ; preds = %.preheader21
  %.rec4 = add i64 %pcoeff.1.rec, 1, !dbg !64     ; [#uses=1 type=i64] [debug line = 136:3]
  %fir2dim_input.load.2 = load float* %fir2dim_input.addr.3, align 4, !dbg !64 ; [#uses=1 type=float] [debug line = 136:3]
  %fir2dim_input.load.3 = load float* %fir2dim_input.addr.2, align 4, !dbg !64 ; [#uses=1 type=float] [debug line = 136:3]
  %tmp.9 = fmul float %fir2dim_input.load.2, %fir2dim_input.load.3, !dbg !64 ; [#uses=1 type=float] [debug line = 136:3]
  %tmp.10 = fadd float %tmp.8, %tmp.9, !dbg !64   ; [#uses=2 type=float] [debug line = 136:3]
  store float %tmp.10, float* %fir2dim_output.addr.1, align 4, !dbg !64 ; [debug line = 136:3]
  br label %.preheader21, !dbg !66                ; [debug line = 135:26]
...
.preheader:                                       ; preds = %8, %.preheader.preheader
  ...
  %.sum2 = add i64 %tmp.4, 12, !dbg !63           ; [#uses=1 type=i64] [debug line = 127:4]
  ...
  %lftr.wideiv3 = trunc i64 %pcoeff.2.rec to i32, !dbg !67 ; [#uses=1 type=i32] [debug line = 139:10]
  %exitcond4 = icmp eq i32 %lftr.wideiv3, 3, !dbg !67 ; [#uses=1 type=i1] [debug line = 139:10]
  br i1 %exitcond4, label %9, label %8, !dbg !67  ; [debug line = 139:10]

; <label>:8                                       ; preds = %.preheader
  %.rec = add i64 %pcoeff.2.rec, 1, !dbg !69      ; [#uses=1 type=i64] [debug line = 140:3]
  %fir2dim_input.load.4 = load float* %fir2dim_input.addr.5, align 4, !dbg !69 ; [#uses=1 type=float] [debug line = 140:3]
  %fir2dim_input.load.5 = load float* %fir2dim_input.addr.4, align 4, !dbg !69 ; [#uses=1 type=float] [debug line = 140:3]
  %tmp.13 = fmul float %fir2dim_input.load.4, %fir2dim_input.load.5, !dbg !69 ; [#uses=1 type=float] [debug line = 140:3]
  %tmp.14 = fadd float %tmp.11, %tmp.13, !dbg !69 ; [#uses=2 type=float] [debug line = 140:3]
  store float %tmp.14, float* %fir2dim_output.addr.1, align 4, !dbg !69 ; [debug line = 140:3]
  br label %.preheader, !dbg !71                  ; [debug line = 139:26]

; <label>:9                                       ; preds = %.preheader
  %.rec1 = add i64 %poutput.1.rec, 1, !dbg !72    ; [#uses=1 type=i64] [debug line = 143:4]
  %f.1 = add nsw i32 %f, 1, !dbg !73              ; [#uses=1 type=i32] [debug line = 122:24]
  call void @llvm.dbg.value(metadata !{i32 %f.1}, i64 0, metadata !74), !dbg !73 ; [debug line = 122:24] [debug variable = f]
  br label %3, !dbg !73                           ; [debug line = 122:24]

; <label>:10                                      ; preds = %3
  %poutput.1.lcssa.idx = phi i64 [ %poutput.0.idx1, %3 ] ; [#uses=1 type=i64]
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str4, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !75 ; [#uses=0 type=i32] [debug line = 145:3]
  %k.1 = add nsw i32 %k, 1, !dbg !76              ; [#uses=1 type=i32] [debug line = 119:25]
  call void @llvm.dbg.value(metadata !{i32 %k.1}, i64 0, metadata !77), !dbg !76 ; [debug line = 119:25] [debug variable = k]
  br label %1, !dbg !76                           ; [debug line = 119:25]

; <label>:11                                      ; preds = %1
  ret void, !dbg !78                              ; [debug line = 149:1]
}
...
!43 = metadata !{i32 110, i32 3, metadata !35, null}
!44 = metadata !{i32 119, i32 9, metadata !45, null}
!45 = metadata !{i32 786443, metadata !35, i32 119, i32 3, metadata !6, i32 1} ; [ DW_TAG_lexical_block ]
!46 = metadata !{i32 119, i32 32, metadata !47, null}
!47 = metadata !{i32 786443, metadata !45, i32 119, i32 31, metadata !6, i32 2} ; [ DW_TAG_lexical_block ]
!48 = metadata !{i32 120, i32 1, metadata !47, null}
!49 = metadata !{i32 125, i32 4, metadata !50, null}
!50 = metadata !{i32 786443, metadata !51, i32 122, i32 30, metadata !6, i32 4} ; [ DW_TAG_lexical_block ]
!51 = metadata !{i32 786443, metadata !47, i32 122, i32 2, metadata !6, i32 3} ; [ DW_TAG_lexical_block ]
!52 = metadata !{i32 122, i32 8, metadata !51, null}
!53 = metadata !{i32 786688, metadata !35, metadata !"pcoeff", metadata !6, i32 108, metadata !9, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!54 = metadata !{i32 124, i32 4, metadata !50, null}
!55 = metadata !{i32 131, i32 10, metadata !56, null}
!56 = metadata !{i32 786443, metadata !50, i32 131, i32 4, metadata !6, i32 5} ; [ DW_TAG_lexical_block ]
!57 = metadata !{i32 132, i32 3, metadata !58, null}
!58 = metadata !{i32 786443, metadata !56, i32 131, i32 31, metadata !6, i32 6} ; [ DW_TAG_lexical_block ]
!59 = metadata !{i32 126, i32 4, metadata !50, null}
!60 = metadata !{i32 131, i32 26, metadata !56, null}
!61 = metadata !{i32 135, i32 10, metadata !62, null}
!62 = metadata !{i32 786443, metadata !50, i32 135, i32 4, metadata !6, i32 7} ; [ DW_TAG_lexical_block ]
!63 = metadata !{i32 127, i32 4, metadata !50, null}
!64 = metadata !{i32 136, i32 3, metadata !65, null}
!65 = metadata !{i32 786443, metadata !62, i32 135, i32 31, metadata !6, i32 8} ; [ DW_TAG_lexical_block ]
!66 = metadata !{i32 135, i32 26, metadata !62, null}
!67 = metadata !{i32 139, i32 10, metadata !68, null}
!68 = metadata !{i32 786443, metadata !50, i32 139, i32 4, metadata !6, i32 9} ; [ DW_TAG_lexical_block ]
!69 = metadata !{i32 140, i32 3, metadata !70, null}
!70 = metadata !{i32 786443, metadata !68, i32 139, i32 31, metadata !6, i32 10} ; [ DW_TAG_lexical_block ]
!71 = metadata !{i32 139, i32 26, metadata !68, null}
!72 = metadata !{i32 143, i32 4, metadata !50, null}
!73 = metadata !{i32 122, i32 24, metadata !51, null}
!74 = metadata !{i32 786688, metadata !35, metadata !"f", metadata !6, i32 113, metadata !22, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!75 = metadata !{i32 145, i32 3, metadata !47, null}
!76 = metadata !{i32 119, i32 25, metadata !45, null}
!77 = metadata !{i32 786688, metadata !35, metadata !"k", metadata !6, i32 113, metadata !22, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!78 = metadata !{i32 149, i32 1, metadata !35, null}
