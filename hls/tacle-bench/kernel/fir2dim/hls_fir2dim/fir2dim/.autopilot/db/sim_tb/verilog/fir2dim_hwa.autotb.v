...
`define AUTOTB_DUT      fir2dim_hwa
`define AUTOTB_DUT_INST AESL_inst_fir2dim_hwa
`define AUTOTB_TOP      apatb_fir2dim_hwa_top
`define AUTOTB_LAT_RESULT_FILE "fir2dim_hwa.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "fir2dim_hwa.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_fir2dim_hwa_top
...
reg dump_tvout_finish_fir2dim_output;

initial begin : dump_tvout_runtime_sign_fir2dim_output
    integer fp;
    dump_tvout_finish_fir2dim_output = 0;
    fp = $fopen(`AUTOTB_TVOUT_fir2dim_output_out_wrapc, "w");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_fir2dim_output_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
    end
    $fdisplay(fp,"[[[runtime]]]");
    ...
    @ (posedge AESL_clock);
    @ (posedge AESL_clock);
    fp = $fopen(`AUTOTB_TVOUT_fir2dim_output_out_wrapc, "a");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_fir2dim_output_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
    ...
    $fdisplay(fp,"[[[/runtime]]]");
    $fclose(fp);
    dump_tvout_finish_fir2dim_output = 1;
end
