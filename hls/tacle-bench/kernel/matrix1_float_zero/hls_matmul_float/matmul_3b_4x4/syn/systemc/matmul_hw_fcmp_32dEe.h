...
#ifndef __matmul_hw_fcmp_32dEe__HH__
#define __matmul_hw_fcmp_32dEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(matmul_hw_fcmp_32dEe) {
    ...
    SC_CTOR(matmul_hw_fcmp_32dEe):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
