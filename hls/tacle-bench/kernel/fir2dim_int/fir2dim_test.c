...
void fir2dim_pin_down(TYPE *pimage, TYPE *parray, 
...
int fir2dim_main(TYPE fir2dim_coefficients[COEFFICIENTS * COEFFICIENTS],
  ...
  TYPE *parray  = &fir2dim_array[0], *parray2, *parray3;
  TYPE *pcoeff  = &fir2dim_coefficients[0];
...
int main(void) {
	...
	TYPE fir2dim_input[SIZE] = {0};
	TYPE fir2dim_coefficients[COEFFICIENTS * COEFFICIENTS] = {0};
	TYPE fir2dim_image[IMAGEDIM * IMAGEDIM] = {0};
	TYPE fir2dim_array[ARRAYDIM * ARRAYDIM]  = {0};
	TYPE fir2dim_output_sw[IMAGEDIM * IMAGEDIM] = {0};
	TYPE fir2dim_output_hw[IMAGEDIM * IMAGEDIM] = {0};
