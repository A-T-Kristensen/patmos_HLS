...
#ifndef __fir2dim_hwa_mul_3bkb__HH__
#define __fir2dim_hwa_mul_3bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(fir2dim_hwa_mul_3bkb) {
    ...
    SC_CTOR(fir2dim_hwa_mul_3bkb):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
