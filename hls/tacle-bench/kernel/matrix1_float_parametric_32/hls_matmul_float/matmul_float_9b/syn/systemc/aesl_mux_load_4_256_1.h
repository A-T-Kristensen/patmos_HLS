...
#ifndef _aesl_mux_load_4_256_1_HH_
#define _aesl_mux_load_4_256_1_HH_
...
struct aesl_mux_load_4_256_1 : public sc_module {
    ...
    sc_in< sc_lv<24> > empty_14;
    sc_in< sc_lv<8> > empty;
    sc_out< sc_lv<32> > ap_return;


    // Module declarations
    aesl_mux_load_4_256_1(sc_module_name name);
    SC_HAS_PROCESS(aesl_mux_load_4_256_1);

    ~aesl_mux_load_4_256_1();
    ...
    sc_signal< sc_lv<32> > empty_13_Addr_A_orig;
    ...
    void thread_empty_13_Addr_A_orig();
