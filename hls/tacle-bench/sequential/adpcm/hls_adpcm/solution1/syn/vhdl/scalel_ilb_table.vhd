...
entity scalel_ilb_table_rom is 
    generic(
             dwidth     : integer := 12; 
             awidth     : integer := 5; 
             mem_size    : integer := 32
...
architecture rtl of scalel_ilb_table_rom is 
...
architecture arch of scalel_ilb_table is
    component scalel_ilb_table_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    scalel_ilb_table_rom_U :  component scalel_ilb_table_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
