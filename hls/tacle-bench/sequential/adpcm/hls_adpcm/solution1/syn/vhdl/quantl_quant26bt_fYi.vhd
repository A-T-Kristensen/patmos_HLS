...
entity quantl_quant26bt_fYi_rom is 
    generic(
             dwidth     : integer := 6; 
             awidth     : integer := 5; 
             mem_size    : integer := 31
...
architecture rtl of quantl_quant26bt_fYi_rom is 
...
entity quantl_quant26bt_fYi is
    generic (
        DataWidth : INTEGER := 6;
...
architecture arch of quantl_quant26bt_fYi is
    component quantl_quant26bt_fYi_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    quantl_quant26bt_fYi_rom_U :  component quantl_quant26bt_fYi_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
