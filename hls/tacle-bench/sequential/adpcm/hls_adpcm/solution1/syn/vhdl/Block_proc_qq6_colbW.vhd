...
entity Block_proc_qq6_colbW_rom is 
    generic(
             dwidth     : integer := 16; 
             awidth     : integer := 6; 
             mem_size    : integer := 64
...
architecture rtl of Block_proc_qq6_colbW_rom is 
...
entity Block_proc_qq6_colbW is
    generic (
...
architecture arch of Block_proc_qq6_colbW is
    component Block_proc_qq6_colbW_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    Block_proc_qq6_colbW_rom_U :  component Block_proc_qq6_colbW_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
