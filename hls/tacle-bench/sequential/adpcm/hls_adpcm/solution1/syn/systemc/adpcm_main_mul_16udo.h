...
#ifndef __adpcm_main_mul_16udo__HH__
#define __adpcm_main_mul_16udo__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(adpcm_main_mul_16udo) {
    ...
    SC_CTOR(adpcm_main_mul_16udo):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
