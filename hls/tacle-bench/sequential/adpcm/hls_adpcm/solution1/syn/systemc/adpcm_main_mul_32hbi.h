...
#ifndef __adpcm_main_mul_32hbi__HH__
#define __adpcm_main_mul_32hbi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(adpcm_main_mul_32hbi) {
    ...
    SC_CTOR(adpcm_main_mul_32hbi):  ACMP_mul_su_U ("ACMP_mul_su_U") {
