...
scalel::scalel(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_ilb_table_load_cast_fu_82_p1);
    sensitive << ( ilb_table_q0 );

    SC_METHOD(thread_tmp_11_fu_86_p1);
    sensitive << ( shift_constant );

    SC_METHOD(thread_tmp_12_fu_112_p1);
    sensitive << ( wd3_fu_106_p2 );

    SC_METHOD(thread_tmp_27_fu_90_p2);
    sensitive << ( tmp_11_fu_86_p1 );

    SC_METHOD(thread_tmp_28_fu_100_p2);
    sensitive << ( tmp_37_cast_fu_96_p1 );
    sensitive << ( wd2_cast_fu_79_p1 );

    SC_METHOD(thread_tmp_29_fu_116_p3);
    sensitive << ( tmp_12_fu_112_p1 );

    SC_METHOD(thread_tmp_37_cast_fu_96_p1);
    sensitive << ( tmp_27_fu_90_p2 );
    ...
    SC_METHOD(thread_wd2_cast_fu_79_p1);
    sensitive << ( tmp_reg_124 );

    SC_METHOD(thread_wd3_fu_106_p2);
    sensitive << ( ilb_table_load_cast_fu_82_p1 );
    sensitive << ( tmp_28_fu_100_p2 );
    ...
    sc_trace(mVcdFile, tmp_11_fu_86_p1, "tmp_11_fu_86_p1");
    sc_trace(mVcdFile, tmp_27_fu_90_p2, "tmp_27_fu_90_p2");
    sc_trace(mVcdFile, tmp_37_cast_fu_96_p1, "tmp_37_cast_fu_96_p1");
    sc_trace(mVcdFile, wd2_cast_fu_79_p1, "wd2_cast_fu_79_p1");
    sc_trace(mVcdFile, ilb_table_load_cast_fu_82_p1, "ilb_table_load_cast_fu_82_p1");
    sc_trace(mVcdFile, tmp_28_fu_100_p2, "tmp_28_fu_100_p2");
    sc_trace(mVcdFile, wd3_fu_106_p2, "wd3_fu_106_p2");
    sc_trace(mVcdFile, tmp_12_fu_112_p1, "tmp_12_fu_112_p1");
    sc_trace(mVcdFile, tmp_29_fu_116_p3, "tmp_29_fu_116_p3");
...
void scalel::thread_ap_return() {
    if ((esl_seteq<1,1,1>(ap_const_lv1_1, ap_CS_fsm_state2.read()))) {
        ap_return = tmp_29_fu_116_p3.read();
    } else {
...
void scalel::thread_ilb_table_load_cast_fu_82_p1() {
    ilb_table_load_cast_fu_82_p1 = esl_zext<22,12>(ilb_table_q0.read());
}

void scalel::thread_tmp_11_fu_86_p1() {
    tmp_11_fu_86_p1 = shift_constant.read().range(4-1, 0);
}

void scalel::thread_tmp_12_fu_112_p1() {
    tmp_12_fu_112_p1 = wd3_fu_106_p2.read().range(12-1, 0);
}

void scalel::thread_tmp_27_fu_90_p2() {
    tmp_27_fu_90_p2 = (!ap_const_lv4_1.is_01() || !tmp_11_fu_86_p1.read().is_01())? sc_lv<4>(): (sc_biguint<4>(ap_const_lv4_1) + sc_biguint<4>(tmp_11_fu_86_p1.read()));
}

void scalel::thread_tmp_28_fu_100_p2() {
    tmp_28_fu_100_p2 = (!tmp_37_cast_fu_96_p1.read().is_01() || !wd2_cast_fu_79_p1.read().is_01())? sc_lv<22>(): (sc_biguint<22>(tmp_37_cast_fu_96_p1.read()) - sc_biguint<22>(wd2_cast_fu_79_p1.read()));
}

void scalel::thread_tmp_29_fu_116_p3() {
    tmp_29_fu_116_p3 = esl_concat<12,3>(tmp_12_fu_112_p1.read(), ap_const_lv3_0);
}

void scalel::thread_tmp_37_cast_fu_96_p1() {
    tmp_37_cast_fu_96_p1 = esl_zext<22,4>(tmp_27_fu_90_p2.read());
}
...
void scalel::thread_wd2_cast_fu_79_p1() {
    wd2_cast_fu_79_p1 = esl_zext<22,4>(tmp_reg_124.read());
}

void scalel::thread_wd3_fu_106_p2() {
    wd3_fu_106_p2 = (!tmp_28_fu_100_p2.read().is_01())? sc_lv<22>(): ilb_table_load_cast_fu_82_p1.read() >> (unsigned short)tmp_28_fu_100_p2.read().to_uint();
}
