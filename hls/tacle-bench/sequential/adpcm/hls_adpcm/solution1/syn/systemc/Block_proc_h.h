...
#ifndef __Block_proc_h_H__
#define __Block_proc_h_H__
...
struct Block_proc_h_ram : public sc_core::sc_module {
...
Block_proc_h_ram* meminst;


SC_CTOR(Block_proc_h) {
meminst = new Block_proc_h_ram("Block_proc_h_ram");
