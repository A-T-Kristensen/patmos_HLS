...
#ifndef __matrixmul_mul_32seOg__HH__
#define __matrixmul_mul_32seOg__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(matrixmul_mul_32seOg) {
    ...
    SC_CTOR(matrixmul_mul_32seOg):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
