...
add wave -group $designtopgroup -group $coutputgroup -group $a_group -radix hex /apatb_matrixmul_top/AESL_inst_matrixmul/a_3_Addr_A
add wave -group $designtopgroup -group $coutputgroup -group $a_group -color #ffff00 -radix hex /apatb_matrixmul_top/AESL_inst_matrixmul/a_3_EN_A
add wave -group $designtopgroup -group $coutputgroup -group $a_group -color #ffff00 -radix hex /apatb_matrixmul_top/AESL_inst_matrixmul/a_3_WEN_A
add wave -group $designtopgroup -group $coutputgroup -group $a_group -radix hex /apatb_matrixmul_top/AESL_inst_matrixmul/a_3_Din_A
add wave -group $designtopgroup -group $coutputgroup -group $a_group -radix hex /apatb_matrixmul_top/AESL_inst_matrixmul/a_3_Dout_A
add wave -group $designtopgroup -group $coutputgroup -group $a_group -radix hex /apatb_matrixmul_top/AESL_inst_matrixmul/a_3_Clk_A
add wave -group $designtopgroup -group $coutputgroup -group $a_group -radix hex /apatb_matrixmul_top/AESL_inst_matrixmul/a_3_Rst_A
set cinoutgroup "C InOut"
add wave -group $designtopgroup -group $cinoutgroup
set a_group a(bram)
add wave -group $designtopgroup -group $cinoutgroup -group $a_group
add wave -group $designtopgroup -group $cinoutgroup -group $a_group -radix hex /apatb_matrixmul_top/AESL_inst_matrixmul/a_2_Addr_A
add wave -group $designtopgroup -group $cinoutgroup -group $a_group -color #ffff00 -radix hex /apatb_matrixmul_top/AESL_inst_matrixmul/a_2_EN_A
add wave -group $designtopgroup -group $cinoutgroup -group $a_group -color #ffff00 -radix hex /apatb_matrixmul_top/AESL_inst_matrixmul/a_2_WEN_A
add wave -group $designtopgroup -group $cinoutgroup -group $a_group -radix hex /apatb_matrixmul_top/AESL_inst_matrixmul/a_2_Din_A
add wave -group $designtopgroup -group $cinoutgroup -group $a_group -radix hex /apatb_matrixmul_top/AESL_inst_matrixmul/a_2_Dout_A
add wave -group $designtopgroup -group $cinoutgroup -group $a_group -radix hex /apatb_matrixmul_top/AESL_inst_matrixmul/a_2_Clk_A
add wave -group $designtopgroup -group $cinoutgroup -group $a_group -radix hex /apatb_matrixmul_top/AESL_inst_matrixmul/a_2_Rst_A
...
add wave -group $testbenchgroup -group $tbcoutputgroup -group $tb_a_group -radix hex /apatb_matrixmul_top/a_3_ADDR_A
add wave -group $testbenchgroup -group $tbcoutputgroup -group $tb_a_group -color #ffff00 -radix hex /apatb_matrixmul_top/a_3_EN_A
add wave -group $testbenchgroup -group $tbcoutputgroup -group $tb_a_group -color #ffff00 -radix hex /apatb_matrixmul_top/a_3_WEN_A
add wave -group $testbenchgroup -group $tbcoutputgroup -group $tb_a_group -radix hex /apatb_matrixmul_top/a_3_DIN_A
add wave -group $testbenchgroup -group $tbcoutputgroup -group $tb_a_group -radix hex /apatb_matrixmul_top/a_3_DOUT_A
add wave -group $testbenchgroup -group $tbcoutputgroup -group $tb_a_group -radix hex /apatb_matrixmul_top/a_3_CLK_A
add wave -group $testbenchgroup -group $tbcoutputgroup -group $tb_a_group -radix hex /apatb_matrixmul_top/a_3_RST_A
set tbcinoutgroup "C InOuts"
add wave -group $testbenchgroup -group $tbcinoutgroup
set tb_a_group a(bram)
add wave -group $testbenchgroup -group $tbcinoutgroup -group $tb_a_group
add wave -group $testbenchgroup -group $tbcinoutgroup -group $tb_a_group -radix hex /apatb_matrixmul_top/a_2_ADDR_A
add wave -group $testbenchgroup -group $tbcinoutgroup -group $tb_a_group -color #ffff00 -radix hex /apatb_matrixmul_top/a_2_EN_A
add wave -group $testbenchgroup -group $tbcinoutgroup -group $tb_a_group -color #ffff00 -radix hex /apatb_matrixmul_top/a_2_WEN_A
add wave -group $testbenchgroup -group $tbcinoutgroup -group $tb_a_group -radix hex /apatb_matrixmul_top/a_2_DIN_A
add wave -group $testbenchgroup -group $tbcinoutgroup -group $tb_a_group -radix hex /apatb_matrixmul_top/a_2_DOUT_A
add wave -group $testbenchgroup -group $tbcinoutgroup -group $tb_a_group -radix hex /apatb_matrixmul_top/a_2_CLK_A
add wave -group $testbenchgroup -group $tbcinoutgroup -group $tb_a_group -radix hex /apatb_matrixmul_top/a_2_RST_A
