...
int a[12][4])
{
	...
	if (wrapc_switch_file_token.good())
	{
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			sc_bv<32> *a_pc_buffer = new sc_bv<32>[48];
			int i = 0;
			...
			if (i > 0)
			{
				// RTL Name: a
				{
					...
					// {
						// celement: a(31, 0)
						// {
							sc_lv<32>* a_lv0_0_11_1_lv1_0_3_1 = new sc_lv<32>[48];
						// }
					// }
						...
						// celement: a(31, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 11; i_0 += 1)
							{
								...
								for (int i_1 = 0; i_1 <= 3; i_1 += 1)
								{
									...
									{
										a_lv0_0_11_1_lv1_0_3_1[hls_map_index++].range(31, 0) = sc_bv<32>(a_pc_buffer[hls_map_index].range(31, 0));
									}
								}
							}
						}
						...
						// celement: a(31, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 11; i_0 += 1)
							{
								...
								for (int i_1 = 0; i_1 <= 3; i_1 += 1)
								{
									...
									// output_type_conversion : (a_lv0_0_11_1_lv1_0_3_1[hls_map_index++]).to_uint64()
									if (&(a[0][0]) != NULL) // check the null address if the c port is array or others
									{
										a[i_0][i_1] = (a_lv0_0_11_1_lv1_0_3_1[hls_map_index++]).to_uint64();
									}
								}
							}
						}
	...
	else
	{
		...
		sc_bv<32>* a_tvin_wrapc_buffer = new sc_bv<32>[48];
		...
		tcl_file.set_num(48, &tcl_file.a_depth);
...
// [call_c_dut] ---------->
		...
		sc_bv<32>* a_tvout_wrapc_buffer = new sc_bv<32>[48];
