; ModuleID = 'C:/Dropbox/Projects/vivado_hls/matmul_float/hls/hls_matmul/solution_default/.autopilot/db/a.g.1.bc'
...
; <label>:2                                       ; preds = %1
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([4 x i8]* @.str2, i32 0, i32 0)), !dbg !40 ; [debug line = 10:2]
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([4 x i8]* @.str2, i32 0, i32 0)) nounwind, !dbg !40 ; [#uses=1 type=i32] [debug line = 10:2]
...
; <label>:4                                       ; preds = %3
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([4 x i8]* @.str3, i32 0, i32 0)), !dbg !44 ; [debug line = 12:4]
  %rbegin3 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([4 x i8]* @.str3, i32 0, i32 0)) nounwind, !dbg !44 ; [#uses=1 type=i32] [debug line = 12:4]
...
; <label>:6                                       ; preds = %5
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([4 x i8]* @.str4, i32 0, i32 0)), !dbg !49 ; [debug line = 16:5]
  %rbegin5 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([4 x i8]* @.str4, i32 0, i32 0)) nounwind, !dbg !49 ; [#uses=1 type=i32] [debug line = 16:5]
  ...
  %rend6 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([4 x i8]* @.str4, i32 0, i32 0), i32 %rbegin5) nounwind, !dbg !53 ; [#uses=0 type=i32] [debug line = 18:4]
...
; <label>:7                                       ; preds = %5
  ...
  %rend4 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([4 x i8]* @.str3, i32 0, i32 0), i32 %rbegin3) nounwind, !dbg !58 ; [#uses=0 type=i32] [debug line = 20:5]
...
; <label>:8                                       ; preds = %3
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([4 x i8]* @.str2, i32 0, i32 0), i32 %rbegin) nounwind, !dbg !61 ; [#uses=0 type=i32] [debug line = 21:2]
