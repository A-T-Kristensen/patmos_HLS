...
add wave -group $designtopgroup -group $cinoutgroup -group $a_group -radix hex /apatb_matrixmul_top/AESL_inst_matrixmul/a_1_Addr_A
add wave -group $designtopgroup -group $cinoutgroup -group $a_group -color #ffff00 -radix hex /apatb_matrixmul_top/AESL_inst_matrixmul/a_1_EN_A
add wave -group $designtopgroup -group $cinoutgroup -group $a_group -color #ffff00 -radix hex /apatb_matrixmul_top/AESL_inst_matrixmul/a_1_WEN_A
add wave -group $designtopgroup -group $cinoutgroup -group $a_group -radix hex /apatb_matrixmul_top/AESL_inst_matrixmul/a_1_Din_A
add wave -group $designtopgroup -group $cinoutgroup -group $a_group -radix hex /apatb_matrixmul_top/AESL_inst_matrixmul/a_1_Dout_A
add wave -group $designtopgroup -group $cinoutgroup -group $a_group -radix hex /apatb_matrixmul_top/AESL_inst_matrixmul/a_1_Clk_A
add wave -group $designtopgroup -group $cinoutgroup -group $a_group -radix hex /apatb_matrixmul_top/AESL_inst_matrixmul/a_1_Rst_A
...
add wave -group $testbenchgroup -group $tbcinoutgroup -group $tb_a_group -radix hex /apatb_matrixmul_top/a_1_ADDR_A
add wave -group $testbenchgroup -group $tbcinoutgroup -group $tb_a_group -color #ffff00 -radix hex /apatb_matrixmul_top/a_1_EN_A
add wave -group $testbenchgroup -group $tbcinoutgroup -group $tb_a_group -color #ffff00 -radix hex /apatb_matrixmul_top/a_1_WEN_A
add wave -group $testbenchgroup -group $tbcinoutgroup -group $tb_a_group -radix hex /apatb_matrixmul_top/a_1_DIN_A
add wave -group $testbenchgroup -group $tbcinoutgroup -group $tb_a_group -radix hex /apatb_matrixmul_top/a_1_DOUT_A
add wave -group $testbenchgroup -group $tbcinoutgroup -group $tb_a_group -radix hex /apatb_matrixmul_top/a_1_CLK_A
add wave -group $testbenchgroup -group $tbcinoutgroup -group $tb_a_group -radix hex /apatb_matrixmul_top/a_1_RST_A
