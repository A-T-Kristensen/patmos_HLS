...
#ifndef __matmul_mac_muladddEe__HH__
#define __matmul_mac_muladddEe__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(matmul_mac_muladddEe) {
    ...
    SC_CTOR(matmul_mac_muladddEe):  simcore_mac_0_U ("simcore_mac_0_U") {
