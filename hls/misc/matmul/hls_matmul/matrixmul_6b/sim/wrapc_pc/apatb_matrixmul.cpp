...
#define AUTOTB_TVOUT_a_4  "../tv/cdatafile/c.matrixmul.autotvout_a_4.dat"
#define AUTOTB_TVIN_a_4  "../tv/cdatafile/c.matrixmul.autotvin_a_4.dat"
// wrapc file define: "a_5"
#define AUTOTB_TVOUT_a_5  "../tv/cdatafile/c.matrixmul.autotvout_a_5.dat"
#define AUTOTB_TVIN_a_5  "../tv/cdatafile/c.matrixmul.autotvin_a_5.dat"

#define INTER_TCL  "../tv/cdatafile/ref.tcl"

// tvout file define: "a_4"
#define AUTOTB_TVOUT_PC_a_4  "../tv/rtldatafile/rtl.matrixmul.autotvout_a_4.dat"
// tvout file define: "a_5"
#define AUTOTB_TVOUT_PC_a_5  "../tv/rtldatafile/rtl.matrixmul.autotvout_a_5.dat"
...
int a[12][4])
{
	...
	if (wrapc_switch_file_token.good())
	{
		...
		// output port post check: "a_4"
		aesl_fh.read(AUTOTB_TVOUT_PC_a_4, AESL_token); // [[transaction]]
		if (AESL_token != "[[transaction]]")
		{
			exit(1);
		}
		aesl_fh.read(AUTOTB_TVOUT_PC_a_4, AESL_num); // transaction number

		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			aesl_fh.read(AUTOTB_TVOUT_PC_a_4, AESL_token); // data

			sc_bv<32> *a_4_pc_buffer = new sc_bv<32>[8];
			int i = 0;
			...
			while (AESL_token != "[[/transaction]]")
			{
				...
				while (!no_x)
				{
					...
					if (x_found != string::npos)
					{
						if (!err)
						{
							cerr << "WARNING: [SIM 212-201] RTL produces unknown value 'X' on port 'a_4', possible cause: There are uninitialized variables in the C design." << endl;
							err = true;
						}
				...
				aesl_fh.read(AUTOTB_TVOUT_PC_a_4, AESL_token); // data or [[/transaction]]

				if (AESL_token == "[[[/runtime]]]" || aesl_fh.eof(AUTOTB_TVOUT_PC_a_4))
				{
					exit(1);
				}
			}
			...
			if (i > 0)
			{
				// RTL Name: a_4
				{
					...
					// {
						// celement: a(31, 0)
						// {
							sc_lv<32>* a_lv0_8_9_1_lv1_0_3_1 = new sc_lv<32>[8];
						// }
					// }
						...
						// celement: a(31, 0)
						{
							...
							for (int i_0 = 8; i_0 <= 9; i_0 += 1)
							{
								...
								for (int i_1 = 0; i_1 <= 3; i_1 += 1)
								{
									...
									{
										a_lv0_8_9_1_lv1_0_3_1[hls_map_index++].range(31, 0) = sc_bv<32>(a_4_pc_buffer[hls_map_index].range(31, 0));
									}
								}
							}
						}
			...
			delete [] a_4_pc_buffer;
		}

		// output port post check: "a_5"
		aesl_fh.read(AUTOTB_TVOUT_PC_a_5, AESL_token); // [[transaction]]
		if (AESL_token != "[[transaction]]")
		{
			exit(1);
		}
		aesl_fh.read(AUTOTB_TVOUT_PC_a_5, AESL_num); // transaction number

		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			aesl_fh.read(AUTOTB_TVOUT_PC_a_5, AESL_token); // data

			sc_bv<32> *a_5_pc_buffer = new sc_bv<32>[8];
			int i = 0;
			...
			while (AESL_token != "[[/transaction]]")
			{
				...
				while (!no_x)
				{
					...
					if (x_found != string::npos)
					{
						if (!err)
						{
							cerr << "WARNING: [SIM 212-201] RTL produces unknown value 'X' on port 'a_5', possible cause: There are uninitialized variables in the C design." << endl;
							err = true;
						}
						AESL_token.replace(x_found, 1, "0");
					}
				...
				aesl_fh.read(AUTOTB_TVOUT_PC_a_5, AESL_token); // data or [[/transaction]]

				if (AESL_token == "[[[/runtime]]]" || aesl_fh.eof(AUTOTB_TVOUT_PC_a_5))
				{
					exit(1);
				}
			}
			...
			if (i > 0)
			{
				// RTL Name: a_5
				{
					...
					// {
						// celement: a(31, 0)
						// {
							sc_lv<32>* a_lv0_10_11_1_lv1_0_3_1 = new sc_lv<32>[8];
						// }
					// }
						...
						// celement: a(31, 0)
						{
							...
							for (int i_0 = 10; i_0 <= 11; i_0 += 1)
							{
								...
								for (int i_1 = 0; i_1 <= 3; i_1 += 1)
								{
									if (&(a[0][0]) != NULL) // check the null address if the c port is array or others
									{
										a_lv0_10_11_1_lv1_0_3_1[hls_map_index++].range(31, 0) = sc_bv<32>(a_5_pc_buffer[hls_map_index].range(31, 0));
									}
								}
							}
						}
	...
	else
	{
		...
		sc_bv<32>* a_2_tvin_wrapc_buffer = new sc_bv<32>[8];
		...
		sc_bv<32>* a_3_tvin_wrapc_buffer = new sc_bv<32>[8];
		...
		sc_bv<32>* a_4_tvin_wrapc_buffer = new sc_bv<32>[8];
		...
		sc_bv<32>* a_5_tvin_wrapc_buffer = new sc_bv<32>[8];
...
// [call_c_dut] ---------->
		...
		// [[transaction]]
		sprintf(tvout_a_4, "[[transaction]] %d\n", AESL_transaction);
		aesl_fh.write(AUTOTB_TVOUT_a_4, tvout_a_4);

		sc_bv<32>* a_4_tvout_wrapc_buffer = new sc_bv<32>[8];
		...
		for (int i = 0; i < 8; i++)
		{
			sprintf(tvout_a_4, "%s\n", (a_4_tvout_wrapc_buffer[i]).to_string(SC_HEX).c_str());
			aesl_fh.write(AUTOTB_TVOUT_a_4, tvout_a_4);
		}

		tcl_file.set_num(8, &tcl_file.a_4_depth);
		sprintf(tvout_a_4, "[[/transaction]] \n");
		aesl_fh.write(AUTOTB_TVOUT_a_4, tvout_a_4);

		// release memory allocation
		delete [] a_4_tvout_wrapc_buffer;

		// [[transaction]]
		sprintf(tvout_a_5, "[[transaction]] %d\n", AESL_transaction);
		aesl_fh.write(AUTOTB_TVOUT_a_5, tvout_a_5);

		sc_bv<32>* a_5_tvout_wrapc_buffer = new sc_bv<32>[8];
		...
		for (int i = 0; i < 8; i++)
		{
			sprintf(tvout_a_5, "%s\n", (a_5_tvout_wrapc_buffer[i]).to_string(SC_HEX).c_str());
			aesl_fh.write(AUTOTB_TVOUT_a_5, tvout_a_5);
		}

		tcl_file.set_num(8, &tcl_file.a_5_depth);
		sprintf(tvout_a_5, "[[/transaction]] \n");
		aesl_fh.write(AUTOTB_TVOUT_a_5, tvout_a_5);

		// release memory allocation
		delete [] a_5_tvout_wrapc_buffer;
