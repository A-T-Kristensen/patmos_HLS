; ModuleID = '/home/andreas/github/bachelor_project_HLS/hls/misc/matmul/hls_matmul/matrixmul_3b/.autopilot/db/a.g.bc'
...
define void @_Z9matrixmulPA4_i([4 x i32]* %a) nounwind uwtable {
  ...
  call void (...)* @_ssdm_SpecArrayPartition([4 x i32]* %3, i32 1, i8* getelementptr inbounds ([6 x i8]* @.str, i32 0, i32 0), i32 3, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !32 ; [debug line = 50:1]
