; ModuleID = '/home/andreas/github/bachelor_project_HLS/hls/misc/matmul/hls_matmul/matrixmul_5b/.autopilot/db/a.o.bc'
...
define void @_Z9matrixmulPA4_i([4 x i32]* %a) nounwind uwtable {
  ...
  call void (...)* @_ssdm_SpecArrayPartition([4 x i32]* %3, i32 1, i8* getelementptr inbounds ([6 x i8]* @.str, i32 0, i32 0), i32 5, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !32 ; [debug line = 50:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 0, i8* getelementptr inbounds ([11 x i8]* @.str2, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !32 ; [debug line = 50:1]
  %4 = load [4 x i32]** %1, align 8, !dbg !33     ; [#uses=1 type=[4 x i32]*] [debug line = 54:1]
  call void (...)* @_ssdm_op_SpecInterface([4 x i32]* %4, i8* getelementptr inbounds ([5 x i8]* @.str3, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !33 ; [debug line = 54:1]
  %5 = load [4 x i32]** %1, align 8, !dbg !34     ; [#uses=1 type=[4 x i32]*] [debug line = 55:1]
  call void (...)* @_ssdm_op_SpecResource([4 x i32]* %5, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([12 x i8]* @.str4, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 -1, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !34 ; [debug line = 55:1]
  ...
  call void @llvm.dbg.declare(metadata !{i32* %tmp}, metadata !41), !dbg !42 ; [debug line = 59:11] [debug variable = tmp]
  store i32 0, i32* %tmp, align 4, !dbg !43       ; [debug line = 59:18]
  call void @llvm.dbg.declare(metadata !{i32* %i}, metadata !44), !dbg !46 ; [debug line = 63:10] [debug variable = i]
  store i32 0, i32* %i, align 4, !dbg !47         ; [debug line = 63:15]
  br label %6, !dbg !47                           ; [debug line = 63:15]

; <label>:6                                       ; preds = %103, %0
  %7 = load i32* %i, align 4, !dbg !47            ; [#uses=1 type=i32] [debug line = 63:15]
  %8 = icmp slt i32 %7, 4, !dbg !47               ; [#uses=1 type=i1] [debug line = 63:15]
  br i1 %8, label %9, label %106, !dbg !47        ; [debug line = 63:15]

; <label>:9                                       ; preds = %6
  br label %10, !dbg !48                          ; [debug line = 63:29]

; <label>:10                                      ; preds = %9
  call void @llvm.dbg.declare(metadata !{i32* %j}, metadata !50), !dbg !52 ; [debug line = 64:15] [debug variable = j]
  store i32 0, i32* %j, align 4, !dbg !53         ; [debug line = 64:20]
  br label %11, !dbg !53                          ; [debug line = 64:20]

; <label>:11                                      ; preds = %99, %10
  %12 = load i32* %j, align 4, !dbg !53           ; [#uses=1 type=i32] [debug line = 64:20]
  %13 = icmp slt i32 %12, 4, !dbg !53             ; [#uses=1 type=i1] [debug line = 64:20]
  br i1 %13, label %14, label %102, !dbg !53      ; [debug line = 64:20]

; <label>:14                                      ; preds = %11
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([4 x i8]* @.str5, i32 0, i32 0)) nounwind, !dbg !54 ; [debug line = 64:35]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([4 x i8]* @.str5, i32 0, i32 0)) nounwind, !dbg !54 ; [debug line = 64:35]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !56 ; [debug line = 65:1]
  store i32 0, i32* %tmp, align 4, !dbg !57       ; [debug line = 66:2]
...
; <label>:22                                      ; preds = %19
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([10 x i8]* @.str6, i32 0, i32 0)) nounwind, !dbg !65 ; [debug line = 71:6]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([10 x i8]* @.str6, i32 0, i32 0)) nounwind, !dbg !65 ; [debug line = 71:6]
  ...
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([10 x i8]* @.str6, i32 0, i32 0)) nounwind, !dbg !67 ; [debug line = 71:23]
...
; <label>:46                                      ; preds = %43
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([10 x i8]* @.str7, i32 0, i32 0)) nounwind, !dbg !77 ; [debug line = 76:44]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([10 x i8]* @.str7, i32 0, i32 0)) nounwind, !dbg !77 ; [debug line = 76:44]
  ...
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([10 x i8]* @.str7, i32 0, i32 0)) nounwind, !dbg !80 ; [debug line = 78:5]
...
; <label>:71                                      ; preds = %68
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([8 x i8]* @.str8, i32 0, i32 0)) nounwind, !dbg !87 ; [debug line = 81:42]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([8 x i8]* @.str8, i32 0, i32 0)) nounwind, !dbg !87 ; [debug line = 81:42]
  ...
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([8 x i8]* @.str8, i32 0, i32 0)) nounwind, !dbg !90 ; [debug line = 83:5]
...
; <label>:89                                      ; preds = %68
  ...
  call void (...)* @_ssdm_RegionEnd(i8* getelementptr inbounds ([4 x i8]* @.str5, i32 0, i32 0)) nounwind, !dbg !93 ; [debug line = 86:3]
  br label %99, !dbg !93                          ; [debug line = 86:3]

; <label>:99                                      ; preds = %89
  %100 = load i32* %j, align 4, !dbg !94          ; [#uses=1 type=i32] [debug line = 64:29]
  %101 = add nsw i32 %100, 1, !dbg !94            ; [#uses=1 type=i32] [debug line = 64:29]
  store i32 %101, i32* %j, align 4, !dbg !94      ; [debug line = 64:29]
  br label %11, !dbg !94                          ; [debug line = 64:29]

; <label>:102                                     ; preds = %11
  br label %103, !dbg !95                         ; [debug line = 87:2]

; <label>:103                                     ; preds = %102
  %104 = load i32* %i, align 4, !dbg !96          ; [#uses=1 type=i32] [debug line = 63:24]
  %105 = add nsw i32 %104, 1, !dbg !96            ; [#uses=1 type=i32] [debug line = 63:24]
  store i32 %105, i32* %i, align 4, !dbg !96      ; [debug line = 63:24]
  br label %6, !dbg !96                           ; [debug line = 63:24]
...
!41 = metadata !{i32 786688, metadata !31, metadata !"tmp", metadata !6, i32 59, metadata !11, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!42 = metadata !{i32 59, i32 11, metadata !31, null}
!43 = metadata !{i32 59, i32 18, metadata !31, null}
!44 = metadata !{i32 786688, metadata !45, metadata !"i", metadata !6, i32 63, metadata !12, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!45 = metadata !{i32 786443, metadata !31, i32 63, i32 2, metadata !6, i32 1} ; [ DW_TAG_lexical_block ]
!46 = metadata !{i32 63, i32 10, metadata !45, null}
!47 = metadata !{i32 63, i32 15, metadata !45, null}
!48 = metadata !{i32 63, i32 29, metadata !49, null}
!49 = metadata !{i32 786443, metadata !45, i32 63, i32 29, metadata !6, i32 2} ; [ DW_TAG_lexical_block ]
!50 = metadata !{i32 786688, metadata !51, metadata !"j", metadata !6, i32 64, metadata !12, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!51 = metadata !{i32 786443, metadata !49, i32 64, i32 7, metadata !6, i32 3} ; [ DW_TAG_lexical_block ]
!52 = metadata !{i32 64, i32 15, metadata !51, null}
!53 = metadata !{i32 64, i32 20, metadata !51, null}
!54 = metadata !{i32 64, i32 35, metadata !55, null}
!55 = metadata !{i32 786443, metadata !51, i32 64, i32 34, metadata !6, i32 4} ; [ DW_TAG_lexical_block ]
!56 = metadata !{i32 65, i32 1, metadata !55, null}
!57 = metadata !{i32 66, i32 2, metadata !55, null}
...
!94 = metadata !{i32 64, i32 29, metadata !51, null}
