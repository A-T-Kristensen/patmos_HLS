...
define void @matrixmul([12 x i32]* %a_0, [12 x i32]* %a_1, [12 x i32]* %a_2, [12 x i32]* %a_3, [4 x i32]* %a_4) {
  ...
  call void (...)* @_ssdm_op_SpecBitsMap([4 x i32]* %a_4), !map !7
  call void (...)* @_ssdm_op_SpecBitsMap([12 x i32]* %a_3), !map !14
  call void (...)* @_ssdm_op_SpecBitsMap([12 x i32]* %a_2), !map !20
  call void (...)* @_ssdm_op_SpecBitsMap([12 x i32]* %a_1), !map !26
  call void (...)* @_ssdm_op_SpecBitsMap([12 x i32]* %a_0), !map !32
...
.preheader7:                                      ; preds = %.loopexit89, %0
  %indvar_flatten = phi i5 [ 0, %0 ], [ %indvar_flatten_next, %.loopexit89 ]
  %i = phi i3 [ 0, %0 ], [ %newIndex1_mid2_v_v, %.loopexit89 ]
  %j = phi i3 [ 0, %0 ], [ %j_1, %.loopexit89 ]
  %tmp = icmp eq i3 %i, 0
...
.preheader7.preheader:                            ; preds = %.preheader7
  ...
  br i1 %tmp_mid2_5, label %branch22, label %branch23
...
!12 = metadata !{i32 12, i32 11, i32 1}
