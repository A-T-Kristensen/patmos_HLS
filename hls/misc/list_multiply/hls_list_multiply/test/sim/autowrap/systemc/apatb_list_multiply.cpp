...
// tvout file define: "a"
#define AUTOTB_TVOUT_PC_a  "../tv/rtldatafile/rtl.list_multiply.autotvout_a.dat"
...
extern "C" void list_multiply (
int a[3]);

extern "C" void AESL_WRAP_list_multiply (
int a[3])
{
	...
	if (wrapc_switch_file_token.good())
	{
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			sc_bv<32> *a_pc_buffer = new sc_bv<32>[3];
			int i = 0;
			...
			if (i > 0)
			{
				// RTL Name: a
				{
					...
					// {
						// celement: a(31, 0)
						// {
							sc_lv<32>* a_lv0_0_2_1 = new sc_lv<32>[3];
						// }
					// }
					...
					// bitslice(31, 0)
					{
						...
						// celement: a(31, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 2; i_0 += 1)
							{
								...
								{
									a_lv0_0_2_1[hls_map_index++].range(31, 0) = sc_bv<32>(a_pc_buffer[hls_map_index].range(31, 0));
								}
							}
						}
					}
					...
					// bitslice(31, 0)
					{
						...
						// celement: a(31, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 2; i_0 += 1)
							{
								...
								// output_type_conversion : (a_lv0_0_2_1[hls_map_index++]).to_uint64()
								if (&(a[0]) != NULL) // check the null address if the c port is array or others
								{
									a[i_0] = (a_lv0_0_2_1[hls_map_index++]).to_uint64();
								}
							}
						}
					}
...
// [call_c_dut] ---------->
		...
		sc_bv<32>* a_tvout_wrapc_buffer = new sc_bv<32>[3];
