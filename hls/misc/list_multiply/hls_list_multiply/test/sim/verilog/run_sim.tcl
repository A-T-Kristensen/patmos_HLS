...
if {[file isfile list_multiply.autotvin.dat]} {
	file delete -force list_multiply.autotvin.dat
}

if {[file isfile list_multiply.autotvout.dat]} {
	file delete -force list_multiply.autotvout.dat
}
