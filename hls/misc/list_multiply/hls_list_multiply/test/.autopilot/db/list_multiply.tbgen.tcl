set C_TypeInfoList {{ 
"list_multiply" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"a": [[], {"array": [ {"scalar": "int"}, [3]]}] }],[],""]
}}
set moduleName list_multiply
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.list_multiply_muxbkb_U1", "Parent" : "0"}]}
