...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "list_multiply.autotvin.dat"
	set constFileTvOut       "list_multiply.autotvout.dat"
	set constFileHdlTvIn     "list_multiply.autohdltvin.dat"
	set constFileHdlTvOut    "list_multiply.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
