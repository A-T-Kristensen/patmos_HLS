...
$(ObjDir)/list_multiply_test.c_pre.c.tb.o : list_multiply_test.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) list_multiply_test.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/list_multiply.c_pre.c.tb.o : list_multiply.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) list_multiply.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
