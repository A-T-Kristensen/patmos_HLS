...
set C_modelArgList {
	{ a int 32 regular {bram 768 { 2 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "a", "interface" : "bram", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "a","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 47,"step" : 1},{"low" : 0,"up" : 15,"step" : 1}]}]}]} ]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "10498", "Max" : "10498"}
	, {"Name" : "Interval", "Min" : "10499", "Max" : "10499"}
]}
