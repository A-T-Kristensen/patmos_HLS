; ModuleID = '/home/patmos/github/bachelor_project_HLS/hls/misc/matmul_int/hls_matmul_int/matmul_2b/.autopilot/db/a.o.2.bc'
...
.preheader7.preheader:                            ; preds = %.preheader7
  ...
  %a_0_addr_4 = getelementptr [24 x i32]* %a_0, i64 0, i64 %tmp_17
  %tmp_18 = add i5 -12, %tmp_8_cast
  %tmp_19_cast = zext i5 %tmp_18 to i64
  %a_0_addr_5 = getelementptr [24 x i32]* %a_0, i64 0, i64 %tmp_19_cast
  %a_1_addr = getelementptr [24 x i32]* %a_1, i64 0, i64 %tmp_8
  %tmp_19 = add i4 4, %tmp_8_cast5
  %tmp_20_cast = zext i4 %tmp_19 to i64
  %a_1_addr_1 = getelementptr [24 x i32]* %a_1, i64 0, i64 %tmp_20_cast
  %tmp_20 = add i6 %tmp_16, %tmp_8_cast6
  %tmp_21_cast = zext i6 %tmp_20 to i64
  %a_1_addr_2 = getelementptr [24 x i32]* %a_1, i64 0, i64 %tmp_21_cast
  ...
  %tmp_3 = call i32 @_ssdm_op_Mux.ap_auto.4i32.i2(i32 %b_copy_0_3_18, i32 %b_copy_0_3_17, i32 %b_copy_0_3_16, i32 %b_copy_0_3_3, i2 %tmp)
  %tmp_s = mul nsw i32 %tmp_3, %a_row_0_1
  ...
  %tmp_11_1 = mul nsw i32 %tmp_4, %a_row_1_1
  %tmp_6 = call i32 @_ssdm_op_Mux.ap_auto.4i32.i2(i32 %b_copy_2_3_18, i32 %b_copy_2_3_17, i32 %b_copy_2_3_16, i32 %b_copy_2_3_3, i2 %tmp)
  %tmp_11_2 = mul nsw i32 %tmp_6, %a_row_2_1
  %tmp_7 = call i32 @_ssdm_op_Mux.ap_auto.4i32.i2(i32 %b_copy_3_3_18, i32 %b_copy_3_3_17, i32 %b_copy_3_3_16, i32 %b_copy_3_3_3, i2 %tmp)
  %tmp_11_3 = mul nsw i32 %tmp_7, %a_row_3_1
  %tmp8 = add i32 %tmp_11_1, %tmp_s
