; ModuleID = '/home/patmos/github/bachelor_project_HLS/hls/misc/matmul_int/hls_matmul_int/matmul_1b_4x4/.autopilot/db/a.o.3.bc'
...
.preheader7.preheader:                            ; preds = %.preheader7
  ...
  call void (...)* @_ssdm_op_SpecLoopName([4 x i8]* @p_str4) nounwind, !dbg !63 ; [debug line = 20:35]
  %tmp_4 = call i32 (...)* @_ssdm_op_SpecRegionBegin([4 x i8]* @p_str4) nounwind, !dbg !63 ; [#uses=1 type=i32] [debug line = 20:35]
  ...
  %empty_3 = call i32 (...)* @_ssdm_op_SpecRegionEnd([4 x i8]* @p_str4, i32 %tmp_4) nounwind, !dbg !85 ; [#uses=0 type=i32] [debug line = 42:3]
