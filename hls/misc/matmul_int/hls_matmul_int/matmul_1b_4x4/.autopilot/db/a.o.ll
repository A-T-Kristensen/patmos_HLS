; ModuleID = '/home/patmos/github/bachelor_project_HLS/hls/misc/matmul_int/hls_matmul_int/matmul_1b_4x4/.autopilot/db/a.o.bc'
...
define void @_Z9matmul_hwPA4_i([4 x i32]* %a) nounwind uwtable {
  %1 = alloca [4 x i32]*, align 8                 ; [#uses=7 type=[4 x i32]**]
  ...
  %3 = load [4 x i32]** %1, align 8, !dbg !33     ; [#uses=1 type=[4 x i32]*] [debug line = 10:1]
  call void (...)* @_ssdm_op_SpecInterface([4 x i32]* %3, i8* getelementptr inbounds ([5 x i8]* @.str2, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !33 ; [debug line = 10:1]
  %4 = load [4 x i32]** %1, align 8, !dbg !34     ; [#uses=1 type=[4 x i32]*] [debug line = 11:1]
  call void (...)* @_ssdm_op_SpecResource([4 x i32]* %4, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([12 x i8]* @.str3, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 -1, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !34 ; [debug line = 11:1]
...
; <label>:5                                       ; preds = %102, %0
  ...
  %7 = icmp slt i32 %6, 4, !dbg !47               ; [#uses=1 type=i1] [debug line = 19:15]
  br i1 %7, label %8, label %105, !dbg !47        ; [debug line = 19:15]

; <label>:8                                       ; preds = %5
  br label %9, !dbg !48                           ; [debug line = 19:29]
...
; <label>:10                                      ; preds = %98, %9
  ...
  %12 = icmp slt i32 %11, 4, !dbg !53             ; [#uses=1 type=i1] [debug line = 20:20]
  br i1 %12, label %13, label %101, !dbg !53      ; [debug line = 20:20]

; <label>:13                                      ; preds = %10
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([4 x i8]* @.str4, i32 0, i32 0)) nounwind, !dbg !54 ; [debug line = 20:35]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([4 x i8]* @.str4, i32 0, i32 0)) nounwind, !dbg !54 ; [debug line = 20:35]
...
; <label>:18                                      ; preds = %33, %17
  ...
  %20 = icmp slt i32 %19, 4, !dbg !64             ; [#uses=1 type=i1] [debug line = 26:28]
...
; <label>:21                                      ; preds = %18
  ...
  %26 = load [4 x i32]** %1, align 8, !dbg !65    ; [#uses=1 type=[4 x i32]*] [debug line = 27:6]
  %27 = getelementptr inbounds [4 x i32]* %26, i64 %25, !dbg !65 ; [#uses=1 type=[4 x i32]*] [debug line = 27:6]
  %28 = getelementptr inbounds [4 x i32]* %27, i32 0, i64 %23, !dbg !65 ; [#uses=1 type=i32*] [debug line = 27:6]
  ...
  %32 = getelementptr inbounds [4 x i32]* %a_row, i32 0, i64 %31, !dbg !65 ; [#uses=1 type=i32*] [debug line = 27:6]
...
; <label>:33                                      ; preds = %21
  %34 = load i32* %k, align 4, !dbg !68           ; [#uses=1 type=i32] [debug line = 26:37]
  %35 = add nsw i32 %34, 1, !dbg !68              ; [#uses=1 type=i32] [debug line = 26:37]
  store i32 %35, i32* %k, align 4, !dbg !68       ; [debug line = 26:37]
  br label %18, !dbg !68                          ; [debug line = 26:37]
...
; <label>:42                                      ; preds = %61, %41
  ...
  %44 = icmp slt i32 %43, 4, !dbg !76             ; [#uses=1 type=i1] [debug line = 32:29]
  br i1 %44, label %45, label %64, !dbg !76       ; [debug line = 32:29]

; <label>:45                                      ; preds = %42
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([10 x i8]* @.str6, i32 0, i32 0)) nounwind, !dbg !77 ; [debug line = 32:44]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([10 x i8]* @.str6, i32 0, i32 0)) nounwind, !dbg !77 ; [debug line = 32:44]
  ...
  %49 = add nsw i32 %48, 4, !dbg !79              ; [#uses=1 type=i32] [debug line = 33:7]
  %50 = sext i32 %49 to i64, !dbg !79             ; [#uses=1 type=i64] [debug line = 33:7]
  %51 = load [4 x i32]** %1, align 8, !dbg !79    ; [#uses=1 type=[4 x i32]*] [debug line = 33:7]
  %52 = getelementptr inbounds [4 x i32]* %51, i64 %50, !dbg !79 ; [#uses=1 type=[4 x i32]*] [debug line = 33:7]
  %53 = getelementptr inbounds [4 x i32]* %52, i32 0, i64 %47, !dbg !79 ; [#uses=1 type=i32*] [debug line = 33:7]
  ...
  %59 = getelementptr inbounds [4 x [4 x i32]]* %b_copy, i32 0, i64 %58, !dbg !79 ; [#uses=1 type=[4 x i32]*] [debug line = 33:7]
  %60 = getelementptr inbounds [4 x i32]* %59, i32 0, i64 %56, !dbg !79 ; [#uses=1 type=i32*] [debug line = 33:7]
...
; <label>:61                                      ; preds = %45
  %62 = load i32* %k1, align 4, !dbg !81          ; [#uses=1 type=i32] [debug line = 32:38]
  %63 = add nsw i32 %62, 1, !dbg !81              ; [#uses=1 type=i32] [debug line = 32:38]
  store i32 %63, i32* %k1, align 4, !dbg !81      ; [debug line = 32:38]
  br label %42, !dbg !81                          ; [debug line = 32:38]
...
; <label>:67                                      ; preds = %85, %66
  ...
  %69 = icmp slt i32 %68, 4, !dbg !86             ; [#uses=1 type=i1] [debug line = 37:27]
  br i1 %69, label %70, label %88, !dbg !86       ; [debug line = 37:27]

; <label>:70                                      ; preds = %67
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([8 x i8]* @.str7, i32 0, i32 0)) nounwind, !dbg !87 ; [debug line = 37:42]
  call void (...)* @_ssdm_RegionBegin(i8* getelementptr inbounds ([8 x i8]* @.str7, i32 0, i32 0)) nounwind, !dbg !87 ; [debug line = 37:42]
  ...
  %73 = getelementptr inbounds [4 x i32]* %a_row, i32 0, i64 %72, !dbg !89 ; [#uses=1 type=i32*] [debug line = 38:4]
  ...
  %79 = getelementptr inbounds [4 x [4 x i32]]* %b_copy, i32 0, i64 %78, !dbg !89 ; [#uses=1 type=[4 x i32]*] [debug line = 38:4]
  %80 = getelementptr inbounds [4 x i32]* %79, i32 0, i64 %76, !dbg !89 ; [#uses=1 type=i32*] [debug line = 38:4]
...
; <label>:85                                      ; preds = %70
  %86 = load i32* %k2, align 4, !dbg !91          ; [#uses=1 type=i32] [debug line = 37:36]
  %87 = add nsw i32 %86, 1, !dbg !91              ; [#uses=1 type=i32] [debug line = 37:36]
  store i32 %87, i32* %k2, align 4, !dbg !91      ; [debug line = 37:36]
  br label %67, !dbg !91                          ; [debug line = 37:36]
...
; <label>:88                                      ; preds = %67
  ...
  %93 = add nsw i32 %92, 8, !dbg !92              ; [#uses=1 type=i32] [debug line = 41:5]
  %94 = sext i32 %93 to i64, !dbg !92             ; [#uses=1 type=i64] [debug line = 41:5]
  %95 = load [4 x i32]** %1, align 8, !dbg !92    ; [#uses=1 type=[4 x i32]*] [debug line = 41:5]
  %96 = getelementptr inbounds [4 x i32]* %95, i64 %94, !dbg !92 ; [#uses=1 type=[4 x i32]*] [debug line = 41:5]
  %97 = getelementptr inbounds [4 x i32]* %96, i32 0, i64 %91, !dbg !92 ; [#uses=1 type=i32*] [debug line = 41:5]
...
; <label>:98                                      ; preds = %88
  %99 = load i32* %j, align 4, !dbg !94           ; [#uses=1 type=i32] [debug line = 20:29]
  %100 = add nsw i32 %99, 1, !dbg !94             ; [#uses=1 type=i32] [debug line = 20:29]
  store i32 %100, i32* %j, align 4, !dbg !94      ; [debug line = 20:29]
  br label %10, !dbg !94                          ; [debug line = 20:29]

; <label>:101                                     ; preds = %10
  br label %102, !dbg !95                         ; [debug line = 43:2]

; <label>:102                                     ; preds = %101
  %103 = load i32* %i, align 4, !dbg !96          ; [#uses=1 type=i32] [debug line = 19:24]
  %104 = add nsw i32 %103, 1, !dbg !96            ; [#uses=1 type=i32] [debug line = 19:24]
  store i32 %104, i32* %i, align 4, !dbg !96      ; [debug line = 19:24]
  br label %5, !dbg !96                           ; [debug line = 19:24]
