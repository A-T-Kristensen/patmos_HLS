; ModuleID = '/home/patmos/github/bachelor_project_HLS/hls/misc/matmul_int/hls_matmul_int/matmul_3b_16x16/.autopilot/db/a.g.1.bc'
...
; [#uses=0]
define void @matmul_hw([16 x i32]* %a) nounwind uwtable {
  ...
  call void @llvm.dbg.value(metadata !{[16 x i32]* %a}, i64 0, metadata !28), !dbg !29 ; [debug line = 4:25] [debug variable = a]
  call void (...)* @_ssdm_SpecArrayDimSize([16 x i32]* %a, i32 48) nounwind, !dbg !30 ; [debug line = 5:2]
  call void (...)* @_ssdm_SpecArrayPartition([16 x i32]* %a, i32 1, i8* getelementptr inbounds ([6 x i8]* @.str, i64 0, i64 0), i32 3, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !32 ; [debug line = 6:1]
  ...
  call void (...)* @_ssdm_op_SpecResource([16 x i32]* %a, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([12 x i8]* @.str4, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 -1, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !34 ; [debug line = 11:1]
...
; <label>:1                                       ; preds = %8, %0
  ...
  %exitcond4 = icmp eq i32 %i, 16, !dbg !41       ; [#uses=1 type=i1] [debug line = 19:15]
...
.preheader7.preheader:                            ; preds = %1
  ...
  %tmp.1 = add nsw i32 %i, 32, !dbg !47           ; [#uses=1 type=i32] [debug line = 41:5]
...
.preheader7:                                      ; preds = %7, %.preheader7.preheader
  ...
  %exitcond3 = icmp eq i32 %j, 16, !dbg !52       ; [#uses=1 type=i1] [debug line = 20:20]
...
.preheader5:                                      ; preds = %3, %.preheader5.preheader
  ...
  %exitcond2 = icmp eq i32 %k, 16, !dbg !56       ; [#uses=1 type=i1] [debug line = 26:28]
...
; <label>:3                                       ; preds = %.preheader5
  ...
  %a.addr = getelementptr inbounds [16 x i32]* %a, i64 %tmp.3, i64 %tmp.6, !dbg !48 ; [#uses=1 type=i32*] [debug line = 27:6]
  ...
  %a_row.addr = getelementptr inbounds [16 x i32]* %a_row, i64 0, i64 %tmp.6, !dbg !48 ; [#uses=1 type=i32*] [debug line = 27:6]
...
.preheader:                                       ; preds = %4, %.preheader.preheader
  ...
  %exitcond1 = icmp eq i32 %k1, 16, !dbg !64      ; [#uses=1 type=i1] [debug line = 32:29]
...
; <label>:4                                       ; preds = %.preheader
  ...
  %tmp.9 = add nsw i32 %k1, 16, !dbg !60          ; [#uses=1 type=i32] [debug line = 33:7]
  %tmp.10 = sext i32 %tmp.9 to i64, !dbg !60      ; [#uses=1 type=i64] [debug line = 33:7]
  %a.addr.1 = getelementptr inbounds [16 x i32]* %a, i64 %tmp.10, i64 %tmp.8, !dbg !60 ; [#uses=1 type=i32*] [debug line = 33:7]
  ...
  %b_copy.addr = getelementptr inbounds [16 x [16 x i32]]* %b_copy, i64 0, i64 %tmp.11, i64 %tmp.8, !dbg !60 ; [#uses=1 type=i32*] [debug line = 33:7]
...
; <label>:5                                       ; preds = %6, %.loopexit
  ...
  %exitcond = icmp eq i32 %k2, 16, !dbg !72       ; [#uses=1 type=i1] [debug line = 37:27]
...
; <label>:6                                       ; preds = %5
  ...
  %a_row.addr.1 = getelementptr inbounds [16 x i32]* %a_row, i64 0, i64 %tmp.16, !dbg !69 ; [#uses=1 type=i32*] [debug line = 38:4]
  ...
  %b_copy.addr.1 = getelementptr inbounds [16 x [16 x i32]]* %b_copy, i64 0, i64 %tmp.16, i64 %tmp.13, !dbg !69 ; [#uses=1 type=i32*] [debug line = 38:4]
...
; <label>:7                                       ; preds = %5
  ...
  %a.addr.2 = getelementptr inbounds [16 x i32]* %a, i64 %tmp.2, i64 %tmp.13, !dbg !47 ; [#uses=1 type=i32*] [debug line = 41:5]
...
!5 = metadata !{i32 786478, i32 0, metadata !6, metadata !"matmul_hw", metadata !"matmul_hw", metadata !"_Z9matmul_hwPA16_i", metadata !6, i32 4, metadata !7, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void ([16 x i32]*)* @matmul_hw, null, null, metadata !15, i32 5} ; [ DW_TAG_subprogram ]
...
!21 = metadata !{void ([16 x i32]*)* @matmul_hw, metadata !22, metadata !23, metadata !24, metadata !25, metadata !26, metadata !27}
