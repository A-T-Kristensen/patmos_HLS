; ModuleID = '/home/patmos/github/bachelor_project_HLS/hls/misc/matmul_int/hls_matmul_int/matmul_1b_32x32/.autopilot/db/a.o.bc'
...
define void @_Z9matmul_hwPA32_i([32 x i32]* %a) nounwind uwtable {
  %1 = alloca [32 x i32]*, align 8                ; [#uses=7 type=[32 x i32]**]
  ...
  %3 = load [32 x i32]** %1, align 8, !dbg !33    ; [#uses=1 type=[32 x i32]*] [debug line = 10:1]
  call void (...)* @_ssdm_op_SpecInterface([32 x i32]* %3, i8* getelementptr inbounds ([5 x i8]* @.str2, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !33 ; [debug line = 10:1]
  %4 = load [32 x i32]** %1, align 8, !dbg !34    ; [#uses=1 type=[32 x i32]*] [debug line = 11:1]
  call void (...)* @_ssdm_op_SpecResource([32 x i32]* %4, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([12 x i8]* @.str3, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 -1, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !34 ; [debug line = 11:1]
...
; <label>:5                                       ; preds = %102, %0
  ...
  %7 = icmp slt i32 %6, 32, !dbg !47              ; [#uses=1 type=i1] [debug line = 19:15]
...
; <label>:10                                      ; preds = %98, %9
  ...
  %12 = icmp slt i32 %11, 32, !dbg !53            ; [#uses=1 type=i1] [debug line = 20:20]
...
; <label>:18                                      ; preds = %33, %17
  ...
  %20 = icmp slt i32 %19, 32, !dbg !64            ; [#uses=1 type=i1] [debug line = 26:28]
...
; <label>:21                                      ; preds = %18
  ...
  %26 = load [32 x i32]** %1, align 8, !dbg !65   ; [#uses=1 type=[32 x i32]*] [debug line = 27:6]
  %27 = getelementptr inbounds [32 x i32]* %26, i64 %25, !dbg !65 ; [#uses=1 type=[32 x i32]*] [debug line = 27:6]
  %28 = getelementptr inbounds [32 x i32]* %27, i32 0, i64 %23, !dbg !65 ; [#uses=1 type=i32*] [debug line = 27:6]
  ...
  %32 = getelementptr inbounds [32 x i32]* %a_row, i32 0, i64 %31, !dbg !65 ; [#uses=1 type=i32*] [debug line = 27:6]
...
; <label>:42                                      ; preds = %61, %41
  ...
  %44 = icmp slt i32 %43, 32, !dbg !76            ; [#uses=1 type=i1] [debug line = 32:29]
...
; <label>:45                                      ; preds = %42
  ...
  %49 = add nsw i32 %48, 32, !dbg !79             ; [#uses=1 type=i32] [debug line = 33:7]
  %50 = sext i32 %49 to i64, !dbg !79             ; [#uses=1 type=i64] [debug line = 33:7]
  %51 = load [32 x i32]** %1, align 8, !dbg !79   ; [#uses=1 type=[32 x i32]*] [debug line = 33:7]
  %52 = getelementptr inbounds [32 x i32]* %51, i64 %50, !dbg !79 ; [#uses=1 type=[32 x i32]*] [debug line = 33:7]
  %53 = getelementptr inbounds [32 x i32]* %52, i32 0, i64 %47, !dbg !79 ; [#uses=1 type=i32*] [debug line = 33:7]
  ...
  %59 = getelementptr inbounds [32 x [32 x i32]]* %b_copy, i32 0, i64 %58, !dbg !79 ; [#uses=1 type=[32 x i32]*] [debug line = 33:7]
  %60 = getelementptr inbounds [32 x i32]* %59, i32 0, i64 %56, !dbg !79 ; [#uses=1 type=i32*] [debug line = 33:7]
...
; <label>:67                                      ; preds = %85, %66
  ...
  %69 = icmp slt i32 %68, 32, !dbg !86            ; [#uses=1 type=i1] [debug line = 37:27]
...
; <label>:70                                      ; preds = %67
  ...
  %73 = getelementptr inbounds [32 x i32]* %a_row, i32 0, i64 %72, !dbg !89 ; [#uses=1 type=i32*] [debug line = 38:4]
  ...
  %79 = getelementptr inbounds [32 x [32 x i32]]* %b_copy, i32 0, i64 %78, !dbg !89 ; [#uses=1 type=[32 x i32]*] [debug line = 38:4]
  %80 = getelementptr inbounds [32 x i32]* %79, i32 0, i64 %76, !dbg !89 ; [#uses=1 type=i32*] [debug line = 38:4]
...
; <label>:88                                      ; preds = %67
  ...
  %93 = add nsw i32 %92, 64, !dbg !92             ; [#uses=1 type=i32] [debug line = 41:5]
  %94 = sext i32 %93 to i64, !dbg !92             ; [#uses=1 type=i64] [debug line = 41:5]
  %95 = load [32 x i32]** %1, align 8, !dbg !92   ; [#uses=1 type=[32 x i32]*] [debug line = 41:5]
  %96 = getelementptr inbounds [32 x i32]* %95, i64 %94, !dbg !92 ; [#uses=1 type=[32 x i32]*] [debug line = 41:5]
  %97 = getelementptr inbounds [32 x i32]* %96, i32 0, i64 %91, !dbg !92 ; [#uses=1 type=i32*] [debug line = 41:5]
