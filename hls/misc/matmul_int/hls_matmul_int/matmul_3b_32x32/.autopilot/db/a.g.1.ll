; ModuleID = '/home/patmos/github/bachelor_project_HLS/hls/misc/matmul_int/hls_matmul_int/matmul_3b_32x32/.autopilot/db/a.g.1.bc'
...
; [#uses=0]
define void @matmul_hw([32 x i32]* %a) nounwind uwtable {
  ...
  call void @llvm.dbg.value(metadata !{[32 x i32]* %a}, i64 0, metadata !28), !dbg !29 ; [debug line = 4:25] [debug variable = a]
  call void (...)* @_ssdm_SpecArrayDimSize([32 x i32]* %a, i32 96) nounwind, !dbg !30 ; [debug line = 5:2]
  call void (...)* @_ssdm_SpecArrayPartition([32 x i32]* %a, i32 1, i8* getelementptr inbounds ([6 x i8]* @.str, i64 0, i64 0), i32 3, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !32 ; [debug line = 6:1]
  ...
  call void (...)* @_ssdm_op_SpecInterface([32 x i32]* %a, i8* getelementptr inbounds ([5 x i8]* @.str3, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !33 ; [debug line = 10:1]
  call void (...)* @_ssdm_op_SpecResource([32 x i32]* %a, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([12 x i8]* @.str4, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 -1, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !34 ; [debug line = 11:1]
...
; <label>:1                                       ; preds = %8, %0
  ...
  %exitcond4 = icmp eq i32 %i, 32, !dbg !41       ; [#uses=1 type=i1] [debug line = 19:15]
...
.preheader7.preheader:                            ; preds = %1
  ...
  %tmp.1 = add nsw i32 %i, 64, !dbg !47           ; [#uses=1 type=i32] [debug line = 41:5]
...
.preheader7:                                      ; preds = %7, %.preheader7.preheader
  ...
  %exitcond3 = icmp eq i32 %j, 32, !dbg !52       ; [#uses=1 type=i1] [debug line = 20:20]
  br i1 %exitcond3, label %8, label %2, !dbg !52  ; [debug line = 20:20]

; <label>:2                                       ; preds = %.preheader7
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([4 x i8]* @.str5, i64 0, i64 0)) nounwind, !dbg !53 ; [debug line = 20:36]
  %rbegin1 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([4 x i8]* @.str5, i64 0, i64 0)) nounwind, !dbg !53 ; [#uses=1 type=i32] [debug line = 20:36]
...
.preheader5:                                      ; preds = %3, %.preheader5.preheader
  ...
  %exitcond2 = icmp eq i32 %k, 32, !dbg !56       ; [#uses=1 type=i1] [debug line = 26:28]
  br i1 %exitcond2, label %.loopexit6.loopexit, label %3, !dbg !56 ; [debug line = 26:28]

; <label>:3                                       ; preds = %.preheader5
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([10 x i8]* @.str6, i64 0, i64 0)) nounwind, !dbg !48 ; [debug line = 27:6]
  %rbegin8 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([10 x i8]* @.str6, i64 0, i64 0)) nounwind, !dbg !48 ; [#uses=1 type=i32] [debug line = 27:6]
  %tmp.6 = sext i32 %k to i64, !dbg !48           ; [#uses=2 type=i64] [debug line = 27:6]
  %a.addr = getelementptr inbounds [32 x i32]* %a, i64 %tmp.3, i64 %tmp.6, !dbg !48 ; [#uses=1 type=i32*] [debug line = 27:6]
  ...
  %a_row.addr = getelementptr inbounds [32 x i32]* %a_row, i64 0, i64 %tmp.6, !dbg !48 ; [#uses=1 type=i32*] [debug line = 27:6]
  store i32 %a.load, i32* %a_row.addr, align 4, !dbg !48 ; [debug line = 27:6]
  %rend9 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([10 x i8]* @.str6, i64 0, i64 0), i32 %rbegin8) nounwind, !dbg !57 ; [#uses=0 type=i32] [debug line = 27:23]
  %k.1 = add nsw i32 %k, 1, !dbg !58              ; [#uses=1 type=i32] [debug line = 26:38]
  call void @llvm.dbg.value(metadata !{i32 %k.1}, i64 0, metadata !59), !dbg !58 ; [debug line = 26:38] [debug variable = k]
  br label %.preheader5, !dbg !58                 ; [debug line = 26:38]
...
.preheader:                                       ; preds = %4, %.preheader.preheader
  ...
  %exitcond1 = icmp eq i32 %k1, 32, !dbg !64      ; [#uses=1 type=i1] [debug line = 32:29]
  br i1 %exitcond1, label %.loopexit.loopexit, label %4, !dbg !64 ; [debug line = 32:29]

; <label>:4                                       ; preds = %.preheader
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([10 x i8]* @.str7, i64 0, i64 0)) nounwind, !dbg !65 ; [debug line = 32:45]
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([10 x i8]* @.str7, i64 0, i64 0)) nounwind, !dbg !65 ; [#uses=1 type=i32] [debug line = 32:45]
  %tmp.9 = add nsw i32 %k1, 32, !dbg !60          ; [#uses=1 type=i32] [debug line = 33:7]
  %tmp.10 = sext i32 %tmp.9 to i64, !dbg !60      ; [#uses=1 type=i64] [debug line = 33:7]
  %a.addr.1 = getelementptr inbounds [32 x i32]* %a, i64 %tmp.10, i64 %tmp.8, !dbg !60 ; [#uses=1 type=i32*] [debug line = 33:7]
  ...
  %b_copy.addr = getelementptr inbounds [32 x [32 x i32]]* %b_copy, i64 0, i64 %tmp.11, i64 %tmp.8, !dbg !60 ; [#uses=1 type=i32*] [debug line = 33:7]
  store i32 %a.load.1, i32* %b_copy.addr, align 4, !dbg !60 ; [debug line = 33:7]
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([10 x i8]* @.str7, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !66 ; [#uses=0 type=i32] [debug line = 34:5]
  %k.2 = add nsw i32 %k1, 1, !dbg !67             ; [#uses=1 type=i32] [debug line = 32:39]
  call void @llvm.dbg.value(metadata !{i32 %k.2}, i64 0, metadata !68), !dbg !67 ; [debug line = 32:39] [debug variable = k]
  br label %.preheader, !dbg !67                  ; [debug line = 32:39]
...
; <label>:5                                       ; preds = %6, %.loopexit
  ...
  %exitcond = icmp eq i32 %k2, 32, !dbg !72       ; [#uses=1 type=i1] [debug line = 37:27]
  br i1 %exitcond, label %7, label %6, !dbg !72   ; [debug line = 37:27]

; <label>:6                                       ; preds = %5
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([8 x i8]* @.str8, i64 0, i64 0)) nounwind, !dbg !73 ; [debug line = 37:43]
  %rbegin2 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([8 x i8]* @.str8, i64 0, i64 0)) nounwind, !dbg !73 ; [#uses=1 type=i32] [debug line = 37:43]
  %tmp.16 = sext i32 %k2 to i64, !dbg !69         ; [#uses=2 type=i64] [debug line = 38:4]
  %a_row.addr.1 = getelementptr inbounds [32 x i32]* %a_row, i64 0, i64 %tmp.16, !dbg !69 ; [#uses=1 type=i32*] [debug line = 38:4]
  ...
  %b_copy.addr.1 = getelementptr inbounds [32 x [32 x i32]]* %b_copy, i64 0, i64 %tmp.16, i64 %tmp.13, !dbg !69 ; [#uses=1 type=i32*] [debug line = 38:4]
  ...
  %rend11 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([8 x i8]* @.str8, i64 0, i64 0), i32 %rbegin2) nounwind, !dbg !75 ; [#uses=0 type=i32] [debug line = 39:5]
  %k.3 = add nsw i32 %k2, 1, !dbg !76             ; [#uses=1 type=i32] [debug line = 37:37]
  call void @llvm.dbg.value(metadata !{i32 %k.3}, i64 0, metadata !77), !dbg !76 ; [debug line = 37:37] [debug variable = k]
  br label %5, !dbg !76                           ; [debug line = 37:37]

; <label>:7                                       ; preds = %5
  %tmp.0.lcssa = phi i32 [ %tmp14, %5 ]           ; [#uses=1 type=i32]
  %a.addr.2 = getelementptr inbounds [32 x i32]* %a, i64 %tmp.2, i64 %tmp.13, !dbg !47 ; [#uses=1 type=i32*] [debug line = 41:5]
  store i32 %tmp.0.lcssa, i32* %a.addr.2, align 4, !dbg !47 ; [debug line = 41:5]
  %rend13 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([4 x i8]* @.str5, i64 0, i64 0), i32 %rbegin1) nounwind, !dbg !78 ; [#uses=0 type=i32] [debug line = 42:3]
  %j.1 = add nsw i32 %j, 1, !dbg !79              ; [#uses=1 type=i32] [debug line = 20:30]
  call void @llvm.dbg.value(metadata !{i32 %j.1}, i64 0, metadata !80), !dbg !79 ; [debug line = 20:30] [debug variable = j]
  br label %.preheader7, !dbg !79                 ; [debug line = 20:30]

; <label>:8                                       ; preds = %.preheader7
  %i.1 = add nsw i32 %i, 1, !dbg !81              ; [#uses=1 type=i32] [debug line = 19:25]
  call void @llvm.dbg.value(metadata !{i32 %i.1}, i64 0, metadata !82), !dbg !81 ; [debug line = 19:25] [debug variable = i]
  br label %1, !dbg !81                           ; [debug line = 19:25]
...
!5 = metadata !{i32 786478, i32 0, metadata !6, metadata !"matmul_hw", metadata !"matmul_hw", metadata !"_Z9matmul_hwPA32_i", metadata !6, i32 4, metadata !7, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void ([32 x i32]*)* @matmul_hw, null, null, metadata !15, i32 5} ; [ DW_TAG_subprogram ]
...
!21 = metadata !{void ([32 x i32]*)* @matmul_hw, metadata !22, metadata !23, metadata !24, metadata !25, metadata !26, metadata !27}
...
!44 = metadata !{i32 786443, metadata !45, i32 20, i32 35, metadata !6, i32 4} ; [ DW_TAG_lexical_block ]
!45 = metadata !{i32 786443, metadata !46, i32 20, i32 7, metadata !6, i32 3} ; [ DW_TAG_lexical_block ]
!46 = metadata !{i32 786443, metadata !42, i32 19, i32 30, metadata !6, i32 2} ; [ DW_TAG_lexical_block ]
...
!53 = metadata !{i32 20, i32 36, metadata !44, null}
...
!58 = metadata !{i32 26, i32 38, metadata !50, null}
...
!61 = metadata !{i32 786443, metadata !62, i32 32, i32 44, metadata !6, i32 10} ; [ DW_TAG_lexical_block ]
...
!65 = metadata !{i32 32, i32 45, metadata !61, null}
!66 = metadata !{i32 34, i32 5, metadata !61, null}
!67 = metadata !{i32 32, i32 39, metadata !62, null}
...
!70 = metadata !{i32 786443, metadata !71, i32 37, i32 42, metadata !6, i32 12} ; [ DW_TAG_lexical_block ]
...
!73 = metadata !{i32 37, i32 43, metadata !70, null}
...
!76 = metadata !{i32 37, i32 37, metadata !71, null}
