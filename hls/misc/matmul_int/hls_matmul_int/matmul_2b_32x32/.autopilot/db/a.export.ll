; ModuleID = '/home/patmos/github/bachelor_project_HLS/hls/misc/matmul_int/hls_matmul_int/matmul_2b_32x32/.autopilot/db/a.o.2.bc'
...
define void @matmul_hw([1536 x i32]* %a_0, [1536 x i32]* %a_1) {
  ...
  call void (...)* @_ssdm_op_SpecBitsMap([1536 x i32]* %a_1), !map !7
  call void (...)* @_ssdm_op_SpecBitsMap([1536 x i32]* %a_0), !map !14
...
.preheader.preheader:                             ; preds = %.preheader7.preheader
  ...
  %tmp_8_cast1 = zext i6 %j_mid2 to i10
  %tmp_8_cast2 = zext i6 %j_mid2 to i9
  %tmp_8_cast37_cast = zext i6 %j_mid2 to i8
  %tmp_8_cast3 = zext i6 %j_mid2 to i7
  %tmp_8_cast = zext i6 %j_mid2 to i11
  %tmp_70 = call i64 @_ssdm_op_BitConcatenate.i64.i58.i6(i58 16, i6 %j_mid2)
  %a_0_addr_32 = getelementptr [1536 x i32]* %a_0, i64 0, i64 %tmp_70
  %tmp_71 = add i11 %tmp_8_cast, -992
  %tmp_72_cast = zext i11 %tmp_71 to i64
  %a_0_addr_33 = getelementptr [1536 x i32]* %a_0, i64 0, i64 %tmp_72_cast
  %tmp_72 = call i64 @_ssdm_op_BitConcatenate.i64.i58.i6(i58 17, i6 %j_mid2)
  %a_0_addr_34 = getelementptr [1536 x i32]* %a_0, i64 0, i64 %tmp_72
  %tmp_73 = add i11 %tmp_8_cast, -928
  %tmp_74_cast = zext i11 %tmp_73 to i64
  %a_0_addr_35 = getelementptr [1536 x i32]* %a_0, i64 0, i64 %tmp_74_cast
  %tmp_74 = call i64 @_ssdm_op_BitConcatenate.i64.i58.i6(i58 18, i6 %j_mid2)
  %a_0_addr_36 = getelementptr [1536 x i32]* %a_0, i64 0, i64 %tmp_74
  %tmp_75 = add i11 %tmp_8_cast, -864
  %tmp_76_cast = zext i11 %tmp_75 to i64
  %a_0_addr_37 = getelementptr [1536 x i32]* %a_0, i64 0, i64 %tmp_76_cast
  %tmp_76 = call i64 @_ssdm_op_BitConcatenate.i64.i58.i6(i58 19, i6 %j_mid2)
  %a_0_addr_38 = getelementptr [1536 x i32]* %a_0, i64 0, i64 %tmp_76
  %tmp_77 = add i11 %tmp_8_cast, -800
  %tmp_78_cast = zext i11 %tmp_77 to i64
  %a_0_addr_39 = getelementptr [1536 x i32]* %a_0, i64 0, i64 %tmp_78_cast
  %tmp_78 = call i64 @_ssdm_op_BitConcatenate.i64.i58.i6(i58 20, i6 %j_mid2)
  %a_0_addr_40 = getelementptr [1536 x i32]* %a_0, i64 0, i64 %tmp_78
  %tmp_79 = add i11 %tmp_8_cast, -736
  %tmp_80_cast = zext i11 %tmp_79 to i64
  %a_0_addr_41 = getelementptr [1536 x i32]* %a_0, i64 0, i64 %tmp_80_cast
  %tmp_80 = call i64 @_ssdm_op_BitConcatenate.i64.i58.i6(i58 21, i6 %j_mid2)
  %a_0_addr_42 = getelementptr [1536 x i32]* %a_0, i64 0, i64 %tmp_80
  %tmp_81 = add i11 %tmp_8_cast, -672
  %tmp_82_cast = zext i11 %tmp_81 to i64
  %a_0_addr_43 = getelementptr [1536 x i32]* %a_0, i64 0, i64 %tmp_82_cast
  %tmp_82 = call i64 @_ssdm_op_BitConcatenate.i64.i58.i6(i58 22, i6 %j_mid2)
  %a_0_addr_44 = getelementptr [1536 x i32]* %a_0, i64 0, i64 %tmp_82
  %tmp_83 = add i11 %tmp_8_cast, -608
  %tmp_84_cast = zext i11 %tmp_83 to i64
  %a_0_addr_45 = getelementptr [1536 x i32]* %a_0, i64 0, i64 %tmp_84_cast
  %tmp_84 = call i64 @_ssdm_op_BitConcatenate.i64.i58.i6(i58 23, i6 %j_mid2)
  %a_0_addr_46 = getelementptr [1536 x i32]* %a_0, i64 0, i64 %tmp_84
  %tmp_85 = add i11 %tmp_8_cast, -544
  %tmp_86_cast = zext i11 %tmp_85 to i64
  %a_0_addr_47 = getelementptr [1536 x i32]* %a_0, i64 0, i64 %tmp_86_cast
  %a_1_addr = getelementptr [1536 x i32]* %a_1, i64 0, i64 %tmp_8
  %tmp_86 = add i7 %tmp_8_cast3, 32
  %tmp_87_cast = zext i7 %tmp_86 to i64
  %a_1_addr_1 = getelementptr [1536 x i32]* %a_1, i64 0, i64 %tmp_87_cast
  %tmp_87 = call i64 @_ssdm_op_BitConcatenate.i64.i58.i6(i58 1, i6 %j_mid2)
  %a_1_addr_2 = getelementptr [1536 x i32]* %a_1, i64 0, i64 %tmp_87
  %tmp_88 = add i8 %tmp_8_cast37_cast, 96
  %tmp_89_cast = zext i8 %tmp_88 to i64
  %a_1_addr_3 = getelementptr [1536 x i32]* %a_1, i64 0, i64 %tmp_89_cast
  %tmp_89 = call i64 @_ssdm_op_BitConcatenate.i64.i58.i6(i58 2, i6 %j_mid2)
  %a_1_addr_4 = getelementptr [1536 x i32]* %a_1, i64 0, i64 %tmp_89
  %tmp_90 = add i8 %tmp_8_cast37_cast, -96
  %tmp_91_cast = zext i8 %tmp_90 to i64
  %a_1_addr_5 = getelementptr [1536 x i32]* %a_1, i64 0, i64 %tmp_91_cast
  %tmp_91 = call i64 @_ssdm_op_BitConcatenate.i64.i58.i6(i58 3, i6 %j_mid2)
  %a_1_addr_6 = getelementptr [1536 x i32]* %a_1, i64 0, i64 %tmp_91
  %tmp_92 = add i9 %tmp_8_cast2, 224
  %tmp_93_cast = zext i9 %tmp_92 to i64
  %a_1_addr_7 = getelementptr [1536 x i32]* %a_1, i64 0, i64 %tmp_93_cast
  %tmp_93 = call i64 @_ssdm_op_BitConcatenate.i64.i58.i6(i58 4, i6 %j_mid2)
  %a_1_addr_8 = getelementptr [1536 x i32]* %a_1, i64 0, i64 %tmp_93
  %tmp_94 = add i9 %tmp_8_cast2, -224
  %tmp_95_cast = zext i9 %tmp_94 to i64
  %a_1_addr_9 = getelementptr [1536 x i32]* %a_1, i64 0, i64 %tmp_95_cast
  %tmp_95 = call i64 @_ssdm_op_BitConcatenate.i64.i58.i6(i58 5, i6 %j_mid2)
  %a_1_addr_10 = getelementptr [1536 x i32]* %a_1, i64 0, i64 %tmp_95
  %tmp_96 = add i9 %tmp_8_cast2, -160
  %tmp_97_cast = zext i9 %tmp_96 to i64
  %a_1_addr_11 = getelementptr [1536 x i32]* %a_1, i64 0, i64 %tmp_97_cast
  %tmp_97 = call i64 @_ssdm_op_BitConcatenate.i64.i58.i6(i58 6, i6 %j_mid2)
  %a_1_addr_12 = getelementptr [1536 x i32]* %a_1, i64 0, i64 %tmp_97
  %tmp_99_cast1 = sext i8 %tmp_90 to i9
  %tmp_99_cast = zext i9 %tmp_99_cast1 to i64
  %a_1_addr_13 = getelementptr [1536 x i32]* %a_1, i64 0, i64 %tmp_99_cast
  %tmp_98 = call i64 @_ssdm_op_BitConcatenate.i64.i58.i6(i58 7, i6 %j_mid2)
  %a_1_addr_14 = getelementptr [1536 x i32]* %a_1, i64 0, i64 %tmp_98
  %tmp_99 = add i10 %tmp_8_cast1, 480
  %tmp_101_cast = zext i10 %tmp_99 to i64
  %a_1_addr_15 = getelementptr [1536 x i32]* %a_1, i64 0, i64 %tmp_101_cast
  %a_0_load = load i32* %a_0_addr_32, align 4
  %b_copy_0_addr = getelementptr [32 x i32]* %b_copy_0, i64 0, i64 %tmp_8
  store i32 %a_0_load, i32* %b_copy_0_addr, align 4
  %a_0_load_1 = load i32* %a_0_addr_33, align 4
  %b_copy_1_addr = getelementptr [32 x i32]* %b_copy_1, i64 0, i64 %tmp_8
  store i32 %a_0_load_1, i32* %b_copy_1_addr, align 4
  %a_0_load_2 = load i32* %a_0_addr_34, align 4
  %b_copy_2_addr = getelementptr [32 x i32]* %b_copy_2, i64 0, i64 %tmp_8
  store i32 %a_0_load_2, i32* %b_copy_2_addr, align 4
  %a_0_load_3 = load i32* %a_0_addr_35, align 4
  %b_copy_3_addr = getelementptr [32 x i32]* %b_copy_3, i64 0, i64 %tmp_8
  store i32 %a_0_load_3, i32* %b_copy_3_addr, align 4
  %a_0_load_4 = load i32* %a_0_addr_36, align 4
  %b_copy_4_addr = getelementptr [32 x i32]* %b_copy_4, i64 0, i64 %tmp_8
  store i32 %a_0_load_4, i32* %b_copy_4_addr, align 4
  %a_0_load_5 = load i32* %a_0_addr_37, align 4
  %b_copy_5_addr = getelementptr [32 x i32]* %b_copy_5, i64 0, i64 %tmp_8
  store i32 %a_0_load_5, i32* %b_copy_5_addr, align 4
  %a_0_load_6 = load i32* %a_0_addr_38, align 4
  %b_copy_6_addr = getelementptr [32 x i32]* %b_copy_6, i64 0, i64 %tmp_8
  store i32 %a_0_load_6, i32* %b_copy_6_addr, align 4
  %a_0_load_7 = load i32* %a_0_addr_39, align 4
  %b_copy_7_addr = getelementptr [32 x i32]* %b_copy_7, i64 0, i64 %tmp_8
  store i32 %a_0_load_7, i32* %b_copy_7_addr, align 4
  %a_0_load_8 = load i32* %a_0_addr_40, align 4
  %b_copy_8_addr = getelementptr [32 x i32]* %b_copy_8, i64 0, i64 %tmp_8
  store i32 %a_0_load_8, i32* %b_copy_8_addr, align 4
  %a_0_load_9 = load i32* %a_0_addr_41, align 4
  %b_copy_9_addr = getelementptr [32 x i32]* %b_copy_9, i64 0, i64 %tmp_8
  store i32 %a_0_load_9, i32* %b_copy_9_addr, align 4
  %a_0_load_10 = load i32* %a_0_addr_42, align 4
  %b_copy_10_addr = getelementptr [32 x i32]* %b_copy_10, i64 0, i64 %tmp_8
  store i32 %a_0_load_10, i32* %b_copy_10_addr, align 4
  %a_0_load_11 = load i32* %a_0_addr_43, align 4
  %b_copy_11_addr = getelementptr [32 x i32]* %b_copy_11, i64 0, i64 %tmp_8
  store i32 %a_0_load_11, i32* %b_copy_11_addr, align 4
  %a_0_load_12 = load i32* %a_0_addr_44, align 4
  %b_copy_12_addr = getelementptr [32 x i32]* %b_copy_12, i64 0, i64 %tmp_8
  store i32 %a_0_load_12, i32* %b_copy_12_addr, align 4
  %a_0_load_13 = load i32* %a_0_addr_45, align 4
  %b_copy_13_addr = getelementptr [32 x i32]* %b_copy_13, i64 0, i64 %tmp_8
  store i32 %a_0_load_13, i32* %b_copy_13_addr, align 4
  %a_0_load_14 = load i32* %a_0_addr_46, align 4
  %b_copy_14_addr = getelementptr [32 x i32]* %b_copy_14, i64 0, i64 %tmp_8
  store i32 %a_0_load_14, i32* %b_copy_14_addr, align 4
  %a_0_load_15 = load i32* %a_0_addr_47, align 4
  %b_copy_15_addr = getelementptr [32 x i32]* %b_copy_15, i64 0, i64 %tmp_8
  store i32 %a_0_load_15, i32* %b_copy_15_addr, align 4
  %a_1_load = load i32* %a_1_addr, align 4
  %b_copy_16_addr = getelementptr [32 x i32]* %b_copy_16, i64 0, i64 %tmp_8
  store i32 %a_1_load, i32* %b_copy_16_addr, align 4
  %a_1_load_1 = load i32* %a_1_addr_1, align 4
  %b_copy_17_addr = getelementptr [32 x i32]* %b_copy_17, i64 0, i64 %tmp_8
  store i32 %a_1_load_1, i32* %b_copy_17_addr, align 4
  %a_1_load_2 = load i32* %a_1_addr_2, align 4
  %b_copy_18_addr = getelementptr [32 x i32]* %b_copy_18, i64 0, i64 %tmp_8
  store i32 %a_1_load_2, i32* %b_copy_18_addr, align 4
  %a_1_load_3 = load i32* %a_1_addr_3, align 4
  %b_copy_19_addr = getelementptr [32 x i32]* %b_copy_19, i64 0, i64 %tmp_8
  store i32 %a_1_load_3, i32* %b_copy_19_addr, align 4
  %a_1_load_4 = load i32* %a_1_addr_4, align 4
  %b_copy_20_addr = getelementptr [32 x i32]* %b_copy_20, i64 0, i64 %tmp_8
  store i32 %a_1_load_4, i32* %b_copy_20_addr, align 4
  %a_1_load_5 = load i32* %a_1_addr_5, align 4
  %b_copy_21_addr = getelementptr [32 x i32]* %b_copy_21, i64 0, i64 %tmp_8
  store i32 %a_1_load_5, i32* %b_copy_21_addr, align 4
  %a_1_load_6 = load i32* %a_1_addr_6, align 4
  %b_copy_22_addr = getelementptr [32 x i32]* %b_copy_22, i64 0, i64 %tmp_8
  store i32 %a_1_load_6, i32* %b_copy_22_addr, align 4
  %a_1_load_7 = load i32* %a_1_addr_7, align 4
  %b_copy_23_addr = getelementptr [32 x i32]* %b_copy_23, i64 0, i64 %tmp_8
  store i32 %a_1_load_7, i32* %b_copy_23_addr, align 4
  %a_1_load_8 = load i32* %a_1_addr_8, align 4
  %b_copy_24_addr = getelementptr [32 x i32]* %b_copy_24, i64 0, i64 %tmp_8
  store i32 %a_1_load_8, i32* %b_copy_24_addr, align 4
  %a_1_load_9 = load i32* %a_1_addr_9, align 4
  %b_copy_25_addr = getelementptr [32 x i32]* %b_copy_25, i64 0, i64 %tmp_8
  store i32 %a_1_load_9, i32* %b_copy_25_addr, align 4
  %a_1_load_10 = load i32* %a_1_addr_10, align 4
  %b_copy_26_addr = getelementptr [32 x i32]* %b_copy_26, i64 0, i64 %tmp_8
  store i32 %a_1_load_10, i32* %b_copy_26_addr, align 4
  %a_1_load_11 = load i32* %a_1_addr_11, align 4
  %b_copy_27_addr = getelementptr [32 x i32]* %b_copy_27, i64 0, i64 %tmp_8
  store i32 %a_1_load_11, i32* %b_copy_27_addr, align 4
  %a_1_load_12 = load i32* %a_1_addr_12, align 4
  %b_copy_28_addr = getelementptr [32 x i32]* %b_copy_28, i64 0, i64 %tmp_8
  store i32 %a_1_load_12, i32* %b_copy_28_addr, align 4
  %a_1_load_13 = load i32* %a_1_addr_13, align 4
  %b_copy_29_addr = getelementptr [32 x i32]* %b_copy_29, i64 0, i64 %tmp_8
  store i32 %a_1_load_13, i32* %b_copy_29_addr, align 4
  %a_1_load_14 = load i32* %a_1_addr_14, align 4
  %b_copy_30_addr = getelementptr [32 x i32]* %b_copy_30, i64 0, i64 %tmp_8
  store i32 %a_1_load_14, i32* %b_copy_30_addr, align 4
  %a_1_load_15 = load i32* %a_1_addr_15, align 4
  %b_copy_31_addr = getelementptr [32 x i32]* %b_copy_31, i64 0, i64 %tmp_8
  store i32 %a_1_load_15, i32* %b_copy_31_addr, align 4
  br label %.loopexit

.loopexit:                                        ; preds = %.preheader.preheader, %.preheader7.preheader
  %tmp_7 = zext i6 %j_mid2 to i64
  %tmp_7_cast = zext i6 %j_mid2 to i12
  %tmp_100 = add i12 %tmp_69, %tmp_7_cast
  %tmp_102_cast = zext i12 %tmp_100 to i64
  %a_1_addr_16 = getelementptr [1536 x i32]* %a_1, i64 0, i64 %tmp_102_cast
  ...
  store i32 %tmp_12_s, i32* %a_1_addr_16, align 4
...
.preheader7.preheader:                            ; preds = %.preheader7
  ...
  %tmp_69 = call i12 @_ssdm_op_BitConcatenate.i12.i7.i5(i7 %newIndex1_mid2_v, i5 0)
