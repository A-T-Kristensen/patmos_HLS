...
set C_modelArgList {
	{ a_0 int 32 regular {bram 384 { 1 } 1 1 }  }
	{ a_1 int 32 regular {bram 384 { 2 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "a_0", "interface" : "bram", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "a","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 23,"step" : 1},{"low" : 0,"up" : 15,"step" : 1}]}]}]} , 
 	{ "Name" : "a_1", "interface" : "bram", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "a","cData": "int","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 24,"up" : 47,"step" : 1},{"low" : 0,"up" : 15,"step" : 1}]}]}]} ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "22", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.matmul_hw_urem_6ndEe_U6", "Parent" : "0"},
	...
	{"ID" : "33", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.matmul_hw_mul_32scud_U17", "Parent" : "0"}]}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "6154", "Max" : "6154"}
	, {"Name" : "Interval", "Min" : "6155", "Max" : "6155"}
]}
