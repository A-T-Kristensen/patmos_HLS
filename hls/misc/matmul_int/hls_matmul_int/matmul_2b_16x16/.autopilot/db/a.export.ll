...
define void @matmul_hw([384 x i32]* %a_0, [384 x i32]* %a_1) {
  ...
  call void (...)* @_ssdm_op_SpecBitsMap([384 x i32]* %a_1), !map !7
  call void (...)* @_ssdm_op_SpecBitsMap([384 x i32]* %a_0), !map !14
...
.preheader.preheader:                             ; preds = %.preheader7.preheader
  ...
  %tmp_8_cast1 = zext i5 %j_mid2 to i8
  %tmp_8_cast2 = zext i5 %j_mid2 to i7
  %tmp_8_cast3 = zext i5 %j_mid2 to i6
  %tmp_8_cast = zext i5 %j_mid2 to i9
  %tmp_38 = call i64 @_ssdm_op_BitConcatenate.i64.i59.i5(i59 8, i5 %j_mid2)
  %a_0_addr_16 = getelementptr [384 x i32]* %a_0, i64 0, i64 %tmp_38
  %tmp_39 = add i9 %tmp_8_cast, -240
  %tmp_40_cast = zext i9 %tmp_39 to i64
  %a_0_addr_17 = getelementptr [384 x i32]* %a_0, i64 0, i64 %tmp_40_cast
  %tmp_40 = call i64 @_ssdm_op_BitConcatenate.i64.i59.i5(i59 9, i5 %j_mid2)
  %a_0_addr_18 = getelementptr [384 x i32]* %a_0, i64 0, i64 %tmp_40
  %tmp_41 = add i9 %tmp_8_cast, -208
  %tmp_42_cast = zext i9 %tmp_41 to i64
  %a_0_addr_19 = getelementptr [384 x i32]* %a_0, i64 0, i64 %tmp_42_cast
  %tmp_42 = call i64 @_ssdm_op_BitConcatenate.i64.i59.i5(i59 10, i5 %j_mid2)
  %a_0_addr_20 = getelementptr [384 x i32]* %a_0, i64 0, i64 %tmp_42
  %tmp_43 = add i9 %tmp_8_cast, -176
  %tmp_44_cast = zext i9 %tmp_43 to i64
  %a_0_addr_21 = getelementptr [384 x i32]* %a_0, i64 0, i64 %tmp_44_cast
  %tmp_44 = call i64 @_ssdm_op_BitConcatenate.i64.i59.i5(i59 11, i5 %j_mid2)
  %a_0_addr_22 = getelementptr [384 x i32]* %a_0, i64 0, i64 %tmp_44
  %tmp_45 = add i9 %tmp_8_cast, -144
  %tmp_46_cast = zext i9 %tmp_45 to i64
  %a_0_addr_23 = getelementptr [384 x i32]* %a_0, i64 0, i64 %tmp_46_cast
  %a_1_addr = getelementptr [384 x i32]* %a_1, i64 0, i64 %tmp_8
  %tmp_46 = add i6 %tmp_8_cast3, 16
  %tmp_47_cast = zext i6 %tmp_46 to i64
  %a_1_addr_1 = getelementptr [384 x i32]* %a_1, i64 0, i64 %tmp_47_cast
  %tmp_47 = call i64 @_ssdm_op_BitConcatenate.i64.i59.i5(i59 1, i5 %j_mid2)
  %a_1_addr_2 = getelementptr [384 x i32]* %a_1, i64 0, i64 %tmp_47
  %tmp_48 = add i7 %tmp_8_cast2, 48
  %tmp_49_cast = zext i7 %tmp_48 to i64
  %a_1_addr_3 = getelementptr [384 x i32]* %a_1, i64 0, i64 %tmp_49_cast
  %tmp_49 = call i64 @_ssdm_op_BitConcatenate.i64.i59.i5(i59 2, i5 %j_mid2)
  %a_1_addr_4 = getelementptr [384 x i32]* %a_1, i64 0, i64 %tmp_49
  %tmp_50 = add i7 %tmp_8_cast2, -48
  %tmp_51_cast = zext i7 %tmp_50 to i64
  %a_1_addr_5 = getelementptr [384 x i32]* %a_1, i64 0, i64 %tmp_51_cast
  %tmp_51 = call i64 @_ssdm_op_BitConcatenate.i64.i59.i5(i59 3, i5 %j_mid2)
  %a_1_addr_6 = getelementptr [384 x i32]* %a_1, i64 0, i64 %tmp_51
  %tmp_52 = add i8 %tmp_8_cast1, 112
  %tmp_53_cast = zext i8 %tmp_52 to i64
  %a_1_addr_7 = getelementptr [384 x i32]* %a_1, i64 0, i64 %tmp_53_cast
  %a_0_load = load i32* %a_0_addr_16, align 4
  %b_copy_0_addr = getelementptr [16 x i32]* %b_copy_0, i64 0, i64 %tmp_8
  store i32 %a_0_load, i32* %b_copy_0_addr, align 4
  %a_0_load_1 = load i32* %a_0_addr_17, align 4
  %b_copy_1_addr = getelementptr [16 x i32]* %b_copy_1, i64 0, i64 %tmp_8
  store i32 %a_0_load_1, i32* %b_copy_1_addr, align 4
  %a_0_load_2 = load i32* %a_0_addr_18, align 4
  %b_copy_2_addr = getelementptr [16 x i32]* %b_copy_2, i64 0, i64 %tmp_8
  store i32 %a_0_load_2, i32* %b_copy_2_addr, align 4
  %a_0_load_3 = load i32* %a_0_addr_19, align 4
  %b_copy_3_addr = getelementptr [16 x i32]* %b_copy_3, i64 0, i64 %tmp_8
  store i32 %a_0_load_3, i32* %b_copy_3_addr, align 4
  %a_0_load_4 = load i32* %a_0_addr_20, align 4
  %b_copy_4_addr = getelementptr [16 x i32]* %b_copy_4, i64 0, i64 %tmp_8
  store i32 %a_0_load_4, i32* %b_copy_4_addr, align 4
  %a_0_load_5 = load i32* %a_0_addr_21, align 4
  %b_copy_5_addr = getelementptr [16 x i32]* %b_copy_5, i64 0, i64 %tmp_8
  store i32 %a_0_load_5, i32* %b_copy_5_addr, align 4
  %a_0_load_6 = load i32* %a_0_addr_22, align 4
  %b_copy_6_addr = getelementptr [16 x i32]* %b_copy_6, i64 0, i64 %tmp_8
  store i32 %a_0_load_6, i32* %b_copy_6_addr, align 4
  %a_0_load_7 = load i32* %a_0_addr_23, align 4
...
.loopexit:                                        ; preds = %.preheader.preheader, %.preheader7.preheader
  ...
  store i32 %tmp_12_s, i32* %a_1_addr_8, align 4
...
.preheader7.preheader:                            ; preds = %.preheader7
  ...
  %tmp_37 = call i10 @_ssdm_op_BitConcatenate.i10.i6.i4(i6 %newIndex1_mid2_v, i4 0)
