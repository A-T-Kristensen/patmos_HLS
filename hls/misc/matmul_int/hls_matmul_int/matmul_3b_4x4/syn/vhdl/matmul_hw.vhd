...
architecture behav of matmul_hw is 
    ...
    component matmul_hw_mul_32shbi IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    matmul_hw_mux_42_g8j_U1 : component matmul_hw_mux_42_g8j
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din1_WIDTH => 32,
    ...
    matmul_hw_mul_32shbi_U2 : component matmul_hw_mul_32shbi
    generic map (
        ID => 1,
        NUM_STAGE => 6,
        din0_WIDTH => 32,
    ...
    matmul_hw_mul_32shbi_U4 : component matmul_hw_mul_32shbi
    generic map (
        ID => 1,
        NUM_STAGE => 6,
        din0_WIDTH => 32,
    ...
    matmul_hw_mul_32shbi_U6 : component matmul_hw_mul_32shbi
    generic map (
        ID => 1,
        NUM_STAGE => 6,
        din0_WIDTH => 32,
    ...
    matmul_hw_mul_32shbi_U8 : component matmul_hw_mul_32shbi
    generic map (
        ID => 1,
        NUM_STAGE => 6,
        din0_WIDTH => 32,
