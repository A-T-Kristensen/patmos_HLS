...
set C_modelArgList {
	{ a float 32 regular {bram 768 { 2 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "a", "interface" : "bram", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "a","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 47,"step" : 1},{"low" : 0,"up" : 15,"step" : 1}]}]}]} ]}
...
set PerformanceInfo {[
	...
	, {"Name" : "Interval", "Min" : "16650", "Max" : "16650"}
]}
