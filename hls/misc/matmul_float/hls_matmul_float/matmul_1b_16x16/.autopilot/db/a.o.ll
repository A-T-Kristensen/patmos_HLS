; ModuleID = '/home/patmos/github/bachelor_project_HLS/hls/misc/matmul_float/hls_matmul_float/matmul_1b_16x16/.autopilot/db/a.o.bc'
...
define void @_Z9matmul_hwPA16_f([16 x float]* %a) nounwind uwtable {
  %1 = alloca [16 x float]*, align 8              ; [#uses=7 type=[16 x float]**]
  ...
  %3 = load [16 x float]** %1, align 8, !dbg !29  ; [#uses=1 type=[16 x float]*] [debug line = 10:1]
  call void (...)* @_ssdm_op_SpecInterface([16 x float]* %3, i8* getelementptr inbounds ([5 x i8]* @.str2, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 0, i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !29 ; [debug line = 10:1]
  %4 = load [16 x float]** %1, align 8, !dbg !30  ; [#uses=1 type=[16 x float]*] [debug line = 11:1]
  call void (...)* @_ssdm_op_SpecResource([16 x float]* %4, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([12 x i8]* @.str3, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i32 -1, i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i32 0, i32 0)) nounwind, !dbg !30 ; [debug line = 11:1]
...
; <label>:5                                       ; preds = %102, %0
  ...
  %7 = icmp slt i32 %6, 16, !dbg !44              ; [#uses=1 type=i1] [debug line = 19:15]
...
; <label>:10                                      ; preds = %98, %9
  ...
  %12 = icmp slt i32 %11, 16, !dbg !50            ; [#uses=1 type=i1] [debug line = 20:20]
...
; <label>:18                                      ; preds = %33, %17
  ...
  %20 = icmp slt i32 %19, 16, !dbg !61            ; [#uses=1 type=i1] [debug line = 26:28]
...
; <label>:21                                      ; preds = %18
  ...
  %26 = load [16 x float]** %1, align 8, !dbg !62 ; [#uses=1 type=[16 x float]*] [debug line = 27:6]
  %27 = getelementptr inbounds [16 x float]* %26, i64 %25, !dbg !62 ; [#uses=1 type=[16 x float]*] [debug line = 27:6]
  %28 = getelementptr inbounds [16 x float]* %27, i32 0, i64 %23, !dbg !62 ; [#uses=1 type=float*] [debug line = 27:6]
  ...
  %32 = getelementptr inbounds [16 x float]* %a_row, i32 0, i64 %31, !dbg !62 ; [#uses=1 type=float*] [debug line = 27:6]
...
; <label>:42                                      ; preds = %61, %41
  ...
  %44 = icmp slt i32 %43, 16, !dbg !73            ; [#uses=1 type=i1] [debug line = 32:29]
...
; <label>:45                                      ; preds = %42
  ...
  %49 = add nsw i32 %48, 16, !dbg !76             ; [#uses=1 type=i32] [debug line = 33:7]
  %50 = sext i32 %49 to i64, !dbg !76             ; [#uses=1 type=i64] [debug line = 33:7]
  %51 = load [16 x float]** %1, align 8, !dbg !76 ; [#uses=1 type=[16 x float]*] [debug line = 33:7]
  %52 = getelementptr inbounds [16 x float]* %51, i64 %50, !dbg !76 ; [#uses=1 type=[16 x float]*] [debug line = 33:7]
  %53 = getelementptr inbounds [16 x float]* %52, i32 0, i64 %47, !dbg !76 ; [#uses=1 type=float*] [debug line = 33:7]
  ...
  %59 = getelementptr inbounds [16 x [16 x float]]* %b_copy, i32 0, i64 %58, !dbg !76 ; [#uses=1 type=[16 x float]*] [debug line = 33:7]
  %60 = getelementptr inbounds [16 x float]* %59, i32 0, i64 %56, !dbg !76 ; [#uses=1 type=float*] [debug line = 33:7]
...
; <label>:67                                      ; preds = %85, %66
  ...
  %69 = icmp slt i32 %68, 16, !dbg !83            ; [#uses=1 type=i1] [debug line = 37:27]
...
; <label>:70                                      ; preds = %67
  ...
  %73 = getelementptr inbounds [16 x float]* %a_row, i32 0, i64 %72, !dbg !86 ; [#uses=1 type=float*] [debug line = 38:4]
  ...
  %79 = getelementptr inbounds [16 x [16 x float]]* %b_copy, i32 0, i64 %78, !dbg !86 ; [#uses=1 type=[16 x float]*] [debug line = 38:4]
  %80 = getelementptr inbounds [16 x float]* %79, i32 0, i64 %76, !dbg !86 ; [#uses=1 type=float*] [debug line = 38:4]
...
; <label>:88                                      ; preds = %67
  ...
  %93 = add nsw i32 %92, 32, !dbg !89             ; [#uses=1 type=i32] [debug line = 41:5]
  %94 = sext i32 %93 to i64, !dbg !89             ; [#uses=1 type=i64] [debug line = 41:5]
  %95 = load [16 x float]** %1, align 8, !dbg !89 ; [#uses=1 type=[16 x float]*] [debug line = 41:5]
  %96 = getelementptr inbounds [16 x float]* %95, i64 %94, !dbg !89 ; [#uses=1 type=[16 x float]*] [debug line = 41:5]
  %97 = getelementptr inbounds [16 x float]* %96, i32 0, i64 %91, !dbg !89 ; [#uses=1 type=float*] [debug line = 41:5]
