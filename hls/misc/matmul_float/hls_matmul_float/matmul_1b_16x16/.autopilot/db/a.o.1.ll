; ModuleID = '/home/patmos/github/bachelor_project_HLS/hls/misc/matmul_float/hls_matmul_float/matmul_1b_16x16/.autopilot/db/a.g.1.bc'
...
; [#uses=0]
define void @matmul_hw([16 x float]* %a) nounwind uwtable {
  ...
  call void (...)* @_ssdm_SpecArrayDimSize([16 x float]* %a, i32 48) nounwind, !dbg !26 ; [debug line = 5:2]
  ...
  call void (...)* @_ssdm_op_SpecResource([16 x float]* %a, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([12 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i32 -1, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0), i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !30 ; [debug line = 11:1]
...
; <label>:1                                       ; preds = %8, %0
  ...
  %exitcond4 = icmp eq i32 %i, 16, !dbg !37       ; [#uses=1 type=i1] [debug line = 19:15]
...
.preheader7.preheader:                            ; preds = %1
  ...
  %tmp.1 = add nsw i32 %i, 32, !dbg !43           ; [#uses=1 type=i32] [debug line = 41:5]
...
.preheader7:                                      ; preds = %7, %.preheader7.preheader
  ...
  %exitcond3 = icmp eq i32 %j, 16, !dbg !48       ; [#uses=1 type=i1] [debug line = 20:20]
  br i1 %exitcond3, label %8, label %2, !dbg !48  ; [debug line = 20:20]

; <label>:2                                       ; preds = %.preheader7
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([4 x i8]* @.str4, i64 0, i64 0)) nounwind, !dbg !49 ; [debug line = 20:36]
  %rbegin1 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([4 x i8]* @.str4, i64 0, i64 0)) nounwind, !dbg !49 ; [#uses=1 type=i32] [debug line = 20:36]
...
.preheader5:                                      ; preds = %3, %.preheader5.preheader
  ...
  %exitcond2 = icmp eq i32 %k, 16, !dbg !52       ; [#uses=1 type=i1] [debug line = 26:28]
  br i1 %exitcond2, label %.loopexit6.loopexit, label %3, !dbg !52 ; [debug line = 26:28]

; <label>:3                                       ; preds = %.preheader5
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([10 x i8]* @.str5, i64 0, i64 0)) nounwind, !dbg !44 ; [debug line = 27:6]
  %rbegin8 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([10 x i8]* @.str5, i64 0, i64 0)) nounwind, !dbg !44 ; [#uses=1 type=i32] [debug line = 27:6]
  %tmp.6 = sext i32 %k to i64, !dbg !44           ; [#uses=2 type=i64] [debug line = 27:6]
  %a.addr = getelementptr inbounds [16 x float]* %a, i64 %tmp.3, i64 %tmp.6, !dbg !44 ; [#uses=1 type=float*] [debug line = 27:6]
  ...
  %a_row.addr = getelementptr inbounds [16 x float]* %a_row, i64 0, i64 %tmp.6, !dbg !44 ; [#uses=1 type=float*] [debug line = 27:6]
  store float %a.load, float* %a_row.addr, align 4, !dbg !44 ; [debug line = 27:6]
  %rend9 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([10 x i8]* @.str5, i64 0, i64 0), i32 %rbegin8) nounwind, !dbg !53 ; [#uses=0 type=i32] [debug line = 27:23]
  %k.1 = add nsw i32 %k, 1, !dbg !54              ; [#uses=1 type=i32] [debug line = 26:38]
  call void @llvm.dbg.value(metadata !{i32 %k.1}, i64 0, metadata !55), !dbg !54 ; [debug line = 26:38] [debug variable = k]
  br label %.preheader5, !dbg !54                 ; [debug line = 26:38]
...
.preheader:                                       ; preds = %4, %.preheader.preheader
  ...
  %exitcond1 = icmp eq i32 %k1, 16, !dbg !61      ; [#uses=1 type=i1] [debug line = 32:29]
  br i1 %exitcond1, label %.loopexit.loopexit, label %4, !dbg !61 ; [debug line = 32:29]

; <label>:4                                       ; preds = %.preheader
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([10 x i8]* @.str6, i64 0, i64 0)) nounwind, !dbg !62 ; [debug line = 32:45]
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([10 x i8]* @.str6, i64 0, i64 0)) nounwind, !dbg !62 ; [#uses=1 type=i32] [debug line = 32:45]
  %tmp.9 = add nsw i32 %k1, 16, !dbg !57          ; [#uses=1 type=i32] [debug line = 33:7]
  %tmp.10 = sext i32 %tmp.9 to i64, !dbg !57      ; [#uses=1 type=i64] [debug line = 33:7]
  %a.addr.1 = getelementptr inbounds [16 x float]* %a, i64 %tmp.10, i64 %tmp.8, !dbg !57 ; [#uses=1 type=float*] [debug line = 33:7]
  ...
  %b_copy.addr = getelementptr inbounds [16 x [16 x float]]* %b_copy, i64 0, i64 %tmp.11, i64 %tmp.8, !dbg !57 ; [#uses=1 type=float*] [debug line = 33:7]
  store float %a.load.1, float* %b_copy.addr, align 4, !dbg !57 ; [debug line = 33:7]
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([10 x i8]* @.str6, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !63 ; [#uses=0 type=i32] [debug line = 34:5]
  %k.2 = add nsw i32 %k1, 1, !dbg !64             ; [#uses=1 type=i32] [debug line = 32:39]
  call void @llvm.dbg.value(metadata !{i32 %k.2}, i64 0, metadata !65), !dbg !64 ; [debug line = 32:39] [debug variable = k]
  br label %.preheader, !dbg !64                  ; [debug line = 32:39]
...
; <label>:5                                       ; preds = %6, %.loopexit
  ...
  %exitcond = icmp eq i32 %k2, 16, !dbg !69       ; [#uses=1 type=i1] [debug line = 37:27]
  br i1 %exitcond, label %7, label %6, !dbg !69   ; [debug line = 37:27]

; <label>:6                                       ; preds = %5
  call void (...)* @_ssdm_op_SpecLoopName(i8* getelementptr inbounds ([8 x i8]* @.str7, i64 0, i64 0)) nounwind, !dbg !70 ; [debug line = 37:43]
  %rbegin2 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([8 x i8]* @.str7, i64 0, i64 0)) nounwind, !dbg !70 ; [#uses=1 type=i32] [debug line = 37:43]
  %tmp.16 = sext i32 %k2 to i64, !dbg !66         ; [#uses=2 type=i64] [debug line = 38:4]
  %a_row.addr.1 = getelementptr inbounds [16 x float]* %a_row, i64 0, i64 %tmp.16, !dbg !66 ; [#uses=1 type=float*] [debug line = 38:4]
  ...
  %b_copy.addr.1 = getelementptr inbounds [16 x [16 x float]]* %b_copy, i64 0, i64 %tmp.16, i64 %tmp.13, !dbg !66 ; [#uses=1 type=float*] [debug line = 38:4]
  ...
  %rend11 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([8 x i8]* @.str7, i64 0, i64 0), i32 %rbegin2) nounwind, !dbg !72 ; [#uses=0 type=i32] [debug line = 39:5]
  %k.3 = add nsw i32 %k2, 1, !dbg !73             ; [#uses=1 type=i32] [debug line = 37:37]
  call void @llvm.dbg.value(metadata !{i32 %k.3}, i64 0, metadata !74), !dbg !73 ; [debug line = 37:37] [debug variable = k]
  br label %5, !dbg !73                           ; [debug line = 37:37]

; <label>:7                                       ; preds = %5
  %tmp.0.lcssa = phi float [ %tmp14, %5 ]         ; [#uses=1 type=float]
  %a.addr.2 = getelementptr inbounds [16 x float]* %a, i64 %tmp.2, i64 %tmp.13, !dbg !43 ; [#uses=1 type=float*] [debug line = 41:5]
  store float %tmp.0.lcssa, float* %a.addr.2, align 4, !dbg !43 ; [debug line = 41:5]
  %rend13 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([4 x i8]* @.str4, i64 0, i64 0), i32 %rbegin1) nounwind, !dbg !75 ; [#uses=0 type=i32] [debug line = 42:3]
  %j.1 = add nsw i32 %j, 1, !dbg !76              ; [#uses=1 type=i32] [debug line = 20:30]
  call void @llvm.dbg.value(metadata !{i32 %j.1}, i64 0, metadata !77), !dbg !76 ; [debug line = 20:30] [debug variable = j]
  br label %.preheader7, !dbg !76                 ; [debug line = 20:30]

; <label>:8                                       ; preds = %.preheader7
  %i.1 = add nsw i32 %i, 1, !dbg !78              ; [#uses=1 type=i32] [debug line = 19:25]
  call void @llvm.dbg.value(metadata !{i32 %i.1}, i64 0, metadata !79), !dbg !78 ; [debug line = 19:25] [debug variable = i]
  br label %1, !dbg !78                           ; [debug line = 19:25]
...
!5 = metadata !{i32 786478, i32 0, metadata !6, metadata !"matmul_hw", metadata !"matmul_hw", metadata !"_Z9matmul_hwPA16_f", metadata !6, i32 4, metadata !7, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void ([16 x float]*)* @matmul_hw, null, null, metadata !15, i32 5} ; [ DW_TAG_subprogram ]
...
!17 = metadata !{void ([16 x float]*)* @matmul_hw, metadata !18, metadata !19, metadata !20, metadata !21, metadata !22, metadata !23}
...
!40 = metadata !{i32 786443, metadata !41, i32 20, i32 35, metadata !6, i32 4} ; [ DW_TAG_lexical_block ]
!41 = metadata !{i32 786443, metadata !42, i32 20, i32 7, metadata !6, i32 3} ; [ DW_TAG_lexical_block ]
!42 = metadata !{i32 786443, metadata !38, i32 19, i32 30, metadata !6, i32 2} ; [ DW_TAG_lexical_block ]
...
!49 = metadata !{i32 20, i32 36, metadata !40, null}
...
!54 = metadata !{i32 26, i32 38, metadata !46, null}
...
!58 = metadata !{i32 786443, metadata !59, i32 32, i32 44, metadata !6, i32 10} ; [ DW_TAG_lexical_block ]
...
!62 = metadata !{i32 32, i32 45, metadata !58, null}
!63 = metadata !{i32 34, i32 5, metadata !58, null}
!64 = metadata !{i32 32, i32 39, metadata !59, null}
...
!67 = metadata !{i32 786443, metadata !68, i32 37, i32 42, metadata !6, i32 12} ; [ DW_TAG_lexical_block ]
...
!70 = metadata !{i32 37, i32 43, metadata !67, null}
...
!73 = metadata !{i32 37, i32 37, metadata !68, null}
