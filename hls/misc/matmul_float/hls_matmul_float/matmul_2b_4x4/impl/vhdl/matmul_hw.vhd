...
architecture behav of matmul_hw is 
    ...
    component matmul_hw_urem_4nhbi IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    ...
    matmul_hw_fmul_32fYi_U2 : component matmul_hw_fmul_32fYi
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,
    ...
    matmul_hw_mux_42_g8j_U3 : component matmul_hw_mux_42_g8j
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din1_WIDTH => 32,
    ...
    matmul_hw_mux_42_g8j_U4 : component matmul_hw_mux_42_g8j
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din1_WIDTH => 32,
    ...
    matmul_hw_urem_4nhbi_U7 : component matmul_hw_urem_4nhbi
    generic map (
        ID => 1,
        NUM_STAGE => 8,
        din0_WIDTH => 4,
