; ModuleID = '/home/patmos/github/bachelor_project_HLS/hls/misc/matmul_float/hls_matmul_float/matmul_2b_4x4/.autopilot/db/a.o.2.bc'
...
define void @matmul_hw([24 x float]* %a_0, [24 x float]* %a_1) {
  ...
  call void (...)* @_ssdm_op_SpecBitsMap([24 x float]* %a_1), !map !7
  call void (...)* @_ssdm_op_SpecBitsMap([24 x float]* %a_0), !map !14
...
.preheader7.preheader:                            ; preds = %.preheader7
  ...
  %tmp_1 = call i5 @_ssdm_op_BitConcatenate.i5.i3.i2(i3 %i2_mid2_v, i2 0)
  %tmp_10 = zext i5 %tmp_1 to i64
  %a_0_addr = getelementptr [24 x float]* %a_0, i64 0, i64 %tmp_10
  %tmp_11 = or i5 %tmp_1, 1
  %tmp_12 = call i64 @_ssdm_op_BitConcatenate.i64.i59.i5(i59 0, i5 %tmp_11)
  %a_0_addr_1 = getelementptr [24 x float]* %a_0, i64 0, i64 %tmp_12
  %tmp_13 = or i5 %tmp_1, 2
  %tmp_14 = call i64 @_ssdm_op_BitConcatenate.i64.i59.i5(i59 0, i5 %tmp_13)
  %a_0_addr_2 = getelementptr [24 x float]* %a_0, i64 0, i64 %tmp_14
  %tmp_15 = or i5 %tmp_1, 3
  %tmp_16 = call i64 @_ssdm_op_BitConcatenate.i64.i59.i5(i59 0, i5 %tmp_15)
  %a_0_addr_3 = getelementptr [24 x float]* %a_0, i64 0, i64 %tmp_16
  ...
  %tmp_17 = call i6 @_ssdm_op_BitConcatenate.i6.i4.i2(i4 %newIndex1_mid2_v, i2 0)
  ...
  %tmp_8_cast5 = zext i3 %j_mid2 to i4
  %tmp_8_cast = zext i3 %j_mid2 to i5
  %tmp_18 = call i64 @_ssdm_op_BitConcatenate.i64.i61.i3(i61 2, i3 %j_mid2)
  %a_0_addr_4 = getelementptr [24 x float]* %a_0, i64 0, i64 %tmp_18
  %tmp_19 = add i5 -12, %tmp_8_cast
  %tmp_20_cast = zext i5 %tmp_19 to i64
  %a_0_addr_5 = getelementptr [24 x float]* %a_0, i64 0, i64 %tmp_20_cast
  %a_1_addr = getelementptr [24 x float]* %a_1, i64 0, i64 %tmp_8
  %tmp_20 = add i4 4, %tmp_8_cast5
  %tmp_21_cast = zext i4 %tmp_20 to i64
  %a_1_addr_1 = getelementptr [24 x float]* %a_1, i64 0, i64 %tmp_21_cast
  %tmp_21 = add i6 %tmp_17, %tmp_8_cast6
  %tmp_22_cast = zext i6 %tmp_21 to i64
  %a_1_addr_2 = getelementptr [24 x float]* %a_1, i64 0, i64 %tmp_22_cast
  %b_copy_0_3_19 = load float* %a_0_addr_4, align 4
  ...
  %b_copy_1_3_19 = load float* %a_0_addr_5, align 4
  ...
  %b_copy_2_3_19 = load float* %a_1_addr, align 4
  ...
  %b_copy_3_3_19 = load float* %a_1_addr_1, align 4
  ...
  %tmp_3 = call float @_ssdm_op_Mux.ap_auto.4float.i2(float %b_copy_0_3_18, float %b_copy_0_3_17, float %b_copy_0_3_16, float %b_copy_0_3_3, i2 %tmp)
  %tmp_s = fmul float %a_row_load, %tmp_3
  %tmp_4 = fadd float %tmp_s, 0.000000e+00
  %tmp_6 = call float @_ssdm_op_Mux.ap_auto.4float.i2(float %b_copy_1_3_18, float %b_copy_1_3_17, float %b_copy_1_3_16, float %b_copy_1_3_3, i2 %tmp)
  %tmp_11_1 = fmul float %a_row_load_1, %tmp_6
  %tmp_12_1 = fadd float %tmp_4, %tmp_11_1
  %tmp_7 = call float @_ssdm_op_Mux.ap_auto.4float.i2(float %b_copy_2_3_18, float %b_copy_2_3_17, float %b_copy_2_3_16, float %b_copy_2_3_3, i2 %tmp)
  %tmp_11_2 = fmul float %a_row_load_2, %tmp_7
  ...
  %tmp_11_3 = fmul float %a_row_load_3, %tmp_9
  %tmp_12_3 = fadd float %tmp_12_2, %tmp_11_3
  store float %tmp_12_3, float* %a_1_addr_2, align 4
...
entry:
  ...
  %empty_16 = zext i3 %1 to i4
  %empty_17 = shl i4 %empty, 3
  %empty_18 = or i4 %empty_17, %empty_16
  ret i4 %empty_18
}
