...
`define AUTOTB_TVOUT_a_1  "./c.matmul_hw.autotvout_a_1.dat"
`define AUTOTB_TVOUT_a_1_out_wrapc  "./impl_rtl.matmul_hw.autotvout_a_1.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 119;
parameter LENGTH_a_0 = 24;
parameter LENGTH_a_1 = 24;
...
assign brama_1_WEN_A = a_1_WEN_A;
assign brama_1_Din_A = a_1_DIN_A;
assign brama_1_ready= ready;
assign brama_1_done = interface_done;
...
reg dump_tvout_finish_a_1;

initial begin : dump_tvout_runtime_sign_a_1
    integer fp;
    dump_tvout_finish_a_1 = 0;
    fp = $fopen(`AUTOTB_TVOUT_a_1_out_wrapc, "w");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_a_1_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
    end
    $fdisplay(fp,"[[[runtime]]]");
    ...
    @ (posedge AESL_clock);
    @ (posedge AESL_clock);
    fp = $fopen(`AUTOTB_TVOUT_a_1_out_wrapc, "a");
    if (fp == 0) begin
        $display("Failed to open file \"%s\"!", `AUTOTB_TVOUT_a_1_out_wrapc);
        $display("ERROR: Simulation using HLS TB failed.");
        $finish;
