...
set C_modelArgList {
	{ a_0 float 32 regular {bram 1536 { 1 } 1 1 }  }
	{ a_1 float 32 regular {bram 1536 { 2 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "a_0", "interface" : "bram", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "a","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 47,"step" : 1},{"low" : 0,"up" : 31,"step" : 1}]}]}]} , 
 	{ "Name" : "a_1", "interface" : "bram", "bitwidth" : 32, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "a","cData": "float","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 48,"up" : 95,"step" : 1},{"low" : 0,"up" : 31,"step" : 1}]}]}]} ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "34", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.matmul_hw_fmul_32eOg_U2", "Parent" : "0"},
	{"ID" : "35", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.matmul_hw_urem_7nfYi_U3", "Parent" : "0"}]}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "49273", "Max" : "49273"}
	, {"Name" : "Interval", "Min" : "49274", "Max" : "49274"}
]}
