; ModuleID = '/home/patmos/github/bachelor_project_HLS/hls/misc/matmul_float/hls_matmul_float/matmul_2b_32x32/.autopilot/db/a.g.1.bc'
...
define void @matmul_hw([32 x float]* %a) nounwind uwtable {
  ...
  call void (...)* @_ssdm_SpecArrayPartition([32 x float]* %a, i32 1, i8* getelementptr inbounds ([6 x i8]* @.str, i64 0, i64 0), i32 2, i8* getelementptr inbounds ([1 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !28 ; [debug line = 6:1]
