...
.preheader.preheader:                             ; preds = %.preheader7.preheader
  ...
  %tmp_8_cast7 = zext i5 %j_mid2 to i8
  %tmp_8_cast6 = zext i5 %j_mid2 to i7
  %tmp_8_cast5 = zext i5 %j_mid2 to i6
  %tmp_8_cast = zext i5 %j_mid2 to i9
  %tmp_39 = call i64 @_ssdm_op_BitConcatenate.i64.i59.i5(i59 8, i5 %j_mid2)
  %a_0_addr_16 = getelementptr [384 x float]* %a_0, i64 0, i64 %tmp_39
  %tmp_40 = add i9 %tmp_8_cast, -240
  %tmp_41_cast = zext i9 %tmp_40 to i64
  %a_0_addr_17 = getelementptr [384 x float]* %a_0, i64 0, i64 %tmp_41_cast
  %tmp_41 = call i64 @_ssdm_op_BitConcatenate.i64.i59.i5(i59 9, i5 %j_mid2)
  %a_0_addr_18 = getelementptr [384 x float]* %a_0, i64 0, i64 %tmp_41
  %tmp_42 = add i9 %tmp_8_cast, -208
  %tmp_43_cast = zext i9 %tmp_42 to i64
  %a_0_addr_19 = getelementptr [384 x float]* %a_0, i64 0, i64 %tmp_43_cast
  %tmp_43 = call i64 @_ssdm_op_BitConcatenate.i64.i59.i5(i59 10, i5 %j_mid2)
  %a_0_addr_20 = getelementptr [384 x float]* %a_0, i64 0, i64 %tmp_43
  %tmp_44 = add i9 %tmp_8_cast, -176
  %tmp_45_cast = zext i9 %tmp_44 to i64
  %a_0_addr_21 = getelementptr [384 x float]* %a_0, i64 0, i64 %tmp_45_cast
  %tmp_45 = call i64 @_ssdm_op_BitConcatenate.i64.i59.i5(i59 11, i5 %j_mid2)
  %a_0_addr_22 = getelementptr [384 x float]* %a_0, i64 0, i64 %tmp_45
  %tmp_46 = add i9 %tmp_8_cast, -144
  %tmp_47_cast = zext i9 %tmp_46 to i64
  %a_0_addr_23 = getelementptr [384 x float]* %a_0, i64 0, i64 %tmp_47_cast
  %a_1_addr = getelementptr [384 x float]* %a_1, i64 0, i64 %tmp_8
  %tmp_47 = add i6 %tmp_8_cast5, 16
  %tmp_48_cast = zext i6 %tmp_47 to i64
  %a_1_addr_1 = getelementptr [384 x float]* %a_1, i64 0, i64 %tmp_48_cast
  %tmp_48 = call i64 @_ssdm_op_BitConcatenate.i64.i59.i5(i59 1, i5 %j_mid2)
  %a_1_addr_2 = getelementptr [384 x float]* %a_1, i64 0, i64 %tmp_48
  %tmp_49 = add i7 %tmp_8_cast6, 48
  %tmp_50_cast = zext i7 %tmp_49 to i64
  %a_1_addr_3 = getelementptr [384 x float]* %a_1, i64 0, i64 %tmp_50_cast
  %tmp_50 = call i64 @_ssdm_op_BitConcatenate.i64.i59.i5(i59 2, i5 %j_mid2)
  %a_1_addr_4 = getelementptr [384 x float]* %a_1, i64 0, i64 %tmp_50
  %tmp_51 = add i7 %tmp_8_cast6, -48
  %tmp_52_cast = zext i7 %tmp_51 to i64
  %a_1_addr_5 = getelementptr [384 x float]* %a_1, i64 0, i64 %tmp_52_cast
  %tmp_52 = call i64 @_ssdm_op_BitConcatenate.i64.i59.i5(i59 3, i5 %j_mid2)
  %a_1_addr_6 = getelementptr [384 x float]* %a_1, i64 0, i64 %tmp_52
  %tmp_53 = add i8 %tmp_8_cast7, 112
  %tmp_54_cast = zext i8 %tmp_53 to i64
  %a_1_addr_7 = getelementptr [384 x float]* %a_1, i64 0, i64 %tmp_54_cast
  %a_0_load_16 = load float* %a_0_addr_16, align 4
  %b_copy_0_addr = getelementptr [16 x float]* %b_copy_0, i64 0, i64 %tmp_8
  store float %a_0_load_16, float* %b_copy_0_addr, align 4
  %a_0_load_17 = load float* %a_0_addr_17, align 4
  %b_copy_1_addr = getelementptr [16 x float]* %b_copy_1, i64 0, i64 %tmp_8
  store float %a_0_load_17, float* %b_copy_1_addr, align 4
  %a_0_load_18 = load float* %a_0_addr_18, align 4
  %b_copy_2_addr = getelementptr [16 x float]* %b_copy_2, i64 0, i64 %tmp_8
  store float %a_0_load_18, float* %b_copy_2_addr, align 4
  %a_0_load_19 = load float* %a_0_addr_19, align 4
  %b_copy_3_addr = getelementptr [16 x float]* %b_copy_3, i64 0, i64 %tmp_8
  store float %a_0_load_19, float* %b_copy_3_addr, align 4
  %a_0_load_20 = load float* %a_0_addr_20, align 4
  %b_copy_4_addr = getelementptr [16 x float]* %b_copy_4, i64 0, i64 %tmp_8
  store float %a_0_load_20, float* %b_copy_4_addr, align 4
  %a_0_load_21 = load float* %a_0_addr_21, align 4
  %b_copy_5_addr = getelementptr [16 x float]* %b_copy_5, i64 0, i64 %tmp_8
  store float %a_0_load_21, float* %b_copy_5_addr, align 4
  %a_0_load_22 = load float* %a_0_addr_22, align 4
  %b_copy_6_addr = getelementptr [16 x float]* %b_copy_6, i64 0, i64 %tmp_8
  store float %a_0_load_22, float* %b_copy_6_addr, align 4
  %a_0_load_23 = load float* %a_0_addr_23, align 4
  %b_copy_7_addr = getelementptr [16 x float]* %b_copy_7, i64 0, i64 %tmp_8
  store float %a_0_load_23, float* %b_copy_7_addr, align 4
  %a_1_load = load float* %a_1_addr, align 4
  %b_copy_8_addr = getelementptr [16 x float]* %b_copy_8, i64 0, i64 %tmp_8
  store float %a_1_load, float* %b_copy_8_addr, align 4
  %a_1_load_1 = load float* %a_1_addr_1, align 4
  %b_copy_9_addr = getelementptr [16 x float]* %b_copy_9, i64 0, i64 %tmp_8
  store float %a_1_load_1, float* %b_copy_9_addr, align 4
  %a_1_load_2 = load float* %a_1_addr_2, align 4
  %b_copy_10_addr = getelementptr [16 x float]* %b_copy_10, i64 0, i64 %tmp_8
  store float %a_1_load_2, float* %b_copy_10_addr, align 4
  %a_1_load_3 = load float* %a_1_addr_3, align 4
  %b_copy_11_addr = getelementptr [16 x float]* %b_copy_11, i64 0, i64 %tmp_8
  store float %a_1_load_3, float* %b_copy_11_addr, align 4
  %a_1_load_4 = load float* %a_1_addr_4, align 4
  %b_copy_12_addr = getelementptr [16 x float]* %b_copy_12, i64 0, i64 %tmp_8
  store float %a_1_load_4, float* %b_copy_12_addr, align 4
  %a_1_load_5 = load float* %a_1_addr_5, align 4
  %b_copy_13_addr = getelementptr [16 x float]* %b_copy_13, i64 0, i64 %tmp_8
  store float %a_1_load_5, float* %b_copy_13_addr, align 4
  %a_1_load_6 = load float* %a_1_addr_6, align 4
  %b_copy_14_addr = getelementptr [16 x float]* %b_copy_14, i64 0, i64 %tmp_8
  store float %a_1_load_6, float* %b_copy_14_addr, align 4
  %a_1_load_7 = load float* %a_1_addr_7, align 4
  %b_copy_15_addr = getelementptr [16 x float]* %b_copy_15, i64 0, i64 %tmp_8
  store float %a_1_load_7, float* %b_copy_15_addr, align 4
  br label %.loopexit

.loopexit:                                        ; preds = %.preheader.preheader, %.preheader7.preheader
  %tmp_7 = zext i5 %j_mid2 to i64
  %tmp_7_cast = zext i5 %j_mid2 to i10
  %tmp_54 = add i10 %tmp_38, %tmp_7_cast
  %tmp_55_cast = zext i10 %tmp_54 to i64
  %a_1_addr_8 = getelementptr [384 x float]* %a_1, i64 0, i64 %tmp_55_cast
  ...
  store float %tmp_12_14, float* %a_1_addr_8, align 4
...
entry:
  ...
  %empty_13 = zext i5 %1 to i6
  %empty_14 = shl i6 %empty, 5
