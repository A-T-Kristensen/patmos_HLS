...
define void @matmul_hw([16 x float]* %a_0, [16 x float]* %a_1, [16 x float]* %a_2) {
  ...
  call void (...)* @_ssdm_op_SpecBitsMap([16 x float]* %a_2), !map !7
  call void (...)* @_ssdm_op_SpecBitsMap([16 x float]* %a_1), !map !14
  call void (...)* @_ssdm_op_SpecBitsMap([16 x float]* %a_0), !map !20
...
.preheader7.preheader:                            ; preds = %.preheader7
  ...
  %tmp_10 = zext i5 %tmp_7 to i64
  %tmp_10_cast = zext i5 %tmp_7 to i6
  %a_0_addr = getelementptr [16 x float]* %a_0, i64 0, i64 %tmp_10
  %tmp_11 = or i5 %tmp_7, 1
  %tmp_12 = call i64 @_ssdm_op_BitConcatenate.i64.i59.i5(i59 0, i5 %tmp_11)
  %a_0_addr_1 = getelementptr [16 x float]* %a_0, i64 0, i64 %tmp_12
  %tmp_13 = or i5 %tmp_7, 2
  %tmp_14 = call i64 @_ssdm_op_BitConcatenate.i64.i59.i5(i59 0, i5 %tmp_13)
  %a_0_addr_2 = getelementptr [16 x float]* %a_0, i64 0, i64 %tmp_14
  %tmp_15 = or i5 %tmp_7, 3
  %tmp_16 = call i64 @_ssdm_op_BitConcatenate.i64.i59.i5(i59 0, i5 %tmp_15)
  %a_0_addr_3 = getelementptr [16 x float]* %a_0, i64 0, i64 %tmp_16
  ...
  %a_row_load_3 = select i1 %tmp_5, float %a_0_load_3, float %a_row_load_10
  %a_row_load_2 = select i1 %tmp_5, float %a_0_load_2, float %a_row_load_6
  %a_row_load_1 = select i1 %tmp_5, float %a_0_load_1, float %a_row_load_5
  %a_row_load = select i1 %tmp_5, float %a_0_load, float %a_row_load_4
  ...
  %a_1_addr = getelementptr [16 x float]* %a_1, i64 0, i64 %tmp_8
  %tmp_17 = add i4 4, %tmp_8_cast
  %tmp_17_cast = zext i4 %tmp_17 to i64
  %a_1_addr_1 = getelementptr [16 x float]* %a_1, i64 0, i64 %tmp_17_cast
  %tmp_18 = call i64 @_ssdm_op_BitConcatenate.i64.i61.i3(i61 1, i3 %j_mid2)
  %a_1_addr_2 = getelementptr [16 x float]* %a_1, i64 0, i64 %tmp_18
  %tmp_19 = add i5 12, %tmp_8_cast5
  %tmp_19_cast = zext i5 %tmp_19 to i64
  %a_1_addr_3 = getelementptr [16 x float]* %a_1, i64 0, i64 %tmp_19_cast
  %tmp_20 = add i6 %tmp_10_cast, %tmp_8_cast6
  %tmp_20_cast = zext i6 %tmp_20 to i64
  %a_2_addr = getelementptr [16 x float]* %a_2, i64 0, i64 %tmp_20_cast
  %b_copy_0_3_19 = load float* %a_1_addr, align 4
  ...
  %b_copy_1_3_19 = load float* %a_1_addr_1, align 4
  ...
  %b_copy_2_3_19 = load float* %a_1_addr_2, align 4
  ...
  %b_copy_3_3_19 = load float* %a_1_addr_3, align 4
  ...
  %tmp_2 = call float @_ssdm_op_Mux.ap_auto.4float.i2(float %b_copy_0_3_18, float %b_copy_0_3_17, float %b_copy_0_3_16, float %b_copy_0_3_3, i2 %tmp)
  %tmp_s = fmul float %a_row_load, %tmp_2
  %tmp_9 = fadd float %tmp_s, 0.000000e+00
  %tmp_3 = call float @_ssdm_op_Mux.ap_auto.4float.i2(float %b_copy_1_3_18, float %b_copy_1_3_17, float %b_copy_1_3_16, float %b_copy_1_3_3, i2 %tmp)
  %tmp_11_1 = fmul float %a_row_load_1, %tmp_3
  %tmp_12_1 = fadd float %tmp_9, %tmp_11_1
  %tmp_4 = call float @_ssdm_op_Mux.ap_auto.4float.i2(float %b_copy_2_3_18, float %b_copy_2_3_17, float %b_copy_2_3_16, float %b_copy_2_3_3, i2 %tmp)
  %tmp_11_2 = fmul float %a_row_load_2, %tmp_4
  %tmp_12_2 = fadd float %tmp_12_1, %tmp_11_2
  %tmp_6 = call float @_ssdm_op_Mux.ap_auto.4float.i2(float %b_copy_3_3_18, float %b_copy_3_3_17, float %b_copy_3_3_16, float %b_copy_3_3_3, i2 %tmp)
  %tmp_11_3 = fmul float %a_row_load_3, %tmp_6
  %tmp_12_3 = fadd float %tmp_12_2, %tmp_11_3
  store float %tmp_12_3, float* %a_2_addr, align 4
  %empty_3 = call i32 (...)* @_ssdm_op_SpecRegionEnd([4 x i8]* @p_str5, i32 %tmp_1) nounwind
  %j_1 = add i3 1, %j_mid2
