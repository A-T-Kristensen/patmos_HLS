...
architecture behav of matmul_hw is 
    ...
    "matmul_hw,hls_ip_2016_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=1,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7a100tcsg324-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.263000,HLS_SYN_LAT=88,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=5,HLS_SYN_FF=1491,HLS_SYN_LUT=2654}";
    ...
    signal tmp_5_reg_1313 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal i2_mid2_v_fu_350_p3 : STD_LOGIC_VECTOR (2 downto 0);
    signal i2_mid2_v_reg_1274 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_7_fu_358_p3 : STD_LOGIC_VECTOR (4 downto 0);
    ...
    signal tmp_2_fu_540_p6 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_2_reg_1365 : STD_LOGIC_VECTOR (31 downto 0);
    signal a_row_load_fu_602_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_3_fu_709_p6 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_3_reg_1385 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal tmp_6_fu_1068_p6 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal tmp_11_1_reg_1440 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_pipeline_reg_pp0_iter2_tmp_11_1_reg_1440 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_11_2_reg_1445 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_pipeline_reg_pp0_iter2_tmp_11_2_reg_1445 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_pipeline_reg_pp0_iter3_tmp_11_2_reg_1445 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_11_3_reg_1450 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_enable_reg_pp0_iter2 : STD_LOGIC := '0';
    signal ap_pipeline_reg_pp0_iter3_tmp_11_3_reg_1450 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_pipeline_reg_pp0_iter4_tmp_11_3_reg_1450 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_pipeline_reg_pp0_iter5_tmp_11_3_reg_1450 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_fu_285_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_9_reg_1455 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_12_1_reg_1460 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_enable_reg_pp0_iter3 : STD_LOGIC := '0';
    signal tmp_12_2_reg_1465 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_enable_reg_pp0_iter5 : STD_LOGIC := '0';
    signal tmp_12_3_reg_1470 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal tmp_8_fu_371_p1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal tmp_8_cast_fu_411_p1 : STD_LOGIC_VECTOR (3 downto 0);
    ...
    signal tmp_2_fu_540_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_2_fu_540_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_2_fu_540_p4 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal tmp_3_fu_709_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_3_fu_709_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_3_fu_709_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_3_fu_709_p4 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_15_fu_765_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal tmp_8_cast5_fu_790_p1 : STD_LOGIC_VECTOR (4 downto 0);
    signal tmp_19_fu_793_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal tmp_10_cast_fu_762_p1 : STD_LOGIC_VECTOR (5 downto 0);
    signal tmp_8_cast6_fu_787_p1 : STD_LOGIC_VECTOR (5 downto 0);
    ...
    signal tmp_6_fu_1068_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_6_fu_1068_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_6_fu_1068_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_6_fu_1068_p4 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_state29 : STD_LOGIC_VECTOR (0 downto 0);
    attribute fsm_encoding of ap_CS_fsm_state29 : signal is "none";
    signal ap_NS_fsm : STD_LOGIC_VECTOR (5 downto 0);

    component matmul_hw_fadd_32ibs IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component matmul_hw_fmul_32jbC IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component matmul_hw_mux_42_kbM IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din1_WIDTH : INTEGER;
...
begin
    matmul_hw_fadd_32ibs_U1 : component matmul_hw_fadd_32ibs
    generic map (
        ID => 1,
        NUM_STAGE => 5,
        din0_WIDTH => 32,
    ...
    matmul_hw_fmul_32jbC_U2 : component matmul_hw_fmul_32jbC
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 32,
    ...
    matmul_hw_mux_42_kbM_U3 : component matmul_hw_mux_42_kbM
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din1_WIDTH => 32,
    ...
    matmul_hw_mux_42_kbM_U4 : component matmul_hw_mux_42_kbM
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din1_WIDTH => 32,
    ...
    matmul_hw_mux_42_kbM_U5 : component matmul_hw_mux_42_kbM
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din1_WIDTH => 32,
    ...
    matmul_hw_mux_42_kbM_U6 : component matmul_hw_mux_42_kbM
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din1_WIDTH => 32,
        ...
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_lv1_1 = ap_CS_fsm_pp0_stage0) and (ap_const_lv1_0 = exitcond_flatten_fu_298_p2))) then
                j_mid2_reg_1244 <= j_mid2_fu_322_p3;
                    tmp_7_reg_1279(4 downto 2) <= tmp_7_fu_358_p3(4 downto 2);
    ...
    a_0_Addr_A_orig_assign_proc : process(ap_CS_fsm_pp0_stage1, ap_enable_reg_pp0_iter0, ap_CS_fsm_pp0_stage2, ap_CS_fsm_pp0_stage3, ap_CS_fsm_pp0_stage0, tmp_10_fu_366_p1, tmp_12_fu_397_p3, tmp_14_fu_593_p3, tmp_16_fu_770_p3)
    begin
        if ((ap_const_logic_1 = ap_enable_reg_pp0_iter0)) then
            if ((ap_const_lv1_1 = ap_CS_fsm_pp0_stage3)) then 
                a_0_Addr_A_orig <= tmp_16_fu_770_p3(32 - 1 downto 0);
            elsif ((ap_const_lv1_1 = ap_CS_fsm_pp0_stage2)) then 
                a_0_Addr_A_orig <= tmp_14_fu_593_p3(32 - 1 downto 0);
            elsif ((ap_const_lv1_1 = ap_CS_fsm_pp0_stage1)) then 
                a_0_Addr_A_orig <= tmp_12_fu_397_p3(32 - 1 downto 0);
            elsif ((ap_const_lv1_1 = ap_CS_fsm_pp0_stage0)) then 
                a_0_Addr_A_orig <= tmp_10_fu_366_p1(32 - 1 downto 0);
            else 
    ...
    a_1_Addr_A_orig_assign_proc : process(ap_CS_fsm_pp0_stage1, ap_enable_reg_pp0_iter0, ap_CS_fsm_pp0_stage2, ap_CS_fsm_pp0_stage3, ap_CS_fsm_pp0_stage0, tmp_8_fu_371_p1, tmp_17_cast_fu_420_p1, tmp_18_fu_610_p3, tmp_19_cast_fu_799_p1)
    begin
        if ((ap_const_logic_1 = ap_enable_reg_pp0_iter0)) then
            if ((ap_const_lv1_1 = ap_CS_fsm_pp0_stage3)) then 
                a_1_Addr_A_orig <= tmp_19_cast_fu_799_p1(32 - 1 downto 0);
            elsif ((ap_const_lv1_1 = ap_CS_fsm_pp0_stage2)) then 
                a_1_Addr_A_orig <= tmp_18_fu_610_p3(32 - 1 downto 0);
            elsif ((ap_const_lv1_1 = ap_CS_fsm_pp0_stage1)) then 
                a_1_Addr_A_orig <= tmp_17_cast_fu_420_p1(32 - 1 downto 0);
            elsif ((ap_const_lv1_1 = ap_CS_fsm_pp0_stage0)) then 
                a_1_Addr_A_orig <= tmp_8_fu_371_p1(32 - 1 downto 0);
            else 
    ...
    a_2_Addr_A_orig <= tmp_20_cast_fu_1111_p1(32 - 1 downto 0);
    a_2_Clk_A <= ap_clk;
    a_2_Din_A <= tmp_12_3_reg_1470;

    a_2_EN_A_assign_proc : process(ap_CS_fsm_pp0_stage2, ap_enable_reg_pp0_iter6)
    begin
    ...
    a_2_WEN_A_assign_proc : process(ap_CS_fsm_pp0_stage2, ap_pipeline_reg_pp0_iter6_exitcond_flatten_reg_1235, ap_enable_reg_pp0_iter6)
    begin
    ...
    a_row_load_1_fu_779_p3 <= 
        reg_294 when (tmp_5_reg_1313(0) = '1') else 
        a_row_load_9_fu_92;
    a_row_load_2_fu_969_p3 <= 
        reg_294 when (tmp_5_reg_1313(0) = '1') else 
        a_row_load_8_fu_96;
    a_row_load_3_fu_962_p3 <= 
        a_0_Dout_A when (tmp_5_reg_1313(0) = '1') else 
        a_row_load_7_fu_100;
    ...
    b_copy_0_3_15_fu_504_p3 <= 
        a_1_Dout_A when (sel_tmp4_fu_451_p2(0) = '1') else 
    ...
    b_copy_0_3_5_fu_464_p3 <= 
        a_1_Dout_A when (sel_tmp_fu_425_p2(0) = '1') else 
        b_copy_0_3_12_fu_112;
    ...
    b_copy_0_3_7_fu_480_p3 <= 
        ...
        b_copy_0_3_6_fu_472_p3;
    b_copy_0_3_9_fu_488_p3 <= 
        a_1_Dout_A when (sel_tmp2_fu_438_p2(0) = '1') else 
        b_copy_0_3_8_fu_108;
    b_copy_0_3_fu_430_p3 <= 
    ...
    b_copy_1_3_15_fu_674_p3 <= 
        a_1_Dout_A when (sel_tmp4_reg_1349(0) = '1') else 
    ...
    b_copy_1_3_5_fu_639_p3 <= 
        a_1_Dout_A when (sel_tmp_reg_1326(0) = '1') else 
        b_copy_1_3_12_fu_128;
    ...
    b_copy_1_3_7_fu_653_p3 <= 
        ...
        b_copy_1_3_6_fu_646_p3;
    b_copy_1_3_9_fu_660_p3 <= 
        a_1_Dout_A when (sel_tmp2_reg_1336(0) = '1') else 
        b_copy_1_3_8_fu_124;
    b_copy_1_3_fu_618_p3 <= 
    ...
    grp_fu_285_p0_assign_proc : process(ap_CS_fsm_pp0_stage1, ap_CS_fsm_pp0_stage2, ap_CS_fsm_pp0_stage3, ap_CS_fsm_pp0_stage0, tmp_s_reg_1435, ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, tmp_9_reg_1455, tmp_12_1_reg_1460, tmp_12_2_reg_1465, ap_enable_reg_pp0_iter5, ap_enable_reg_pp0_iter4)
    begin
    ...
    grp_fu_285_p1_assign_proc : process(ap_CS_fsm_pp0_stage1, ap_CS_fsm_pp0_stage2, ap_CS_fsm_pp0_stage3, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_pipeline_reg_pp0_iter2_tmp_11_1_reg_1440, ap_pipeline_reg_pp0_iter3_tmp_11_2_reg_1445, ap_enable_reg_pp0_iter2, ap_pipeline_reg_pp0_iter5_tmp_11_3_reg_1450, ap_enable_reg_pp0_iter5, ap_enable_reg_pp0_iter4)
    begin
        if (((ap_const_lv1_1 = ap_CS_fsm_pp0_stage1) and (ap_const_logic_1 = ap_enable_reg_pp0_iter5))) then 
    ...
    grp_fu_290_p1_assign_proc : process(ap_CS_fsm_pp0_stage1, ap_enable_reg_pp0_iter0, ap_CS_fsm_pp0_stage2, ap_CS_fsm_pp0_stage3, ap_CS_fsm_pp0_stage0, tmp_2_reg_1365, tmp_3_reg_1385, tmp_4_reg_1410, tmp_6_reg_1430, ap_enable_reg_pp0_iter1)
    begin
        if (((ap_const_lv1_1 = ap_CS_fsm_pp0_stage1) and (ap_const_logic_1 = ap_enable_reg_pp0_iter1))) then 
    ...
    i_phi_fu_267_p4_assign_proc : process(i_reg_263, exitcond_flatten_reg_1235, ap_CS_fsm_pp0_stage0, i2_mid2_v_reg_1274, ap_enable_reg_pp0_iter1)
    begin
        if (((exitcond_flatten_reg_1235 = ap_const_lv1_0) and (ap_const_lv1_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_enable_reg_pp0_iter1))) then 
    ...
    tmp_10_cast_fu_762_p1 <= std_logic_vector(resize(unsigned(tmp_7_reg_1279),6));
    tmp_10_fu_366_p1 <= std_logic_vector(resize(unsigned(tmp_7_fu_358_p3),64));
    tmp_11_fu_392_p2 <= (tmp_7_reg_1279 or ap_const_lv5_1);
    tmp_12_fu_397_p3 <= (ap_const_lv59_0 & tmp_11_fu_392_p2);
    tmp_13_fu_588_p2 <= (tmp_7_reg_1279 or ap_const_lv5_2);
    tmp_14_fu_593_p3 <= (ap_const_lv59_0 & tmp_13_fu_588_p2);
    tmp_15_fu_765_p2 <= (tmp_7_reg_1279 or ap_const_lv5_3);
    ...
    tmp_17_fu_414_p2 <= std_logic_vector(unsigned(ap_const_lv4_4) + unsigned(tmp_8_cast_fu_411_p1));
    ...
    tmp_19_fu_793_p2 <= std_logic_vector(unsigned(ap_const_lv5_C) + unsigned(tmp_8_cast5_fu_790_p1));
    tmp_20_cast_fu_1111_p1 <= std_logic_vector(resize(unsigned(ap_pipeline_reg_pp0_iter5_tmp_20_reg_1405),64));
    tmp_20_fu_804_p2 <= std_logic_vector(unsigned(tmp_10_cast_fu_762_p1) + unsigned(tmp_8_cast6_fu_787_p1));
    tmp_2_fu_540_p1 <= 
        b_copy_0_3_15_fu_504_p3 when (tmp_mid2_reg_1254(0) = '1') else 
        b_copy_0_3_11_fu_104;
    tmp_2_fu_540_p2 <= 
    ...
    tmp_4_fu_901_p4 <= 
        b_copy_2_3_2_fu_824_p3 when (tmp_mid2_reg_1254(0) = '1') else 
        b_copy_2_3_1_fu_148;
    tmp_5_fu_406_p2 <= "1" when (j_mid2_reg_1244 = ap_const_lv3_0) else "0";
    tmp_6_fu_1068_p1 <= 
        b_copy_3_3_15_fu_1033_p3 when (tmp_mid2_reg_1254(0) = '1') else 
        b_copy_3_3_11_fu_152;
    tmp_6_fu_1068_p2 <= 
    ...
    tmp_6_fu_1068_p4 <= 
        b_copy_3_3_2_fu_991_p3 when (tmp_mid2_reg_1254(0) = '1') else 
        b_copy_3_3_1_fu_164;
    tmp_7_fu_358_p3 <= (i2_mid2_v_fu_350_p3 & ap_const_lv2_0);
    tmp_8_cast5_fu_790_p1 <= std_logic_vector(resize(unsigned(j_mid2_reg_1244),5));
    tmp_8_cast6_fu_787_p1 <= std_logic_vector(resize(unsigned(j_mid2_reg_1244),6));
    tmp_8_cast_fu_411_p1 <= std_logic_vector(resize(unsigned(j_mid2_reg_1244),4));
    tmp_8_fu_371_p1 <= std_logic_vector(resize(unsigned(j_mid2_fu_322_p3),64));
