...
.preheader.preheader:                             ; preds = %.preheader7.preheader
  ...
  %tmp_8_cast7 = zext i5 %j_mid2 to i9
  %tmp_8_cast6 = zext i5 %j_mid2 to i8
  %tmp_8_cast6_cast = zext i5 %j_mid2 to i7
  %tmp_8_cast = zext i5 %j_mid2 to i6
  %a_1_addr = getelementptr [256 x float]* %a_1, i64 0, i64 %tmp_8
  %tmp_38 = add i6 %tmp_8_cast, 16
  %tmp_38_cast = zext i6 %tmp_38 to i64
  %a_1_addr_1 = getelementptr [256 x float]* %a_1, i64 0, i64 %tmp_38_cast
  %tmp_39 = call i64 @_ssdm_op_BitConcatenate.i64.i59.i5(i59 1, i5 %j_mid2)
  %a_1_addr_2 = getelementptr [256 x float]* %a_1, i64 0, i64 %tmp_39
  %tmp_40 = add i7 %tmp_8_cast6_cast, 48
  %tmp_40_cast = zext i7 %tmp_40 to i64
  %a_1_addr_3 = getelementptr [256 x float]* %a_1, i64 0, i64 %tmp_40_cast
  %tmp_41 = call i64 @_ssdm_op_BitConcatenate.i64.i59.i5(i59 2, i5 %j_mid2)
  %a_1_addr_4 = getelementptr [256 x float]* %a_1, i64 0, i64 %tmp_41
  %tmp_42 = add i7 %tmp_8_cast6_cast, -48
  %tmp_42_cast = zext i7 %tmp_42 to i64
  %a_1_addr_5 = getelementptr [256 x float]* %a_1, i64 0, i64 %tmp_42_cast
  %tmp_43 = call i64 @_ssdm_op_BitConcatenate.i64.i59.i5(i59 3, i5 %j_mid2)
  %a_1_addr_6 = getelementptr [256 x float]* %a_1, i64 0, i64 %tmp_43
  %tmp_44 = add i8 %tmp_8_cast6, 112
  %tmp_44_cast = zext i8 %tmp_44 to i64
  %a_1_addr_7 = getelementptr [256 x float]* %a_1, i64 0, i64 %tmp_44_cast
  %tmp_45 = call i64 @_ssdm_op_BitConcatenate.i64.i59.i5(i59 4, i5 %j_mid2)
  %a_1_addr_8 = getelementptr [256 x float]* %a_1, i64 0, i64 %tmp_45
  %tmp_46 = add i8 %tmp_8_cast6, -112
  %tmp_46_cast = zext i8 %tmp_46 to i64
  %a_1_addr_9 = getelementptr [256 x float]* %a_1, i64 0, i64 %tmp_46_cast
  %tmp_47 = call i64 @_ssdm_op_BitConcatenate.i64.i59.i5(i59 5, i5 %j_mid2)
  %a_1_addr_10 = getelementptr [256 x float]* %a_1, i64 0, i64 %tmp_47
  %tmp_48 = add i8 %tmp_8_cast6, -80
  %tmp_48_cast = zext i8 %tmp_48 to i64
  %a_1_addr_11 = getelementptr [256 x float]* %a_1, i64 0, i64 %tmp_48_cast
  %tmp_49 = call i64 @_ssdm_op_BitConcatenate.i64.i59.i5(i59 6, i5 %j_mid2)
  %a_1_addr_12 = getelementptr [256 x float]* %a_1, i64 0, i64 %tmp_49
  %tmp_50_cast8 = sext i7 %tmp_42 to i8
  %tmp_50_cast = zext i8 %tmp_50_cast8 to i64
  %a_1_addr_13 = getelementptr [256 x float]* %a_1, i64 0, i64 %tmp_50_cast
  %tmp_50 = call i64 @_ssdm_op_BitConcatenate.i64.i59.i5(i59 7, i5 %j_mid2)
  %a_1_addr_14 = getelementptr [256 x float]* %a_1, i64 0, i64 %tmp_50
  %tmp_51 = add i9 %tmp_8_cast7, 240
  %tmp_52_cast = zext i9 %tmp_51 to i64
  %a_1_addr_15 = getelementptr [256 x float]* %a_1, i64 0, i64 %tmp_52_cast
...
.loopexit:                                        ; preds = %.preheader.preheader, %.preheader7.preheader
  ...
  %tmp_52 = add i10 %tmp_4_cast, %tmp_7_cast
  %tmp_53_cast = zext i10 %tmp_52 to i64
  %a_2_addr = getelementptr [256 x float]* %a_2, i64 0, i64 %tmp_53_cast
  ...
  store float %tmp_12_14, float* %a_2_addr, align 4
...
.preheader7.preheader:                            ; preds = %.preheader7
  ...
  %tmp_3 = call i9 @_ssdm_op_BitConcatenate.i9.i5.i4(i5 %i2_mid2_v, i4 0)
  %tmp_4 = zext i9 %tmp_3 to i64
  %tmp_4_cast = zext i9 %tmp_3 to i10
  %a_0_addr = getelementptr [256 x float]* %a_0, i64 0, i64 %tmp_4
  %tmp_6 = or i9 %tmp_3, 1
  %tmp_9 = call i64 @_ssdm_op_BitConcatenate.i64.i55.i9(i55 0, i9 %tmp_6)
  %a_0_addr_1 = getelementptr [256 x float]* %a_0, i64 0, i64 %tmp_9
  ...
  %a_row_load_15 = select i1 %tmp_5, float %a_0_load_15, float %a_row_load_45
  %a_row_load_14 = select i1 %tmp_5, float %a_0_load_14, float %a_row_load_44
  %a_row_load_13 = select i1 %tmp_5, float %a_0_load_13, float %a_row_load_43
  %a_row_load_12 = select i1 %tmp_5, float %a_0_load_12, float %a_row_load_42
  %a_row_load_11 = select i1 %tmp_5, float %a_0_load_11, float %a_row_load_41
  %a_row_load_10 = select i1 %tmp_5, float %a_0_load_10, float %a_row_load_40
  %a_row_load_9 = select i1 %tmp_5, float %a_0_load_9, float %a_row_load_39
  %a_row_load_8 = select i1 %tmp_5, float %a_0_load_8, float %a_row_load_38
  %a_row_load_7 = select i1 %tmp_5, float %a_0_load_7, float %a_row_load_37
  %a_row_load_6 = select i1 %tmp_5, float %a_0_load_6, float %a_row_load_36
  %a_row_load_5 = select i1 %tmp_5, float %a_0_load_5, float %a_row_load_35
  %a_row_load_4 = select i1 %tmp_5, float %a_0_load_4, float %a_row_load_34
  %a_row_load_3 = select i1 %tmp_5, float %a_0_load_3, float %a_row_load_33
  %a_row_load_2 = select i1 %tmp_5, float %a_0_load_2, float %a_row_load_32
  %a_row_load_1 = select i1 %tmp_5, float %a_0_load_1, float %a_row_load_31
  %a_row_load = select i1 %tmp_5, float %a_0_load, float %a_row_load_30
